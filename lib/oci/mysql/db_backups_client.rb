...
module OCI
  ...
  class Mysql::DbBackupsClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mysql/cancel_backup_deletion.rb.html) to see an example of how to use cancel_backup_deletion API.
    def cancel_backup_deletion(backup_id, opts = {})
      logger.debug 'Calling operation DbBackupsClient#cancel_backup_deletion.' if logger

      raise "Missing the required parameter 'backup_id' when calling cancel_backup_deletion." if backup_id.nil?
      raise "Parameter value for 'backup_id' must not be blank" if OCI::Internal::Util.blank_string?(backup_id)

      path = '/backups/{backupId}/actions/cancelDeletion'.sub('{backupId}', backup_id.to_s)
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DbBackupsClient#cancel_backup_deletion') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] backup_id The OCID of the Backup
    # @param [OCI::Mysql::Models::ExportBackupDetails] export_backup_details Details required to export a given DB system backup to an Object Storage bucket.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Customer-defined unique identifier for the request. If you need to
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mysql/export_backup.rb.html) to see an example of how to use export_backup API.
    def export_backup(backup_id, export_backup_details, opts = {})
      logger.debug 'Calling operation DbBackupsClient#export_backup.' if logger

      raise "Missing the required parameter 'backup_id' when calling export_backup." if backup_id.nil?
      raise "Missing the required parameter 'export_backup_details' when calling export_backup." if export_backup_details.nil?
      raise "Parameter value for 'backup_id' must not be blank" if OCI::Internal::Util.blank_string?(backup_id)

      path = '/backups/{backupId}/actions/export'.sub('{backupId}', backup_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(export_backup_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DbBackupsClient#export_backup') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @option opts [String] :soft_delete Backup Soft Delete
    # @option opts [String] :backup_preparation_status Indicates whether the backup has been prepared successfully.
    #    (default to NOT_PREPARED)
    # @option opts [String] :validation_status Backup validation status (default to NOT_VALIDATED)
    ...
    def list_backups(compartment_id, opts = {})
      ...
      if opts[:soft_delete] && !OCI::Mysql::Models::SOFT_DELETE_ENUM.include?(opts[:soft_delete])
        raise 'Invalid value for "soft_delete", must be one of the values in OCI::Mysql::Models::SOFT_DELETE_ENUM.'
      end

      if opts[:backup_preparation_status] && !OCI::Mysql::Models::BackupValidationDetails::BACKUP_PREPARATION_STATUS_ENUM.include?(opts[:backup_preparation_status])
        raise 'Invalid value for "backup_preparation_status", must be one of the values in OCI::Mysql::Models::BackupValidationDetails::BACKUP_PREPARATION_STATUS_ENUM.'
      end

      if opts[:validation_status] && !OCI::Mysql::Models::BackupValidationDetails::VALIDATION_STATUS_ENUM.include?(opts[:validation_status])
        raise 'Invalid value for "validation_status", must be one of the values in OCI::Mysql::Models::BackupValidationDetails::VALIDATION_STATUS_ENUM.'
      end
      ...
      query_params[:softDelete] = opts[:soft_delete] if opts[:soft_delete]
      query_params[:backupPreparationStatus] = opts[:backup_preparation_status] if opts[:backup_preparation_status]
      query_params[:validationStatus] = opts[:validation_status] if opts[:validation_status]
    ...
    #   creation request may be rejected).
    #
    # @option opts [OCI::Mysql::Models::ValidateBackupDetails] :validate_backup_details Details required to validate the backup.
    # @return [Response] A Response object with data of type {OCI::Mysql::Models::Backup Backup}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mysql/validate_backup.rb.html) to see an example of how to use validate_backup API.
    def validate_backup(backup_id, opts = {})
      logger.debug 'Calling operation DbBackupsClient#validate_backup.' if logger

      raise "Missing the required parameter 'backup_id' when calling validate_backup." if backup_id.nil?
      raise "Parameter value for 'backup_id' must not be blank" if OCI::Internal::Util.blank_string?(backup_id)

      path = '/backups/{backupId}/actions/validate'.sub('{backupId}', backup_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(opts[:validate_backup_details])

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DbBackupsClient#validate_backup') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
