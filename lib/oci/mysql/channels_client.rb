...
module OCI
  ...
  class Mysql::ChannelsClient
    ...
    #   creation request may be rejected).
    #
    # @return [Response] A Response object with data of type {OCI::Mysql::Models::ChannelStatus ChannelStatus}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mysql/generate_channel_status.rb.html) to see an example of how to use generate_channel_status API.
    def generate_channel_status(channel_id, opts = {})
      logger.debug 'Calling operation ChannelsClient#generate_channel_status.' if logger

      raise "Missing the required parameter 'channel_id' when calling generate_channel_status." if channel_id.nil?
      raise "Parameter value for 'channel_id' must not be blank" if OCI::Internal::Util.blank_string?(channel_id)

      path = '/channels/{channelId}/actions/generateChannelStatus'.sub('{channelId}', channel_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ChannelsClient#generate_channel_status') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Mysql::Models::ChannelStatus'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Mysql::Models::ChannelStatus ChannelStatus}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mysql/get_channel_status.rb.html) to see an example of how to use get_channel_status API.
    def get_channel_status(channel_id, opts = {})
      logger.debug 'Calling operation ChannelsClient#get_channel_status.' if logger

      raise "Missing the required parameter 'channel_id' when calling get_channel_status." if channel_id.nil?
      raise "Parameter value for 'channel_id' must not be blank" if OCI::Internal::Util.blank_string?(channel_id)

      path = '/channels/{channelId}/channelStatus'.sub('{channelId}', channel_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ChannelsClient#get_channel_status') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
