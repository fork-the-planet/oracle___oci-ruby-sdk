...
module OCI
  ...
  class Mysql::WorkRequestsClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mysql/cancel_work_request.rb.html) to see an example of how to use cancel_work_request API.
