...
module OCI
  ...
  class Mysql::Models::DbSystemSnapshot
    ...
    # @return [OCI::Mysql::Models::DatabaseConsoleDetails]
    ...
    # @return [OCI::Mysql::Models::TelemetryConfigurationDetails]
    ...
    # @option attributes [OCI::Mysql::Models::DatabaseConsoleDetails] :database_console The value to assign to the {#database_console} property
    ...
    # @option attributes [OCI::Mysql::Models::TelemetryConfigurationDetails] :telemetry_configuration The value to assign to the {#telemetry_configuration} property
    ...
    def hash
      [id, display_name, description, compartment_id, subnet_id, nsg_ids, security_attributes, availability_domain, fault_domain, shape_name, mysql_version, admin_username, backup_policy, configuration_id, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, ipv6_address, port, port_x, rest, database_console, is_highly_available, endpoints, maintenance, deletion_policy, freeform_tags, defined_tags, crash_recovery, database_management, secure_connections, encrypt_data, region, read_endpoint, telemetry_configuration].hash
    end
