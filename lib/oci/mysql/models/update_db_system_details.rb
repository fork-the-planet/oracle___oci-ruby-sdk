...
module OCI
  ...
  class Mysql::Models::UpdateDbSystemDetails
    ...
    # @return [OCI::Mysql::Models::UpdateDatabaseConsoleDetails]
    ...
    # @return [OCI::Mysql::Models::UpdateTelemetryConfigurationDetails]
    ...
    # @option attributes [OCI::Mysql::Models::UpdateDatabaseConsoleDetails] :database_console The value to assign to the {#database_console} property
    ...
    # @option attributes [OCI::Mysql::Models::UpdateTelemetryConfigurationDetails] :telemetry_configuration The value to assign to the {#telemetry_configuration} property
