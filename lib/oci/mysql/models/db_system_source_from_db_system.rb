...
module OCI
  ...
  #
  class Mysql::Models::DbSystemSourceFromDbSystem < Mysql::Models::DbSystemSource
    # **[Required]** The OCID of the DB system used as the source for the new DB system.
    #
    # @return [String]
