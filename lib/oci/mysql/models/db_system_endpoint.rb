...
module OCI
  ...
  class Mysql::Models::DbSystemEndpoint
    ...
    # @return [String]
    attr_reader :ip_address_version
    ...
    # @option attributes [String] :ip_address_version The value to assign to the {#ip_address_version} property
    ...
    # @param [Object] ip_address_version Object to be assigned
    def ip_address_version=(ip_address_version)
      # rubocop:disable Style/ConditionalAssignment
      if ip_address_version && !IP_ADDRESS_VERSION_ENUM.include?(ip_address_version)
        OCI.logger.debug("Unknown value for 'ip_address_version' [" + ip_address_version + "]. Mapping to 'IP_ADDRESS_VERSION_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @ip_address_version = IP_ADDRESS_VERSION_UNKNOWN_ENUM_VALUE
      else
