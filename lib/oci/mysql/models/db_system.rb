...
module OCI
  ...
  class Mysql::Models::DbSystem
    ...
    # @return [OCI::Mysql::Models::ControlledUpdate]
    attr_accessor :controlled_update
    ...
    # @option attributes [OCI::Mysql::Models::ControlledUpdate] :controlled_update The value to assign to the {#controlled_update} property
