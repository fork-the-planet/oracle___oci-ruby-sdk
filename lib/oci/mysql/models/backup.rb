...
module OCI
  ...
  class Mysql::Models::Backup
    ...
    # @return [OCI::Mysql::Models::BackupValidationDetails]
    attr_accessor :backup_validation_details
    ...
    def self.swagger_types
      {
        ...
        'description': :'String',
        'soft_delete': :'String',
        'backup_validation_details': :'OCI::Mysql::Models::BackupValidationDetails',
    ...
    # @option attributes [OCI::Mysql::Models::BackupValidationDetails] :backup_validation_details The value to assign to the {#backup_validation_details} property
    ...
    def initialize(attributes = {})
      ...
      self.backup_validation_details = attributes[:'backupValidationDetails'] if attributes[:'backupValidationDetails']

      raise 'You cannot provide both :backupValidationDetails and :backup_validation_details' if attributes.key?(:'backupValidationDetails') && attributes.key?(:'backup_validation_details')

      self.backup_validation_details = attributes[:'backup_validation_details'] if attributes[:'backup_validation_details']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        backup_validation_details == other.backup_validation_details &&
    ...
    def hash
      [id, display_name, description, soft_delete, backup_validation_details, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, backup_type, creation_type, db_system_id, db_system_snapshot, backup_size_in_gbs, retention_in_days, data_storage_size_in_gbs, mysql_version, shape_name, freeform_tags, defined_tags, system_tags, immediate_source_backup_id, original_source_backup_id, time_copy_created, encrypt_data].hash
    end
