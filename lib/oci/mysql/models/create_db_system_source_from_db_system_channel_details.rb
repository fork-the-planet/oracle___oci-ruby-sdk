...
module OCI
  ...
  #
  class Mysql::Models::CreateDbSystemSourceFromDbSystemChannelDetails
    SSL_MODE_ENUM = [
    ...
    # **[Required]** The name of the replication user on the source DB system.
    ...
    # @option attributes [String] :source_username The value to assign to the {#source_username} property
    # @option attributes [String] :source_password The value to assign to the {#source_password} property
    ...
    def ssl_mode=(ssl_mode)
      raise "Invalid value for 'ssl_mode': this must be one of the values in SSL_MODE_ENUM." if ssl_mode && !SSL_MODE_ENUM.include?(ssl_mode)
