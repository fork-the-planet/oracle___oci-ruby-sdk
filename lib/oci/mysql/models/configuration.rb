...
module OCI
  ...
  class Mysql::Models::Configuration
    ...
    # **[Required]** The MySQL options defined in the Configuration.
    # @return [Array<OCI::Mysql::Models::Option>]
    ...
    def self.swagger_types
      {
        ...
        'options': :'Array<OCI::Mysql::Models::Option>',
    ...
    # @option attributes [Array<OCI::Mysql::Models::Option>] :options The value to assign to the {#options} property
    ...
    def hash
      [id, compartment_id, description, display_name, shape_name, type, time_created, time_updated, lifecycle_state, options, init_variables, variables, parent_configuration_id, freeform_tags, defined_tags, system_tags].hash
    end
