...
module OCI
  ...
  class Mysql::Models::MaintenanceDetails
    ...
    VERSION_TRACK_PREFERENCE_ENUM = [
      ...
      VERSION_TRACK_PREFERENCE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    MAINTENANCE_SCHEDULE_TYPE_ENUM = [
      ...
      MAINTENANCE_SCHEDULE_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def version_track_preference=(version_track_preference)
      # rubocop:disable Style/ConditionalAssignment
      if version_track_preference && !VERSION_TRACK_PREFERENCE_ENUM.include?(version_track_preference)
        OCI.logger.debug("Unknown value for 'version_track_preference' [" + version_track_preference + "]. Mapping to 'VERSION_TRACK_PREFERENCE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @version_track_preference = VERSION_TRACK_PREFERENCE_UNKNOWN_ENUM_VALUE
      else
    ...
    def maintenance_schedule_type=(maintenance_schedule_type)
      # rubocop:disable Style/ConditionalAssignment
      if maintenance_schedule_type && !MAINTENANCE_SCHEDULE_TYPE_ENUM.include?(maintenance_schedule_type)
        OCI.logger.debug("Unknown value for 'maintenance_schedule_type' [" + maintenance_schedule_type + "]. Mapping to 'MAINTENANCE_SCHEDULE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @maintenance_schedule_type = MAINTENANCE_SCHEDULE_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [window_start_time, version_preference, version_track_preference, maintenance_schedule_type, time_scheduled, target_version, maintenance_disabled_windows].hash
    end
