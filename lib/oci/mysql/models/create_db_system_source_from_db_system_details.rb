...
module OCI
  ...
  #
  class Mysql::Models::CreateDbSystemSourceFromDbSystemDetails < Mysql::Models::CreateDbSystemSourceDetails
    ...
    # @return [OCI::Mysql::Models::CreateDbSystemSourceFromDbSystemChannelDetails]
    ...
    # @option attributes [OCI::Mysql::Models::CreateDbSystemSourceFromDbSystemChannelDetails] :channel The value to assign to the {#channel} property
