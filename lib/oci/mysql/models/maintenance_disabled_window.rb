...
module OCI
  ...
  #
  class Mysql::Models::MaintenanceDisabledWindow
    # **[Required]** The time from when maintenance is disabled.
    ...
    # **[Required]** The time until when maintenance is disabled.
