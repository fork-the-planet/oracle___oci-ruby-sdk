...
module OCI
  ...
  class Mysql::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_GENERATE_DBSYSTEM_STATUS = 'GENERATE_DBSYSTEM_STATUS'.freeze,
      OPERATION_TYPE_GENERATE_CHANNEL_STATUS = 'GENERATE_CHANNEL_STATUS'.freeze,
      ...
      OPERATION_TYPE_UPDATE_BACKUP = 'UPDATE_BACKUP'.freeze,
      OPERATION_TYPE_EXPORT_BACKUP = 'EXPORT_BACKUP'.freeze,
