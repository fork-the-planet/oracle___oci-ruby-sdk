...
module OCI
  ...
  class Mysql::Models::CreateDbSystemDetails
    ...
    # @return [OCI::Mysql::Models::CreateDatabaseConsoleDetails]
    attr_accessor :database_console
    ...
    # @return [OCI::Mysql::Models::CreateTelemetryConfigurationDetails]
    attr_accessor :telemetry_configuration
    ...
    def self.swagger_types
      {
        ...
        'database_console': :'OCI::Mysql::Models::CreateDatabaseConsoleDetails',
        ...
        'telemetry_configuration': :'OCI::Mysql::Models::CreateTelemetryConfigurationDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Mysql::Models::CreateDatabaseConsoleDetails] :database_console The value to assign to the {#database_console} property
    ...
    # @option attributes [OCI::Mysql::Models::Ipv6AddressIpv6SubnetCidrPairDetails] :ipv6_address_ipv6_subnet_cidr_pair_details The value to assign to the {#ipv6_address_ipv6_subnet_cidr_pair_details} property
    ...
    # @option attributes [OCI::Mysql::Models::CreateTelemetryConfigurationDetails] :telemetry_configuration The value to assign to the {#telemetry_configuration} property
    ...
    def hash
      [display_name, description, compartment_id, rest, database_console, is_highly_available, availability_domain, fault_domain, configuration_id, shape_name, mysql_version, subnet_id, nsg_ids, security_attributes, admin_username, admin_password, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, is_ipv6_enabled, ipv6_address_ipv6_subnet_cidr_pair_details, port, port_x, backup_policy, source, maintenance, freeform_tags, defined_tags, deletion_policy, crash_recovery, database_management, secure_connections, encrypt_data, database_mode, access_mode, customer_contacts, read_endpoint, telemetry_configuration].hash
    end
