...
module OCI
  ...
  class Mysql::Models::CompressionOptions
    TYPE_ENUM = [
      TYPE_GZIP = 'GZIP'.freeze,
      TYPE_ZSTD = 'ZSTD'.freeze
    ].freeze
    ...
    def initialize(attributes = {})
      ...
      self.type = "ZSTD" if type.nil? && !attributes.key?(:'type') # rubocop:disable Style/StringLiterals
    end
