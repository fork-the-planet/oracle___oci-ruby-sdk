...
module OCI
  ...
  class Mysql::Models::ExportBackupDetails
    # **[Required]** The Object Storage bucket name.
    # @return [String]
    attr_accessor :bucket_name

    # @return [OCI::Mysql::Models::ExportOptions]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'bucket_name': :'String',
        'export_options': :'OCI::Mysql::Models::ExportOptions',
    ...
    # @option attributes [OCI::Mysql::Models::ExportOptions] :export_options The value to assign to the {#export_options} property
    ...
    def hash
      [bucket_name, export_options, namespace_name, subnet_id].hash
    end
