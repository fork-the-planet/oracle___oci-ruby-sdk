...
module OCI
  ...
  class Mysql::DbSystemClient
    ...
    #
    # @param [String] db_system_id The DB System [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).
    # @param [OCI::Mysql::Models::ControlledUpdateDbSystemDetails] controlled_update_db_system_details Required parameters for the controlled update action.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mysql/controlled_update_db_system.rb.html) to see an example of how to use controlled_update_db_system API.
    def controlled_update_db_system(db_system_id, controlled_update_db_system_details, opts = {})
      logger.debug 'Calling operation DbSystemClient#controlled_update_db_system.' if logger

      raise "Missing the required parameter 'db_system_id' when calling controlled_update_db_system." if db_system_id.nil?
      raise "Missing the required parameter 'controlled_update_db_system_details' when calling controlled_update_db_system." if controlled_update_db_system_details.nil?
      raise "Parameter value for 'db_system_id' must not be blank" if OCI::Internal::Util.blank_string?(db_system_id)

      path = '/dbSystems/{dbSystemId}/actions/controlledUpdate'.sub('{dbSystemId}', db_system_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(controlled_update_db_system_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DbSystemClient#controlled_update_db_system') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] db_system_id The DB System [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).
    # @param [OCI::Mysql::Models::GenerateDbSystemStatusDetails] generate_db_system_status_details The parameters for selecting the attributes to collect the status of.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Customer-defined unique identifier for the request. If you need to
    ...
    #   creation request may be rejected).
    #
    # @return [Response] A Response object with data of type {OCI::Mysql::Models::DbSystemStatus DbSystemStatus}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mysql/generate_db_system_status.rb.html) to see an example of how to use generate_db_system_status API.
    def generate_db_system_status(db_system_id, generate_db_system_status_details, opts = {})
      logger.debug 'Calling operation DbSystemClient#generate_db_system_status.' if logger

      raise "Missing the required parameter 'db_system_id' when calling generate_db_system_status." if db_system_id.nil?
      raise "Missing the required parameter 'generate_db_system_status_details' when calling generate_db_system_status." if generate_db_system_status_details.nil?
      raise "Parameter value for 'db_system_id' must not be blank" if OCI::Internal::Util.blank_string?(db_system_id)

      path = '/dbSystems/{dbSystemId}/actions/generateDbSystemStatus'.sub('{dbSystemId}', db_system_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(generate_db_system_status_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DbSystemClient#generate_db_system_status') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Mysql::Models::DbSystemStatus'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Mysql::Models::DbSystemStatus DbSystemStatus}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mysql/get_db_system_status.rb.html) to see an example of how to use get_db_system_status API.
    def get_db_system_status(db_system_id, opts = {})
      logger.debug 'Calling operation DbSystemClient#get_db_system_status.' if logger

      raise "Missing the required parameter 'db_system_id' when calling get_db_system_status." if db_system_id.nil?
      raise "Parameter value for 'db_system_id' must not be blank" if OCI::Internal::Util.blank_string?(db_system_id)

      path = '/dbSystems/{dbSystemId}/dbSystemStatus'.sub('{dbSystemId}', db_system_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DbSystemClient#get_db_system_status') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    #   ID that you supplied in this header with the request.
    #
    # @option opts [String] :mysql_version_before_maintenance The MySQL version before the maintenance event.
    # @option opts [String] :mysql_version_after_maintenance The MySQL version after the maintenance event.
    # @option opts [String] :maintenance_type How the maintenance event was triggered.
    # @option opts [String] :maintenance_action The nature of the maintenance event.
    # @option opts [String] :maintenance_status The last status of the maintenance event.
    # @option opts [Integer] :limit The maximum number of items to return in a paginated list call. For information about pagination, see
    #   [List Pagination](https://docs.cloud.oracle.com/#API/Concepts/usingapi.htm#List_Pagination).
    #    (default to 100)
    # @option opts [String] :page The value of the `opc-next-page` or `opc-prev-page` response header from
    ...
    # @option opts [String] :sort_order The sort order to use (ASC or DESC). (default to ASC)
    #   Allowed values are: ASC, DESC
    # @return [Response] A Response object with data of type Array<{OCI::Mysql::Models::MaintenanceEvent MaintenanceEvent}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mysql/list_maintenance_events.rb.html) to see an example of how to use list_maintenance_events API.
    def list_maintenance_events(db_system_id, opts = {})
      logger.debug 'Calling operation DbSystemClient#list_maintenance_events.' if logger

      raise "Missing the required parameter 'db_system_id' when calling list_maintenance_events." if db_system_id.nil?

      if opts[:maintenance_type] && !OCI::Mysql::Models::MAINTENANCE_TYPE_ENUM.include?(opts[:maintenance_type])
        raise 'Invalid value for "maintenance_type", must be one of the values in OCI::Mysql::Models::MAINTENANCE_TYPE_ENUM.'
      end

      if opts[:maintenance_action] && !OCI::Mysql::Models::MAINTENANCE_ACTION_ENUM.include?(opts[:maintenance_action])
        raise 'Invalid value for "maintenance_action", must be one of the values in OCI::Mysql::Models::MAINTENANCE_ACTION_ENUM.'
      end

      if opts[:maintenance_status] && !OCI::Mysql::Models::MaintenanceEvent::MAINTENANCE_STATUS_ENUM.include?(opts[:maintenance_status])
        raise 'Invalid value for "maintenance_status", must be one of the values in OCI::Mysql::Models::MaintenanceEvent::MAINTENANCE_STATUS_ENUM.'
      end

      if opts[:sort_by] && !%w[timeCreated timeScheduled timeStarted timeEnded].include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of timeCreated, timeScheduled, timeStarted, timeEnded.'
      end
      ...
      path = '/dbSystems/{dbSystemId}/maintenanceEvents'.sub('{dbSystemId}', db_system_id.to_s)
      operation_signing_strategy = :standard

      # rubocop:disable Style/NegatedIf
      # Query Params
      query_params = {}
      query_params[:mysqlVersionBeforeMaintenance] = opts[:mysql_version_before_maintenance] if opts[:mysql_version_before_maintenance]
      query_params[:mysqlVersionAfterMaintenance] = opts[:mysql_version_after_maintenance] if opts[:mysql_version_after_maintenance]
      query_params[:maintenanceType] = opts[:maintenance_type] if opts[:maintenance_type]
      query_params[:maintenanceAction] = opts[:maintenance_action] if opts[:maintenance_action]
      query_params[:maintenanceStatus] = opts[:maintenance_status] if opts[:maintenance_status]
      query_params[:limit] = opts[:limit] if opts[:limit]
      query_params[:page] = opts[:page] if opts[:page]
      query_params[:sortBy] = opts[:sort_by] if opts[:sort_by]
      query_params[:sortOrder] = opts[:sort_order] if opts[:sort_order]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DbSystemClient#list_maintenance_events') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'Array<OCI::Mysql::Models::MaintenanceEvent>'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
