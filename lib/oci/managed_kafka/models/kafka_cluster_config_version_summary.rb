...
module OCI
  ...
  class ManagedKafka::Models::KafkaClusterConfigVersionSummary
    ...
    # **[Required]** Version of the cluster configuration
    # @return [Integer]
    attr_accessor :version_number

    # **[Required]** The date and time the KafkaClusterConfigVersion was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    ...
    def hash
      [config_id, version_number, time_created].hash
    end
