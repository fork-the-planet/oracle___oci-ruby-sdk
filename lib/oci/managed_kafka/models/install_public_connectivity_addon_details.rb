...
require 'date'
require_relative 'install_addon_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The data to install a KafkaClusterAddon.
  class ManagedKafka::Models::InstallPublicConnectivityAddonDetails < ManagedKafka::Models::InstallAddonDetails
    # **[Required]** Authentication mechanism.
    # @return [String]
    attr_accessor :authentication_mechanism

    # **[Required]** A list of CIDR's for ingress/egress traffic.
    # @return [Array<String>]
    ...
    # @option attributes [String] :name The value to assign to the {OCI::ManagedKafka::Models::InstallAddonDetails#name #name} proprety
    # @option attributes [String] :description The value to assign to the {OCI::ManagedKafka::Models::InstallAddonDetails#description #description} proprety
    ...
    def hash
      [name, description, addon_type, authentication_mechanism, network_cidrs].hash
    end
