...
module OCI
  ...
  class ManagedKafka::Models::BrokerShape
    # **[Required]** Number of Kafka broker nodes
    # @return [Integer]
    attr_accessor :node_count

    # **[Required]** Number of OCPUs per nodes
    # @return [Integer]
    ...
    def hash
      [node_count, ocpu_count, storage_size_in_gbs, node_shape].hash
    end
