...
module OCI
  ...
  class ManagedKafka::Models::UpdateKafkaClusterDetails
    ...
    def hash
      [display_name, client_certificate_bundle, broker_shape, cluster_config_id, cluster_config_version, access_subnets, coordination_type, freeform_tags, defined_tags].hash
    end
