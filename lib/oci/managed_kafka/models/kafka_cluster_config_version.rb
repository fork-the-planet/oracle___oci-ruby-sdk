...
module OCI
  ...
  #
  class ManagedKafka::Models::KafkaClusterConfigVersion
    ...
    # **[Required]** Cluster configuration key-value pairs
    ...
    def hash
      [config_id, version_number, time_created, properties].hash
    end
