...
require 'date'
require_relative 'update_addon_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The data to update a KafkaClusterAddon.
  class ManagedKafka::Models::UpdatePublicConnectivityAddonDetails < ManagedKafka::Models::UpdateAddonDetails
    ...
    # @option attributes [String] :description The value to assign to the {OCI::ManagedKafka::Models::UpdateAddonDetails#description #description} proprety
    ...
    def hash
      [addon_type, description, network_cidrs].hash
    end
