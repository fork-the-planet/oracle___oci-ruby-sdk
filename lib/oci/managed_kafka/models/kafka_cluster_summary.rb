...
module OCI
  ...
  class ManagedKafka::Models::KafkaClusterSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, access_subnets, kafka_version, cluster_type, broker_shape, cluster_config_id, cluster_config_version, coordination_type, freeform_tags, defined_tags, system_tags].hash
    end
