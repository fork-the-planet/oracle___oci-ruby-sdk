...
module OCI
  ...
  class KeyManagement::KmsHsmClusterClient
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/keymanagement/disable_audit_mgmt_logging.rb.html) to see an example of how to use disable_audit_mgmt_logging API.
    def disable_audit_mgmt_logging(hsm_cluster_id, opts = {})
      logger.debug 'Calling operation KmsHsmClusterClient#disable_audit_mgmt_logging.' if logger

      raise "Missing the required parameter 'hsm_cluster_id' when calling disable_audit_mgmt_logging." if hsm_cluster_id.nil?
      raise "Parameter value for 'hsm_cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(hsm_cluster_id)

      path = '/20180608/hsmClusters/{hsmClusterId}/actions/disableAuditMgmtLogging'.sub('{hsmClusterId}', hsm_cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'KmsHsmClusterClient#disable_audit_mgmt_logging') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #   generated by the service.
    #
    # @return [Response] A Response object with data of type {OCI::KeyManagement::Models::EnableAuditMgmtLogging EnableAuditMgmtLogging}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/keymanagement/enable_audit_mgmt_logging.rb.html) to see an example of how to use enable_audit_mgmt_logging API.
    def enable_audit_mgmt_logging(hsm_cluster_id, opts = {})
      logger.debug 'Calling operation KmsHsmClusterClient#enable_audit_mgmt_logging.' if logger

      raise "Missing the required parameter 'hsm_cluster_id' when calling enable_audit_mgmt_logging." if hsm_cluster_id.nil?
      raise "Parameter value for 'hsm_cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(hsm_cluster_id)

      path = '/20180608/hsmClusters/{hsmClusterId}/actions/enableAuditMgmtLogging'.sub('{hsmClusterId}', hsm_cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'KmsHsmClusterClient#enable_audit_mgmt_logging') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::KeyManagement::Models::EnableAuditMgmtLogging'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @param [String] hsm_cluster_id The OCID of the HSM Cluster. This is a unique identifier assigned to each hsmCluster.
    # @param [OCI::KeyManagement::Models::InitiateAuditLoggingDetails] initiate_audit_logging_details The information need to make changes for management audit logs.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique identifier for the request. If provided, the returned request ID
    ...
    #   creation request may be rejected).
    #
    # @return [Response] A Response object with data of type {OCI::KeyManagement::Models::AuditLogging AuditLogging}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/keymanagement/initiate_audit_logging.rb.html) to see an example of how to use initiate_audit_logging API.
    def initiate_audit_logging(hsm_cluster_id, initiate_audit_logging_details, opts = {})
      logger.debug 'Calling operation KmsHsmClusterClient#initiate_audit_logging.' if logger

      raise "Missing the required parameter 'hsm_cluster_id' when calling initiate_audit_logging." if hsm_cluster_id.nil?
      raise "Missing the required parameter 'initiate_audit_logging_details' when calling initiate_audit_logging." if initiate_audit_logging_details.nil?
      raise "Parameter value for 'hsm_cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(hsm_cluster_id)

      path = '/20180608/hsmClusters/{hsmClusterId}/actions/initiateAuditLogging'.sub('{hsmClusterId}', hsm_cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(initiate_audit_logging_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'KmsHsmClusterClient#initiate_audit_logging') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::KeyManagement::Models::AuditLogging'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @param [String] hsm_cluster_id The OCID of the HSM Cluster. This is a unique identifier assigned to each hsmCluster.
    # @param [OCI::KeyManagement::Models::UpdateAuditLoggingDestinationDetails] update_audit_logging_destination_details The information need to make changes for management audit logs.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique identifier for the request. If provided, the returned request ID
    ...
    #
    # @return [Response] A Response object with data of type {OCI::KeyManagement::Models::AuditLogging AuditLogging}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/keymanagement/update_audit_logging_destination.rb.html) to see an example of how to use update_audit_logging_destination API.
    def update_audit_logging_destination(hsm_cluster_id, update_audit_logging_destination_details, opts = {})
      logger.debug 'Calling operation KmsHsmClusterClient#update_audit_logging_destination.' if logger

      raise "Missing the required parameter 'hsm_cluster_id' when calling update_audit_logging_destination." if hsm_cluster_id.nil?
      raise "Missing the required parameter 'update_audit_logging_destination_details' when calling update_audit_logging_destination." if update_audit_logging_destination_details.nil?
      raise "Parameter value for 'hsm_cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(hsm_cluster_id)

      path = '/20180608/hsmClusters/{hsmClusterId}/actions/updateAuditLoggingDestination'.sub('{hsmClusterId}', hsm_cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(update_audit_logging_destination_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'KmsHsmClusterClient#update_audit_logging_destination') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
