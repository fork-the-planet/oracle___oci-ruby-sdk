...
module OCI
  ...
  class KeyManagement::KmsVaultClient
    ...
    #
    # @param [String] vault_id The OCID of the vault.
    # @param [OCI::KeyManagement::Models::UpdateRegisteredVaultForMtlsDetails] update_registered_vault_for_mtls_details Payload to update fleet ids for the registered mTLS vault for mtls.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a
    ...
    #   generated by the service.
    #
    # @return [Response] A Response object with data of type {OCI::KeyManagement::Models::VaultMtlsUpdateResponse VaultMtlsUpdateResponse}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/keymanagement/update_registered_vault_for_mtls.rb.html) to see an example of how to use update_registered_vault_for_mtls API.
    def update_registered_vault_for_mtls(vault_id, update_registered_vault_for_mtls_details, opts = {})
      logger.debug 'Calling operation KmsVaultClient#update_registered_vault_for_mtls.' if logger

      raise "Missing the required parameter 'vault_id' when calling update_registered_vault_for_mtls." if vault_id.nil?
      raise "Missing the required parameter 'update_registered_vault_for_mtls_details' when calling update_registered_vault_for_mtls." if update_registered_vault_for_mtls_details.nil?
      raise "Parameter value for 'vault_id' must not be blank" if OCI::Internal::Util.blank_string?(vault_id)

      path = '/20180608/vaults/{vaultId}/updateRegisteredVaultForMtls'.sub('{vaultId}', vault_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(update_registered_vault_for_mtls_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'KmsVaultClient#update_registered_vault_for_mtls') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::KeyManagement::Models::VaultMtlsUpdateResponse'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
