...
module OCI
  ...
  class KeyManagement::Models::AuditLogging
    # **[Required]** The workRequestId to track the request later.
    # @return [String]
    attr_accessor :work_request_id

    # **[Required]** The Hsm Cluster Id
    # @return [String]
    ...
    def hash
      [work_request_id, hsm_cluster_id].hash
    end
