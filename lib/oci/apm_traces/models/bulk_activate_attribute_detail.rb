...
module OCI
  ...
  class ApmTraces::Models::BulkActivateAttributeDetail
    ATTRIBUTE_TYPE_ENUM = [
      ...
      ATTRIBUTE_TYPE_NONE = 'NONE'.freeze
    ].freeze
    ...
    ATTRIBUTE_NAME_SPACE_ENUM = [
      ...
      ATTRIBUTE_NAME_SPACE_LOGS = 'LOGS'.freeze
    ].freeze
    ...
    #
    # @return [String]
    attr_accessor :attribute_expression
    ...
    # @option attributes [String] :attribute_expression The value to assign to the {#attribute_expression} property
    ...
    def initialize(attributes = {})
      ...
      self.attribute_expression = attributes[:'attributeExpression'] if attributes[:'attributeExpression']

      raise 'You cannot provide both :attributeExpression and :attribute_expression' if attributes.key?(:'attributeExpression') && attributes.key?(:'attribute_expression')

      self.attribute_expression = attributes[:'attribute_expression'] if attributes[:'attribute_expression']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        attribute_expression == other.attribute_expression &&
        unit == other.unit &&
    ...
    def hash
      [attribute_name, attribute_type, attribute_expression, unit, attribute_name_space].hash
    end
