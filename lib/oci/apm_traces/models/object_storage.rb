...
module OCI
  ...
  #
  class ApmTraces::Models::ObjectStorage
    ...
    # @option attributes [String] :name_space The value to assign to the {#name_space} property
    ...
    def initialize(attributes = {})
      ...
      self.name_space = attributes[:'nameSpace'] if attributes[:'nameSpace']

      raise 'You cannot provide both :nameSpace and :name_space' if attributes.key?(:'nameSpace') && attributes.key?(:'name_space')

      self.name_space = attributes[:'name_space'] if attributes[:'name_space']
    ...
    def hash
      [bucket_name, name_space, object_name_prefix].hash
    end
