...
module OCI
  ...
  class ApmTraces::QueryClient
    ...
    # @param [String] apm_domain_id The APM Domain ID for the intended request.
    #
    # @param [DateTime] time_span_started_greater_than_or_equal_to Include spans that have a `spanStartTime` equal to or greater than this value.  Also, include logs and traces
    #   that have startTime greater than this value.
    #
    # @param [DateTime] time_span_started_less_than Include spans that have a `spanStartTime` less than this value.  Also, include traces that have startTime less than this value
    #   and logs that have endTime less than this value.
    #
    # @param [OCI::ApmTraces::Models::QueryDetails] query_details Request body containing the query to be run against the trace, span, services, background queries and other metric data and to filter and
