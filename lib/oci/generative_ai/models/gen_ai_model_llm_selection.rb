...
module OCI
  ...
  class GenerativeAi::Models::GenAiModelLlmSelection < GenerativeAi::Models::LlmSelection
    # **[Required]** The id of the GenAI model
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['llmSelectionType'] = 'GEN_AI_MODEL'
