...
module OCI
  ...
  class GenerativeAi::Models::CreateArtifactDetails
    ARTIFACT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GenerativeAi::Models::CreateSingleDockerArtifactDetails' if type == 'SIMPLE_DOCKER_ARTIFACT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GenerativeAi::Models::CreateArtifactDetails'
    end
    ...
    def hash
      [artifact_type, is_vulnerability_scan_required].hash
    end
