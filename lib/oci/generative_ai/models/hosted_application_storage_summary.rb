...
module OCI
  ...
  class GenerativeAi::Models::HostedApplicationStorageSummary
    STORAGE_TYPE_ENUM = [
    ...
    def hash
      [id, display_name, description, compartment_id, storage_type, time_created, time_updated, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
