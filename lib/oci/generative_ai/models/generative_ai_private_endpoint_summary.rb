...
module OCI
  ...
  #
  class GenerativeAi::Models::GenerativeAiPrivateEndpointSummary
    ...
    # **[Required]** Fully qualified domain name the customer will use for access
    #
    # @return [String]
    attr_accessor :fqdn
    ...
    def hash
      [id, display_name, description, compartment_id, subnet_id, lifecycle_state, lifecycle_details, fqdn, is_allow_on_demand, private_endpoint_ip, time_created, time_updated, resource_type, defined_tags, freeform_tags, system_tags, security_attributes].hash
    end
