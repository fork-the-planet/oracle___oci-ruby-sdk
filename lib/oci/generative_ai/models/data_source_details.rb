...
module OCI
  ...
  class GenerativeAi::Models::DataSourceDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GenerativeAi::Models::DataSourceDatabaseToolsConnectionDetails' if type == 'DATABASE_TOOLS_CONNECTION'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GenerativeAi::Models::DataSourceDetails'
    end
