...
module OCI
  ...
  class GenerativeAi::Models::ObjectStorageConfig
    ...
    # @option attributes [Array<String>] :prefix_list The value to assign to the {#prefix_list} property
    def initialize(attributes = {})
      ...
      self.prefix_list = attributes[:'prefixList'] if attributes[:'prefixList']

      raise 'You cannot provide both :prefixList and :prefix_list' if attributes.key?(:'prefixList') && attributes.key?(:'prefix_list')

      self.prefix_list = attributes[:'prefix_list'] if attributes[:'prefix_list']
    end
    ...
    def hash
      [namespace, bucket_name, prefix_list].hash
    end
