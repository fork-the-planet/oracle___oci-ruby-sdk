...
module OCI
  ...
  class GenerativeAi::Models::FileSyncIngestionLogs
    STATUS_ENUM = [
    ...
    def hash
      [file_id, file_path, file_size_in_bytes, total_chunks_created, duration_in_seconds, status, freeform_tags, defined_tags, system_tags].hash
    end
