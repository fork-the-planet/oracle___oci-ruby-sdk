...
module OCI
  ...
  #
  class GenerativeAi::Models::CreateGenerativeAiPrivateEndpointDetails
    # **[Required]** The OCID of the compartment where the private endpoint is created.
    #
    # @return [String]
    ...
    # **[Required]** dnsPrefix of the private endpoint FQDN.
    #
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      self.resource_type = "ENDPOINT" if resource_type.nil? && !attributes.key?(:'resourceType') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :resourceType and :resource_type' if attributes.key?(:'resourceType') && attributes.key?(:'resource_type')

      self.resource_type = attributes[:'resource_type'] if attributes[:'resource_type']
      self.resource_type = "ENDPOINT" if resource_type.nil? && !attributes.key?(:'resourceType') && !attributes.key?(:'resource_type') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [compartment_id, subnet_id, description, display_name, dns_prefix, nsg_ids, is_allow_on_demand, resource_type, freeform_tags, defined_tags, security_attributes].hash
    end
