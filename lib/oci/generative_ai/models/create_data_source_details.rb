...
module OCI
  ...
  class GenerativeAi::Models::CreateDataSourceDetails
    CONNECTION_TYPE_ENUM = [
      CONNECTION_TYPE_DATABASE_TOOLS_CONNECTION = 'DATABASE_TOOLS_CONNECTION'.freeze
    ].freeze

    # **[Required]** Specifies the type of underlying connection.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GenerativeAi::Models::CreateDataSourceDatabaseToolsConnectionDetails' if type == 'DATABASE_TOOLS_CONNECTION'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GenerativeAi::Models::CreateDataSourceDetails'
    end
