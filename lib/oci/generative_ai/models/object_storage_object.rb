...
require 'date'
require_relative 'model_data_source'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details about the object storage location.
  #
  class GenerativeAi::Models::ObjectStorageObject < GenerativeAi::Models::ModelDataSource
    # **[Required]** The namespace of the Object Storage where the files are stored.
    # @return [String]
    ...
    # **[Required]** The prefix path (or folder) within the bucket where files are located.
    # @return [String]
    ...
    # @option attributes [String] :prefix_name The value to assign to the {#prefix_name} property
    # @option attributes [String] :region The value to assign to the {#region} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['sourceType'] = 'OBJECT_STORAGE_OBJECT'
      ...
      self.prefix_name = attributes[:'prefixName'] if attributes[:'prefixName']

      raise 'You cannot provide both :prefixName and :prefix_name' if attributes.key?(:'prefixName') && attributes.key?(:'prefix_name')

      self.prefix_name = attributes[:'prefix_name'] if attributes[:'prefix_name']
    ...
    def hash
      [source_type, namespace_name, bucket_name, prefix_name, region].hash
    end
