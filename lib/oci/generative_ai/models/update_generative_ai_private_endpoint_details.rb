...
module OCI
  ...
  #
  class GenerativeAi::Models::UpdateGenerativeAiPrivateEndpointDetails
    ...
    def hash
      [description, display_name, dns_prefix, nsg_ids, is_allow_on_demand, freeform_tags, defined_tags, security_attributes].hash
    end
