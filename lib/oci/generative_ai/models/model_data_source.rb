...
module OCI
  ...
  class GenerativeAi::Models::ModelDataSource
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_HUGGING_FACE_MODEL = 'HUGGING_FACE_MODEL'.freeze,
      SOURCE_TYPE_OBJECT_STORAGE_OBJECT = 'OBJECT_STORAGE_OBJECT'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GenerativeAi::Models::ObjectStorageObject' if type == 'OBJECT_STORAGE_OBJECT'
      return 'OCI::GenerativeAi::Models::HuggingFaceModel' if type == 'HUGGING_FACE_MODEL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GenerativeAi::Models::ModelDataSource'
    end
