...
module OCI
  ...
  #
  class GenerativeAi::Models::GenerativeAiPrivateEndpoint
    ...
    RESOURCE_TYPE_ENUM = [
      RESOURCE_TYPE_APPLICATION = 'APPLICATION'.freeze,
      RESOURCE_TYPE_ENDPOINT = 'ENDPOINT'.freeze,
    ...
    # **[Required]** The OCID of the compartment that contains the private endpoint.
    #
    # @return [String]
    ...
    # **[Required]** The current state of the Generative AI Private Endpoint.
    #
    # @return [String]
    ...
    # **[Required]** Fully qualified domain name the customer will use for access (for eg: xyz.oraclecloud.com)
    #
    # @return [String]
    attr_accessor :fqdn
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_allow_on_demand
    ...
    # **[Required]** The date and time that the Generative AI private endpoint was created expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2018-04-03T21:10:29.600Z`
    #
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The date and time that the Generative AI private endpoint was updated expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2018-04-03T21:10:29.600Z`
    #
    # @return [DateTime]
    attr_accessor :time_updated

    # @return [OCI::GenerativeAi::Models::GenerativeAiPrivateEndpoint]
    ...
    def self.swagger_types
      {
        ...
        'fqdn': :'String',
        'is_allow_on_demand': :'BOOLEAN',
        'private_endpoint_ip': :'String',
        'time_created': :'DateTime',
        'time_updated': :'DateTime',
        'previous_state': :'OCI::GenerativeAi::Models::GenerativeAiPrivateEndpoint',
    ...
    # @option attributes [BOOLEAN] :is_allow_on_demand The value to assign to the {#is_allow_on_demand} property
    ...
    # @option attributes [OCI::GenerativeAi::Models::GenerativeAiPrivateEndpoint] :previous_state The value to assign to the {#previous_state} property
    ...
    def initialize(attributes = {})
      ...
      self.is_allow_on_demand = attributes[:'isAllowOnDemand'] unless attributes[:'isAllowOnDemand'].nil?
      self.is_allow_on_demand = false if is_allow_on_demand.nil? && !attributes.key?(:'isAllowOnDemand') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isAllowOnDemand and :is_allow_on_demand' if attributes.key?(:'isAllowOnDemand') && attributes.key?(:'is_allow_on_demand')

      self.is_allow_on_demand = attributes[:'is_allow_on_demand'] unless attributes[:'is_allow_on_demand'].nil?
      self.is_allow_on_demand = false if is_allow_on_demand.nil? && !attributes.key?(:'isAllowOnDemand') && !attributes.key?(:'is_allow_on_demand') # rubocop:disable Style/StringLiterals
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        fqdn == other.fqdn &&
        is_allow_on_demand == other.is_allow_on_demand &&
    ...
    def hash
      [id, display_name, description, compartment_id, subnet_id, lifecycle_state, lifecycle_details, nsg_ids, fqdn, is_allow_on_demand, private_endpoint_ip, time_created, time_updated, previous_state, resource_type, freeform_tags, defined_tags, system_tags, security_attributes].hash
    end
