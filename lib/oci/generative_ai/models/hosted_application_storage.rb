...
module OCI
  ...
  #
  class GenerativeAi::Models::HostedApplicationStorage
    STORAGE_TYPE_ENUM = [
      STORAGE_TYPE_CACHE = 'CACHE'.freeze,
      STORAGE_TYPE_POSTGRESQL = 'POSTGRESQL'.freeze,
      STORAGE_TYPE_ADB = 'ADB'.freeze,
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the hosted application storage.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The compartment OCID to create the hosted application in.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** type like Cache, Postgresql and ADB.
    # @return [String]
    ...
    # **[Required]** The current state of the hosted application storage.
    # @return [String]
    ...
    # **[Required]** A list of application OCID.
    # @return [Array<String>]
    ...
    # @option attributes [Array<String>] :application_ids The value to assign to the {#application_ids} property
    ...
    def initialize(attributes = {})
      ...
      self.application_ids = attributes[:'applicationIds'] if attributes[:'applicationIds']

      raise 'You cannot provide both :applicationIds and :application_ids' if attributes.key?(:'applicationIds') && attributes.key?(:'application_ids')

      self.application_ids = attributes[:'application_ids'] if attributes[:'application_ids']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        application_ids == other.application_ids &&
    ...
    def hash
      [id, display_name, description, compartment_id, storage_type, time_created, time_updated, lifecycle_state, lifecycle_details, application_ids, freeform_tags, defined_tags, system_tags].hash
    end
