...
require 'date'
require_relative 'refresh_schedule_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Defines the refresh schedule by specifying the interval between each refresh.
  class GenerativeAi::Models::RefreshScheduleIntervalDetails < GenerativeAi::Models::RefreshScheduleDetails
    # **[Required]** Specifies the refresh interval value. The interval must be provided using the ISO 8601 extended format, either as PnW or PnYnMnDTnHnMnS,
