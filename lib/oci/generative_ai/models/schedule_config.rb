...
module OCI
  ...
  class GenerativeAi::Models::ScheduleConfig
    STATE_ENUM = [
    ...
    CONFIG_TYPE_ENUM = [
      CONFIG_TYPE_INTERVAL = 'INTERVAL'.freeze,
      CONFIG_TYPE_CRON = 'CRON'.freeze,
    ...
    # **[Required]** The schedule config type
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GenerativeAi::Models::ScheduleCronConfig' if type == 'CRON'
      return 'OCI::GenerativeAi::Models::ScheduleIntervalConfig' if type == 'INTERVAL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GenerativeAi::Models::ScheduleConfig'
    end
    ...
    def initialize(attributes = {})
      ...
      self.state = "ENABLED" if state.nil? && !attributes.key?(:'state') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [state, config_type, time_start, time_end].hash
    end
