...
module OCI
  ...
  class GenerativeAi::Models::SetApiKeyStateDetails
    # **[Required]** The key to set state.
    # @return [String]
    attr_accessor :key_name

    # **[Required]** The target state of the API key item.
    # @return [String]
    attr_accessor :state
    ...
    def hash
      [key_name, state, freeform_tags, defined_tags].hash
    end
