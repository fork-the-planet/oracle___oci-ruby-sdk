...
module OCI
  ...
  #
  class GenerativeAi::Models::HuggingFaceModel < GenerativeAi::Models::ModelDataSource
    # **[Required]** The full model OCID from Hugging Face, typically in the format
    ...
    # @option attributes [String] :commit The value to assign to the {#commit} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['sourceType'] = 'HUGGING_FACE_MODEL'
      ...
      self.branch = "main" if branch.nil? && !attributes.key?(:'branch') # rubocop:disable Style/StringLiterals

      self.commit = attributes[:'commit'] if attributes[:'commit']
    end
    ...
    def hash
      [source_type, model_id, access_token, branch, commit].hash
    end
