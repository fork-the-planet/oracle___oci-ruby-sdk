...
module OCI
  ...
  class GenerativeAi::Models::CreateSchemasDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GenerativeAi::Models::CreateSchemasDatabaseToolsConnectionDetails' if type == 'DATABASE_TOOLS_CONNECTION'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GenerativeAi::Models::CreateSchemasDetails'
    end
