...
module OCI
  ...
  class GenerativeAi::Models::Endpoint
    ...
    # @return [String]
    attr_accessor :generative_ai_private_endpoint_id
    ...
    # @return [OCI::GenerativeAi::Models::PromptInjectionConfig]
    attr_accessor :prompt_injection_config

    # @return [OCI::GenerativeAi::Models::PiiDetectionConfig]
    attr_accessor :pii_detection_config
    ...
    def self.swagger_types
      {
        ...
        'prompt_injection_config': :'OCI::GenerativeAi::Models::PromptInjectionConfig',
        'pii_detection_config': :'OCI::GenerativeAi::Models::PiiDetectionConfig',
    ...
    # @option attributes [String] :generative_ai_private_endpoint_id The value to assign to the {#generative_ai_private_endpoint_id} property
    ...
    # @option attributes [OCI::GenerativeAi::Models::PromptInjectionConfig] :prompt_injection_config The value to assign to the {#prompt_injection_config} property
    # @option attributes [OCI::GenerativeAi::Models::PiiDetectionConfig] :pii_detection_config The value to assign to the {#pii_detection_config} property
    ...
    def initialize(attributes = {})
      ...
      self.generative_ai_private_endpoint_id = attributes[:'generativeAiPrivateEndpointId'] if attributes[:'generativeAiPrivateEndpointId']

      raise 'You cannot provide both :generativeAiPrivateEndpointId and :generative_ai_private_endpoint_id' if attributes.key?(:'generativeAiPrivateEndpointId') && attributes.key?(:'generative_ai_private_endpoint_id')

      self.generative_ai_private_endpoint_id = attributes[:'generative_ai_private_endpoint_id'] if attributes[:'generative_ai_private_endpoint_id']
      ...
      self.pii_detection_config = attributes[:'piiDetectionConfig'] if attributes[:'piiDetectionConfig']

      raise 'You cannot provide both :piiDetectionConfig and :pii_detection_config' if attributes.key?(:'piiDetectionConfig') && attributes.key?(:'pii_detection_config')

      self.pii_detection_config = attributes[:'pii_detection_config'] if attributes[:'pii_detection_config']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        generative_ai_private_endpoint_id == other.generative_ai_private_endpoint_id &&
        ...
        pii_detection_config == other.pii_detection_config &&
    ...
    def hash
      [id, display_name, description, model_id, compartment_id, dedicated_ai_cluster_id, generative_ai_private_endpoint_id, time_created, time_updated, lifecycle_state, lifecycle_details, content_moderation_config, prompt_injection_config, pii_detection_config, previous_state, freeform_tags, defined_tags, system_tags].hash
    end
