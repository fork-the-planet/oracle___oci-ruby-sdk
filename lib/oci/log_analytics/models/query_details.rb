...
module OCI
  ...
  class LogAnalytics::Models::QueryDetails
    ...
    # **[Required]** Query to perform. Must conform to log analytics querylanguage syntax. Syntax errors will be returned if present.
    # @return [String]
    ...
    # @option attributes [Array<String>] :variables The value to assign to the {#variables} property
    ...
    def hash
      [compartment_id, compartment_id_in_subtree, saved_search_id, query_string, sub_system, max_total_count, time_filter, scope_filters, variables, query_timeout_in_seconds, should_run_async, async_mode, should_include_total_count, should_include_columns, should_include_fields, should_use_acceleration].hash
    end
