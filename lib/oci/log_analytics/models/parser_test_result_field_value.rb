...
module OCI
  ...
  #
  class LogAnalytics::Models::ParserTestResultFieldValue
    # The field position.
    # @return [Integer]
    ...
    # @return [OCI::LogAnalytics::Models::ParserTestResult]
    attr_accessor :sub_parser_result
    ...
    def self.swagger_types
      {
        ...
        'value': :'String',
        'parser_name': :'String',
        'sub_parser_result': :'OCI::LogAnalytics::Models::ParserTestResult'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::LogAnalytics::Models::ParserTestResult] :sub_parser_result The value to assign to the {#sub_parser_result} property
    def initialize(attributes = {})
      ...
      self.sub_parser_result = attributes[:'subParserResult'] if attributes[:'subParserResult']

      raise 'You cannot provide both :subParserResult and :sub_parser_result' if attributes.key?(:'subParserResult') && attributes.key?(:'sub_parser_result')

      self.sub_parser_result = attributes[:'sub_parser_result'] if attributes[:'sub_parser_result']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        sub_parser_result == other.sub_parser_result
    end
    ...
    def hash
      [position, field_name, value, parser_name, sub_parser_result].hash
    end
