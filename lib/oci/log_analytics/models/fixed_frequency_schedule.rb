...
module OCI
  ...
  class LogAnalytics::Models::FixedFrequencySchedule < LogAnalytics::Models::Schedule
    ...
    # @option attributes [Integer] :query_offset_secs The value to assign to the {OCI::LogAnalytics::Models::Schedule#query_offset_secs #query_offset_secs} proprety
    # @option attributes [DateTime] :time_end The value to assign to the {OCI::LogAnalytics::Models::Schedule#time_end #time_end} proprety
    ...
    def hash
      [type, misfire_policy, time_of_first_execution, query_offset_secs, time_end, recurring_interval, repeat_count].hash
    end
