...
module OCI
  ...
  class LogAnalytics::Models::StandardTask < LogAnalytics::Models::ScheduledTask
    ...
    # @option attributes [String] :description The value to assign to the {OCI::LogAnalytics::Models::ScheduledTask#description #description} proprety
    ...
    def hash
      [kind, id, display_name, description, task_type, schedules, action, task_status, pause_reason, work_request_id, num_occurrences, compartment_id, time_created, time_updated, time_of_next_execution, lifecycle_state, freeform_tags, defined_tags, last_execution_status, time_last_executed].hash
    end
