...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsLabelSummary
    ...
    def hash
      [aliases, count_usage_in_source, suggest_type, description, display_name, edit_version, impact, is_system, name, priority, recommendation, type, is_user_deleted, time_updated].hash
    end
