...
module OCI
  ...
  class LogAnalytics::Models::CreateStandardTaskDetails < LogAnalytics::Models::CreateScheduledTaskDetails
    ...
    # @option attributes [String] :description The value to assign to the {OCI::LogAnalytics::Models::CreateScheduledTaskDetails#description #description} proprety
    ...
    def hash
      [kind, compartment_id, display_name, description, freeform_tags, defined_tags, task_type, schedules, action].hash
    end
