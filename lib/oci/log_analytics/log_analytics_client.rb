...
module OCI
  ...
  class LogAnalytics::LogAnalyticsClient
    ...
    # @param [String] namespace_name The Log Analytics namespace used for the request. The namespace can be obtained by running 'oci os ns get'
    #
    # @param [String] log_analytics_entity_id The log analytics entity ID [OCID]. Entity ID can be obtained by running 'oci log-analytics entity list --namespace-name <namespace> --compartment-id <compartment>'. The json output 'id' parameter value contains the entity ID.
    #
    ...
    # @param [String] namespace_name The Log Analytics namespace used for the request. The namespace can be obtained by running 'oci os ns get'
    #
    # @param [String] work_request_id Work Request Identifier [OCID] (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the asynchronous request. The work request id can be usually obtained from the 'opc-work-request-id' response header of the asynchronous request.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    ...
    # @param [String] namespace_name The Log Analytics namespace used for the request. The namespace can be obtained by running 'oci os ns get'
    #
    # @param [String] ingest_time_rule_id Unique ocid of the ingest time rule. Ingest time rule ID can be obtained by running 'oci log-analytics ingest-time-rule list --namespace-name <namespace> --compartment-id <compartment>'. The json output 'id' parameter value contains the rule ID.
    #
    ...
    # @param [String] namespace_name The Log Analytics namespace used for the request. The namespace can be obtained by running 'oci os ns get'
    #
    # @param [String] log_analytics_em_bridge_id The log analytics enterprise manager bridge OCID. Bridge ID can be obtained by running 'oci log-analytics em-bridge list --namespace-name <namespace> --compartment-id <compartment>'. The json output 'id' parameter value contains the bridge ID.
    #
    ...
    # @param [String] namespace_name The Log Analytics namespace used for the request. The namespace can be obtained by running 'oci os ns get'
    #
    # @param [String] log_analytics_object_collection_rule_id The Log Analytics Object Collection Rule [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    ...
    # @param [String] namespace_name The Log Analytics namespace used for the request. The namespace can be obtained by running 'oci os ns get'
    #
    # @param [String] field_name The field name. Field name can be obtained by running 'oci log-analytics field list-fields --namespace-name <namespace>'. The json output 'name' parameter value contains the field name.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    # @param [String] namespace_name The Log Analytics namespace used for the request. The namespace can be obtained by running 'oci os ns get'
    #
    # @param [String] label_name The label name. Label name can be obtained by running 'oci log-analytics label list-labels --namespace-name <namespace>'. The json output 'name' parameter value contains the label name.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    # @param [String] namespace_name The Log Analytics namespace used for the request. The namespace can be obtained by running 'oci os ns get'
    #
    # @param [String] entity_type_name Log analytics entity type name. Entity type name can be obtained by running 'oci log-analytics entity-type list --namespace-name <namespacename> --all'. The json output 'internal-name' parameter value contains the entity type name.
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    def extract_structured_log_field_paths(namespace_name, logan_parser_details, opts = {})
      ...
      if opts[:parser_type] && !%w[XML JSON DELIMITED REGEX].include?(opts[:parser_type])
        raise 'Invalid value for "parser_type", must be one of XML, JSON, DELIMITED, REGEX.'
      end
      raise "Parameter value for 'namespace_name' must not be blank" if OCI::Internal::Util.blank_string?(namespace_name)
    ...
    def list_labels(namespace_name, opts = {})
      ...
      if opts[:label_sort_by] && !%w[name priority sourceUsing timeUpdated].include?(opts[:label_sort_by])
        raise 'Invalid value for "label_sort_by", must be one of name, priority, sourceUsing, timeUpdated.'
      end
      raise "Parameter value for 'namespace_name' must not be blank" if OCI::Internal::Util.blank_string?(namespace_name)
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @option opts [BOOLEAN] :is_compartment_delete if true, the request is from compartment delete service.
    #    (default to false)
    ...
    def list_namespaces(compartment_id, opts = {})
      ...
      query_params = {}
      query_params[:compartmentId] = compartment_id
      query_params[:isCompartmentDelete] = opts[:is_compartment_delete] if !opts[:is_compartment_delete].nil?
    ...
    # @option opts [String] :entity_id The entity OCID.
    #
    # @option opts [String] :entity_name The entity name used for filtering.
    #
    # @option opts [String] :life_cycle_state The life cycle state used for filtering.  Only associations with the specified
    #   life cycle state will be returned.
    #    (default to ALL)
    ...
    #    (default to ALL)
    #   Allowed values are: ALL, CUSTOM, BUILT_IN
    # @option opts [String] :lifecycle_state The source lifecycle state used for filtering. Currently supported
    #   values are ACTIVE and DELETED.
    #    (default to ACTIVE)
    ...
    def list_sources(namespace_name, compartment_id, opts = {})
      ...
      if opts[:lifecycle_state] && !%w[ACTIVE DELETED ALL].include?(opts[:lifecycle_state])
        raise 'Invalid value for "lifecycle_state", must be one of ACTIVE, DELETED, ALL.'
      end
    ...
    # @param [String] namespace_name The Log Analytics namespace used for the request. The namespace can be obtained by running 'oci os ns get'
    #
    # @param [String] bucket_name Name of the Object Storage bucket. Bucket name can be obtained by running 'oci os bucket list --namespace-name <namespace> --compartment-id <compartment>'. The json output 'name' parameter value contains the bucket name.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [BOOLEAN] :is_enabled The enabled flag used for filtering.  Only items with the specified enabled value
