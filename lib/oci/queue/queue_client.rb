...
module OCI
  ...
  class Queue::QueueClient
    ...
    # @option opts [String] :consumer_group_id Optional parameter to specify a consumer group.
    ...
    def delete_message(queue_id, message_receipt, opts = {})
      ...
      # Query Params
      query_params = {}
      query_params[:consumerGroupId] = opts[:consumer_group_id] if opts[:consumer_group_id]
