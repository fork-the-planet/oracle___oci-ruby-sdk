...
module OCI
  ...
  class Queue::QueueAdminClientCompositeOperations
    ...
    # Calls {OCI::Queue::QueueAdminClient#create_consumer_group} and then waits for the {OCI::Queue::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Queue::Models::CreateConsumerGroupDetails] create_consumer_group_details Details for the new consumer group.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Queue::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Queue::QueueAdminClient#create_consumer_group}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Queue::Models::WorkRequest}
    def create_consumer_group_and_wait_for_state(create_consumer_group_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_consumer_group(create_consumer_group_details, base_operation_opts)
      use_util = OCI::Queue::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Queue::QueueAdminClient#delete_consumer_group} and then waits for the {OCI::Queue::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] consumer_group_id The unique consumer group identifier.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Queue::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Queue::QueueAdminClient#delete_consumer_group}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Queue::Models::WorkRequest}
    def delete_consumer_group_and_wait_for_state(consumer_group_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_consumer_group(consumer_group_id, base_operation_opts)
      use_util = OCI::Queue::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Queue::QueueAdminClient#update_consumer_group} and then waits for the {OCI::Queue::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] consumer_group_id The unique consumer group identifier.
    # @param [OCI::Queue::Models::UpdateConsumerGroupDetails] update_consumer_group_details The information to be updated.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Queue::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Queue::QueueAdminClient#update_consumer_group}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Queue::Models::WorkRequest}
    def update_consumer_group_and_wait_for_state(consumer_group_id, update_consumer_group_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_consumer_group(consumer_group_id, update_consumer_group_details, base_operation_opts)
      use_util = OCI::Queue::Util.respond_to?(:wait_on_work_request)
