...
module OCI
  ...
  class Queue::Models::QueueSummary
    CAPABILITIES_ENUM = [
      CAPABILITIES_CONSUMER_GROUPS = 'CONSUMER_GROUPS'.freeze,
      CAPABILITIES_LARGE_MESSAGES = 'LARGE_MESSAGES'.freeze,
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, messages_endpoint, freeform_tags, defined_tags, system_tags, capabilities].hash
    end
