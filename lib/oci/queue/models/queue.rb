...
module OCI
  ...
  class Queue::Models::Queue
    ...
    # @return [Array<OCI::Queue::Models::CapabilityDetails>]
    ...
    def self.swagger_types
      {
        ...
        'capabilities': :'Array<OCI::Queue::Models::CapabilityDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Queue::Models::CapabilityDetails>] :capabilities The value to assign to the {#capabilities} property
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, messages_endpoint, retention_in_seconds, visibility_in_seconds, timeout_in_seconds, dead_letter_queue_delivery_count, custom_encryption_key_id, freeform_tags, defined_tags, system_tags, channel_consumption_limit, capabilities].hash
    end
