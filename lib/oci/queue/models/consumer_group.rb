...
module OCI
  ...
  class Queue::Models::ConsumerGroup
    ...
    # **[Required]** A unique identifier for the consumer group that is immutable on creation.
    # @return [String]
    attr_accessor :id

    # **[Required]** A user-friendly name for the consumer group. It has to be unique within the same queue in a case-insensitive manner. It's changeable. Avoid entering confidential information.
    # @return [String]
    attr_accessor :display_name

    # **[Required]** The time that the consumer group was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.
    #
    ...
    # **[Required]** The time that the consumer group was updated, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.
    #
    # Example: `2018-04-20T00:00:07.405Z`
    #
    # @return [DateTime]
    ...
    # **[Required]** The current state of the consumer group.
    # @return [String]
    ...
    # **[Required]** The filter used by the consumer group. Only messages matching the filter will be available by consumers of the group.
    # An empty value means that all messages will be available in the group.
    #
    # @return [String]
    attr_accessor :filter

    # **[Required]** The OCID of the associated queue.
    # @return [String]
    ...
    # @option attributes [String] :queue_id The value to assign to the {#queue_id} property
    ...
    def initialize(attributes = {})
      ...
      self.queue_id = attributes[:'queueId'] if attributes[:'queueId']

      raise 'You cannot provide both :queueId and :queue_id' if attributes.key?(:'queueId') && attributes.key?(:'queue_id')

      self.queue_id = attributes[:'queue_id'] if attributes[:'queue_id']
    ...
    def hash
      [id, display_name, time_created, time_updated, lifecycle_state, lifecycle_details, filter, queue_id, dead_letter_queue_delivery_count, freeform_tags, defined_tags, system_tags].hash
    end
