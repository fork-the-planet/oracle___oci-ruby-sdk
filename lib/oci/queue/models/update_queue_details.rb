...
module OCI
  ...
  class Queue::Models::UpdateQueueDetails
    ...
    def hash
      [display_name, visibility_in_seconds, timeout_in_seconds, channel_consumption_limit, dead_letter_queue_delivery_count, custom_encryption_key_id, capabilities, freeform_tags, defined_tags].hash
    end
