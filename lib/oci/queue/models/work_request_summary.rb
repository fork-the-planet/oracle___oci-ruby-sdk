...
module OCI
  ...
  class Queue::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CREATE_CONSUMER_GROUP = 'CREATE_CONSUMER_GROUP'.freeze,
      OPERATION_TYPE_UPDATE_CONSUMER_GROUP = 'UPDATE_CONSUMER_GROUP'.freeze,
      OPERATION_TYPE_DELETE_CONSUMER_GROUP = 'DELETE_CONSUMER_GROUP'.freeze,
