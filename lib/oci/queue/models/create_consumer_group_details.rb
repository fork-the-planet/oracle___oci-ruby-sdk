...
module OCI
  ...
  class Queue::Models::CreateConsumerGroupDetails
    # **[Required]** The user-friendly name of the consumer group.
    # @return [String]
    ...
    def hash
      [display_name, filter, queue_id, is_enabled, dead_letter_queue_delivery_count, freeform_tags, defined_tags].hash
    end
