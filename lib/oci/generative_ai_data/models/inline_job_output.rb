...
module OCI
  ...
  #
  class GenerativeAiData::Models::InlineJobOutput < GenerativeAiData::Models::JobOutput
    # **[Required]** SQL statement generated from the natural language query.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['jobOutputLocation'] = 'INLINE'
    ...
    def hash
      [job_output_location, content].hash
    end
