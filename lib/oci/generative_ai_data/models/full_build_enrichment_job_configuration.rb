...
module OCI
  ...
  #
  class GenerativeAiData::Models::FullBuildEnrichmentJobConfiguration < GenerativeAiData::Models::EnrichmentJobConfiguration
    ...
    def initialize(attributes = {})
      ...
      attributes['enrichmentJobType'] = 'FULL_BUILD'
    ...
    def hash
      [enrichment_job_type, schema_name].hash
    end
