...
module OCI
  ...
  #
  class Psa::Models::PrivateServiceAccess
    ...
    # **[Required]** The private service access FQDNs, which are going to be used to access the service.
    #
    ...
    def hash
      [compartment_id, defined_tags, freeform_tags, system_tags, security_attributes, display_name, description, id, time_created, time_updated, vcn_id, subnet_id, vnic_id, lifecycle_state, nsg_ids, service_id, fqdns, ipv4_ip].hash
    end
