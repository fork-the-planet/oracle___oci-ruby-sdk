...
module OCI
  ...
  class Psa::Models::CreatePrivateServiceAccessDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN's
    ...
    def hash
      [compartment_id, defined_tags, freeform_tags, security_attributes, display_name, description, subnet_id, nsg_ids, service_id, ipv4_ip].hash
    end
