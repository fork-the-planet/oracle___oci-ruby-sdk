...
module OCI
  ...
  class Psa::Models::WorkRequestSummaryCollection
    # **[Required]** A list of work requests.
    # @return [Array<OCI::Psa::Models::WorkRequestSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Psa::Models::WorkRequestSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Psa::Models::WorkRequestSummary>] :items The value to assign to the {#items} property
