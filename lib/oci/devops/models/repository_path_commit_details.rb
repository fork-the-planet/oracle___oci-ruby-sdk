...
module OCI
  ...
  class Devops::Models::RepositoryPathCommitDetails
    ...
    def self.swagger_types
      {
        ...
        'commit_id': :'String',
        'message': :'String',
        'author': :'OCI::Devops::Models::PrincipalDetails',
    ...
    # @option attributes [OCI::Devops::Models::PrincipalDetails] :author The value to assign to the {#author} property
    ...
    def hash
      [commit_id, message, author, time_updated].hash
    end
