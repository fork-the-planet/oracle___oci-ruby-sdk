...
module OCI
  ...
  class Devops::Models::ComputeInstanceGroupDeployEnvironment < Devops::Models::DeployEnvironment
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :security_attributes The value to assign to the {OCI::Devops::Models::DeployEnvironment#security_attributes #security_attributes} proprety
