...
module OCI
  ...
  class Devops::Models::DeployEnvironmentSummary
    ...
    def hash
      [id, description, display_name, project_id, compartment_id, deploy_environment_type, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags, security_attributes].hash
    end
