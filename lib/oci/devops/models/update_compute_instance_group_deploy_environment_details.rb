...
module OCI
  ...
  class Devops::Models::UpdateComputeInstanceGroupDeployEnvironmentDetails < Devops::Models::UpdateDeployEnvironmentDetails
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :security_attributes The value to assign to the {OCI::Devops::Models::UpdateDeployEnvironmentDetails#security_attributes #security_attributes} proprety
    ...
    def hash
      [description, display_name, deploy_environment_type, freeform_tags, defined_tags, security_attributes, compute_instance_group_selectors].hash
    end
