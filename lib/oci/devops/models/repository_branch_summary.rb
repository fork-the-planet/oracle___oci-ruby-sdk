...
module OCI
  ...
  class Devops::Models::RepositoryBranchSummary < Devops::Models::RepositoryRefSummary
    ...
    # @option attributes [DateTime] :time_created The value to assign to the {OCI::Devops::Models::RepositoryRefSummary#time_created #time_created} proprety
    # @option attributes [DateTime] :time_updated The value to assign to the {OCI::Devops::Models::RepositoryRefSummary#time_updated #time_updated} proprety
    ...
    # @option attributes [String] :latest_commit_author_name The value to assign to the {#latest_commit_author_name} property
    # @option attributes [Array<OCI::Devops::Models::PullRequestSummary>] :top_n_pull_requests The value to assign to the {#top_n_pull_requests} property
    # @option attributes [Hash<String, Integer>] :pull_request_state_counts The value to assign to the {#pull_request_state_counts} property
