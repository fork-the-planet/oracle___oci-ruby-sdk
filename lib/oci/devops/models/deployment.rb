...
module OCI
  ...
  class Devops::Models::Deployment
    ...
    # @option attributes [String] :cm_url The value to assign to the {#cm_url} property
    def initialize(attributes = {})
      ...
      self.cm_url = attributes[:'cmUrl'] if attributes[:'cmUrl']
      self.cm_url = "" if cm_url.nil? && !attributes.key?(:'cmUrl') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :cmUrl and :cm_url' if attributes.key?(:'cmUrl') && attributes.key?(:'cm_url')

      self.cm_url = attributes[:'cm_url'] if attributes[:'cm_url']
      self.cm_url = "" if cm_url.nil? && !attributes.key?(:'cmUrl') && !attributes.key?(:'cm_url') # rubocop:disable Style/StringLiterals
    end
