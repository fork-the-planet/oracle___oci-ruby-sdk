...
module OCI
  ...
  class Devops::Models::CreateComputeInstanceGroupDeployEnvironmentDetails < Devops::Models::CreateDeployEnvironmentDetails
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :security_attributes The value to assign to the {OCI::Devops::Models::CreateDeployEnvironmentDetails#security_attributes #security_attributes} proprety
    ...
    def hash
      [description, display_name, deploy_environment_type, project_id, freeform_tags, defined_tags, security_attributes, compute_instance_group_selectors].hash
    end
