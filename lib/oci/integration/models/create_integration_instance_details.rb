...
module OCI
  ...
  class Integration::Models::CreateIntegrationInstanceDetails
    ...
    def hash
      [display_name, compartment_id, integration_instance_type, freeform_tags, defined_tags, security_attributes, is_byol, idcs_at, message_packs, is_visual_builder_enabled, custom_endpoint, alternate_custom_endpoints, consumption_model, is_file_server_enabled, is_disaster_recovery_enabled, network_endpoint_details, shape, domain_id].hash
    end
