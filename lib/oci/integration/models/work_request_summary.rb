...
module OCI
  ...
  class Integration::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_DISABLE_PROCESS_AUTOMATION = 'DISABLE_PROCESS_AUTOMATION'.freeze,
      OPERATION_TYPE_ADD_LOG_ANALYTICS_LOG_GROUP = 'ADD_LOG_ANALYTICS_LOG_GROUP'.freeze,
      OPERATION_TYPE_DELETE_LOG_ANALYTICS_LOG_GROUP = 'DELETE_LOG_ANALYTICS_LOG_GROUP'.freeze,
      OPERATION_TYPE_CONVERT_INSTANCE = 'CONVERT_INSTANCE'.freeze,
      OPERATION_TYPE_ADD_OPA_LOG_ANALYTICS_LOG_GROUP = 'ADD_OPA_LOG_ANALYTICS_LOG_GROUP'.freeze,
      OPERATION_TYPE_DELETE_OPA_LOG_ANALYTICS_LOG_GROUP = 'DELETE_OPA_LOG_ANALYTICS_LOG_GROUP'.freeze,
      OPERATION_TYPE_BEGIN_MIGRATION = 'BEGIN_MIGRATION'.freeze,
      OPERATION_TYPE_COMPLETE_MIGRATION = 'COMPLETE_MIGRATION'.freeze,
      OPERATION_TYPE_ROLLBACK_MIGRATION = 'ROLLBACK_MIGRATION'.freeze,
