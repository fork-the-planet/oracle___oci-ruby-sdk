...
module OCI
  ...
  class Integration::Models::UpdateIntegrationInstanceDetails
    ...
    def hash
      [display_name, integration_instance_type, freeform_tags, defined_tags, security_attributes, is_byol, message_packs, is_file_server_enabled, is_visual_builder_enabled, custom_endpoint, alternate_custom_endpoints].hash
    end
