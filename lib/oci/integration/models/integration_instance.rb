...
module OCI
  ...
  class Integration::Models::IntegrationInstance
    ...
    # @return [String]
    attr_accessor :process_automation_log_group_id
    ...
    def self.swagger_types
      {
        ...
        'log_group_id': :'String',
        'process_automation_log_group_id': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :process_automation_log_group_id The value to assign to the {#process_automation_log_group_id} property
    def initialize(attributes = {})
      ...
      self.process_automation_log_group_id = attributes[:'processAutomationLogGroupId'] if attributes[:'processAutomationLogGroupId']

      raise 'You cannot provide both :processAutomationLogGroupId and :process_automation_log_group_id' if attributes.key?(:'processAutomationLogGroupId') && attributes.key?(:'process_automation_log_group_id')

      self.process_automation_log_group_id = attributes[:'process_automation_log_group_id'] if attributes[:'process_automation_log_group_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        process_automation_log_group_id == other.process_automation_log_group_id
    end
    ...
    def hash
      [id, display_name, compartment_id, integration_instance_type, time_created, time_updated, lifecycle_state, lifecycle_details, state_message, freeform_tags, defined_tags, system_tags, security_attributes, is_byol, instance_url, instance_design_time_url, message_packs, is_file_server_enabled, is_visual_builder_enabled, custom_endpoint, alternate_custom_endpoints, consumption_model, network_endpoint_details, idcs_info, attachments, shape, private_endpoint_outbound_connection, is_disaster_recovery_enabled, disaster_recovery_details, data_retention_period, log_group_id, process_automation_log_group_id].hash
    end
