...
module OCI
  ...
  class Integration::IntegrationInstanceClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/integration/add_log_analytics_log_group.rb.html) to see an example of how to use add_log_analytics_log_group API.
    def add_log_analytics_log_group(integration_instance_id, add_log_analytics_log_group_details, opts = {})
      logger.debug 'Calling operation IntegrationInstanceClient#add_log_analytics_log_group.' if logger

      raise "Missing the required parameter 'integration_instance_id' when calling add_log_analytics_log_group." if integration_instance_id.nil?
      raise "Missing the required parameter 'add_log_analytics_log_group_details' when calling add_log_analytics_log_group." if add_log_analytics_log_group_details.nil?
      ...
      path = '/integrationInstances/{integrationInstanceId}/actions/addLogAnalyticsLogGroup'.sub('{integrationInstanceId}', integration_instance_id.to_s)
      ...
      post_body = @api_client.object_to_http_body(add_log_analytics_log_group_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'IntegrationInstanceClient#add_log_analytics_log_group') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/integration/convert_instance.rb.html) to see an example of how to use convert_instance API.
    def convert_instance(integration_instance_id, convert_instance_details, opts = {})
      logger.debug 'Calling operation IntegrationInstanceClient#convert_instance.' if logger

      raise "Missing the required parameter 'integration_instance_id' when calling convert_instance." if integration_instance_id.nil?
      raise "Missing the required parameter 'convert_instance_details' when calling convert_instance." if convert_instance_details.nil?
      raise "Parameter value for 'integration_instance_id' must not be blank" if OCI::Internal::Util.blank_string?(integration_instance_id)

      path = '/integrationInstances/{integrationInstanceId}/actions/convertInstance'.sub('{integrationInstanceId}', integration_instance_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(convert_instance_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'IntegrationInstanceClient#convert_instance') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/integration/disable_process_automation.rb.html) to see an example of how to use disable_process_automation API.
    def disable_process_automation(integration_instance_id, opts = {})
      logger.debug 'Calling operation IntegrationInstanceClient#disable_process_automation.' if logger

      raise "Missing the required parameter 'integration_instance_id' when calling disable_process_automation." if integration_instance_id.nil?
      raise "Parameter value for 'integration_instance_id' must not be blank" if OCI::Internal::Util.blank_string?(integration_instance_id)

      path = '/integrationInstances/{integrationInstanceId}/actions/disableProcessAutomation'.sub('{integrationInstanceId}', integration_instance_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'IntegrationInstanceClient#disable_process_automation') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [OCI::Integration::Models::RemoveLogAnalyticsLogGroupDetails] :remove_log_analytics_log_group_details Details to remove Log Group for given integration instance or Process Automation attached to integration instance.
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    #   for a resource, set the `if-match` parameter to the value of the
    #   etag from a previous GET or POST response for that resource.
    #   The resource will be updated or deleted only if the etag you
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/integration/remove_log_analytics_log_group.rb.html) to see an example of how to use remove_log_analytics_log_group API.
    def remove_log_analytics_log_group(integration_instance_id, opts = {})
      logger.debug 'Calling operation IntegrationInstanceClient#remove_log_analytics_log_group.' if logger

      raise "Missing the required parameter 'integration_instance_id' when calling remove_log_analytics_log_group." if integration_instance_id.nil?
      raise "Parameter value for 'integration_instance_id' must not be blank" if OCI::Internal::Util.blank_string?(integration_instance_id)

      path = '/integrationInstances/{integrationInstanceId}/actions/removeLogAnalyticsLogGroup'.sub('{integrationInstanceId}', integration_instance_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(opts[:remove_log_analytics_log_group_details])

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'IntegrationInstanceClient#remove_log_analytics_log_group') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
