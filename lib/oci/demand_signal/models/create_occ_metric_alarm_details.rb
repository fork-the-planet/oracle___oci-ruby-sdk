...
module OCI
  ...
  class DemandSignal::Models::CreateOccMetricAlarmDetails
    ...
    def hash
      [display_name, description, lifecycle_state, compartment_id, is_active, subscribers, frequency, threshold, threshold_type, resource_configuration, freeform_tags, defined_tags].hash
    end
