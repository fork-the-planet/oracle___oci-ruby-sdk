...
module OCI
  ...
  class FusionApps::Models::MarketingBrandSummary
    # **[Required]** The unique identifier (OCID) of marketing brand. Can't be changed after creation.
    # @return [String]
    attr_accessor :id

    # **[Required]** marketing brand name for fusion environment
    # @return [String]
    attr_accessor :name

    # **[Required]** lifecycle state of marketing brand
    # @return [String]
    ...
    # **[Required]** fusion environment id
    # @return [String]
    ...
    def hash
      [id, name, lifecycle_state, lifecycle_details, fusion_environment_id, time_created, freeform_tags, defined_tags, system_tags].hash
    end
