...
module OCI
  ...
  class FusionApps::Models::RequestEmailSubdomainCsrDetails
    ...
    # @option attributes [String] :sans The value to assign to the {#sans} property
    ...
    def initialize(attributes = {})
      ...
      self.sans = attributes[:'sans'] if attributes[:'sans']
    ...
    def hash
      [common_name, sans, organization_name, organization_unit, locality, state, country, email_address].hash
    end
