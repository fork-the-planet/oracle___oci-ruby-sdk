...
module OCI
  ...
  class FusionApps::Models::VanityDomainSummary
    # **[Required]** The unique identifier (OCID) of the VanityDomain. Can't be changed after creation
    # @return [String]
    attr_accessor :id

    # **[Required]** Vanity domain. Can't be changed after creation
    # @return [String]
    ...
    def hash
      [id, vanity_domain, prefix, fusion_environment_id, lifecycle_state, lifecycle_details, time_created, time_updated, time_enabled, scheduled_activity_id, system_tags, freeform_tags, defined_tags].hash
    end
