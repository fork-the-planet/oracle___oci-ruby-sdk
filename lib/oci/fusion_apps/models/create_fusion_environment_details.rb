...
module OCI
  ...
  class FusionApps::Models::CreateFusionEnvironmentDetails
    ...
    # **[Required]** The type of environment. Valid values are Production, Test, Development, or Demo.
    # @return [String]
    ...
    # @return [BOOLEAN]
    attr_accessor :is_i_pv6_dual_stack_enabled
    ...
    # @return [Array<OCI::FusionApps::Models::AdditionalEgressRule>]
    attr_accessor :additional_egress_rules
    ...
    # @option attributes [BOOLEAN] :is_i_pv6_dual_stack_enabled The value to assign to the {#is_i_pv6_dual_stack_enabled} property
    # @option attributes [Array<OCI::FusionApps::Models::Rule>] :rules The value to assign to the {#rules} property
    # @option attributes [Array<OCI::FusionApps::Models::AdditionalEgressRule>] :additional_egress_rules The value to assign to the {#additional_egress_rules} property
    ...
    def initialize(attributes = {})
      ...
      self.additional_egress_rules = attributes[:'additionalEgressRules'] if attributes[:'additionalEgressRules']

      raise 'You cannot provide both :additionalEgressRules and :additional_egress_rules' if attributes.key?(:'additionalEgressRules') && attributes.key?(:'additional_egress_rules')

      self.additional_egress_rules = attributes[:'additional_egress_rules'] if attributes[:'additional_egress_rules']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        rules == other.rules &&
        additional_egress_rules == other.additional_egress_rules &&
    ...
    def hash
      [display_name, maintenance_policy, compartment_id, fusion_environment_family_id, fusion_environment_type, kms_key_id, dns_prefix, additional_language_packs, is_i_pv6_dual_stack_enabled, rules, additional_egress_rules, create_fusion_environment_admin_user_details, freeform_tags, defined_tags].hash
    end
