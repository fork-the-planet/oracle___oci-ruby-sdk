...
module OCI
  ...
  class FusionApps::Models::UpdateFusionEnvironmentDetails
    ...
    def hash
      [display_name, kms_key_id, maintenance_policy, additional_language_packs, is_i_pv6_dual_stack_enabled, rules, additional_egress_rules, freeform_tags, defined_tags].hash
    end
