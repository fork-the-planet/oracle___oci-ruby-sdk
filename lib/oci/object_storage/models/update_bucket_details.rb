...
module OCI
  ...
  class ObjectStorage::Models::UpdateBucketDetails
    ...
    def hash
      [namespace, compartment_id, name, metadata, public_access_type, object_events_enabled, freeform_tags, defined_tags, kms_key_id, is_bucket_key_enabled, versioning, auto_tiering, bucket_scope].hash
    end
