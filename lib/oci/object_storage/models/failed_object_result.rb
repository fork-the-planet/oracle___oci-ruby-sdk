...
module OCI
  ...
  #
  class ObjectStorage::Models::FailedObjectResult
    ...
    # **[Required]** HTTP status code for the failure.
    # Example: 409
    #
    # @return [Integer]
    attr_accessor :status_code

    # **[Required]** Detailed error message on why the delete/update was failed.
    # @return [String]
    ...
    def hash
      [object_name, status_code, error_message].hash
    end
