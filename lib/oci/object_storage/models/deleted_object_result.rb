...
module OCI
  ...
  #
  class ObjectStorage::Models::DeletedObjectResult
    # **[Required]** The name of the deleted object. Avoid entering confidential information.
    # Example: test/object1.log
    #
    # @return [String]
    attr_accessor :object_name

    # **[Required]** The time the object was deleted, as described in [RFC 2616](https://tools.ietf.org/html/rfc2616#section-14.29).
    # @return [DateTime]
    ...
    def hash
      [object_name, time_last_modified].hash
    end
