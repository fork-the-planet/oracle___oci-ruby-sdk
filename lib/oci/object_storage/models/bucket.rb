...
module OCI
  ...
  class ObjectStorage::Models::Bucket
    ...
    BUCKET_SCOPE_ENUM = [
      BUCKET_SCOPE_NAMESPACE = 'NAMESPACE'.freeze,
      BUCKET_SCOPE_REGION = 'REGION'.freeze,
      BUCKET_SCOPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_bucket_key_enabled
    ...
    # @option attributes [BOOLEAN] :is_bucket_key_enabled The value to assign to the {#is_bucket_key_enabled} property
    ...
    # @option attributes [String] :bucket_scope The value to assign to the {#bucket_scope} property
    def initialize(attributes = {})
      ...
      self.is_bucket_key_enabled = attributes[:'isBucketKeyEnabled'] unless attributes[:'isBucketKeyEnabled'].nil?

      raise 'You cannot provide both :isBucketKeyEnabled and :is_bucket_key_enabled' if attributes.key?(:'isBucketKeyEnabled') && attributes.key?(:'is_bucket_key_enabled')

      self.is_bucket_key_enabled = attributes[:'is_bucket_key_enabled'] unless attributes[:'is_bucket_key_enabled'].nil?
      ...
      self.bucket_scope = attributes[:'bucketScope'] if attributes[:'bucketScope']

      raise 'You cannot provide both :bucketScope and :bucket_scope' if attributes.key?(:'bucketScope') && attributes.key?(:'bucket_scope')

      self.bucket_scope = attributes[:'bucket_scope'] if attributes[:'bucket_scope']
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] bucket_scope Object to be assigned
    def bucket_scope=(bucket_scope)
      # rubocop:disable Style/ConditionalAssignment
      if bucket_scope && !BUCKET_SCOPE_ENUM.include?(bucket_scope)
        OCI.logger.debug("Unknown value for 'bucket_scope' [" + bucket_scope + "]. Mapping to 'BUCKET_SCOPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @bucket_scope = BUCKET_SCOPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_bucket_key_enabled == other.is_bucket_key_enabled &&
        ...
        bucket_scope == other.bucket_scope
    end
    ...
    def hash
      [namespace, name, compartment_id, metadata, created_by, time_created, etag, public_access_type, storage_tier, object_events_enabled, freeform_tags, defined_tags, kms_key_id, is_bucket_key_enabled, object_lifecycle_policy_etag, approximate_count, approximate_size, replication_enabled, is_read_only, id, versioning, auto_tiering, bucket_scope].hash
    end
