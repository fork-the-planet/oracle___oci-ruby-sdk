...
module OCI
  ...
  class Bds::Models::AddBlockStorageDetails
    ...
    # **[Required]** The size of block volume in GB to be added. For WORKER, COMPUTE_ONLY_WORKER, and KAFKA_BROKER nodes,
    ...
    # @option attributes [Array<String>] :node_ids The value to assign to the {#node_ids} property
    def initialize(attributes = {})
      ...
      self.node_ids = attributes[:'nodeIds'] if attributes[:'nodeIds']

      raise 'You cannot provide both :nodeIds and :node_ids' if attributes.key?(:'nodeIds') && attributes.key?(:'node_ids')

      self.node_ids = attributes[:'node_ids'] if attributes[:'node_ids']
    end
    ...
    def hash
      [cluster_admin_password, secret_id, block_volume_size_in_gbs, node_type, node_ids].hash
    end
