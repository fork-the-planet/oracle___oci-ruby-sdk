...
module OCI
  ...
  class Bds::Models::ManageBdsCertificateLevelTypeDetails
    TRIGGER_TYPE_ENUM = [
      TRIGGER_TYPE_NODE_LEVEL = 'NODE_LEVEL'.freeze,
      TRIGGER_TYPE_CONFIG_LEVEL = 'CONFIG_LEVEL'.freeze
    ].freeze

    # **[Required]** Type of level used to trigger certificate generation or renewal.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Bds::Models::NodeLevelManageBdsCertificateDetails' if type == 'NODE_LEVEL'
      return 'OCI::Bds::Models::ConfigLevelManageBdsCertificateDetails' if type == 'CONFIG_LEVEL'
    ...
    def trigger_type=(trigger_type)
      raise "Invalid value for 'trigger_type': this must be one of the values in TRIGGER_TYPE_ENUM." if trigger_type && !TRIGGER_TYPE_ENUM.include?(trigger_type)
