...
module OCI
  ...
  class Bds::Models::CreateIdentityConfigurationDetails
    ...
    def hash
      [cluster_admin_password, secret_id, display_name, identity_domain_id, confidential_application_id, upst_configuration_details, iam_user_sync_configuration_details].hash
    end
