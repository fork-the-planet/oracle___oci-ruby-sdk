...
module OCI
  ...
  class Bds::Models::RemoveNodesDetails
    ...
    # **[Required]** List of instance IDs to be removed.
    # @return [Array<String>]
    ...
    # @option attributes [Array<String>] :instance_ids The value to assign to the {#instance_ids} property
    def initialize(attributes = {})
      ...
      self.instance_ids = attributes[:'instanceIds'] if attributes[:'instanceIds']

      raise 'You cannot provide both :instanceIds and :instance_ids' if attributes.key?(:'instanceIds') && attributes.key?(:'instance_ids')

      self.instance_ids = attributes[:'instance_ids'] if attributes[:'instance_ids']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        instance_ids == other.instance_ids
    end
    ...
    def hash
      [cluster_admin_password, secret_id, is_force_remove_enabled, instance_ids].hash
    end
