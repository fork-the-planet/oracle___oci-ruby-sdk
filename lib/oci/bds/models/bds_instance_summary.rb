...
module OCI
  ...
  class Bds::Models::BdsInstanceSummary
    ...
    def hash
      [id, compartment_id, display_name, lifecycle_state, number_of_nodes, number_of_nodes_requiring_maintenance_reboot, cluster_version, is_high_availability, is_secure, is_cloud_sql_configured, is_kafka_configured, cluster_profile, time_created, time_earliest_certificate_expiration, freeform_tags, defined_tags].hash
    end
