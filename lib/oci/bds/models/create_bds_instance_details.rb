...
module OCI
  ...
  class Bds::Models::CreateBdsInstanceDetails
    ...
    def hash
      [compartment_id, display_name, cluster_version, cluster_public_key, cluster_admin_password, secret_id, is_secret_reused, is_high_availability, is_secure, network_config, bootstrap_script_url, nodes, kerberos_realm_name, freeform_tags, defined_tags, kms_key_id, cluster_profile, bds_cluster_version_summary].hash
    end
