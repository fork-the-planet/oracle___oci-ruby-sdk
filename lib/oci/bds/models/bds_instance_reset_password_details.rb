...
module OCI
  ...
  class Bds::Models::BdsInstanceResetPasswordDetails
    SERVICE_ENUM = [
      SERVICE_AMBARI = 'AMBARI'.freeze,
      SERVICE_HUE = 'HUE'.freeze,
      SERVICE_RANGER = 'RANGER'.freeze,
      SERVICE_JUPYTERHUB = 'JUPYTERHUB'.freeze
    ].freeze
    ...
    # **[Required]** Target service to which this operation applies.
    # @return [String]
    attr_reader :service
    ...
    def service=(service)
      raise "Invalid value for 'service': this must be one of the values in SERVICE_ENUM." if service && !SERVICE_ENUM.include?(service)
    ...
    def hash
      [cluster_admin_password, secret_id, service].hash
    end
