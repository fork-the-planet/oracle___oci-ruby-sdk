...
module OCI
  ...
  class Bds::Models::BdsInstance
    ...
    # @return [BOOLEAN]
    attr_accessor :is_secret_reused
    ...
    # @return [DateTime]
    attr_accessor :time_earliest_certificate_expiration
    ...
    # @option attributes [BOOLEAN] :is_secret_reused The value to assign to the {#is_secret_reused} property
    ...
    # @option attributes [DateTime] :time_earliest_certificate_expiration The value to assign to the {#time_earliest_certificate_expiration} property
    def initialize(attributes = {})
      ...
      self.is_secret_reused = attributes[:'isSecretReused'] unless attributes[:'isSecretReused'].nil?
      self.is_secret_reused = false if is_secret_reused.nil? && !attributes.key?(:'isSecretReused') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isSecretReused and :is_secret_reused' if attributes.key?(:'isSecretReused') && attributes.key?(:'is_secret_reused')

      self.is_secret_reused = attributes[:'is_secret_reused'] unless attributes[:'is_secret_reused'].nil?
      self.is_secret_reused = false if is_secret_reused.nil? && !attributes.key?(:'isSecretReused') && !attributes.key?(:'is_secret_reused') # rubocop:disable Style/StringLiterals
      ...
      self.time_earliest_certificate_expiration = attributes[:'timeEarliestCertificateExpiration'] if attributes[:'timeEarliestCertificateExpiration']

      raise 'You cannot provide both :timeEarliestCertificateExpiration and :time_earliest_certificate_expiration' if attributes.key?(:'timeEarliestCertificateExpiration') && attributes.key?(:'time_earliest_certificate_expiration')

      self.time_earliest_certificate_expiration = attributes[:'time_earliest_certificate_expiration'] if attributes[:'time_earliest_certificate_expiration']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_secret_reused == other.is_secret_reused &&
        ...
        time_earliest_certificate_expiration == other.time_earliest_certificate_expiration
    end
    ...
    def hash
      [id, compartment_id, display_name, lifecycle_state, cluster_version, secret_id, is_secret_reused, is_high_availability, is_secure, is_cloud_sql_configured, is_kafka_configured, network_config, cluster_details, nodes, cloud_sql_details, created_by, time_created, time_updated, number_of_nodes, number_of_nodes_requiring_maintenance_reboot, bootstrap_script_url, freeform_tags, defined_tags, kms_key_id, cluster_profile, bds_cluster_version_summary, time_earliest_certificate_expiration].hash
    end
