...
module OCI
  ...
  class FleetAppsManagement::Models::SubnetVariableDependsOn
    ...
    # @return [String]
    attr_accessor :hide_public_subnet

    # If present, hides private subnets.
    # @return [String]
    attr_accessor :hide_private_subnet

    # If present, hides regional subnets.
    # @return [String]
    attr_accessor :hide_regional_subnet

    # If present, hides AD subnet.
    # @return [String]
    attr_accessor :hide_ad_subnet
    ...
    # @option attributes [String] :hide_public_subnet The value to assign to the {#hide_public_subnet} property
    # @option attributes [String] :hide_private_subnet The value to assign to the {#hide_private_subnet} property
    # @option attributes [String] :hide_regional_subnet The value to assign to the {#hide_regional_subnet} property
    # @option attributes [String] :hide_ad_subnet The value to assign to the {#hide_ad_subnet} property
