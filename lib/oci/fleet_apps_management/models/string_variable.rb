...
module OCI
  # String variable.
  class FleetAppsManagement::Models::StringVariable < FleetAppsManagement::Models::BaseVariable
    ...
    def hash
      [type, title, description, is_required, visible, default_value, pattern, max_length, min_length].hash
    end
