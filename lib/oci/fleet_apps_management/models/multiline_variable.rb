...
module OCI
  # Multiline variable.
  class FleetAppsManagement::Models::MultilineVariable < FleetAppsManagement::Models::BaseVariable
    ...
    # @option attributes [BOOLEAN] :is_multiline The value to assign to the {#is_multiline} property
    ...
    def initialize(attributes = {})
      ...
      self.is_multiline = attributes[:'isMultiline'] unless attributes[:'isMultiline'].nil?

      raise 'You cannot provide both :isMultiline and :is_multiline' if attributes.key?(:'isMultiline') && attributes.key?(:'is_multiline')

      self.is_multiline = attributes[:'is_multiline'] unless attributes[:'is_multiline'].nil?
    ...
    def hash
      [type, title, description, is_required, visible, default_value, pattern, is_multiline, max_length, min_length].hash
    end
