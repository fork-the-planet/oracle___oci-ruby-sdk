...
module OCI
  ...
  class FleetAppsManagement::Models::RunbookSummary
    ...
    # @option attributes [String] :original_version The value to assign to the {#original_version} property
    ...
    def initialize(attributes = {})
      ...
      self.original_version = attributes[:'originalVersion'] if attributes[:'originalVersion']

      raise 'You cannot provide both :originalVersion and :original_version' if attributes.key?(:'originalVersion') && attributes.key?(:'original_version')

      self.original_version = attributes[:'original_version'] if attributes[:'original_version']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        original_version == other.original_version &&
    ...
    def hash
      [id, display_name, description, type, operation, os_type, platform, is_default, estimated_time, latest_version, has_draft_version, original_version, lifecycle_state, lifecycle_details, time_created, time_updated, compartment_id, resource_region, freeform_tags, defined_tags, system_tags].hash
    end
