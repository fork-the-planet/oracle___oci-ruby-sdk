...
module OCI
  ...
  class FleetAppsManagement::Models::KeyValueProperty
    # **[Required]** Name of the configuration variable or property to set for the catalog item.
    # @return [String]
    attr_accessor :key

    # **[Required]** The value assigned to the specified configuration property key.
    # @return [String]
    attr_accessor :value
