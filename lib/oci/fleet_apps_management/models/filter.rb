...
module OCI
  ...
  class FleetAppsManagement::Models::Filter
    FILTER_TYPE_ENUM = [
      FILTER_TYPE_SINGLE_VALUE = 'SINGLE_VALUE'.freeze,
      FILTER_TYPE_MULTI_VALUE = 'MULTI_VALUE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetAppsManagement::Models::MultiValueFilter' if type == 'MULTI_VALUE'
      return 'OCI::FleetAppsManagement::Models::SingleValueFilter' if type == 'SINGLE_VALUE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetAppsManagement::Models::Filter'
    end
