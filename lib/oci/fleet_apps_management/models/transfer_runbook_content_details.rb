...
module OCI
  ...
  class FleetAppsManagement::Models::TransferRunbookContentDetails
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_OBJECT_STORAGE_BUCKET = 'OBJECT_STORAGE_BUCKET'.freeze,
      SOURCE_TYPE_PAR_URL = 'PAR_URL'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetAppsManagement::Models::TransferRunbookObjectStorageBucketContentDetails' if type == 'OBJECT_STORAGE_BUCKET'
      return 'OCI::FleetAppsManagement::Models::TransferRunbookParUrlContentDetails' if type == 'PAR_URL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetAppsManagement::Models::TransferRunbookContentDetails'
    end
