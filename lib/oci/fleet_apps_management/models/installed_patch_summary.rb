...
module OCI
  ...
  class FleetAppsManagement::Models::InstalledPatchSummary
    SEVERITY_ENUM = [
    ...
    # **[Required]** Description of the patch
    # @return [String]
    ...
    def hash
      [patch_id, patch_name, patch_description, time_applied, time_released, patch_type, patch_level, severity].hash
    end
