...
module OCI
  ...
  #
  class Multicloud::Models::ExternalLocationMappingMetadatumSummary
    ...
    # @return [OCI::Multicloud::Models::ExternalLocation]
    ...
    def self.swagger_types
      {
        ...
        'external_location': :'OCI::Multicloud::Models::ExternalLocation',
    ...
    # @option attributes [OCI::Multicloud::Models::ExternalLocation] :external_location The value to assign to the {#external_location} property
    ...
    def hash
      [freeform_tags, defined_tags, system_tags, external_location, oci_physical_ad, oci_logical_ad, oci_region].hash
    end
