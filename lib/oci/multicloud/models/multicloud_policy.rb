...
module OCI
  ...
  class Multicloud::Models::MulticloudPolicy
    ...
    # **[Required]** Compartment The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) where the policy is configured.
    # @return [String]
    ...
    # **[Required]** Name of the missing policy.
    # @return [String]
    attr_accessor :name
    ...
    # **[Required]** IAM policy statements required.
    # @return [Array<String>]
    ...
    def hash
      [compartment_id, compartment_name, name, description, statements, freeform_tags, defined_tags, system_tags, lifecycle_state].hash
    end
