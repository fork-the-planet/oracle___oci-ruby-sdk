...
module OCI
  ...
  class Multicloud::Models::ExternalLocationSummariesMetadatumSummary
    ...
    # @return [OCI::Multicloud::Models::ExternalLocationSummary]
    ...
    def self.swagger_types
      {
        ...
        'external_location': :'OCI::Multicloud::Models::ExternalLocationSummary',
        'oci_region': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Multicloud::Models::ExternalLocationSummary] :external_location The value to assign to the {#external_location} property
    ...
    def hash
      [freeform_tags, defined_tags, system_tags, external_location, oci_region].hash
    end
