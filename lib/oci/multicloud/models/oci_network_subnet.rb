...
module OCI
  ...
  class Multicloud::Models::OciNetworkSubnet
    TYPE_ENUM = [
      TYPE_CLIENT = 'CLIENT'.freeze,
      TYPE_BACKUP = 'BACKUP'.freeze,
      TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Defines if the subnet is the primary or backup for the network
    # @return [String]
    attr_reader :type
