...
module OCI
  ...
  #
  class Multicloud::Models::MultiCloudMetadataSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Multicloud base compartment associated with the indicated subscription (`subscriptionId`).
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The date and time that the Multicloud base compartment was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the OCI subscription.
    # @return [String]
    ...
    def hash
      [compartment_id, time_created, subscription_id, freeform_tags, defined_tags, system_tags].hash
    end
