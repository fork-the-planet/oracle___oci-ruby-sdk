...
module OCI
  ...
  class Multicloud::Models::CspZoneKeyReferenceId
    # **[Required]** Value of keyName
    ...
    # **[Required]** KeyName for Azure=AzureSubscriptionId Aws=AwsAccountId GCP=GcpProjectName
    # @return [String]
