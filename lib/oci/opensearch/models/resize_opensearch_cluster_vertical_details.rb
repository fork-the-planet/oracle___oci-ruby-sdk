...
module OCI
  ...
  class Opensearch::Models::ResizeOpensearchClusterVerticalDetails
    ...
    def hash
      [master_node_host_ocpu_count, master_node_host_memory_gb, master_node_host_shape, data_node_host_ocpu_count, data_node_host_memory_gb, data_node_storage_gb, data_node_host_shape, opendashboard_node_host_ocpu_count, opendashboard_node_host_memory_gb, opendashboard_node_host_shape, search_node_host_shape, search_node_host_ocpu_count, search_node_host_memory_gb, search_node_storage_gb, coordinator_node_host_shape, coordinator_node_host_ocpu_count, coordinator_node_host_memory_gb, ml_node_host_shape, ml_node_host_ocpu_count, ml_node_host_memory_gb, ml_node_storage_gb, freeform_tags, defined_tags].hash
    end
