...
module OCI
  ...
  class Opensearch::Models::OpensearchCluster
    ...
    def coordinator_node_host_type=(coordinator_node_host_type)
      # rubocop:disable Style/ConditionalAssignment
      if coordinator_node_host_type && !COORDINATOR_NODE_HOST_TYPE_ENUM.include?(coordinator_node_host_type)
        OCI.logger.debug("Unknown value for 'coordinator_node_host_type' [" + coordinator_node_host_type + "]. Mapping to 'COORDINATOR_NODE_HOST_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @coordinator_node_host_type = COORDINATOR_NODE_HOST_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def ml_node_host_type=(ml_node_host_type)
      # rubocop:disable Style/ConditionalAssignment
      if ml_node_host_type && !ML_NODE_HOST_TYPE_ENUM.include?(ml_node_host_type)
        OCI.logger.debug("Unknown value for 'ml_node_host_type' [" + ml_node_host_type + "]. Mapping to 'ML_NODE_HOST_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @ml_node_host_type = ML_NODE_HOST_TYPE_UNKNOWN_ENUM_VALUE
      else
