...
module OCI
  ...
  #
  class Opensearch::Models::LoadBalancerConfig
    ...
    # @option attributes [String] :load_balancer_service_type The value to assign to the {#load_balancer_service_type} property
    # @option attributes [Integer] :load_balancer_min_bandwidth_in_mbps The value to assign to the {#load_balancer_min_bandwidth_in_mbps} property
    # @option attributes [Integer] :load_balancer_max_bandwidth_in_mbps The value to assign to the {#load_balancer_max_bandwidth_in_mbps} property
    ...
    # @param [Object] load_balancer_service_type Object to be assigned
    def load_balancer_service_type=(load_balancer_service_type)
      # rubocop:disable Style/ConditionalAssignment
      if load_balancer_service_type && !LOAD_BALANCER_SERVICE_TYPE_ENUM.include?(load_balancer_service_type)
        OCI.logger.debug("Unknown value for 'load_balancer_service_type' [" + load_balancer_service_type + "]. Mapping to 'LOAD_BALANCER_SERVICE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @load_balancer_service_type = LOAD_BALANCER_SERVICE_TYPE_UNKNOWN_ENUM_VALUE
      else
        @load_balancer_service_type = load_balancer_service_type
      end
