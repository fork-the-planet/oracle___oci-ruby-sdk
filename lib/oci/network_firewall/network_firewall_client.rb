...
module OCI
  # Use the Network Firewall API to create network firewalls and configure policies that regulates network traffic in and across VCNs. For more information, see [Overview of Network Firewall](/iaas/Content/network-firewall/overview.htm).
  class NetworkFirewall::NetworkFirewallClient
    ...
    #
    # @param [String] network_firewall_policy_id Unique Network Firewall Policy identifier
    # @param [OCI::NetworkFirewall::Models::CreateNatRuleDetails] create_nat_rule_details Request details used to create NAT rule under a Network Firewall policy resource.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::NetworkFirewall::Models::NetworkFirewallHealthStatus NetworkFirewallHealthStatus}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/networkfirewall/get_network_firewall_health_status.rb.html) to see an example of how to use get_network_firewall_health_status API.
    def get_network_firewall_health_status(network_firewall_id, opts = {})
      logger.debug 'Calling operation NetworkFirewallClient#get_network_firewall_health_status.' if logger

      raise "Missing the required parameter 'network_firewall_id' when calling get_network_firewall_health_status." if network_firewall_id.nil?
      raise "Parameter value for 'network_firewall_id' must not be blank" if OCI::Internal::Util.blank_string?(network_firewall_id)

      path = '/networkFirewalls/{networkFirewallId}/healthStatus'.sub('{networkFirewallId}', network_firewall_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'NetworkFirewallClient#get_network_firewall_health_status') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::NetworkFirewall::Models::NetworkFirewallHealthStatus'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
