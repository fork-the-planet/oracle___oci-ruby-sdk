...
module OCI
  ...
  class NetworkFirewall::Models::UpdateIcmpApplicationDetails < NetworkFirewall::Models::UpdateApplicationDetails
    ...
    # @option attributes [String] :description The value to assign to the {OCI::NetworkFirewall::Models::UpdateApplicationDetails#description #description} proprety
    ...
    def hash
      [type, description, icmp_type, icmp_code].hash
    end
