...
module OCI
  ...
  class NetworkFirewall::Models::Icmp6ApplicationSummary < NetworkFirewall::Models::ApplicationSummary
    ...
    # @option attributes [String] :description The value to assign to the {OCI::NetworkFirewall::Models::ApplicationSummary#description #description} proprety
    ...
    def hash
      [type, name, parent_resource_id, description, icmp_type, icmp_code].hash
    end
