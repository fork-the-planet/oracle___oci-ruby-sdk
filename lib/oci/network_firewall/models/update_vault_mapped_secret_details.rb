...
module OCI
  ...
  class NetworkFirewall::Models::UpdateVaultMappedSecretDetails < NetworkFirewall::Models::UpdateMappedSecretDetails
    ...
    # @option attributes [String] :description The value to assign to the {OCI::NetworkFirewall::Models::UpdateMappedSecretDetails#description #description} proprety
    ...
    def hash
      [source, type, description, vault_secret_id, version_number].hash
    end
