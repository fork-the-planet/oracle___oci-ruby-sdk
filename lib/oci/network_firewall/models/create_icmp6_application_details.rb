...
module OCI
  ...
  class NetworkFirewall::Models::CreateIcmp6ApplicationDetails < NetworkFirewall::Models::CreateApplicationDetails
    ...
    # @option attributes [String] :description The value to assign to the {OCI::NetworkFirewall::Models::CreateApplicationDetails#description #description} proprety
    ...
    def hash
      [name, type, description, icmp_type, icmp_code].hash
    end
