...
module OCI
  ...
  class NetworkFirewall::Models::CreateVaultMappedSecretDetails < NetworkFirewall::Models::CreateMappedSecretDetails
    ...
    # @option attributes [String] :description The value to assign to the {OCI::NetworkFirewall::Models::CreateMappedSecretDetails#description #description} proprety
    ...
    def hash
      [name, source, type, description, vault_secret_id, version_number].hash
    end
