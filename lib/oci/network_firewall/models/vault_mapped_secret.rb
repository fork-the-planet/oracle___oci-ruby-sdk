...
module OCI
  ...
  class NetworkFirewall::Models::VaultMappedSecret < NetworkFirewall::Models::MappedSecret
    ...
    # @option attributes [String] :description The value to assign to the {OCI::NetworkFirewall::Models::MappedSecret#description #description} proprety
    ...
    def hash
      [name, source, type, parent_resource_id, description, vault_secret_id, version_number].hash
    end
