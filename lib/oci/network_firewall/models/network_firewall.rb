...
module OCI
  ...
  class NetworkFirewall::Models::NetworkFirewall
    ...
    def hash
      [id, compartment_id, display_name, subnet_id, ipv4_address, ipv6_address, network_firewall_policy_id, availability_domain, nat_configuration, shape, network_security_group_ids, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags, security_attributes].hash
    end
