...
module OCI
  ...
  class NetworkFirewall::Models::SslInboundInspectionProfile < NetworkFirewall::Models::DecryptionProfile
    ...
    # @option attributes [String] :description The value to assign to the {OCI::NetworkFirewall::Models::DecryptionProfile#description #description} proprety
    ...
    def hash
      [type, name, parent_resource_id, description, is_unsupported_version_blocked, is_unsupported_cipher_blocked, is_out_of_capacity_blocked].hash
    end
