...
module OCI
  ...
  class NetworkFirewall::Models::NetworkFirewallPolicy
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_updated, lifecycle_state, lifecycle_details, attached_network_firewall_count, description, freeform_tags, defined_tags, system_tags].hash
    end
