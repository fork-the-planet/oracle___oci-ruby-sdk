...
module OCI
  ...
  class NetworkFirewall::Models::UpdateSslInboundInspectionProfileDetails < NetworkFirewall::Models::UpdateDecryptionProfileDetails
    ...
    # @option attributes [String] :description The value to assign to the {OCI::NetworkFirewall::Models::UpdateDecryptionProfileDetails#description #description} proprety
    ...
    def hash
      [type, description, is_unsupported_version_blocked, is_unsupported_cipher_blocked, is_out_of_capacity_blocked].hash
    end
