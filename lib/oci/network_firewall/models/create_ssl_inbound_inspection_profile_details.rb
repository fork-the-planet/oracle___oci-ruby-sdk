...
module OCI
  ...
  class NetworkFirewall::Models::CreateSslInboundInspectionProfileDetails < NetworkFirewall::Models::CreateDecryptionProfileDetails
    ...
    # @option attributes [String] :description The value to assign to the {OCI::NetworkFirewall::Models::CreateDecryptionProfileDetails#description #description} proprety
    ...
    def hash
      [type, name, description, is_unsupported_version_blocked, is_unsupported_cipher_blocked, is_out_of_capacity_blocked].hash
    end
