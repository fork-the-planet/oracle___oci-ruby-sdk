...
module OCI
  ...
  class NetworkFirewall::Models::DecryptionRule
    ...
    # @option attributes [Array<String>] :secrets The value to assign to the {#secrets} property
    ...
    def hash
      [name, condition, action, decryption_profile, secret, secrets, position, parent_resource_id, description].hash
    end
