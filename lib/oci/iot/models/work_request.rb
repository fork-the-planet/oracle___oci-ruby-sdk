...
module OCI
  ...
  class Iot::Models::WorkRequest
    ...
    # @return [Array<OCI::Iot::Models::WorkRequestResource>]
    attr_accessor :resources

    # **[Required]** Shows the progress of the operation tracked by the work request as a percentage of the total work to be completed.
    #
    # @return [Float]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Iot::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Iot::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
