...
module OCI
  ...
  #
  class Iot::Models::DigitalTwinAdapterEnvelopeMapping
    ...
    # @option attributes [String] :time_observed The value to assign to the {#time_observed} property
    # @option attributes [String] :target The value to assign to the {#target} property
    # @option attributes [String] :content_root The value to assign to the {#content_root} property
    def initialize(attributes = {})
      ...
      self.content_root = attributes[:'contentRoot'] if attributes[:'contentRoot']

      raise 'You cannot provide both :contentRoot and :content_root' if attributes.key?(:'contentRoot') && attributes.key?(:'content_root')

      self.content_root = attributes[:'content_root'] if attributes[:'content_root']
    end
    ...
    def hash
      [time_observed, target, content_root].hash
    end
