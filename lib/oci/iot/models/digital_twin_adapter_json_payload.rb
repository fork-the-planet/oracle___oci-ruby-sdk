...
require 'date'
require_relative 'digital_twin_adapter_payload'
...
module OCI
  ...
  #
  class Iot::Models::DigitalTwinAdapterJsonPayload < Iot::Models::DigitalTwinAdapterPayload
    ...
    # @option attributes [Hash<String, Object>] :data The value to assign to the {#data} property
