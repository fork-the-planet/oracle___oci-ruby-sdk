...
module OCI
  ...
  class Iot::Models::WorkRequestSummaryCollection
    # **[Required]** A list of work requests.
    # @return [Array<OCI::Iot::Models::WorkRequestSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Iot::Models::WorkRequestSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Iot::Models::WorkRequestSummary>] :items The value to assign to the {#items} property
