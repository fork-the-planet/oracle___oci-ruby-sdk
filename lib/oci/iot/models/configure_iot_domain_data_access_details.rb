...
module OCI
  ...
  class Iot::Models::ConfigureIotDomainDataAccessDetails
    TYPE_ENUM = [
      TYPE_DIRECT = 'DIRECT'.freeze,
      TYPE_ORDS = 'ORDS'.freeze,
      TYPE_APEX = 'APEX'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Iot::Models::ApexDataAccessDetails' if type == 'APEX'
      return 'OCI::Iot::Models::DirectDataAccessDetails' if type == 'DIRECT'
      return 'OCI::Iot::Models::OrdsDataAccessDetails' if type == 'ORDS'
