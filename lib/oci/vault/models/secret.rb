...
module OCI
  ...
  class Vault::Models::Secret
    ...
    # @return [OCI::Vault::Models::ReplicationConfig]
    ...
    # @return [OCI::Vault::Models::SourceRegionInformation]
    attr_accessor :source_region_information
    ...
    def self.swagger_types
      {
        ...
        'is_replica': :'BOOLEAN',
        'source_region_information': :'OCI::Vault::Models::SourceRegionInformation',
    ...
    # @option attributes [OCI::Vault::Models::ReplicationConfig] :replication_config The value to assign to the {#replication_config} property
    # @option attributes [BOOLEAN] :is_replica The value to assign to the {#is_replica} property
    # @option attributes [OCI::Vault::Models::SourceRegionInformation] :source_region_information The value to assign to the {#source_region_information} property
    ...
    def initialize(attributes = {})
      ...
      self.is_replica = attributes[:'isReplica'] unless attributes[:'isReplica'].nil?
      self.is_replica = false if is_replica.nil? && !attributes.key?(:'isReplica') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isReplica and :is_replica' if attributes.key?(:'isReplica') && attributes.key?(:'is_replica')

      self.is_replica = attributes[:'is_replica'] unless attributes[:'is_replica'].nil?
      self.is_replica = false if is_replica.nil? && !attributes.key?(:'isReplica') && !attributes.key?(:'is_replica') # rubocop:disable Style/StringLiterals

      self.source_region_information = attributes[:'sourceRegionInformation'] if attributes[:'sourceRegionInformation']

      raise 'You cannot provide both :sourceRegionInformation and :source_region_information' if attributes.key?(:'sourceRegionInformation') && attributes.key?(:'source_region_information')

      self.source_region_information = attributes[:'source_region_information'] if attributes[:'source_region_information']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        source_region_information == other.source_region_information &&
    ...
    def hash
      [compartment_id, current_version_number, defined_tags, description, freeform_tags, id, key_id, lifecycle_details, lifecycle_state, metadata, replication_config, is_replica, source_region_information, rotation_config, rotation_status, last_rotation_time, next_rotation_time, secret_name, secret_rules, time_created, time_of_current_version_expiry, time_of_deletion, vault_id, secret_generation_context, is_auto_generation_enabled].hash
    end
