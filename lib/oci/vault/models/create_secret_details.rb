...
module OCI
  ...
  class Vault::Models::CreateSecretDetails
    ...
    def hash
      [compartment_id, defined_tags, description, freeform_tags, key_id, metadata, secret_content, replication_config, rotation_config, secret_name, secret_rules, vault_id, secret_generation_context, enable_auto_generation].hash
    end
