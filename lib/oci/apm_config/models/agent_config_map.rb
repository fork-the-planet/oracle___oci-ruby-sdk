...
module OCI
  ...
  # }
  #
  class ApmConfig::Models::AgentConfigMap
    # Map of agent configuration files, where keys are file names.
    # @return [Hash<String, OCI::ApmConfig::Models::AgentConfigFile>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'config_map': :'Hash<String, OCI::ApmConfig::Models::AgentConfigFile>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Hash<String, OCI::ApmConfig::Models::AgentConfigFile>] :config_map The value to assign to the {#config_map} property
