...
module OCI
  ...
  class ApmConfig::Models::CreateConfigDetails
    CONFIG_TYPE_ENUM = [
      ...
      CONFIG_TYPE_AGENT = 'AGENT'.freeze,
      CONFIG_TYPE_MACS_APM_EXTENSION = 'MACS_APM_EXTENSION'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ApmConfig::Models::CreateAgentConfigDetails' if type == 'AGENT'
      return 'OCI::ApmConfig::Models::CreateOptionsDetails' if type == 'OPTIONS'
      return 'OCI::ApmConfig::Models::CreateMacsApmExtensionDetails' if type == 'MACS_APM_EXTENSION'
