...
module OCI
  ...
  class ApmConfig::Models::UpdateMacsApmExtensionDetails < ApmConfig::Models::UpdateConfigDetails
    ...
    def hash
      [config_type, freeform_tags, defined_tags, display_name, process_filter, run_as_user, service_name, agent_version, attach_install_dir].hash
    end
