...
module OCI
  ...
  class Database::Models::CreateCrossRegionDisasterRecoveryDetails < Database::Models::CreateAutonomousDatabaseBase
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the source Autonomous AI Database that will be used to create a new peer database for the DR association.
    # @return [String]
    attr_accessor :source_id

    # **[Required]** Indicates the cross-region disaster recovery (DR) type of the standby Autonomous AI Database Serverless instance.
    ...
    # @option attributes [OCI::Database::Models::AutonomousDatabaseMaintenanceWindowSummary] :autonomous_database_maintenance_window The value to assign to the {OCI::Database::Models::CreateAutonomousDatabaseBase#autonomous_database_maintenance_window #autonomous_database_maintenance_window} proprety
    ...
    # @option attributes [OCI::Database::Models::ImportTransportableTablespaceDetails] :transportable_tablespace The value to assign to the {OCI::Database::Models::CreateAutonomousDatabaseBase#transportable_tablespace #transportable_tablespace} proprety
