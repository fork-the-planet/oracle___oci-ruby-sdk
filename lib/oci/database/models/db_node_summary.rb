...
module OCI
  ...
  class Database::Models::DbNodeSummary
    ...
    AVAILABLE_ACTIONS_ENUM = [
      AVAILABLE_ACTIONS_STOP = 'STOP'.freeze,
      AVAILABLE_ACTIONS_FORCESTOP = 'FORCESTOP'.freeze,
      AVAILABLE_ACTIONS_FORCERESET = 'FORCERESET'.freeze,
      AVAILABLE_ACTIONS_START = 'START'.freeze,
      AVAILABLE_ACTIONS_SOFTRESET = 'SOFTRESET'.freeze,
      AVAILABLE_ACTIONS_RESET = 'RESET'.freeze,
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_os_patch_reboot_required
    ...
    # @option attributes [BOOLEAN] :is_os_patch_reboot_required The value to assign to the {#is_os_patch_reboot_required} property
    def initialize(attributes = {})
      ...
      self.is_os_patch_reboot_required = attributes[:'isOsPatchRebootRequired'] unless attributes[:'isOsPatchRebootRequired'].nil?

      raise 'You cannot provide both :isOsPatchRebootRequired and :is_os_patch_reboot_required' if attributes.key?(:'isOsPatchRebootRequired') && attributes.key?(:'is_os_patch_reboot_required')

      self.is_os_patch_reboot_required = attributes[:'is_os_patch_reboot_required'] unless attributes[:'is_os_patch_reboot_required'].nil?
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_os_patch_reboot_required == other.is_os_patch_reboot_required
    end
    ...
    def hash
      [id, db_system_id, vnic_id, backup_vnic_id, host_ip_id, backup_ip_id, host_ipv6_id, backup_ipv6_id, vnic2_id, backup_vnic2_id, lifecycle_state, available_actions, hostname, fault_domain, time_created, software_storage_size_in_gb, maintenance_type, time_maintenance_window_start, time_maintenance_window_end, additional_details, freeform_tags, defined_tags, system_tags, lifecycle_details, cpu_core_count, memory_size_in_gbs, db_node_storage_size_in_gbs, total_cpu_core_count, db_server_id, compute_model, compute_count, is_os_patch_reboot_required].hash
    end
