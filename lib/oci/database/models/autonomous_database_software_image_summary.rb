...
module OCI
  ...
  class Database::Models::AutonomousDatabaseSoftwareImageSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Autonomous AI Database Software Image.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The database version with which the Autonomous AI Database Software Image is to be built.
    # @return [String]
    attr_accessor :database_version

    # **[Required]** The user-friendly name for the Autonomous AI Database Software Image. The name does not have to be unique.
    # @return [String]
    attr_accessor :display_name

    # **[Required]** The current state of the Autonomous AI Database Software Image.
    # @return [String]
    ...
    # **[Required]** The date and time the Autonomous AI Database Software Image was created.
    # @return [DateTime]
    ...
    def hash
      [id, compartment_id, database_version, display_name, lifecycle_state, lifecycle_details, time_created, release_update, freeform_tags, defined_tags, system_tags, autonomous_dsi_one_off_patches, image_shape_family, dst_file_version].hash
    end
