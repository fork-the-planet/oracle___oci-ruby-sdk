...
module OCI
  ...
  class Database::Models::CreateAutonomousDatabaseSoftwareImageDetails
    ...
    # **[Required]** The source Autonomous Container Database [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) from which to create Autonomous AI Database Software Image.
    # @return [String]
