...
module OCI
  ...
  class Database::Models::BackupDestinationDetailsSummary
    ...
    def hash
      [backup_destination_attach_history, space_utilized_in_gbs, time_at_which_storage_details_are_updated, type, id, vpc_user, vpc_password, is_zero_data_loss_enabled, internet_proxy, dbrs_policy_id, is_retention_lock_enabled, backup_retention_policy_on_terminate, is_remote, remote_region].hash
    end
