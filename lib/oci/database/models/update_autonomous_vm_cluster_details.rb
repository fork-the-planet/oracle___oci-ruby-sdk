...
module OCI
  ...
  class Database::Models::UpdateAutonomousVmClusterDetails
    ...
    def hash
      [maintenance_window_details, license_model, freeform_tags, defined_tags, autonomous_data_storage_size_in_tbs, cpu_core_count_per_node, total_container_databases, time_zone, scan_listener_port_tls, scan_listener_port_non_tls, is_mtls_enabled, distribution_algorithm].hash
    end
