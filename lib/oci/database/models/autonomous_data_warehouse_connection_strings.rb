...
module OCI
  # **Deprecated.** For information about connection strings to connect to an Oracle Autonomous AI Lakehouse, see {#autonomous_database_connection_strings autonomous_database_connection_strings}.
  #
