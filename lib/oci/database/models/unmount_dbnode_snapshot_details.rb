...
module OCI
  ...
  #
  class Database::Models::UnmountDbnodeSnapshotDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata Database Node where snapshot needs to be unmounted.
    # @return [String]
