...
module OCI
  # **Deprecated.** See {#autonomous_database autonomous_database} for reference information about Autonomous AI Databases with the warehouse workload type.
  #
  ...
  class Database::Models::AutonomousDataWarehouseSummary
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Autonomous AI Lakehouse.
    # @return [String]
    attr_accessor :id
