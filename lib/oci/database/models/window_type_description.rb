...
module OCI
  ...
  class Database::Models::WindowTypeDescription
    WINDOW_TYPE_ENUM = [
    ...
    # @option attributes [Array<String>] :messages The value to assign to the {#messages} property
