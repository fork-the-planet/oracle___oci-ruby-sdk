...
module OCI
  ...
  class Database::Models::DbHome
    ...
    def hash
      [id, compartment_id, display_name, last_patch_history_entry_id, lifecycle_state, db_system_id, vm_cluster_id, db_version, db_home_location, lifecycle_details, time_created, kms_key_id, one_off_patches, freeform_tags, defined_tags, system_tags, database_software_image_id, is_unified_auditing_enabled, home_type].hash
    end
