...
module OCI
  ...
  class Database::Models::CreatePluggableDatabaseFromRemoteCloneDetails < Database::Models::CreatePluggableDatabaseCreationTypeDetails
    ...
    # @return [String]
    attr_accessor :source_pluggable_database_snapshot_id
    ...
    def self.swagger_types
      {
        ...
        'source_pluggable_database_snapshot_id': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :source_pluggable_database_snapshot_id The value to assign to the {#source_pluggable_database_snapshot_id} property
    def initialize(attributes = {})
      ...
      self.source_pluggable_database_snapshot_id = attributes[:'sourcePluggableDatabaseSnapshotId'] if attributes[:'sourcePluggableDatabaseSnapshotId']

      raise 'You cannot provide both :sourcePluggableDatabaseSnapshotId and :source_pluggable_database_snapshot_id' if attributes.key?(:'sourcePluggableDatabaseSnapshotId') && attributes.key?(:'source_pluggable_database_snapshot_id')

      self.source_pluggable_database_snapshot_id = attributes[:'source_pluggable_database_snapshot_id'] if attributes[:'source_pluggable_database_snapshot_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        source_pluggable_database_snapshot_id == other.source_pluggable_database_snapshot_id
    end
    ...
    def hash
      [creation_type, dblink_username, dblink_user_password, source_pluggable_database_id, source_container_database_admin_password, refreshable_clone_details, is_thin_clone, source_pluggable_database_snapshot_id].hash
    end
