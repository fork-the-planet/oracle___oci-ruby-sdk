...
module OCI
  ...
  #
  class Database::Models::RunDataPatchDetails
    ACTION_ENUM = [
    ...
    # @return [OCI::Database::Models::DataPatchOptions]
    attr_accessor :data_patch_options
    ...
    def self.swagger_types
      {
        ...
        'data_patch_options': :'OCI::Database::Models::DataPatchOptions',
        'action': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Database::Models::DataPatchOptions] :data_patch_options The value to assign to the {#data_patch_options} property
    ...
    def initialize(attributes = {})
      ...
      self.data_patch_options = attributes[:'dataPatchOptions'] if attributes[:'dataPatchOptions']

      raise 'You cannot provide both :dataPatchOptions and :data_patch_options' if attributes.key?(:'dataPatchOptions') && attributes.key?(:'data_patch_options')

      self.data_patch_options = attributes[:'data_patch_options'] if attributes[:'data_patch_options']

      self.action = attributes[:'action'] if attributes[:'action']
      self.action = "APPLY" if action.nil? && !attributes.key?(:'action') # rubocop:disable Style/StringLiterals
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        data_patch_options == other.data_patch_options &&
        action == other.action
    end
    ...
    def hash
      [pluggable_databases, data_patch_options, action].hash
    end
