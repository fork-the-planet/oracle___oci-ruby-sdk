...
module OCI
  ...
  class Database::Models::ExternalMacsConnectorSummary < Database::Models::ExternalDatabaseConnectorSummary
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#system_tags #system_tags} proprety
    ...
    def hash
      [compartment_id, freeform_tags, defined_tags, system_tags, display_name, id, lifecycle_state, lifecycle_details, time_created, connector_type, external_database_id, connection_status, time_connection_status_last_updated, connection_string, connection_credentials, connector_agent_id].hash
    end
