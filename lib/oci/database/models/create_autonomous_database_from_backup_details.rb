...
module OCI
  ...
  class Database::Models::CreateAutonomousDatabaseFromBackupDetails < Database::Models::CreateAutonomousDatabaseBase
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the source Autonomous AI Database Backup that you will clone to create a new Autonomous AI Database.
    # @return [String]
