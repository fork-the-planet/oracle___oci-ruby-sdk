...
module OCI
  ...
  class Database::Models::ExternalDatabaseConnector
    ...
    def hash
      [compartment_id, freeform_tags, defined_tags, system_tags, display_name, id, lifecycle_state, lifecycle_details, time_created, connector_type, external_database_id, connection_status, time_connection_status_last_updated].hash
    end
