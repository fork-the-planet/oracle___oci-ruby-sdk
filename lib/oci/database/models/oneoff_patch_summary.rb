...
module OCI
  ...
  class Database::Models::OneoffPatchSummary
    ...
    def hash
      [id, compartment_id, display_name, db_version, release_update, one_off_patches, size_in_kbs, lifecycle_state, lifecycle_details, sha256_sum, time_updated, time_created, time_of_expiration, freeform_tags, defined_tags, system_tags].hash
    end
