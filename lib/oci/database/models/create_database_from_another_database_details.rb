...
module OCI
  ...
  class Database::Models::CreateDatabaseFromAnotherDatabaseDetails
    ...
    def hash
      [database_id, backup_tde_password, admin_password, db_unique_name, db_name, time_stamp_for_point_in_time_recovery, pluggable_databases, freeform_tags, defined_tags, sid_prefix, source_encryption_key_location_details, storage_size_details, managed_software_update_details, vm_cluster_id].hash
    end
