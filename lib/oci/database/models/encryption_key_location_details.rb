...
module OCI
  ...
  class Database::Models::EncryptionKeyLocationDetails
    PROVIDER_TYPE_ENUM = [
      ...
      PROVIDER_TYPE_AZURE = 'AZURE'.freeze,
      PROVIDER_TYPE_GCP = 'GCP'.freeze,
      PROVIDER_TYPE_AWS = 'AWS'.freeze,
      PROVIDER_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Use 'EXTERNAL' for creating a new database or migrating a database key to an External HSM.
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Database::Models::GoogleCloudProviderEncryptionKeyDetails' if type == 'GCP'
      return 'OCI::Database::Models::AzureEncryptionKeyDetails' if type == 'AZURE'
      return 'OCI::Database::Models::AwsEncryptionKeyDetails' if type == 'AWS'
