...
module OCI
  ...
  class Database::Models::AutonomousDatabase
    ...
    # @return [String]
    attr_accessor :external_location_zone

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Autonomous AI Database.
    # @return [String]
    attr_accessor :id
    ...
    #
    # @return [Float]
    attr_accessor :memory_per_compute_unit_in_gbs
    ...
    # The Autonomous Container Database [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm). Used only by Autonomous AI Database on Dedicated Exadata Infrastructure.
    # @return [String]
    ...
    #
    # @return [DateTime]
    attr_accessor :time_earliest_available_db_version_upgrade

    # The max date and time the Autonomous AI Database can be scheduled to upgrade to 26ai.
    #
    # @return [DateTime]
    attr_accessor :time_latest_available_db_version_upgrade
    ...
    # @return [OCI::Database::Models::AutonomousDatabaseConnectionUrls]
    attr_accessor :vanity_connection_urls
    ...
    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the source Autonomous AI Database that was cloned to create the current Autonomous AI Database.
    # @return [String]
    ...
    # @option attributes [String] :external_location_zone The value to assign to the {#external_location_zone} property
    ...
    # @option attributes [Float] :memory_per_compute_unit_in_gbs The value to assign to the {#memory_per_compute_unit_in_gbs} property
    ...
    # @option attributes [DateTime] :time_earliest_available_db_version_upgrade The value to assign to the {#time_earliest_available_db_version_upgrade} property
    # @option attributes [DateTime] :time_latest_available_db_version_upgrade The value to assign to the {#time_latest_available_db_version_upgrade} property
    ...
    # @option attributes [OCI::Database::Models::AutonomousDatabaseConnectionUrls] :vanity_connection_urls The value to assign to the {#vanity_connection_urls} property
    ...
    # @option attributes [Array<String>] :access_types The value to assign to the {#access_types} property
    ...
    # @option attributes [Hash<String, String>] :additional_attributes The value to assign to the {#additional_attributes} property
    ...
    def clone_type=(clone_type)
      # rubocop:disable Style/ConditionalAssignment
      if clone_type && !CLONE_TYPE_ENUM.include?(clone_type)
        OCI.logger.debug("Unknown value for 'clone_type' [" + clone_type + "]. Mapping to 'CLONE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @clone_type = CLONE_TYPE_UNKNOWN_ENUM_VALUE
      else
