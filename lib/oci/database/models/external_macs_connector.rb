...
module OCI
  ...
  class Database::Models::ExternalMacsConnector < Database::Models::ExternalDatabaseConnector
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::Database::Models::ExternalDatabaseConnector#system_tags #system_tags} proprety
