...
module OCI
  ...
  class Database::Models::CreateAutonomousDatabaseBase
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment of the Autonomous AI Database.
    # @return [String]
    ...
    # @return [OCI::Database::Models::ImportTransportableTablespaceDetails]
    attr_accessor :transportable_tablespace
    ...
    # @option attributes [OCI::Database::Models::ImportTransportableTablespaceDetails] :transportable_tablespace The value to assign to the {#transportable_tablespace} property
