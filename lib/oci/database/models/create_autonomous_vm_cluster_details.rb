...
module OCI
  ...
  class Database::Models::CreateAutonomousVmClusterDetails
    ...
    def distribution_algorithm=(distribution_algorithm)
      raise "Invalid value for 'distribution_algorithm': this must be one of the values in DISTRIBUTION_ALGORITHM_ENUM." if distribution_algorithm && !DISTRIBUTION_ALGORITHM_ENUM.include?(distribution_algorithm)
