...
module OCI
  ...
  class Database::Models::CreateCrossTenancyDisasterRecoveryDetails < Database::Models::CreateAutonomousDatabaseBase
    ...
    # **[Required]** Indicates the disaster recovery (DR) type of the standby Autonomous AI Database Serverless instance.
