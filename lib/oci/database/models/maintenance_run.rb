...
module OCI
  ...
  class Database::Models::MaintenanceRun
    ...
    # **[Required]** The current state of the maintenance run. For Autonomous AI Database Serverless instances, valid states are IN_PROGRESS, SUCCEEDED, and FAILED.
    #
    # @return [String]
    ...
    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the resource the maintenance run will refer to when trying to fetch target versions.
    ...
    #
    # @return [String]
    attr_accessor :reference_resource_id_for_image_updates
    ...
    #
    # @return [Array<OCI::Database::Models::WindowTypeDescription>]
    attr_accessor :window_type_descriptions
    ...
    def self.swagger_types
      {
        ...
        'reference_resource_id_for_image_updates': :'String',
        'database_software_image_id': :'String',
        'window_type_descriptions': :'Array<OCI::Database::Models::WindowTypeDescription>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :reference_resource_id_for_image_updates The value to assign to the {#reference_resource_id_for_image_updates} property
    # @option attributes [String] :database_software_image_id The value to assign to the {#database_software_image_id} property
    # @option attributes [Array<OCI::Database::Models::WindowTypeDescription>] :window_type_descriptions The value to assign to the {#window_type_descriptions} property
    def initialize(attributes = {})
      ...
      self.reference_resource_id_for_image_updates = attributes[:'referenceResourceIdForImageUpdates'] if attributes[:'referenceResourceIdForImageUpdates']

      raise 'You cannot provide both :referenceResourceIdForImageUpdates and :reference_resource_id_for_image_updates' if attributes.key?(:'referenceResourceIdForImageUpdates') && attributes.key?(:'reference_resource_id_for_image_updates')

      self.reference_resource_id_for_image_updates = attributes[:'reference_resource_id_for_image_updates'] if attributes[:'reference_resource_id_for_image_updates']
      ...
      self.window_type_descriptions = attributes[:'windowTypeDescriptions'] if attributes[:'windowTypeDescriptions']

      raise 'You cannot provide both :windowTypeDescriptions and :window_type_descriptions' if attributes.key?(:'windowTypeDescriptions') && attributes.key?(:'window_type_descriptions')

      self.window_type_descriptions = attributes[:'window_type_descriptions'] if attributes[:'window_type_descriptions']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        reference_resource_id_for_image_updates == other.reference_resource_id_for_image_updates &&
        database_software_image_id == other.database_software_image_id &&
        window_type_descriptions == other.window_type_descriptions
    end
