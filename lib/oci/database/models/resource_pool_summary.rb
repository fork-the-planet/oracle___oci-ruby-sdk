...
module OCI
  ...
  class Database::Models::ResourcePoolSummary
    ...
    # @return [Integer]
    attr_accessor :pool_storage_size_in_tbs
    ...
    # @return [Float]
    attr_accessor :available_storage_capacity_in_tbs

    # Resource Pool total capacity, it's currently 4x of pool size
    # @return [Integer]
    attr_accessor :total_compute_capacity

    # Available capacity left for new elastic pool members provision
    # @return [Integer]
    attr_accessor :available_compute_capacity
    ...
    # @option attributes [Integer] :pool_storage_size_in_tbs The value to assign to the {#pool_storage_size_in_tbs} property
    # @option attributes [Float] :available_storage_capacity_in_tbs The value to assign to the {#available_storage_capacity_in_tbs} property
    # @option attributes [Integer] :total_compute_capacity The value to assign to the {#total_compute_capacity} property
    # @option attributes [Integer] :available_compute_capacity The value to assign to the {#available_compute_capacity} property
