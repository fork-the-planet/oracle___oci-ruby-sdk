...
module OCI
  ...
  class Database::Models::AutonomousVmCluster
    ...
    DISTRIBUTION_ALGORITHM_ENUM = [
      DISTRIBUTION_ALGORITHM_RESOURCE_OPTIMIZED = 'RESOURCE_OPTIMIZED'.freeze,
      DISTRIBUTION_ALGORITHM_DISTRIBUTION_OPTIMIZED = 'DISTRIBUTION_OPTIMIZED'.freeze,
      DISTRIBUTION_ALGORITHM_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @return [String]
    attr_reader :distribution_algorithm

    # Percentage of ECPU memory allocated for SGA(System Global Area).
    # @return [Float]
    attr_accessor :sga_percentage
    ...
    # @option attributes [String] :distribution_algorithm The value to assign to the {#distribution_algorithm} property
    # @option attributes [Float] :sga_percentage The value to assign to the {#sga_percentage} property
    ...
    def initialize(attributes = {})
      ...
      self.distribution_algorithm = attributes[:'distributionAlgorithm'] if attributes[:'distributionAlgorithm']

      raise 'You cannot provide both :distributionAlgorithm and :distribution_algorithm' if attributes.key?(:'distributionAlgorithm') && attributes.key?(:'distribution_algorithm')

      self.distribution_algorithm = attributes[:'distribution_algorithm'] if attributes[:'distribution_algorithm']

      self.sga_percentage = attributes[:'sgaPercentage'] if attributes[:'sgaPercentage']

      raise 'You cannot provide both :sgaPercentage and :sga_percentage' if attributes.key?(:'sgaPercentage') && attributes.key?(:'sga_percentage')

      self.sga_percentage = attributes[:'sga_percentage'] if attributes[:'sga_percentage']
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] distribution_algorithm Object to be assigned
    def distribution_algorithm=(distribution_algorithm)
      # rubocop:disable Style/ConditionalAssignment
      if distribution_algorithm && !DISTRIBUTION_ALGORITHM_ENUM.include?(distribution_algorithm)
        OCI.logger.debug("Unknown value for 'distribution_algorithm' [" + distribution_algorithm + "]. Mapping to 'DISTRIBUTION_ALGORITHM_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @distribution_algorithm = DISTRIBUTION_ALGORITHM_UNKNOWN_ENUM_VALUE
      else
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        distribution_algorithm == other.distribution_algorithm &&
        sga_percentage == other.sga_percentage &&
