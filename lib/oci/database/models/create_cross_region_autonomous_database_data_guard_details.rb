...
module OCI
  ...
  class Database::Models::CreateCrossRegionAutonomousDatabaseDataGuardDetails < Database::Models::CreateAutonomousDatabaseBase
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the source Autonomous AI Database that will be used to create a new peer database for the Data Guard association.
    # @return [String]
