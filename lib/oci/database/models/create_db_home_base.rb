...
module OCI
  ...
  class Database::Models::CreateDbHomeBase
    SOURCE_ENUM = [
      ...
      SOURCE_VM_CLUSTER_DATABASE = 'VM_CLUSTER_DATABASE'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Database::Models::CreateDbHomeWithVmClusterIdFromDatabaseDetails' if type == 'VM_CLUSTER_DATABASE'
