...
module OCI
  ...
  class Database::Models::DefinedFileSystemConfiguration
    ...
    # @option attributes [Integer] :max_size_gb The value to assign to the {#max_size_gb} property
    ...
    def initialize(attributes = {})
      ...
      self.max_size_gb = attributes[:'maxSizeGb'] if attributes[:'maxSizeGb']

      raise 'You cannot provide both :maxSizeGb and :max_size_gb' if attributes.key?(:'maxSizeGb') && attributes.key?(:'max_size_gb')

      self.max_size_gb = attributes[:'max_size_gb'] if attributes[:'max_size_gb']
    ...
    def hash
      [mount_point, min_size_gb, max_size_gb, is_resizable, is_backup_partition].hash
    end
