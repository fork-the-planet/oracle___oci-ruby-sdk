...
module OCI
  ...
  class Database::Models::DbSystemOsPatchDetailsSummary
    # **[Required]** The OCID of the DB node targeted for this patch action.
    # @return [String]
    attr_accessor :db_node_id

    # **[Required]** Indicates whether a reboot is required after applying the patch.
    # @return [BOOLEAN]
    attr_accessor :is_reboot_required

    # **[Required]** List of OS package identifiers (e.g., RPM strings).
    # @return [Array<String>]
    attr_accessor :rpms
    ...
    # @option attributes [Array<String>] :rpms The value to assign to the {#rpms} property
    def initialize(attributes = {})
      ...
      self.rpms = attributes[:'rpms'] if attributes[:'rpms']
    end
    ...
    def hash
      [db_node_id, is_reboot_required, rpms].hash
    end
