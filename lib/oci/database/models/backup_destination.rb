...
module OCI
  ...
  class Database::Models::BackupDestination
    ...
    # @return [Array<OCI::Database::Models::AssociatedLongTermBackup>]
    attr_accessor :associated_long_term_backups

    # Indicates the number of long term backups of Autonomous AI Databases associated with this backup destination.
    # @return [Integer]
    attr_accessor :associated_long_term_backup_count
    ...
    def self.swagger_types
      {
        ...
        'associated_long_term_backups': :'Array<OCI::Database::Models::AssociatedLongTermBackup>',
        'associated_long_term_backup_count': :'Integer',
    ...
    # @option attributes [Array<OCI::Database::Models::AssociatedLongTermBackup>] :associated_long_term_backups The value to assign to the {#associated_long_term_backups} property
    # @option attributes [Integer] :associated_long_term_backup_count The value to assign to the {#associated_long_term_backup_count} property
    ...
    def initialize(attributes = {})
      ...
      self.associated_long_term_backups = attributes[:'associatedLongTermBackups'] if attributes[:'associatedLongTermBackups']

      raise 'You cannot provide both :associatedLongTermBackups and :associated_long_term_backups' if attributes.key?(:'associatedLongTermBackups') && attributes.key?(:'associated_long_term_backups')

      self.associated_long_term_backups = attributes[:'associated_long_term_backups'] if attributes[:'associated_long_term_backups']

      self.associated_long_term_backup_count = attributes[:'associatedLongTermBackupCount'] if attributes[:'associatedLongTermBackupCount']

      raise 'You cannot provide both :associatedLongTermBackupCount and :associated_long_term_backup_count' if attributes.key?(:'associatedLongTermBackupCount') && attributes.key?(:'associated_long_term_backup_count')

      self.associated_long_term_backup_count = attributes[:'associated_long_term_backup_count'] if attributes[:'associated_long_term_backup_count']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        associated_long_term_backups == other.associated_long_term_backups &&
        associated_long_term_backup_count == other.associated_long_term_backup_count &&
    ...
    def hash
      [id, display_name, compartment_id, type, associated_databases, associated_long_term_backups, associated_long_term_backup_count, connection_string, vpc_users, local_mount_point_path, nfs_mount_type, nfs_server, nfs_server_export, lifecycle_state, time_created, lifecycle_details, freeform_tags, defined_tags, system_tags, total_storage_size_in_gbs, utilized_storage_size_in_gbs, time_at_which_storage_details_are_updated].hash
    end
