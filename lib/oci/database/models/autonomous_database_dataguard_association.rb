...
module OCI
  ...
  class Database::Models::AutonomousDatabaseDataguardAssociation
    ...
    PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_ENUM = [
      ...
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_TRANSPORTING = 'TRANSPORTING'.freeze,
    ...
    # **[Required]** The OCID of the Autonomous Dataguard created for Autonomous Container Database where given Autonomous AI Database resides in.
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Autonomous AI Database that has a relationship with the peer Autonomous AI Database.
    #
    # @return [String]
