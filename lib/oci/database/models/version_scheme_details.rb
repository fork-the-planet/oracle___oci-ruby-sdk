...
module OCI
  ...
  class Database::Models::VersionSchemeDetails
    SOURCE_ENUM = [
      SOURCE_VERSION_SERIES = 'VERSION_SERIES'.freeze,
      SOURCE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The update should be applied on the database for the selected version scheme.
    #
    # @return [String]
    attr_reader :source
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Database::Models::VersionSchemeFromVersionSeriesDetails' if type == 'VERSION_SERIES'
