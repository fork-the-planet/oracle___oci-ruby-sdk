...
module OCI
  ...
  class Database::Models::VmClusterNetwork
    ...
    def hash
      [id, exadata_infrastructure_id, compartment_id, vm_cluster_id, display_name, scans, dns, ntp, vm_networks, dr_scans, lifecycle_state, time_created, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
