...
module OCI
  # The Autonomous AI Database [Vault](https://docs.cloud.oracle.com/Content/KeyManagement/Concepts/keyoverview.htm#concepts) service key management history entry.
  #
  class Database::Models::AutonomousDatabaseKeyHistoryEntry
    # **[Required]** The id of the Autonomous AI Database [Vault](https://docs.cloud.oracle.com/Content/KeyManagement/Concepts/keyoverview.htm#concepts) service key management history entry.
    # @return [String]
    attr_accessor :id
