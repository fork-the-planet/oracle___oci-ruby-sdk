...
module OCI
  ...
  #
  class Database::Models::MountPointDetails
    # **[Required]** Mount Point Name
    # @return [String]
    attr_accessor :name

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata Database Node where snapshot was mounted.
    # @return [String]
