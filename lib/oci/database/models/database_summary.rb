...
module OCI
  ...
  class Database::Models::DatabaseSummary
    ...
    HOME_TYPE_ENUM = [
      HOME_TYPE_ORACLE_MANAGED = 'ORACLE_MANAGED'.freeze,
      HOME_TYPE_CUSTOMER_MANAGED = 'CUSTOMER_MANAGED'.freeze,
      HOME_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @return [OCI::Database::Models::DatabaseStorageSizeResponseDetails]
    attr_accessor :storage_size_details

    # @return [OCI::Database::Models::ManagedSoftwareUpdateDetails]
    ...
    # @option attributes [OCI::Database::Models::DatabaseStorageSizeResponseDetails] :storage_size_details The value to assign to the {#storage_size_details} property
    # @option attributes [OCI::Database::Models::ManagedSoftwareUpdateDetails] :managed_software_update_details The value to assign to the {#managed_software_update_details} property
    # @option attributes [String] :home_type The value to assign to the {#home_type} property
    # @option attributes [String] :patch_version The value to assign to the {#patch_version} property
    def initialize(attributes = {})
      ...
      self.home_type = attributes[:'homeType'] if attributes[:'homeType']

      raise 'You cannot provide both :homeType and :home_type' if attributes.key?(:'homeType') && attributes.key?(:'home_type')

      self.home_type = attributes[:'home_type'] if attributes[:'home_type']

      self.patch_version = attributes[:'patchVersion'] if attributes[:'patchVersion']

      raise 'You cannot provide both :patchVersion and :patch_version' if attributes.key?(:'patchVersion') && attributes.key?(:'patch_version')

      self.patch_version = attributes[:'patch_version'] if attributes[:'patch_version']
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] home_type Object to be assigned
    def home_type=(home_type)
      # rubocop:disable Style/ConditionalAssignment
      if home_type && !HOME_TYPE_ENUM.include?(home_type)
        OCI.logger.debug("Unknown value for 'home_type' [" + home_type + "]. Mapping to 'HOME_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @home_type = HOME_TYPE_UNKNOWN_ENUM_VALUE
      else
        @home_type = home_type
      end
      # rubocop:enable Style/ConditionalAssignment
