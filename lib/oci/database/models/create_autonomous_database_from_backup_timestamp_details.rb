...
module OCI
  ...
  class Database::Models::CreateAutonomousDatabaseFromBackupTimestampDetails < Database::Models::CreateAutonomousDatabaseBase
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the source Autonomous AI Database that you will clone to create a new Autonomous AI Database.
    # @return [String]
    ...
    # **[Required]** The Autonomous AI Database clone type.
    # @return [String]
