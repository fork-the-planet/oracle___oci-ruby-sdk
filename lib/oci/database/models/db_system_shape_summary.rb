...
module OCI
  ...
  class Database::Models::DbSystemShapeSummary
    SHAPE_TYPE_ENUM = [
      ...
      SHAPE_TYPE_STANDARD_X86 = 'STANDARD_X86'.freeze,
    ...
    #
    # @return [Array<String>]
    attr_accessor :shape_attributes
    ...
    # @option attributes [Array<String>] :shape_attributes The value to assign to the {#shape_attributes} property
    def initialize(attributes = {})
      ...
      self.shape_attributes = attributes[:'shapeAttributes'] if attributes[:'shapeAttributes']

      raise 'You cannot provide both :shapeAttributes and :shape_attributes' if attributes.key?(:'shapeAttributes') && attributes.key?(:'shape_attributes')

      self.shape_attributes = attributes[:'shape_attributes'] if attributes[:'shape_attributes']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        shape_attributes == other.shape_attributes
    end
