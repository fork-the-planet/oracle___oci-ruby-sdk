...
module OCI
  ...
  class Database::Models::UpdateDatabaseDetails
    ...
    # @return [OCI::Database::Models::PatchOptions]
    attr_accessor :patch_options
    ...
    def self.swagger_types
      {
        ...
        'patch_options': :'OCI::Database::Models::PatchOptions'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Database::Models::PatchOptions] :patch_options The value to assign to the {#patch_options} property
    def initialize(attributes = {})
      ...
      self.patch_options = attributes[:'patchOptions'] if attributes[:'patchOptions']

      raise 'You cannot provide both :patchOptions and :patch_options' if attributes.key?(:'patchOptions') && attributes.key?(:'patch_options')

      self.patch_options = attributes[:'patch_options'] if attributes[:'patch_options']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        patch_options == other.patch_options
    end
    ...
    def hash
      [db_backup_config, db_home_id, new_admin_password, old_tde_wallet_password, new_tde_wallet_password, storage_size_details, freeform_tags, defined_tags, managed_software_update_details, patch_options].hash
    end
