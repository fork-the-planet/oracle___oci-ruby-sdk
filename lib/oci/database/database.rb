...
require 'oci/database/models/add_dbnode_snapshots_for_exadb_vm_cluster_details'
...
require 'oci/database/models/advanced_cluster_file_system'
require 'oci/database/models/advanced_cluster_file_system_collection'
require 'oci/database/models/advanced_cluster_file_system_summary'
...
require 'oci/database/models/associated_long_term_backup'
require 'oci/database/models/associated_resource_details'
require 'oci/database/models/automated_mount_details'
require 'oci/database/models/autonomous_container_database'
require 'oci/database/models/autonomous_container_database_backup'
require 'oci/database/models/autonomous_container_database_backup_collection'
require 'oci/database/models/autonomous_container_database_backup_config'
require 'oci/database/models/autonomous_container_database_backup_summary'
...
require 'oci/database/models/autonomous_database_in_backup'
require 'oci/database/models/autonomous_database_key_history_entry'
require 'oci/database/models/autonomous_database_maintenance_window_summary'
...
require 'oci/database/models/aws_encryption_key_details'
require 'oci/database/models/aws_key_details'
require 'oci/database/models/azure_encryption_key_details'
...
require 'oci/database/models/change_cloud_autonomous_vm_cluster_subscription_details'
require 'oci/database/models/change_cloud_db_system_subscription_details'
...
require 'oci/database/models/change_db_connection_bundle_compartment_details'
...
require 'oci/database/models/configure_exascale_cloud_exadata_infrastructure_details'
...
require 'oci/database/models/convert_standby_database_type_details'
...
require 'oci/database/models/create_advanced_cluster_file_system_details'
require 'oci/database/models/create_application_vip_details'
require 'oci/database/models/create_autonomous_container_database_base'
...
require 'oci/database/models/create_autonomous_container_database_from_backup_details'
...
require 'oci/database/models/create_database_for_standby_db_system_details'
...
require 'oci/database/models/create_database_from_database'
...
require 'oci/database/models/create_db_connection_bundle_details'
require 'oci/database/models/create_db_home_base'
require 'oci/database/models/create_db_home_details'
require 'oci/database/models/create_db_home_for_standby_db_system'
...
require 'oci/database/models/create_db_home_with_vm_cluster_id_from_database_details'
...
require 'oci/database/models/create_pluggable_database_snapshot_details'
...
require 'oci/database/models/data_patch_options'
...
require 'oci/database/models/database_storage_size_details'
require 'oci/database/models/database_storage_size_response_details'
...
require 'oci/database/models/db_connection_bundle'
require 'oci/database/models/db_connection_bundle_summary'
...
require 'oci/database/models/db_system_os_patch_details_collection'
require 'oci/database/models/db_system_os_patch_details_summary'
require 'oci/database/models/db_system_os_patch_history_entry'
require 'oci/database/models/db_system_os_patch_history_entry_collection'
require 'oci/database/models/db_system_os_patch_history_entry_summary'
...
require 'oci/database/models/dbnode_snapshot'
require 'oci/database/models/dbnode_snapshot_summary'
require 'oci/database/models/dbnode_snapshots'
...
require 'oci/database/models/download_db_connection_bundle_details'
...
require 'oci/database/models/estimate_cost_saving_summary'
require 'oci/database/models/estimate_cost_savings_summary_collection'
...
require 'oci/database/models/execute_db_system_os_patch_details'
...
require 'oci/database/models/gcp_key_details'
...
require 'oci/database/models/google_cloud_provider_encryption_key_details'
require 'oci/database/models/granular_maintenance_history_details'
require 'oci/database/models/identity_connector_details'
require 'oci/database/models/import_transportable_tablespace_details'
...
require 'oci/database/models/launch_standby_db_system_details'
...
require 'oci/database/models/maintenance_version_preference_details'
require 'oci/database/models/maintenance_window'
require 'oci/database/models/managed_software_update_day_of_week'
require 'oci/database/models/managed_software_update_details'
require 'oci/database/models/managed_software_update_input_details'
require 'oci/database/models/managed_software_update_maintenance_details'
require 'oci/database/models/managed_software_update_preference_details'
...
require 'oci/database/models/mount_dbnode_snapshot_details'
require 'oci/database/models/mount_point_details'
...
require 'oci/database/models/patch_options'
...
require 'oci/database/models/pluggable_database_snapshot'
require 'oci/database/models/pluggable_database_snapshot_summary'
...
require 'oci/database/models/register_cloud_autonomous_vm_cluster_pkcs_details'
require 'oci/database/models/register_cloud_vm_cluster_pkcs_details'
...
require 'oci/database/models/resource_pool_member_collection'
require 'oci/database/models/resource_pool_member_summary'
...
require 'oci/database/models/restart_autonomous_container_database_details'
require 'oci/database/models/restart_autonomous_database_details'
...
require 'oci/database/models/run_data_patch_details'
...
require 'oci/database/models/source_database_details'
require 'oci/database/models/stack_monitoring_config'
require 'oci/database/models/stop_autonomous_database_details'
...
require 'oci/database/models/unmount_dbnode_snapshot_details'
require 'oci/database/models/unregister_cloud_autonomous_vm_cluster_pkcs_details'
require 'oci/database/models/unregister_cloud_vm_cluster_pkcs_details'
require 'oci/database/models/update'
require 'oci/database/models/update_advanced_cluster_file_system_details'
...
require 'oci/database/models/update_db_connection_bundle_details'
...
require 'oci/database/models/vanity_url_details'
require 'oci/database/models/version_scheme_details'
require 'oci/database/models/version_scheme_from_version_series_details'
...
require 'oci/database/models/volume_details'
require 'oci/database/models/window_preference_detail'
require 'oci/database/models/window_type_description'
