...
module OCI
  ...
  class DataSafe::Models::MaskingAnalyticsSummary
    ...
    # @return [DateTime]
    attr_accessor :time_last_masked
    ...
    # @option attributes [DateTime] :time_last_masked The value to assign to the {#time_last_masked} property
    def initialize(attributes = {})
      ...
      self.time_last_masked = attributes[:'timeLastMasked'] if attributes[:'timeLastMasked']

      raise 'You cannot provide both :timeLastMasked and :time_last_masked' if attributes.key?(:'timeLastMasked') && attributes.key?(:'time_last_masked')

      self.time_last_masked = attributes[:'time_last_masked'] if attributes[:'time_last_masked']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        count == other.count &&
        time_last_masked == other.time_last_masked
    end
    ...
    def hash
      [metric_name, dimensions, count, time_last_masked].hash
    end
