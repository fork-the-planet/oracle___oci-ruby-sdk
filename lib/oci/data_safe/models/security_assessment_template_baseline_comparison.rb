...
module OCI
  ...
  #
  class DataSafe::Models::SecurityAssessmentTemplateBaselineComparison
    ...
    # @return [Array<OCI::DataSafe::Models::TemplateBaselineDiffs>]
    ...
    # @option attributes [String] :template_baseline_id The value to assign to the {#template_baseline_id} property
    # @option attributes [String] :template_baseline_name The value to assign to the {#template_baseline_name} property
    # @option attributes [String] :lifecycle_state The value to assign to the {#lifecycle_state} property
    # @option attributes [DateTime] :time_created The value to assign to the {#time_created} property
    # @option attributes [Array<OCI::DataSafe::Models::TemplateBaselineDiffs>] :auditing The value to assign to the {#auditing} property
    # @option attributes [Array<OCI::DataSafe::Models::TemplateBaselineDiffs>] :authorization_control The value to assign to the {#authorization_control} property
    # @option attributes [Array<OCI::DataSafe::Models::TemplateBaselineDiffs>] :data_encryption The value to assign to the {#data_encryption} property
    # @option attributes [Array<OCI::DataSafe::Models::TemplateBaselineDiffs>] :db_configuration The value to assign to the {#db_configuration} property
    # @option attributes [Array<OCI::DataSafe::Models::TemplateBaselineDiffs>] :fine_grained_access_control The value to assign to the {#fine_grained_access_control} property
    # @option attributes [Array<OCI::DataSafe::Models::TemplateBaselineDiffs>] :privileges_and_roles The value to assign to the {#privileges_and_roles} property
    # @option attributes [Array<OCI::DataSafe::Models::TemplateBaselineDiffs>] :user_accounts The value to assign to the {#user_accounts} property
