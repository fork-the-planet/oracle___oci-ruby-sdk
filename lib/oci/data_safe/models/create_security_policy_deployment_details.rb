...
module OCI
  ...
  class DataSafe::Models::CreateSecurityPolicyDeploymentDetails
    ...
    # **[Required]** Indicates whether the security policy deployment is for a target database or a target database group.
    # @return [String]
    ...
    def hash
      [display_name, description, compartment_id, target_id, target_type, security_policy_id, freeform_tags, defined_tags].hash
    end
