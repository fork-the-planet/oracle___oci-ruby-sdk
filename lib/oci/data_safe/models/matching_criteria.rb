...
module OCI
  ...
  #
  class DataSafe::Models::MatchingCriteria
    # This attribute is required.
    # @return [OCI::DataSafe::Models::Include]
    attr_accessor :include

    # @return [OCI::DataSafe::Models::Exclude]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'include': :'OCI::DataSafe::Models::Include',
        'exclude': :'OCI::DataSafe::Models::Exclude'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataSafe::Models::Include] :include The value to assign to the {#include} property
    # @option attributes [OCI::DataSafe::Models::Exclude] :exclude The value to assign to the {#exclude} property
