...
module OCI
  ...
  class DataSafe::Models::TargetAlertPolicyAssociation
    ...
    # **[Required]** The resource type that is represented by the target alert policy association.
    # @return [String]
    ...
    def hash
      [id, display_name, description, policy_id, target_id, is_enabled, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, target_type, freeform_tags, defined_tags, system_tags].hash
    end
