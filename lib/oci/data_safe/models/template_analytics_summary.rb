...
module OCI
  ...
  class DataSafe::Models::TemplateAnalyticsSummary
    METRIC_NAME_ENUM = [
      METRIC_NAME_TEMPLATE_STATS = 'TEMPLATE_STATS'.freeze,
    ...
    # @return [OCI::DataSafe::Models::TemplateAnalyticsDimensions]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'metric_name': :'String',
        'dimensions': :'OCI::DataSafe::Models::TemplateAnalyticsDimensions',
        'count': :'Integer'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataSafe::Models::TemplateAnalyticsDimensions] :dimensions The value to assign to the {#dimensions} property
