...
module OCI
  ...
  class DataSafe::Models::AuditEventAggregationDimensions
    ...
    def self.swagger_types
      {
        ...
        'object_owner': :'Array<String>',
        'audit_policies': :'Array<String>',
        'object_name': :'Array<String>',
        'os_user_name': :'Array<String>',
        'error_code': :'Array<String>',
        'client_ip': :'Array<String>',
        'external_user_id': :'Array<String>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<String>] :object_owner The value to assign to the {#object_owner} property
    # @option attributes [Array<String>] :audit_policies The value to assign to the {#audit_policies} property
    # @option attributes [Array<String>] :object_name The value to assign to the {#object_name} property
    # @option attributes [Array<String>] :os_user_name The value to assign to the {#os_user_name} property
    # @option attributes [Array<String>] :error_code The value to assign to the {#error_code} property
    # @option attributes [Array<String>] :client_ip The value to assign to the {#client_ip} property
    # @option attributes [Array<String>] :external_user_id The value to assign to the {#external_user_id} property
    def initialize(attributes = {})
      ...
      self.external_user_id = attributes[:'externalUserId'] if attributes[:'externalUserId']

      raise 'You cannot provide both :externalUserId and :external_user_id' if attributes.key?(:'externalUserId') && attributes.key?(:'external_user_id')

      self.external_user_id = attributes[:'external_user_id'] if attributes[:'external_user_id']
    end
    ...
    def hash
      [audit_event_time, db_user_name, target_id, target_name, target_class, object_type, client_hostname, client_program, client_id, audit_type, event_name, object_owner, audit_policies, object_name, os_user_name, error_code, client_ip, external_user_id].hash
    end
