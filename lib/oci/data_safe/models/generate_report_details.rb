...
module OCI
  ...
  class DataSafe::Models::GenerateReportDetails
    ...
    # @return [Array<String>]
    attr_accessor :target_group_ids
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_pagination_enabled
    ...
    # @option attributes [Array<String>] :target_group_ids The value to assign to the {#target_group_ids} property
    ...
    # @option attributes [BOOLEAN] :is_pagination_enabled The value to assign to the {#is_pagination_enabled} property
    def initialize(attributes = {})
      ...
      self.target_group_ids = attributes[:'targetGroupIds'] if attributes[:'targetGroupIds']

      raise 'You cannot provide both :targetGroupIds and :target_group_ids' if attributes.key?(:'targetGroupIds') && attributes.key?(:'target_group_ids')

      self.target_group_ids = attributes[:'target_group_ids'] if attributes[:'target_group_ids']
      ...
      self.is_pagination_enabled = attributes[:'isPaginationEnabled'] unless attributes[:'isPaginationEnabled'].nil?
      self.is_pagination_enabled = false if is_pagination_enabled.nil? && !attributes.key?(:'isPaginationEnabled') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isPaginationEnabled and :is_pagination_enabled' if attributes.key?(:'isPaginationEnabled') && attributes.key?(:'is_pagination_enabled')

      self.is_pagination_enabled = attributes[:'is_pagination_enabled'] unless attributes[:'is_pagination_enabled'].nil?
      self.is_pagination_enabled = false if is_pagination_enabled.nil? && !attributes.key?(:'isPaginationEnabled') && !attributes.key?(:'is_pagination_enabled') # rubocop:disable Style/StringLiterals
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        target_group_ids == other.target_group_ids &&
        ...
        is_pagination_enabled == other.is_pagination_enabled
    end
    ...
    def hash
      [display_name, target_ids, target_group_ids, description, compartment_id, mime_type, time_less_than, time_greater_than, row_limit, is_pagination_enabled].hash
    end
