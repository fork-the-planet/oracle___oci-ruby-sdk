...
module OCI
  ...
  class DataSafe::Models::ReportDefinition
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_schedule_pagination_enabled
    ...
    # @option attributes [BOOLEAN] :is_schedule_pagination_enabled The value to assign to the {#is_schedule_pagination_enabled} property
