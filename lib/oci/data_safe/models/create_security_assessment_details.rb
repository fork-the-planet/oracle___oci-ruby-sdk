...
module OCI
  ...
  class DataSafe::Models::CreateSecurityAssessmentDetails
    ...
    #
    # @return [String]
    attr_accessor :base_security_assessment_id
    ...
    # @option attributes [String] :base_security_assessment_id The value to assign to the {#base_security_assessment_id} property
    ...
    def initialize(attributes = {})
      ...
      self.target_type = "TARGET_DATABASE" if target_type.nil? && !attributes.key?(:'targetType') # rubocop:disable Style/StringLiterals
      ...
      self.target_type = "TARGET_DATABASE" if target_type.nil? && !attributes.key?(:'targetType') && !attributes.key?(:'target_type') # rubocop:disable Style/StringLiterals
      ...
      self.base_security_assessment_id = attributes[:'baseSecurityAssessmentId'] if attributes[:'baseSecurityAssessmentId']

      raise 'You cannot provide both :baseSecurityAssessmentId and :base_security_assessment_id' if attributes.key?(:'baseSecurityAssessmentId') && attributes.key?(:'base_security_assessment_id')

      self.base_security_assessment_id = attributes[:'base_security_assessment_id'] if attributes[:'base_security_assessment_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        base_security_assessment_id == other.base_security_assessment_id &&
    ...
    def hash
      [compartment_id, display_name, description, target_id, target_type, type, template_assessment_id, base_security_assessment_id, is_assessment_scheduled, schedule, freeform_tags, defined_tags].hash
    end
