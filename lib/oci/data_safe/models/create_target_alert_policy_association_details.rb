...
module OCI
  ...
  class DataSafe::Models::CreateTargetAlertPolicyAssociationDetails
    ...
    # **[Required]** The OCID of the target or target database group.
    # @return [String]
    ...
    def hash
      [policy_id, target_id, display_name, description, compartment_id, is_enabled, target_type, freeform_tags, defined_tags].hash
    end
