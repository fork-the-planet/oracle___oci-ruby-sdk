...
module OCI
  ...
  class DataSafe::Models::SecurityPolicyEntryStateSummary
    ...
    # @return [String]
    attr_accessor :deployment_status_details
    ...
    # @option attributes [String] :deployment_status_details The value to assign to the {#deployment_status_details} property
    ...
    def hash
      [id, security_policy_entry_id, security_policy_deployment_id, target_id, entry_type, deployment_status, deployment_status_details].hash
    end
