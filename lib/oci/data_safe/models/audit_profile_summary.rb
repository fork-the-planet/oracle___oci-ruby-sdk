...
module OCI
  ...
  class DataSafe::Models::AuditProfileSummary
    ...
    # **[Required]** The OCID of the target database for which the audit profile is created.
    # @return [String]
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_updated, target_id, lifecycle_state, description, lifecycle_details, is_paid_usage_enabled, online_months, offline_months, audit_collected_volume, is_override_global_retention_setting, is_override_global_paid_usage, target_type, freeform_tags, defined_tags].hash
    end
