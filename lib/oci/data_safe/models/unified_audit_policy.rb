...
module OCI
  ...
  #
  class DataSafe::Models::UnifiedAuditPolicy
    ...
    # **[Required]** The OCID of the unified audit policy.
    # @return [String]
    attr_accessor :id

    # **[Required]** The OCID of the compartment containing the unified audit policy.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The display name of the unified audit policy.
    # @return [String]
    ...
    # @return [String]
    attr_accessor :unified_audit_policy_definition_id

    # **[Required]** The current state of the unified audit policy.
    # @return [String]
    ...
    # @return [Array<OCI::DataSafe::Models::PolicyCondition>]
    attr_accessor :conditions

    # **[Required]** The time the the unified audit policy was created, in the format defined by RFC3339.
    # @return [DateTime]
    ...
    def self.swagger_types
      {
        ...
        'conditions': :'Array<OCI::DataSafe::Models::PolicyCondition>',
    ...
    # @option attributes [String] :unified_audit_policy_definition_id The value to assign to the {#unified_audit_policy_definition_id} property
    ...
    # @option attributes [Array<OCI::DataSafe::Models::PolicyCondition>] :conditions The value to assign to the {#conditions} property
    ...
    def initialize(attributes = {})
      ...
      self.unified_audit_policy_definition_id = attributes[:'unifiedAuditPolicyDefinitionId'] if attributes[:'unifiedAuditPolicyDefinitionId']

      raise 'You cannot provide both :unifiedAuditPolicyDefinitionId and :unified_audit_policy_definition_id' if attributes.key?(:'unifiedAuditPolicyDefinitionId') && attributes.key?(:'unified_audit_policy_definition_id')

      self.unified_audit_policy_definition_id = attributes[:'unified_audit_policy_definition_id'] if attributes[:'unified_audit_policy_definition_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        unified_audit_policy_definition_id == other.unified_audit_policy_definition_id &&
    ...
    def hash
      [id, compartment_id, display_name, description, security_policy_id, unified_audit_policy_definition_id, lifecycle_state, lifecycle_details, is_seeded, status, enabled_entities, conditions, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
