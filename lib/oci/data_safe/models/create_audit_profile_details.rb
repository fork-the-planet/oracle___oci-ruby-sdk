...
module OCI
  ...
  class DataSafe::Models::CreateAuditProfileDetails
    ...
    def hash
      [display_name, compartment_id, target_id, description, target_type, is_paid_usage_enabled, online_months, offline_months, is_override_global_paid_usage, freeform_tags, defined_tags].hash
    end
