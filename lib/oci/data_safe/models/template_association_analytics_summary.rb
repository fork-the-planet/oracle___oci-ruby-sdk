...
module OCI
  ...
  class DataSafe::Models::TemplateAssociationAnalyticsSummary
    METRIC_NAME_ENUM = [
      METRIC_NAME_TEMPLATE_ASSOCIATION_STATS = 'TEMPLATE_ASSOCIATION_STATS'.freeze,
    ...
    # @return [OCI::DataSafe::Models::TemplateAssociationAnalyticsDimensions]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'metric_name': :'String',
        'dimensions': :'OCI::DataSafe::Models::TemplateAssociationAnalyticsDimensions',
        'count': :'Integer'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataSafe::Models::TemplateAssociationAnalyticsDimensions] :dimensions The value to assign to the {#dimensions} property
