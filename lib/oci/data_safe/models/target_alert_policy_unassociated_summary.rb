...
module OCI
  ...
  class DataSafe::Models::TargetAlertPolicyUnassociatedSummary
    # **[Required]** The OCID of the target database that differs from the alert policy association of the target database group.
    # @return [String]
    ...
    # @return [String]
    attr_accessor :not_applied_reason
    ...
    # @option attributes [String] :not_applied_reason The value to assign to the {#not_applied_reason} property
    ...
    def initialize(attributes = {})
      ...
      self.not_applied_reason = attributes[:'notAppliedReason'] if attributes[:'notAppliedReason']

      raise 'You cannot provide both :notAppliedReason and :not_applied_reason' if attributes.key?(:'notAppliedReason') && attributes.key?(:'not_applied_reason')

      self.not_applied_reason = attributes[:'not_applied_reason'] if attributes[:'not_applied_reason']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        not_applied_reason == other.not_applied_reason &&
    ...
    def hash
      [target_database_id, is_enabled, not_applied_reason, freeform_tags, defined_tags, system_tags].hash
    end
