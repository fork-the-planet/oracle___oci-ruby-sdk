...
module OCI
  ...
  class DataSafe::Models::CreateUserAssessmentDetails
    ...
    # **[Required]** The OCID of the target database or target database group on which user assessment is to be run.
    # @return [String]
    ...
    def hash
      [compartment_id, description, display_name, is_assessment_scheduled, schedule, target_id, target_type, freeform_tags, defined_tags].hash
    end
