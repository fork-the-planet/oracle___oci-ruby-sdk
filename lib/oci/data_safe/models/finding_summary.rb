...
module OCI
  ...
  class DataSafe::Models::FindingSummary
    ...
    # @option attributes [String] :doclink The value to assign to the {#doclink} property
    ...
    def initialize(attributes = {})
      ...
      self.doclink = attributes[:'doclink'] if attributes[:'doclink']
    ...
    def hash
      [severity, assessment_id, target_id, key, is_top_finding, title, category, remarks, details, summary, oneline, doclink, references, oracle_defined_severity, is_risk_modified, has_target_db_risk_level_changed, justification, time_valid_until, time_updated, lifecycle_state, lifecycle_details].hash
    end
