...
module OCI
  ...
  class DataSafe::Models::SecurityPolicyDeployment
    ...
    LIFECYCLE_STATE_ENUM = [
      ...
      LIFECYCLE_STATE_PENDING_DEPLOYMENT = 'PENDING_DEPLOYMENT'.freeze,
    ...
    # **[Required]** The OCID of the target/target group where the security policy is deployed.
    # @return [String]
    ...
    # @option attributes [DateTime] :time_deployed The value to assign to the {#time_deployed} property
    ...
    def initialize(attributes = {})
      ...
      self.time_deployed = attributes[:'timeDeployed'] if attributes[:'timeDeployed']

      raise 'You cannot provide both :timeDeployed and :time_deployed' if attributes.key?(:'timeDeployed') && attributes.key?(:'time_deployed')

      self.time_deployed = attributes[:'time_deployed'] if attributes[:'time_deployed']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        time_deployed == other.time_deployed &&
    ...
    def hash
      [id, compartment_id, display_name, description, target_id, target_type, time_deployed, security_policy_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
