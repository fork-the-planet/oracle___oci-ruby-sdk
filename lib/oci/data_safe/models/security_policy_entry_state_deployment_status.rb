...
module OCI
  module DataSafe::Models
    SECURITY_POLICY_ENTRY_STATE_DEPLOYMENT_STATUS_ENUM = [
      ...
      SECURITY_POLICY_ENTRY_STATE_DEPLOYMENT_STATUS_CONNECTIVITY_ISSUE = 'CONNECTIVITY_ISSUE'.freeze,
      SECURITY_POLICY_ENTRY_STATE_DEPLOYMENT_STATUS_UNSUPPORTED_SYNTAX = 'UNSUPPORTED_SYNTAX'.freeze,
      SECURITY_POLICY_ENTRY_STATE_DEPLOYMENT_STATUS_UNKNOWN_ERROR = 'UNKNOWN_ERROR'.freeze,
