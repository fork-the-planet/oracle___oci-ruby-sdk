...
module OCI
  ...
  class DataSafe::Models::DiscoveryJobResult
    ...
    #
    # @return [Array<Object>]
    attr_accessor :confidence_level_details
    ...
    # @option attributes [Array<Object>] :confidence_level_details The value to assign to the {#confidence_level_details} property
