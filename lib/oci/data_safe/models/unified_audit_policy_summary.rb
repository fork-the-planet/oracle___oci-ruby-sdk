...
module OCI
  ...
  #
  class DataSafe::Models::UnifiedAuditPolicySummary
    ...
    # @return [String]
    attr_accessor :enabled_entities
    ...
    def hash
      [id, compartment_id, display_name, description, security_policy_id, unified_audit_policy_definition_id, lifecycle_state, lifecycle_details, is_seeded, status, enabled_entities, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
