...
module OCI
  ...
  class DataSafe::Models::SensitiveColumnSummary
    ...
    def hash
      [key, sensitive_data_model_id, lifecycle_state, lifecycle_details, time_created, time_updated, app_name, schema_name, object_name, column_name, object_type, data_type, status, sensitive_type_id, source, parent_column_keys, relation_type, estimated_data_value_count, confidence_level, sample_data_values].hash
    end
