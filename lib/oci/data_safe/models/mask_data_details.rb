...
module OCI
  ...
  class DataSafe::Models::MaskDataDetails
    ...
    # @return [String]
    attr_accessor :user_defined_function_seed
    ...
    attr_accessor :target_credentials
    ...
    # @option attributes [String] :user_defined_function_seed The value to assign to the {#user_defined_function_seed} property
    ...
    # @option attributes [OCI::DataSafe::Models::Credentials] :target_credentials The value to assign to the {#target_credentials} property
    def initialize(attributes = {})
      ...
      self.user_defined_function_seed = attributes[:'userDefinedFunctionSeed'] if attributes[:'userDefinedFunctionSeed']

      raise 'You cannot provide both :userDefinedFunctionSeed and :user_defined_function_seed' if attributes.key?(:'userDefinedFunctionSeed') && attributes.key?(:'user_defined_function_seed')

      self.user_defined_function_seed = attributes[:'user_defined_function_seed'] if attributes[:'user_defined_function_seed']
      ...
      self.target_credentials = attributes[:'targetCredentials'] if attributes[:'targetCredentials']

      raise 'You cannot provide both :targetCredentials and :target_credentials' if attributes.key?(:'targetCredentials') && attributes.key?(:'target_credentials')

      self.target_credentials = attributes[:'target_credentials'] if attributes[:'target_credentials']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        seed == other.seed &&
        user_defined_function_seed == other.user_defined_function_seed &&
        ...
        target_credentials == other.target_credentials
    end
    ...
    def hash
      [target_id, is_decrypt, is_rerun, re_run_from_step, tablespace, is_ignore_errors_enabled, seed, user_defined_function_seed, is_move_interim_tables_enabled, is_execute_saved_script_enabled, is_drop_temp_tables_enabled, is_redo_logging_enabled, is_refresh_stats_enabled, parallel_degree, recompile, target_credentials].hash
    end
