...
module OCI
  ...
  class DataSafe::Models::TargetDatabaseSummary
    ...
    def hash
      [compartment_id, id, display_name, description, infrastructure_type, database_type, associated_resource_ids, lifecycle_state, lifecycle_details, time_created, freeform_tags, defined_tags, system_tags].hash
    end
