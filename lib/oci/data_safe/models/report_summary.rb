...
module OCI
  ...
  class DataSafe::Models::ReportSummary
    ...
    def hash
      [display_name, id, report_definition_id, description, mime_type, time_generated, time_created, time_updated, compartment_id, lifecycle_state, type, data_source, freeform_tags, defined_tags].hash
    end
