...
module OCI
  ...
  class DataSafe::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_PATCH_CHECKS = 'PATCH_CHECKS'.freeze,
      OPERATION_TYPE_UPDATE_FINDING_SEVERITY = 'UPDATE_FINDING_SEVERITY'.freeze,
      OPERATION_TYPE_APPLY_TEMPLATE = 'APPLY_TEMPLATE'.freeze,
      ...
      OPERATION_TYPE_CREATE_SECURITY_POLICY = 'CREATE_SECURITY_POLICY'.freeze,
      OPERATION_TYPE_DELETE_SECURITY_POLICY = 'DELETE_SECURITY_POLICY'.freeze,
      ...
      OPERATION_TYPE_GENERATE_PAGINATED_REPORT = 'GENERATE_PAGINATED_REPORT'.freeze,
      ...
      OPERATION_TYPE_CREATE_TARGET_DATABASE_GROUP = 'CREATE_TARGET_DATABASE_GROUP'.freeze,
      OPERATION_TYPE_UPDATE_TARGET_DATABASE_GROUP = 'UPDATE_TARGET_DATABASE_GROUP'.freeze,
      OPERATION_TYPE_DELETE_TARGET_DATABASE_GROUP = 'DELETE_TARGET_DATABASE_GROUP'.freeze,
      OPERATION_TYPE_CHANGE_TARGET_DATABASE_GROUP_COMPARTMENT = 'CHANGE_TARGET_DATABASE_GROUP_COMPARTMENT'.freeze,
      OPERATION_TYPE_CREATE_SECURITY_POLICY_CONFIG = 'CREATE_SECURITY_POLICY_CONFIG'.freeze,
      OPERATION_TYPE_UPDATE_SECURITY_POLICY_CONFIG = 'UPDATE_SECURITY_POLICY_CONFIG'.freeze,
      OPERATION_TYPE_DELETE_SECURITY_POLICY_CONFIG = 'DELETE_SECURITY_POLICY_CONFIG'.freeze,
      OPERATION_TYPE_CHANGE_SECURITY_POLICY_CONFIG_COMPARTMENT = 'CHANGE_SECURITY_POLICY_CONFIG_COMPARTMENT'.freeze,
      OPERATION_TYPE_CREATE_UNIFIED_AUDIT_POLICY = 'CREATE_UNIFIED_AUDIT_POLICY'.freeze,
      OPERATION_TYPE_UPDATE_UNIFIED_AUDIT_POLICY = 'UPDATE_UNIFIED_AUDIT_POLICY'.freeze,
      OPERATION_TYPE_DELETE_UNIFIED_AUDIT_POLICY = 'DELETE_UNIFIED_AUDIT_POLICY'.freeze,
      OPERATION_TYPE_CHANGE_UNIFIED_AUDIT_POLICY_COMPARTMENT = 'CHANGE_UNIFIED_AUDIT_POLICY_COMPARTMENT'.freeze,
      OPERATION_TYPE_UPDATE_UNIFIED_AUDIT_POLICY_DEFINITION = 'UPDATE_UNIFIED_AUDIT_POLICY_DEFINITION'.freeze,
      OPERATION_TYPE_DELETE_UNIFIED_AUDIT_POLICY_DEFINITION = 'DELETE_UNIFIED_AUDIT_POLICY_DEFINITION'.freeze,
      OPERATION_TYPE_CHANGE_UNIFIED_AUDIT_POLICY_DEFINITION_COMPARTMENT = 'CHANGE_UNIFIED_AUDIT_POLICY_DEFINITION_COMPARTMENT'.freeze,
      OPERATION_TYPE_FLEET_GENERATE_SECURITY_ASSESSMENT_REPORT = 'FLEET_GENERATE_SECURITY_ASSESSMENT_REPORT'.freeze,
      OPERATION_TYPE_FLEET_GENERATE_USER_ASSESSMENT_REPORT = 'FLEET_GENERATE_USER_ASSESSMENT_REPORT'.freeze,
      OPERATION_TYPE_REFRESH_TARGET_DATABASE_GROUP_WITH_CHANGES = 'REFRESH_TARGET_DATABASE_GROUP_WITH_CHANGES'.freeze,
      OPERATION_TYPE_FETCH_AUDIT_POLICY_DETAILS = 'FETCH_AUDIT_POLICY_DETAILS'.freeze,
      OPERATION_TYPE_BULK_CREATE_UNIFIED_AUDIT_POLICY = 'BULK_CREATE_UNIFIED_AUDIT_POLICY'.freeze,
      OPERATION_TYPE_SECURITY_POLICY_DEPLOYMENT_ACTIONS = 'SECURITY_POLICY_DEPLOYMENT_ACTIONS'.freeze,
      OPERATION_TYPE_PROVISION_SECURITY_POLICY_DEPLOYMENT = 'PROVISION_SECURITY_POLICY_DEPLOYMENT'.freeze,
      ...
      OPERATION_TYPE_DELETE_MASKING_REPORT = 'DELETE_MASKING_REPORT'.freeze,
      ...
      OPERATION_TYPE_CREATE_SENSITIVE_TYPE_GROUP = 'CREATE_SENSITIVE_TYPE_GROUP'.freeze,
      OPERATION_TYPE_UPDATE_SENSITIVE_TYPE_GROUP = 'UPDATE_SENSITIVE_TYPE_GROUP'.freeze,
      OPERATION_TYPE_DELETE_SENSITIVE_TYPE_GROUP = 'DELETE_SENSITIVE_TYPE_GROUP'.freeze,
      OPERATION_TYPE_DELETE_SENSITIVE_TYPE = 'DELETE_SENSITIVE_TYPE'.freeze,
      OPERATION_TYPE_PATCH_GROUPED_SENSITIVE_TYPES = 'PATCH_GROUPED_SENSITIVE_TYPES'.freeze,
      OPERATION_TYPE_CREATE_RELATION = 'CREATE_RELATION'.freeze,
      OPERATION_TYPE_DELETE_RELATION = 'DELETE_RELATION'.freeze,
      ...
      OPERATION_TYPE_UPDATE_TARGET_GROUP_AUDIT_PROFILE = 'UPDATE_TARGET_GROUP_AUDIT_PROFILE'.freeze,
      OPERATION_TYPE_CREATE_ATTRIBUTE_SET = 'CREATE_ATTRIBUTE_SET'.freeze,
      OPERATION_TYPE_UPDATE_ATTRIBUTE_SET = 'UPDATE_ATTRIBUTE_SET'.freeze,
      OPERATION_TYPE_DELETE_ATTRIBUTE_SET = 'DELETE_ATTRIBUTE_SET'.freeze,
      OPERATION_TYPE_CHANGE_ATTRIBUTE_SET_COMPARTMENT = 'CHANGE_ATTRIBUTE_SET_COMPARTMENT'.freeze,
