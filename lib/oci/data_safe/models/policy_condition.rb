...
module OCI
  ...
  class DataSafe::Models::PolicyCondition
    ...
    ENTITY_TYPE_ENUM = [
      ...
      ENTITY_TYPE_ATTRIBUTE_SET = 'ATTRIBUTE_SET'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataSafe::Models::AttributeSetCondition' if type == 'ATTRIBUTE_SET'
      return 'OCI::DataSafe::Models::UserCondition' if type == 'USER'
      return 'OCI::DataSafe::Models::RoleCondition' if type == 'ROLE'
      return 'OCI::DataSafe::Models::AllUserCondition' if type == 'ALL_USERS'
