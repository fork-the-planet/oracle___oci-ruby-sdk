...
module OCI
  ...
  class DataSafe::Models::AuditProfile
    ...
    TARGET_TYPE_ENUM = [
      TARGET_TYPE_TARGET_DATABASE = 'TARGET_DATABASE'.freeze,
      TARGET_TYPE_TARGET_DATABASE_GROUP = 'TARGET_DATABASE_GROUP'.freeze,
    ...
    # **[Required]** Indicates whether audit retention settings like online and offline months set at the
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_override_global_paid_usage
    ...
    # @option attributes [BOOLEAN] :is_override_global_paid_usage The value to assign to the {#is_override_global_paid_usage} property
    ...
    def initialize(attributes = {})
      ...
      self.is_override_global_paid_usage = attributes[:'isOverrideGlobalPaidUsage'] unless attributes[:'isOverrideGlobalPaidUsage'].nil?

      raise 'You cannot provide both :isOverrideGlobalPaidUsage and :is_override_global_paid_usage' if attributes.key?(:'isOverrideGlobalPaidUsage') && attributes.key?(:'is_override_global_paid_usage')

      self.is_override_global_paid_usage = attributes[:'is_override_global_paid_usage'] unless attributes[:'is_override_global_paid_usage'].nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_override_global_paid_usage == other.is_override_global_paid_usage &&
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_updated, lifecycle_state, lifecycle_details, target_id, description, audit_trails, is_paid_usage_enabled, online_months, offline_months, audit_collected_volume, is_override_global_retention_setting, is_override_global_paid_usage, online_months_source, offline_months_source, paid_usage_source, target_type, freeform_tags, defined_tags, system_tags].hash
    end
