...
module OCI
  ...
  class DataSafe::Models::Report
    ...
    # @return [String]
    attr_accessor :previous_report_id

    # The OCID of the next report generated.
    # @return [String]
    attr_accessor :next_report_id
    ...
    # @option attributes [String] :previous_report_id The value to assign to the {#previous_report_id} property
    # @option attributes [String] :next_report_id The value to assign to the {#next_report_id} property
    ...
    def initialize(attributes = {})
      ...
      self.previous_report_id = attributes[:'previousReportId'] if attributes[:'previousReportId']

      raise 'You cannot provide both :previousReportId and :previous_report_id' if attributes.key?(:'previousReportId') && attributes.key?(:'previous_report_id')

      self.previous_report_id = attributes[:'previous_report_id'] if attributes[:'previous_report_id']

      self.next_report_id = attributes[:'nextReportId'] if attributes[:'nextReportId']

      raise 'You cannot provide both :nextReportId and :next_report_id' if attributes.key?(:'nextReportId') && attributes.key?(:'next_report_id')

      self.next_report_id = attributes[:'next_report_id'] if attributes[:'next_report_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        previous_report_id == other.previous_report_id &&
        next_report_id == other.next_report_id &&
    ...
    def hash
      [id, display_name, report_definition_id, description, compartment_id, mime_type, time_generated, time_created, time_updated, lifecycle_state, type, data_source, lifecycle_details, previous_report_id, next_report_id, freeform_tags, defined_tags, system_tags].hash
    end
