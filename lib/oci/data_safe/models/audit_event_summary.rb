...
module OCI
  ...
  class DataSafe::Models::AuditEventSummary
    ...
    # @option attributes [String] :external_user_id The value to assign to the {#external_user_id} property
