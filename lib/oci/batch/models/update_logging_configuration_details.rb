...
module OCI
  ...
  class Batch::Models::UpdateLoggingConfigurationDetails
    TYPE_ENUM = [
      TYPE_OCI_LOGGING = 'OCI_LOGGING'.freeze
    ].freeze

    # **[Required]** Type of the logging configuration. Discriminator for sub-entities.
    # @return [String]
    attr_reader :type
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Batch::Models::UpdateOciLoggingConfiguration' if type == 'OCI_LOGGING'
