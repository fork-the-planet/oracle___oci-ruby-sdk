...
module OCI
  ...
  class Batch::Models::CreateGpuShapeTaskProfileExtendedInformationDetails < Batch::Models::CreateBatchTaskProfileExtendedInformationDetails
    # **[Required]** A name of the GPU shape.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'GPU_SHAPE_TASK_PROFILE_EXTENDED_INFORMATION'
