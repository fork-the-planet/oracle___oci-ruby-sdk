...
require 'date'
require_relative 'fleet_shape_execution_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details about the GPU shape which was used for the task execution.
  class Batch::Models::GpuFleetShapeExecutionDetails < Batch::Models::FleetShapeExecutionDetails
    # Name of the shape.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'GPU_FLEET_SHAPE_EXECUTION_DETAILS'
    ...
    def hash
      [type, shape_name, ocpus, memory_in_gbs, disk_size_in_gbs, gpus].hash
    end
