...
module OCI
  ...
  class Batch::Models::BatchTaskEnvironmentSummary
    ...
    def hash
      [id, compartment_id, display_name, description, image_url, security_context, working_directory, lifecycle_state, time_created, time_updated, defined_tags, freeform_tags, system_tags].hash
    end
