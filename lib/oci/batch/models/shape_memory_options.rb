...
module OCI
  ...
  class Batch::Models::ShapeMemoryOptions
    ...
    # **[Required]** For a flexible shape, the maximum amount of memory per OCPU available for this shape (GB).
    # @return [Float]
    ...
    def hash
      [default_per_ocpu_in_gbs, max_in_gbs, max_per_ocpu_in_gbs, min_in_gbs, min_per_ocpu_in_gbs].hash
    end
