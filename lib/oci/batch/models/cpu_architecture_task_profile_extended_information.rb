...
require 'date'
require 'logger'
require_relative 'batch_task_profile_extended_information'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Extended information about CPU architecture for the task profile.
  class Batch::Models::CpuArchitectureTaskProfileExtendedInformation < Batch::Models::BatchTaskProfileExtendedInformation
    ARCHITECTURE_ENUM = [
