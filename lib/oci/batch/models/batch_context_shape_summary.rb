...
module OCI
  ...
  class Batch::Models::BatchContextShapeSummary
    # **[Required]** The name identifying the shape.
    # @return [String]
    attr_accessor :name

    # @return [OCI::Batch::Models::ShapeMemoryOptions]
    attr_accessor :memory_options

    # @return [OCI::Batch::Models::ShapeNetworkingBandwidthOptions]
    attr_accessor :networking_bandwidth_options

    # @return [OCI::Batch::Models::ShapeOcpuOptions]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'name': :'String',
        'memory_options': :'OCI::Batch::Models::ShapeMemoryOptions',
        'networking_bandwidth_options': :'OCI::Batch::Models::ShapeNetworkingBandwidthOptions',
        'ocpu_options': :'OCI::Batch::Models::ShapeOcpuOptions',
    ...
    # @option attributes [OCI::Batch::Models::ShapeMemoryOptions] :memory_options The value to assign to the {#memory_options} property
    # @option attributes [OCI::Batch::Models::ShapeNetworkingBandwidthOptions] :networking_bandwidth_options The value to assign to the {#networking_bandwidth_options} property
    # @option attributes [OCI::Batch::Models::ShapeOcpuOptions] :ocpu_options The value to assign to the {#ocpu_options} property
    ...
    def hash
      [name, memory_options, networking_bandwidth_options, ocpu_options, processor_description].hash
    end
