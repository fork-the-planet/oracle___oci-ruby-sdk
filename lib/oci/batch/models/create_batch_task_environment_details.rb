...
module OCI
  ...
  #
  class Batch::Models::CreateBatchTaskEnvironmentDetails
    ...
    def hash
      [compartment_id, display_name, description, image_url, security_context, working_directory, volumes, defined_tags, freeform_tags].hash
    end
