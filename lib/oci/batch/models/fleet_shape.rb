...
module OCI
  ...
  class Batch::Models::FleetShape
    # **[Required]** The name of the shape.
    # @return [String]
    attr_accessor :shape_name

    # **[Required]** Number of OCPUs required for the shape.
    # @return [Integer]
    attr_accessor :ocpus

    # **[Required]** Amount of memory in GBs required for the shape.
    # @return [Integer]
    ...
    def hash
      [shape_name, ocpus, memory_in_gbs, disk_size_in_gbs].hash
    end
