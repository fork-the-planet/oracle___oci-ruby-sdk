...
module OCI
  ...
  class Batch::Models::CreateGpuFleetShapeDetails
    TYPE_ENUM = [
      TYPE_FIXED_GPU_FLEET_SHAPE = 'FIXED_GPU_FLEET_SHAPE'.freeze
    ].freeze

    # **[Required]** Type of the GPU fleet shape. Also serves as a discriminator for sub-entities.
    # @return [String]
    attr_reader :type
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Batch::Models::CreateFixedGpuFleetShapeDetails' if type == 'FIXED_GPU_FLEET_SHAPE'
