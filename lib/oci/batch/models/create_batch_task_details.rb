...
module OCI
  ...
  class Batch::Models::CreateBatchTaskDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Batch::Models::CreateComputeTaskDetails' if type == 'COMPUTE'
      return 'OCI::Batch::Models::CreateGroupTaskDetails' if type == 'GROUP'
    ...
    def hash
      [name, description, type, entitlement_claims, dependencies, environment_variables].hash
    end
