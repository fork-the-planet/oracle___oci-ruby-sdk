...
module OCI
  ...
  class Batch::Models::CpuFleetShapeExecutionDetails < Batch::Models::FleetShapeExecutionDetails
    # Name of the shape.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'CPU_FLEET_SHAPE_EXECUTION_DETAILS'
    ...
    def hash
      [type, shape_name, ocpus, memory_in_gbs, disk_size_in_gbs].hash
    end
