...
module OCI
  ...
  class Batch::Models::CreateCpuShapeTaskProfileExtendedInformationDetails < Batch::Models::CreateBatchTaskProfileExtendedInformationDetails
    # **[Required]** A name of the CPU shape.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'CPU_SHAPE_TASK_PROFILE_EXTENDED_INFORMATION'
