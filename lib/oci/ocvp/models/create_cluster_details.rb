...
module OCI
  ...
  class Ocvp::Models::CreateClusterDetails
    ...
    # @return [OCI::Ocvp::Models::ClusterByolAllocationDetails]
    attr_accessor :cluster_byol_allocation_details
    ...
    #
    # @return [String]
    attr_accessor :initial_vcf_byol_allocation_id
    ...
    def self.swagger_types
      {
        ...
        'initial_vcf_byol_allocation_id': :'String',
    ...
    # @option attributes [OCI::Ocvp::Models::ClusterByolAllocationDetails] :cluster_byol_allocation_details The value to assign to the {#cluster_byol_allocation_details} property
    # @option attributes [String] :initial_vcf_byol_allocation_id The value to assign to the {#initial_vcf_byol_allocation_id} property
    ...
    def initialize(attributes = {})
      ...
      self.cluster_byol_allocation_details = attributes[:'clusterByolAllocationDetails'] if attributes[:'clusterByolAllocationDetails']

      raise 'You cannot provide both :clusterByolAllocationDetails and :cluster_byol_allocation_details' if attributes.key?(:'clusterByolAllocationDetails') && attributes.key?(:'cluster_byol_allocation_details')

      self.cluster_byol_allocation_details = attributes[:'cluster_byol_allocation_details'] if attributes[:'cluster_byol_allocation_details']

      self.initial_vcf_byol_allocation_id = attributes[:'initialVcfByolAllocationId'] if attributes[:'initialVcfByolAllocationId']

      raise 'You cannot provide both :initialVcfByolAllocationId and :initial_vcf_byol_allocation_id' if attributes.key?(:'initialVcfByolAllocationId') && attributes.key?(:'initial_vcf_byol_allocation_id')

      self.initial_vcf_byol_allocation_id = attributes[:'initial_vcf_byol_allocation_id'] if attributes[:'initial_vcf_byol_allocation_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        cluster_byol_allocation_details == other.cluster_byol_allocation_details &&
        initial_vcf_byol_allocation_id == other.initial_vcf_byol_allocation_id &&
    ...
    def hash
      [sddc_id, compute_availability_domain, display_name, instance_display_name_prefix, esxi_hosts_count, network_configuration, initial_commitment, workload_network_cidr, initial_host_shape_name, initial_host_ocpu_count, is_shielded_instance_enabled, capacity_reservation_id, datastores, datastore_cluster_ids, vmware_software_version, esxi_software_version, cluster_byol_allocation_details, initial_vcf_byol_allocation_id, freeform_tags, defined_tags].hash
    end
