...
module OCI
  ...
  #
  class Ocvp::Models::DatastoreAttachment
    # **[Required]** An IQN of the Block Storage Volume.
    # @return [String]
    attr_accessor :volume_iqn

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Block Volume that belongs to the datastore.
    # @return [String]
    attr_accessor :block_volume_id

    # **[Required]** The [OCIDs](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Datastore that ESXi host is attached to.
    #
    # @return [String]
    ...
    # @option attributes [String] :volume_iqn The value to assign to the {#volume_iqn} property
    # @option attributes [String] :block_volume_id The value to assign to the {#block_volume_id} property
    # @option attributes [String] :datastore_id The value to assign to the {#datastore_id} property
