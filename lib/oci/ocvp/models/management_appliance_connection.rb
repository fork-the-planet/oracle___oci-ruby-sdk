...
module OCI
  ...
  class Ocvp::Models::ManagementApplianceConnection
    TYPE_ENUM = [
      TYPE_VCENTER = 'VCENTER'.freeze,
      TYPE_ADMIN_VCENTER = 'ADMIN_VCENTER'.freeze,
      TYPE_NSX = 'NSX'.freeze,
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of secret in OCI vault, that is used for storage of username and password in JSON format.
    #
    # @return [String]
    ...
    def hash
      [type, credentials_secret_id].hash
    end
