...
module OCI
  ...
  class Ocvp::Models::SupportedHostShapeSummary
    SUPPORTED_OPERATIONS_ENUM = [
      ...
      SUPPORTED_OPERATIONS_CREATE_MANAGEMENT_APPLIANCE = 'CREATE_MANAGEMENT_APPLIANCE'.freeze,
      SUPPORTED_OPERATIONS_UPDATE_MANAGEMENT_APPLIANCE = 'UPDATE_MANAGEMENT_APPLIANCE'.freeze,
      SUPPORTED_OPERATIONS_DELETE_MANAGEMENT_APPLIANCE = 'DELETE_MANAGEMENT_APPLIANCE'.freeze,
      SUPPORTED_OPERATIONS_ABANDON_MANAGEMENT_APPLIANCE_JOBS = 'ABANDON_MANAGEMENT_APPLIANCE_JOBS'.freeze,
      SUPPORTED_OPERATIONS_BATCH_DELETE_MANAGEMENT_APPLIANCE_JOBS = 'BATCH_DELETE_MANAGEMENT_APPLIANCE_JOBS'.freeze,
      SUPPORTED_OPERATIONS_MANAGEMENT_APPLIANCE_ESXI_HOST_PROVISIONING = 'MANAGEMENT_APPLIANCE_ESXI_HOST_PROVISIONING'.freeze,
      SUPPORTED_OPERATIONS_MANAGEMENT_APPLIANCE_ESXI_HOST_DELETION = 'MANAGEMENT_APPLIANCE_ESXI_HOST_DELETION'.freeze,
      SUPPORTED_OPERATIONS_MANAGEMENT_APPLIANCE_DATASTORE_PROVISIONING = 'MANAGEMENT_APPLIANCE_DATASTORE_PROVISIONING'.freeze,
      SUPPORTED_OPERATIONS_MANAGEMENT_APPLIANCE_DATASTORE_DELETE = 'MANAGEMENT_APPLIANCE_DATASTORE_DELETE'.freeze,
      SUPPORTED_OPERATIONS_CREATE_BYOL = 'CREATE_BYOL'.freeze,
      SUPPORTED_OPERATIONS_UPDATE_BYOL = 'UPDATE_BYOL'.freeze,
      SUPPORTED_OPERATIONS_DELETE_BYOL = 'DELETE_BYOL'.freeze,
      SUPPORTED_OPERATIONS_CREATE_BYOL_ALLOCATION = 'CREATE_BYOL_ALLOCATION'.freeze,
      SUPPORTED_OPERATIONS_UPDATE_BYOL_ALLOCATION = 'UPDATE_BYOL_ALLOCATION'.freeze,
      SUPPORTED_OPERATIONS_DELETE_BYOL_ALLOCATION = 'DELETE_BYOL_ALLOCATION'.freeze,
