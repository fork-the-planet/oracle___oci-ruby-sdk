...
module OCI
  ...
  class Ocvp::Models::ManagementApplianceConnectionStatus
    TYPE_ENUM = [
      TYPE_VCENTER = 'VCENTER'.freeze,
      TYPE_ADMIN_VCENTER = 'ADMIN_VCENTER'.freeze,
      TYPE_UI_PLUGIN_REGISTRATION = 'UI_PLUGIN_REGISTRATION'.freeze,
      TYPE_NSX = 'NSX'.freeze,
      TYPE_EXPORT_METRICS = 'EXPORT_METRICS'.freeze,
