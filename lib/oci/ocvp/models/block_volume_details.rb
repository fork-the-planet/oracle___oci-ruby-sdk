...
module OCI
  ...
  #
  class Ocvp::Models::BlockVolumeDetails
    # **[Required]** An [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)s of the Block Storage Volume.
    # @return [String]
    attr_accessor :id
    ...
    # @return [Array<OCI::Ocvp::Models::BlockVolumeAttachment>]
    ...
    def self.swagger_types
      {
        ...
        'id': :'String',
        'iqn': :'String',
        'attachments': :'Array<OCI::Ocvp::Models::BlockVolumeAttachment>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Ocvp::Models::BlockVolumeAttachment>] :attachments The value to assign to the {#attachments} property
