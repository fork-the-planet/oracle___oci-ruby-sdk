...
module OCI
  ...
  class Ocvp::Models::CreateSddcDetails
    ...
    def hash
      [display_name, vmware_software_version, esxi_software_version, compartment_id, hcx_mode, initial_configuration, is_single_host_sddc, ssh_authorized_keys, sddc_byol_allocation_details, freeform_tags, defined_tags].hash
    end
