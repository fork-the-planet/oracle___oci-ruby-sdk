...
module OCI
  ...
  class Ocvp::Models::ManagementApplianceSummary
    ...
    # **[Required]** [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of SDDC in OCI, that this appliance is going to be registered in.
    #
    # @return [String]
