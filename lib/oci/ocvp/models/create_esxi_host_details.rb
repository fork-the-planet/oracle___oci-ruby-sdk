...
module OCI
  ...
  class Ocvp::Models::CreateEsxiHostDetails
    ...
    def initialize(attributes = {})
      ...
      self.is_vsan_byol_enabled = false if is_vsan_byol_enabled.nil? && !attributes.key?(:'isVsanByolEnabled') # rubocop:disable Style/StringLiterals
      ...
      self.is_vsan_byol_enabled = false if is_vsan_byol_enabled.nil? && !attributes.key?(:'isVsanByolEnabled') && !attributes.key?(:'is_vsan_byol_enabled') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [cluster_id, display_name, billing_donor_host_id, current_commitment, next_commitment, compute_availability_domain, host_shape_name, host_ocpu_count, capacity_reservation_id, esxi_software_version, vcf_byol_allocation_id, is_vsan_byol_enabled, freeform_tags, defined_tags].hash
    end
