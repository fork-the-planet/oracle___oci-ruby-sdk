...
module OCI
  ...
  class Ocvp::Models::AddBlockVolumeToDatastoreDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Block Volume to be added to the Datastore.
    # @return [String]
