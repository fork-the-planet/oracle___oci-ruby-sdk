...
module OCI
  ...
  class Ocvp::Models::InitialClusterConfiguration
    ...
    def hash
      [vsphere_type, compute_availability_domain, display_name, instance_display_name_prefix, esxi_hosts_count, network_configuration, initial_commitment, workload_network_cidr, initial_host_shape_name, initial_host_ocpu_count, is_shielded_instance_enabled, capacity_reservation_id, datastores, datastore_cluster_ids, cluster_byol_allocation_details, initial_vcf_byol_allocation_id].hash
    end
