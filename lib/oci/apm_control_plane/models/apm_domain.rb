...
module OCI
  ...
  class ApmControlPlane::Models::ApmDomain
    ...
    def hash
      [data_upload_endpoint, id, display_name, description, compartment_id, lifecycle_state, is_free_tier, log_group_id, time_created, time_updated, freeform_tags, defined_tags].hash
    end
