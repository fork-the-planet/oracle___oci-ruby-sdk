...
module OCI
  ...
  class Oda::Models::OdaPrivateEndpoint
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, time_updated, lifecycle_state, subnet_id, nsg_ids, security_attributes, freeform_tags, defined_tags].hash
    end
