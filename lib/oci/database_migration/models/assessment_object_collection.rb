...
module OCI
  ...
  class DatabaseMigration::Models::AssessmentObjectCollection
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseMigration::Models::OracleAssessmentObjectCollection' if type == 'ORACLE'
      return 'OCI::DatabaseMigration::Models::MySqlAssessmentObjectCollection' if type == 'MYSQL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseMigration::Models::AssessmentObjectCollection'
    end
