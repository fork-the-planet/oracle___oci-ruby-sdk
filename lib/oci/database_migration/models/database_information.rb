...
module OCI
  ...
  #
  class DatabaseMigration::Models::DatabaseInformation
    # The database name.
    # @return [String]
    ...
    # @return [Integer]
    attr_accessor :data_size_in_mbs
    ...
    # @option attributes [Integer] :data_size_in_mbs The value to assign to the {#data_size_in_mbs} property
    def initialize(attributes = {})
      ...
      self.data_size_in_mbs = attributes[:'dataSizeInMBs'] if attributes[:'dataSizeInMBs']

      raise 'You cannot provide both :dataSizeInMBs and :data_size_in_mbs' if attributes.key?(:'dataSizeInMBs') && attributes.key?(:'data_size_in_mbs')

      self.data_size_in_mbs = attributes[:'data_size_in_mbs'] if attributes[:'data_size_in_mbs']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        data_size_in_mbs == other.data_size_in_mbs
    end
    ...
    def hash
      [database_name, database_version, data_size_in_mbs].hash
    end
