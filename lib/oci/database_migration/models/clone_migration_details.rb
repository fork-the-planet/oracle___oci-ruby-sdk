...
module OCI
  ...
  class DatabaseMigration::Models::CloneMigrationDetails
    ...
    def hash
      [database_combination, display_name, compartment_id, source_database_connection_id, target_database_connection_id, assessment_id, freeform_tags, defined_tags].hash
    end
