...
module OCI
  ...
  class DatabaseMigration::Models::CollectTracesData
    ...
    #
    # @return [String]
    attr_reader :collect_traces_state
    ...
    # @option attributes [String] :collect_traces_state The value to assign to the {#collect_traces_state} property
    ...
    # @param [Object] collect_traces_state Object to be assigned
    def collect_traces_state=(collect_traces_state)
      # rubocop:disable Style/ConditionalAssignment
      if collect_traces_state && !COLLECT_TRACES_STATE_ENUM.include?(collect_traces_state)
        OCI.logger.debug("Unknown value for 'collect_traces_state' [" + collect_traces_state + "]. Mapping to 'COLLECT_TRACES_STATE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @collect_traces_state = COLLECT_TRACES_STATE_UNKNOWN_ENUM_VALUE
      else
        @collect_traces_state = collect_traces_state
      end
