...
module OCI
  ...
  class DatabaseMigration::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CREATE_ASSESSMENT = 'CREATE_ASSESSMENT'.freeze,
      OPERATION_TYPE_DELETE_ASSESSMENT = 'DELETE_ASSESSMENT'.freeze,
      OPERATION_TYPE_UPDATE_ASSESSMENT = 'UPDATE_ASSESSMENT'.freeze,
      OPERATION_TYPE_RUN_ASSESSOR_ACTION = 'RUN_ASSESSOR_ACTION'.freeze,
      OPERATION_TYPE_RUN_MIGRATE_TABLE_ASSESSOR = 'RUN_MIGRATE_TABLE_ASSESSOR'.freeze,
      OPERATION_TYPE_RUN_COMPATIBILITY_ASSESSOR = 'RUN_COMPATIBILITY_ASSESSOR'.freeze,
      OPERATION_TYPE_RUN_VIABILITY_ASSESSOR = 'RUN_VIABILITY_ASSESSOR'.freeze,
      OPERATION_TYPE_CONFIGURE_MIGRATION_ASSESSOR = 'CONFIGURE_MIGRATION_ASSESSOR'.freeze,
      OPERATION_TYPE_CREATE_MIGRATION_ASSESSOR = 'CREATE_MIGRATION_ASSESSOR'.freeze,
      OPERATION_TYPE_PREPARE_SOURCE_ASSESSOR = 'PREPARE_SOURCE_ASSESSOR'.freeze,
      OPERATION_TYPE_PREPARE_TARGET_ASSESSOR = 'PREPARE_TARGET_ASSESSOR'.freeze,
      OPERATION_TYPE_CONFIRM_VIABILITY_ASSESSOR = 'CONFIRM_VIABILITY_ASSESSOR'.freeze,
