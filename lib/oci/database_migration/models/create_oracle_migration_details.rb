...
module OCI
  ...
  class DatabaseMigration::Models::CreateOracleMigrationDetails < DatabaseMigration::Models::CreateMigrationDetails
    ...
    # @option attributes [String] :assessment_id The value to assign to the {OCI::DatabaseMigration::Models::CreateMigrationDetails#assessment_id #assessment_id} proprety
