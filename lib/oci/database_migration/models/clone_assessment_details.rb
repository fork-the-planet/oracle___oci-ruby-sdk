...
module OCI
  ...
  class DatabaseMigration::Models::CloneAssessmentDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseMigration::Models::MySqlCloneAssessmentDetails' if type == 'MYSQL'
      return 'OCI::DatabaseMigration::Models::OracleCloneAssessmentDetails' if type == 'ORACLE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseMigration::Models::CloneAssessmentDetails'
    end
