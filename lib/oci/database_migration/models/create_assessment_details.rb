...
module OCI
  ...
  class DatabaseMigration::Models::CreateAssessmentDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseMigration::Models::CreateOracleAssessmentDetails' if type == 'ORACLE'
      return 'OCI::DatabaseMigration::Models::CreateMySqlAssessmentDetails' if type == 'MYSQL'
    ...
    def hash
      [description, compartment_id, database_combination, display_name, network_speed_megabit_per_second, acceptable_downtime, database_data_size, ddl_expectation, creation_type, source_database_connection, target_database_connection, freeform_tags, defined_tags].hash
    end
