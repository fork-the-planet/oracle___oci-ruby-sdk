...
module OCI
  ...
  class Jms::JavaManagementServiceClient
    ...
    def region=(new_region)
      ...
      @endpoint = OCI::Regions.get_service_endpoint_for_template(@region, 'https://javamanagement.{region}.{dualStack?ds.:}oci.{secondLevelDomain}', 'javamanagement') + '/20210610'
    ...
    #   might be rejected.
    #
    # @return [Response] A Response object with data of type {OCI::Jms::Models::TaskSchedule TaskSchedule}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/create_task_schedule.rb.html) to see an example of how to use create_task_schedule API.
    def create_task_schedule(create_task_schedule_details, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#create_task_schedule.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#create_task_schedule') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Jms::Models::TaskSchedule'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/delete_task_schedule.rb.html) to see an example of how to use delete_task_schedule API.
    def delete_task_schedule(task_schedule_id, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#delete_task_schedule.' if logger

      raise "Missing the required parameter 'task_schedule_id' when calling delete_task_schedule." if task_schedule_id.nil?
      raise "Parameter value for 'task_schedule_id' must not be blank" if OCI::Internal::Util.blank_string?(task_schedule_id)

      path = '/taskSchedules/{taskScheduleId}'.sub('{taskScheduleId}', task_schedule_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#delete_task_schedule') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Jms::Models::TaskSchedule TaskSchedule}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/get_task_schedule.rb.html) to see an example of how to use get_task_schedule API.
    def get_task_schedule(task_schedule_id, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#get_task_schedule.' if logger

      raise "Missing the required parameter 'task_schedule_id' when calling get_task_schedule." if task_schedule_id.nil?
      raise "Parameter value for 'task_schedule_id' must not be blank" if OCI::Internal::Util.blank_string?(task_schedule_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#get_task_schedule') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [DateTime] :time_started_greater_than_or_equal_to If specified, only containers with a start time later than or equal to this parameter will be included in the response (formatted according to RFC3339).
    # @option opts [DateTime] :time_started_less_than_or_equal_to If specified, only containers with a start time earlier than or equal to this parameter will be included in the response (formatted according to RFC3339).
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page The page token representing the page at which to start retrieving results. The token is usually retrieved from a previous list call.
    # @option opts [String] :sort_order The sort order, either 'asc' or 'desc'. (default to ASC)
    # @option opts [String] :sort_by The field to sort the containers. Only one sort order can be provided.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Jms::Models::ContainerCollection ContainerCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/list_containers.rb.html) to see an example of how to use list_containers API.
    def list_containers(fleet_id, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#list_containers.' if logger

      raise "Missing the required parameter 'fleet_id' when calling list_containers." if fleet_id.nil?
      ...
      if opts[:sort_by] && !OCI::Jms::Models::CONTAINER_SORT_BY_ENUM.include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of the values in OCI::Jms::Models::CONTAINER_SORT_BY_ENUM.'
      end
      raise "Parameter value for 'fleet_id' must not be blank" if OCI::Internal::Util.blank_string?(fleet_id)

      path = '/fleets/{fleetId}/containers'.sub('{fleetId}', fleet_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#list_containers') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Jms::Models::ContainerCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :fleet_id The ID of the Fleet.
    # @option opts [String] :agent_id The ManagementAgent (OMA), Oracle Cloud Agent (OCA), or the Oracle Container Management Agent (OCMA) [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)
    ...
    #
    # @param [String] fleet_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Fleet.
    # @param [String] library_key The unique identifier of a Java library.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :application_id The Fleet-unique identifier of the application.
    # @option opts [String] :managed_instance_id The Fleet-unique identifier of the managed instance.
    # @option opts [String] :application_name The name of the application.
    # @option opts [String] :application_name_contains Filter the list with application name contains the given value.
    #
    # @option opts [DateTime] :time_start The start of the time period during which resources are searched (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
    # @option opts [DateTime] :time_end The end of the time period during which resources are searched (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page The page token representing the page at which to start retrieving results. The token is usually retrieved from a previous list call.
    # @option opts [String] :sort_by The field to sort library application usage summaries.  Only one sort order may be provided.
    #   If no value is specified _lastSeenInClasspath_ is default.
    #    (default to lastSeenInClasspath)
    # @option opts [String] :sort_order The sort order, either 'asc' or 'desc'. (default to ASC)
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Jms::Models::LibraryApplicationUsageCollection LibraryApplicationUsageCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/list_library_application_usage.rb.html) to see an example of how to use list_library_application_usage API.
    def list_library_application_usage(fleet_id, library_key, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#list_library_application_usage.' if logger

      raise "Missing the required parameter 'fleet_id' when calling list_library_application_usage." if fleet_id.nil?
      raise "Missing the required parameter 'library_key' when calling list_library_application_usage." if library_key.nil?

      if opts[:sort_by] && !OCI::Jms::Models::LIBRARY_APPLICATION_SORT_BY_ENUM.include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of the values in OCI::Jms::Models::LIBRARY_APPLICATION_SORT_BY_ENUM.'
      end
      ...
      raise "Parameter value for 'fleet_id' must not be blank" if OCI::Internal::Util.blank_string?(fleet_id)
      raise "Parameter value for 'library_key' must not be blank" if OCI::Internal::Util.blank_string?(library_key)

      path = '/fleets/{fleetId}/libraries/{libraryKey}/applications'.sub('{fleetId}', fleet_id.to_s).sub('{libraryKey}', library_key.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#list_library_application_usage') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Jms::Models::LibraryApplicationUsageCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :sort_order The sort order, either 'asc' or 'desc'. (default to ASC)
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Jms::Models::LibraryManagedInstanceUsageCollection LibraryManagedInstanceUsageCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/list_library_managed_instance_usage.rb.html) to see an example of how to use list_library_managed_instance_usage API.
    def list_library_managed_instance_usage(fleet_id, library_key, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#list_library_managed_instance_usage.' if logger

      raise "Missing the required parameter 'fleet_id' when calling list_library_managed_instance_usage." if fleet_id.nil?
      raise "Missing the required parameter 'library_key' when calling list_library_managed_instance_usage." if library_key.nil?

      if opts[:sort_by] && !OCI::Jms::Models::LIBRARY_MANAGED_INSTANCE_SORT_BY_ENUM.include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of the values in OCI::Jms::Models::LIBRARY_MANAGED_INSTANCE_SORT_BY_ENUM.'
      end
      ...
      path = '/fleets/{fleetId}/libraries/{libraryKey}/managedInstances'.sub('{fleetId}', fleet_id.to_s).sub('{libraryKey}', library_key.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#list_library_managed_instance_usage') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Jms::Models::LibraryManagedInstanceUsageCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :fleet_id The ID of the Fleet.
    # @option opts [String] :id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) to identify this task schedule.
    # @option opts [String] :managed_instance_id The Fleet-unique identifier of the related managed instance.
    # @option opts [String] :name The task name.
    # @option opts [String] :task_schedule_name_contains Filter the list with task schedule name contains the given value.
    #
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page The page token representing the page at which to start retrieving results. The token is usually retrieved from a previous list call.
    # @option opts [String] :sort_order The sort order, either 'asc' or 'desc'. (default to ASC)
    # @option opts [String] :sort_by The field used to sort task schedule records. Only one sort order may be provided.
    #   Default order for _timeCreated_ is **ascending**.
    #   If no value is specified, _timeCreated_ is default.
    #    (default to timeCreated)
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Jms::Models::TaskScheduleCollection TaskScheduleCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/list_task_schedules.rb.html) to see an example of how to use list_task_schedules API.
    def list_task_schedules(opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#list_task_schedules.' if logger
      ...
      if opts[:sort_by] && !OCI::Jms::Models::TASK_SCHEDULE_SORT_BY_ENUM.include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of the values in OCI::Jms::Models::TASK_SCHEDULE_SORT_BY_ENUM.'
      end
      ...
      query_params[:taskScheduleNameContains] = opts[:task_schedule_name_contains] if opts[:task_schedule_name_contains]
      query_params[:limit] = opts[:limit] if opts[:limit]
      query_params[:page] = opts[:page] if opts[:page]
      query_params[:sortOrder] = opts[:sort_order] if opts[:sort_order]
      query_params[:sortBy] = opts[:sort_by] if opts[:sort_by]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#list_task_schedules') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Jms::Models::TaskScheduleCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @param [String] fleet_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Fleet.
    # @param [String] package_name The unique identifier of a Java package.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :application_id The Fleet-unique identifier of the application.
    ...
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page The page token representing the page at which to start retrieving results. The token is usually retrieved from a previous list call.
    # @option opts [String] :sort_by The field to sort detection events.  Only one sort order may be provided.
    #   If no value is specified _dynamicallyLastDetected_ is default.
    #    (default to dynamicallyLastDetected)
    # @option opts [String] :sort_order The sort order, either 'asc' or 'desc'. (default to ASC)
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Jms::Models::UncorrelatedPackageApplicationUsageCollection UncorrelatedPackageApplicationUsageCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/list_uncorrelated_package_application_usage.rb.html) to see an example of how to use list_uncorrelated_package_application_usage API.
    def list_uncorrelated_package_application_usage(fleet_id, package_name, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#list_uncorrelated_package_application_usage.' if logger

      raise "Missing the required parameter 'fleet_id' when calling list_uncorrelated_package_application_usage." if fleet_id.nil?
      raise "Missing the required parameter 'package_name' when calling list_uncorrelated_package_application_usage." if package_name.nil?

      if opts[:sort_by] && !OCI::Jms::Models::UNCORRELATED_PACKAGE_APPLICATION_SORT_BY_ENUM.include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of the values in OCI::Jms::Models::UNCORRELATED_PACKAGE_APPLICATION_SORT_BY_ENUM.'
      end
      ...
      raise "Parameter value for 'fleet_id' must not be blank" if OCI::Internal::Util.blank_string?(fleet_id)
      raise "Parameter value for 'package_name' must not be blank" if OCI::Internal::Util.blank_string?(package_name)

      path = '/fleets/{fleetId}/uncorrelatedPackages/{packageName}/applications'.sub('{fleetId}', fleet_id.to_s).sub('{packageName}', package_name.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#list_uncorrelated_package_application_usage') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Jms::Models::UncorrelatedPackageApplicationUsageCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :sort_order The sort order, either 'asc' or 'desc'. (default to ASC)
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Jms::Models::UncorrelatedPackageManagedInstanceUsageCollection UncorrelatedPackageManagedInstanceUsageCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/list_uncorrelated_package_managed_instance_usage.rb.html) to see an example of how to use list_uncorrelated_package_managed_instance_usage API.
    def list_uncorrelated_package_managed_instance_usage(fleet_id, package_name, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#list_uncorrelated_package_managed_instance_usage.' if logger

      raise "Missing the required parameter 'fleet_id' when calling list_uncorrelated_package_managed_instance_usage." if fleet_id.nil?
      raise "Missing the required parameter 'package_name' when calling list_uncorrelated_package_managed_instance_usage." if package_name.nil?

      if opts[:sort_by] && !OCI::Jms::Models::UNCORRELATED_PACKAGE_MANAGED_INSTANCE_SORT_BY_ENUM.include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of the values in OCI::Jms::Models::UNCORRELATED_PACKAGE_MANAGED_INSTANCE_SORT_BY_ENUM.'
      end
      ...
      path = '/fleets/{fleetId}/uncorrelatedPackages/{packageName}/managedInstances'.sub('{fleetId}', fleet_id.to_s).sub('{packageName}', package_name.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#list_uncorrelated_package_managed_instance_usage') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Jms::Models::UncorrelatedPackageManagedInstanceUsageCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :package_name The unique identifier of a Java package.
    # @option opts [String] :managed_instance_id The Fleet-unique identifier of the managed instance.
    # @option opts [String] :application_id The Fleet-unique identifier of the application.
    # @option opts [DateTime] :time_start The start of the time period during which resources are searched (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
    # @option opts [DateTime] :time_end The end of the time period during which resources are searched (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
    ...
    # @option opts [String] :page The page token representing the page at which to start retrieving results. The token is usually retrieved from a previous list call.
    # @option opts [String] :sort_order The sort order, either 'asc' or 'desc'. (default to ASC)
    # @option opts [String] :sort_by The field to sort Java packages.  Only one sort order may be provided.
    #   If no value is specified _timeLastSeen_ is default.
    #    (default to timeLastSeen)
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Jms::Models::UncorrelatedPackageUsageCollection UncorrelatedPackageUsageCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/list_uncorrelated_package_usage.rb.html) to see an example of how to use list_uncorrelated_package_usage API.
    def list_uncorrelated_package_usage(fleet_id, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#list_uncorrelated_package_usage.' if logger

      raise "Missing the required parameter 'fleet_id' when calling list_uncorrelated_package_usage." if fleet_id.nil?

      if opts[:sort_order] && !OCI::Jms::Models::SORT_ORDER_ENUM.include?(opts[:sort_order])
        raise 'Invalid value for "sort_order", must be one of the values in OCI::Jms::Models::SORT_ORDER_ENUM.'
      end

      if opts[:sort_by] && !OCI::Jms::Models::PACKAGE_SORT_BY_ENUM.include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of the values in OCI::Jms::Models::PACKAGE_SORT_BY_ENUM.'
      end
      raise "Parameter value for 'fleet_id' must not be blank" if OCI::Internal::Util.blank_string?(fleet_id)

      path = '/fleets/{fleetId}/uncorrelatedPackages'.sub('{fleetId}', fleet_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#list_uncorrelated_package_usage') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Jms::Models::UncorrelatedPackageUsageCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [DateTime] :time_end The end of the time period during which resources are searched (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Jms::Models::LibraryInventory LibraryInventory}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/summarize_library_inventory.rb.html) to see an example of how to use summarize_library_inventory API.
    def summarize_library_inventory(fleet_id, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#summarize_library_inventory.' if logger

      raise "Missing the required parameter 'fleet_id' when calling summarize_library_inventory." if fleet_id.nil?
      raise "Parameter value for 'fleet_id' must not be blank" if OCI::Internal::Util.blank_string?(fleet_id)

      path = '/fleets/{fleetId}/summarizeLibraryInventory'.sub('{fleetId}', fleet_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#summarize_library_inventory') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Jms::Models::LibraryInventory'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @option opts [Float] :cvss_score_greater_than Total Common Vulnerability Scoring System (CVSS) Score reported by the analysis.
    # @option opts [Float] :cvss_score_less_than Total Common Vulnerability Scoring System (CVSS) Score reported by the analysis.
    # @option opts [DateTime] :time_start The start of the time period during which resources are searched (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
    # @option opts [DateTime] :time_end The end of the time period during which resources are searched (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page The page token representing the page at which to start retrieving results. The token is usually retrieved from a previous list call.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Jms::Models::TaskSchedule TaskSchedule}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/jms/update_task_schedule.rb.html) to see an example of how to use update_task_schedule API.
    def update_task_schedule(update_task_schedule_details, task_schedule_id, opts = {})
      logger.debug 'Calling operation JavaManagementServiceClient#update_task_schedule.' if logger
      ...
      raise "Missing the required parameter 'task_schedule_id' when calling update_task_schedule." if task_schedule_id.nil?
      raise "Parameter value for 'task_schedule_id' must not be blank" if OCI::Internal::Util.blank_string?(task_schedule_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'JavaManagementServiceClient#update_task_schedule') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
