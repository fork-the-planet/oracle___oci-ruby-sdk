...
module OCI
  ...
  #
  class Jms::Models::UncorrelatedPackageManagedInstanceUsageSummary
    ...
    # **[Required]** The count of applications wherein the specified library was detected.
    #
    # @return [Integer]
    ...
    def hash
      [managed_instance_id, hostname, application_count, last_detected_dynamically].hash
    end
