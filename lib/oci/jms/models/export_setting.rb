...
module OCI
  ...
  class Jms::Models::ExportSetting
    ...
    # @return [OCI::Jms::Models::ExportDataFilters]
    attr_accessor :export_data_filters
    ...
    # @option attributes [OCI::Jms::Models::ExportDataFilters] :export_data_filters The value to assign to the {#export_data_filters} property
    def initialize(attributes = {})
      ...
      self.export_data_filters = attributes[:'exportDataFilters'] if attributes[:'exportDataFilters']

      raise 'You cannot provide both :exportDataFilters and :export_data_filters' if attributes.key?(:'exportDataFilters') && attributes.key?(:'export_data_filters')

      self.export_data_filters = attributes[:'export_data_filters'] if attributes[:'export_data_filters']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        export_data_filters == other.export_data_filters
    end
    ...
    def hash
      [export_setting_key, fleet_id, export_duration, export_resources, is_cross_region_acknowledged, target_bucket_name, target_bucket_namespace, target_bucket_region, export_frequency, is_enabled, time_created, time_last_modified, export_data_filters].hash
    end
