...
module OCI
  ...
  class Jms::Models::JavaMigrationApplicationWorkItemDetails < Jms::Models::WorkItemDetails
    # **[Required]** The unique key of the application of the java migration analysis.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['kind'] = 'JAVA_MIGRATION_APPLICATION'
    ...
    def hash
      [kind, work_item_type, application_key, application_installation_key, application_name, application_installation_path, target_jdk_version].hash
    end
