...
module OCI
  ...
  class Jms::Models::ManagedInstanceUsage
    MANAGED_INSTANCE_TYPE_ENUM = [
      ...
      MANAGED_INSTANCE_TYPE_ORACLE_CONTAINER_MANAGEMENT_AGENT = 'ORACLE_CONTAINER_MANAGEMENT_AGENT'.freeze,
    ...
    # @return [OCI::Jms::Models::ClusterDetails]
    ...
    def self.swagger_types
      {
        ...
        'cluster_details': :'OCI::Jms::Models::ClusterDetails',
    ...
    # @option attributes [OCI::Jms::Models::ClusterDetails] :cluster_details The value to assign to the {#cluster_details} property
    ...
    def hash
      [managed_instance_id, managed_instance_type, hostname, host_id, ip_addresses, hostnames, fqdns, operating_system, agent, cluster_details, approximate_application_count, approximate_installation_count, approximate_jre_count, drs_file_status, application_invoked_by, time_start, time_end, time_first_seen, time_last_seen].hash
    end
