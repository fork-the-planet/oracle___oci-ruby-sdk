...
module OCI
  ...
  class Jms::Models::ClusterDetails
    CLUSTER_TYPE_ENUM = [
      CLUSTER_TYPE_OKE = 'OKE'.freeze,
      CLUSTER_TYPE_OTHER = 'OTHER'.freeze,
    ...
    # @option attributes [Integer] :pod_count The value to assign to the {#pod_count} property
    ...
    def initialize(attributes = {})
      ...
      self.pod_count = attributes[:'podCount'] if attributes[:'podCount']

      raise 'You cannot provide both :podCount and :pod_count' if attributes.key?(:'podCount') && attributes.key?(:'pod_count')

      self.pod_count = attributes[:'pod_count'] if attributes[:'pod_count']
    ...
    def hash
      [cluster_type, node_count, pod_count, container_count].hash
    end
