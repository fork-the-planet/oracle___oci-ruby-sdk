...
module OCI
  ...
  class Jms::Models::JavaFamily
    ...
    # @return [Array<OCI::Jms::Models::LicenseType>]
    attr_accessor :license_types
    ...
    # @option attributes [Array<OCI::Jms::Models::LicenseType>] :license_types The value to assign to the {#license_types} property
    def initialize(attributes = {})
      ...
      self.license_types = attributes[:'licenseTypes'] if attributes[:'licenseTypes']

      raise 'You cannot provide both :licenseTypes and :license_types' if attributes.key?(:'licenseTypes') && attributes.key?(:'license_types')

      self.license_types = attributes[:'license_types'] if attributes[:'license_types']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        license_types == other.license_types
    end
    ...
    def hash
      [latest_release_artifacts, family_version, display_name, support_type, end_of_support_life_date, doc_url, latest_release_version, is_supported_version, release_date, license_types].hash
    end
