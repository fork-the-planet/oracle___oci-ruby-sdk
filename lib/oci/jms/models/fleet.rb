...
module OCI
  ...
  class Jms::Models::Fleet
    ...
    # **[Required]** The approximate count of all unique libraries in the Fleet in the past seven days.
    # This metric is provided on a best-effort manner, and isn't taken into account when computing the resource ETag.
    #
    # @return [Integer]
    attr_accessor :approximate_library_count

    # **[Required]** The approximate count of all unique library vulnerabilities in the Fleet in the past seven days.
    # This metric is provided on a best-effort manner, and isn't taken into account when computing the resource ETag.
    #
    # @return [Integer]
    attr_accessor :approximate_library_vulnerability_count
    ...
    def self.swagger_types
      {
        ...
        'approximate_library_vulnerability_count': :'Integer',
    ...
    # @option attributes [Integer] :approximate_library_vulnerability_count The value to assign to the {#approximate_library_vulnerability_count} property
    ...
    def initialize(attributes = {})
      ...
      self.approximate_library_vulnerability_count = attributes[:'approximateLibraryVulnerabilityCount'] if attributes[:'approximateLibraryVulnerabilityCount']

      raise 'You cannot provide both :approximateLibraryVulnerabilityCount and :approximate_library_vulnerability_count' if attributes.key?(:'approximateLibraryVulnerabilityCount') && attributes.key?(:'approximate_library_vulnerability_count')

      self.approximate_library_vulnerability_count = attributes[:'approximate_library_vulnerability_count'] if attributes[:'approximate_library_vulnerability_count']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        approximate_library_vulnerability_count == other.approximate_library_vulnerability_count &&
    ...
    def hash
      [id, display_name, description, compartment_id, approximate_jre_count, approximate_installation_count, approximate_application_count, approximate_managed_instance_count, approximate_java_server_count, approximate_library_count, approximate_library_vulnerability_count, inventory_log, operation_log, is_advanced_features_enabled, is_export_setting_enabled, time_created, lifecycle_state, defined_tags, freeform_tags, system_tags].hash
    end
