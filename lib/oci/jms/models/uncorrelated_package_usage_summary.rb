...
module OCI
  ...
  class Jms::Models::UncorrelatedPackageUsageSummary
    # **[Required]** The name of the package.
    # @return [String]
    attr_accessor :package_name

    # **[Required]** The count of managed instances wherein the specified package was detected.
    # @return [Integer]
    attr_accessor :managed_instance_count

    # **[Required]** The count of applications wherein the specified package was detected.
    # @return [Integer]
    ...
    def hash
      [package_name, managed_instance_count, application_count, last_detected_dynamically].hash
    end
