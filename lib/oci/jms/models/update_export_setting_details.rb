...
module OCI
  ...
  class Jms::Models::UpdateExportSettingDetails
    ...
    def hash
      [export_duration, export_resources, is_cross_region_acknowledged, target_bucket_name, target_bucket_namespace, target_bucket_region, export_frequency, is_enabled, export_data_filters].hash
    end
