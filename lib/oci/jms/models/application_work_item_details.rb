...
module OCI
  ...
  class Jms::Models::ApplicationWorkItemDetails < Jms::Models::WorkItemDetails
    ...
    # @return [OCI::Jms::Models::ContainerSummary]
    ...
    def self.swagger_types
      {
        ...
        'bucket_name': :'String',
        'object_name': :'String',
        'container_info': :'OCI::Jms::Models::ContainerSummary'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Jms::Models::ContainerSummary] :container_info The value to assign to the {#container_info} property
    def initialize(attributes = {})
      ...
      self.container_info = attributes[:'containerInfo'] if attributes[:'containerInfo']

      raise 'You cannot provide both :containerInfo and :container_info' if attributes.key?(:'containerInfo') && attributes.key?(:'container_info')

      self.container_info = attributes[:'container_info'] if attributes[:'container_info']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        container_info == other.container_info
    end
    ...
    def hash
      [kind, work_item_type, application_key, application_installation_key, application_name, application_installation_path, namespace, bucket_name, object_name, container_info].hash
    end
