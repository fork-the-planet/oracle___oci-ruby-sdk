...
module OCI
  ...
  class Jms::Models::CreateJmsPluginDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Management Agent (OMA), the Oracle Cloud Agent (OCA),
    # or the Oracle Container Management Agent (OCMA) instance where the JMS plugin is deployed.
    #
    # @return [String]
    attr_accessor :agent_id

    # **[Required]** The OMA/OCA/OCMA agent's compartment [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).
    # @return [String]
    ...
    def agent_type=(agent_type)
      raise "Invalid value for 'agent_type': this must be one of the values in AGENT_TYPE_ENUM." if agent_type && !AGENT_TYPE_ENUM.include?(agent_type)
    ...
    def hash
      [agent_id, compartment_id, agent_type, fleet_id, defined_tags, freeform_tags].hash
    end
