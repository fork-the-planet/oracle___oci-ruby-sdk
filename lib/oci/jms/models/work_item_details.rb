...
module OCI
  ...
  class Jms::Models::WorkItemDetails
    ...
    WORK_ITEM_TYPE_ENUM = [
      ...
      WORK_ITEM_TYPE_ADV_USAGE_JAVA_LIBRARIES_DYNAMIC = 'ADV_USAGE_JAVA_LIBRARIES_DYNAMIC'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Jms::Models::JavaMigrationDeployedApplicationWorkItemDetails' if type == 'JAVA_MIGRATION_DEPLOYED_APPLICATION'
      ...
      return 'OCI::Jms::Models::JavaMigrationApplicationWorkItemDetails' if type == 'JAVA_MIGRATION_APPLICATION'
