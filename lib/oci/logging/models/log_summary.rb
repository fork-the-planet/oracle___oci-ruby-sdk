...
module OCI
  ...
  class Logging::Models::LogSummary
    ...
    def hash
      [id, log_group_id, display_name, is_enabled, lifecycle_state, log_type, configuration, defined_tags, freeform_tags, system_tags, time_created, time_last_modified, retention_duration, compartment_id].hash
    end
