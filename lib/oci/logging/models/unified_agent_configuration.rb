...
module OCI
  ...
  class Logging::Models::UnifiedAgentConfiguration
    ...
    def hash
      [id, compartment_id, display_name, description, defined_tags, freeform_tags, system_tags, time_created, time_last_modified, lifecycle_state, is_enabled, configuration_state, service_configuration, group_association].hash
    end
