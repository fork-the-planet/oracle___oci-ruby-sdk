...
module OCI
  ...
  class Logging::Models::UnifiedAgentConfigurationSummary
    ...
    def hash
      [id, compartment_id, display_name, description, defined_tags, freeform_tags, system_tags, time_created, time_last_modified, lifecycle_state, is_enabled, configuration_type, configuration_state].hash
    end
