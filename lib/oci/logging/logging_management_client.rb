...
module OCI
  ...
  class Logging::LoggingManagementClient
    ...
    def region=(new_region)
      ...
      @endpoint = OCI::Regions.get_service_endpoint_for_template(@region, 'https://logging.{region}.{dualStack?ds.:}oci.{secondLevelDomain}', 'logging') + '/20200531'
    ...
    #
    # @option opts [Integer] :limit When setting the page limit, specifies the maximum number of unfiltered records that can be fetched from the data store in one request. Filtering happens after the records are retrieved. Subsequent pages might include results that match the query criteria.
    #    (default to 100)
