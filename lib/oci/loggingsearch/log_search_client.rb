...
module OCI
  ...
  class Loggingsearch::LogSearchClient
    ...
    def region=(new_region)
      ...
      @endpoint = OCI::Regions.get_service_endpoint_for_template(@region, 'https://logging.{region}.{dualStack?ds.:}oci.{secondLevelDomain}') + '/20190909'
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. The input value can be null but an empty string will return an error.
    #   If you need to contact Oracle about a particular request, please provide the request ID.
    #
    # @option opts [Integer] :limit The maximum number of items to return in a response.
    #    (default to 100)
