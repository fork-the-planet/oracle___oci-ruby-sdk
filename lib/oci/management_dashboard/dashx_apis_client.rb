...
module OCI
  ...
  class ManagementDashboard::DashxApisClient
    ...
    #
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @option opts [String] :export_tags Indicates whether tags must be included when exporting dashboards and saved searches. If this attribute is set to true, then both defined and free-form tags are included in the response. The default is false and tag fields are empty objects in the response.
    ...
    def export_dashboard(export_dashboard_id, opts = {})
      ...
      # Query Params
      query_params = {}
      query_params[:exportTags] = opts[:export_tags] if opts[:export_tags]
    ...
    #
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @option opts [String] :override_same_name By default, if a resource with the same OCID exists in the target compartment, it is updated during the import process, otherwise, a new resource is created.
    ...
    #
    # @option opts [String] :override_dashboard_compartment_ocid If this attribute is set, the dashboard resources are created or updated in the compartment specified by OCID. If this attribute is not set, the compartment specified in the JSON metadata is used.
    #
    # @option opts [String] :override_saved_search_compartment_ocid If this attribute is set, the saved search resources are created or updated in the compartment specified by OCID. If this attribute is not set, the compartment specified in the JSON metadata is used.
    #
    # @return [Response] A Response object with data of type nil
    ...
    def import_dashboard(management_dashboard_import_details, opts = {})
      ...
      # Query Params
      query_params = {}
      query_params[:overrideSameName] = opts[:override_same_name] if opts[:override_same_name]
      query_params[:overrideDashboardCompartmentOcid] = opts[:override_dashboard_compartment_ocid] if opts[:override_dashboard_compartment_ocid]
      query_params[:overrideSavedSearchCompartmentOcid] = opts[:override_saved_search_compartment_ocid] if opts[:override_saved_search_compartment_ocid]
    ...
    # @option opts [String] :compartment_id_in_subtree This parameter applies only when compartmentId is root compartment. When set to true, all accessible resources will be returned. Default is false. (default to false)
    ...
    def list_management_dashboards(compartment_id, opts = {})
      ...
      query_params[:compartmentIdInSubtree] = opts[:compartment_id_in_subtree] if opts[:compartment_id_in_subtree]
