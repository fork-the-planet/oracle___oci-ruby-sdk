...
module OCI
  ...
  class Dif::Models::ObjectStorageUpdateDetail
    ...
    # **[Required]** Instance id of the existing Object Storage instance to be updated.
    # @return [String]
    ...
    def object_versioning=(object_versioning)
      raise "Invalid value for 'object_versioning': this must be one of the values in OBJECT_VERSIONING_ENUM." if object_versioning && !OBJECT_VERSIONING_ENUM.include?(object_versioning)
    ...
    def auto_tiering=(auto_tiering)
      raise "Invalid value for 'auto_tiering': this must be one of the values in AUTO_TIERING_ENUM." if auto_tiering && !AUTO_TIERING_ENUM.include?(auto_tiering)
    ...
    def hash
      [instance_id, object_versioning, auto_tiering].hash
    end
