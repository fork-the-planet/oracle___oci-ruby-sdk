...
module OCI
  ...
  class Dif::Models::OkeDetail
    # **[Required]** Unique identifier for an oke instance.
    # @return [String]
    attr_accessor :instance_id

    # **[Required]** OCID of existing OKE cluster.
    # @return [String]
    attr_accessor :cluster_id

    # **[Required]** Kubernetes namespace-name of OKE cluster.
    # @return [String]
    ...
    def hash
      [instance_id, cluster_id, namespace_name].hash
    end
