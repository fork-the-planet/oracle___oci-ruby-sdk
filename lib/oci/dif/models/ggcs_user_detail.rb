...
module OCI
  ...
  class Dif::Models::GgcsUserDetail
    ACTION_ENUM = [
    ...
    # **[Required]** Vault OCID containing password for existing or new user.
    # @return [String]
    attr_accessor :secret_id

    # **[Required]** Type of GoldenGate user. Allowed values are \"OPERATOR\".
    # @return [String]
    ...
    def hash
      [user_name, secret_id, user_type, action].hash
    end
