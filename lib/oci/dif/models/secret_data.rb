...
module OCI
  ...
  class Dif::Models::SecretData
    # **[Required]** Data key in the kubernetes secret.
    # @return [String]
    attr_accessor :key

    # **[Required]** OCID of the Oci vault secret that provides the value for this key. The latest active secret version is used at deploy time unless otherwise configured.
    # @return [String]
