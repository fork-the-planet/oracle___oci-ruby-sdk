...
module OCI
  ...
  class Dif::Models::AdbArtifactsDetail
    # **[Required]** Instance id of the existing ADB instance.
    # @return [String]
    attr_accessor :instance_id

    # **[Required]** Object storage path for the artifacts.
    # @return [String]
    attr_accessor :artifact_object_storage_path

    # DB credential details.
    # @return [Array<OCI::Dif::Models::DbCredentialsDetail>]
    ...
    def self.swagger_types
      {
        ...
        'db_credentials': :'Array<OCI::Dif::Models::DbCredentialsDetail>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Dif::Models::DbCredentialsDetail>] :db_credentials The value to assign to the {#db_credentials} property
    ...
    def hash
      [instance_id, artifact_object_storage_path, db_credentials].hash
    end
