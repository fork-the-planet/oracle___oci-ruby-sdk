...
module OCI
  ...
  class Dif::Models::ShapeConfig
    # **[Required]** The amount of memory used for the driver or executors.
    # @return [Integer]
    attr_accessor :memory_in_gbs

    # **[Required]** The total number of OCPUs used for the driver or executors. See here for details.
    # @return [Integer]
    attr_accessor :ocpus
