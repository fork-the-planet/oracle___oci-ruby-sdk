...
module OCI
  ...
  class Dif::Models::AssignedConnectionDetails
    ...
    # @option attributes [String] :requested_by The value to assign to the {#requested_by} property
    ...
    def hash
      [connection_name, connection_id, requested_by].hash
    end
