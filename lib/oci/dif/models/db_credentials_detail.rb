...
module OCI
  ...
  class Dif::Models::DbCredentialsDetail
    # **[Required]** Username for ADB to be created or updated.
    # @return [String]
    attr_accessor :user_name

    # **[Required]** Vault secret OCID containing the corresponding user password.
    # @return [String]
    attr_accessor :secret_id

    # **[Required]** Type of the user. Allowed values are \"ADMIN\" or \"CUSTOM\" or \"GGCS\".
    # @return [String]
    ...
    def hash
      [user_name, secret_id, user_type].hash
    end
