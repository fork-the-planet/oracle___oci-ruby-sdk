...
module OCI
  ...
  class Dif::Models::DataflowUpdateDetail
    ...
    # @return [OCI::Dif::Models::UpdateDataflowConnections]
    ...
    # @option attributes [OCI::Dif::Models::UpdateDataflowConnections] :connections The value to assign to the {#connections} property
