...
module OCI
  ...
  class Dif::Models::DataflowConnections
    # **[Required]** OCID of the private subnet
    # @return [String]
    attr_accessor :subnet_id

    # This attribute is required.
    # @return [OCI::Dif::Models::DataflowConnectionDetails]
    ...
    # @option attributes [OCI::Dif::Models::DataflowConnectionDetails] :connection_details The value to assign to the {#connection_details} property
    ...
    def hash
      [subnet_id, connection_details].hash
    end
