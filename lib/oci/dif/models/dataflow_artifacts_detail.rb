...
module OCI
  ...
  class Dif::Models::DataflowArtifactsDetail
    # **[Required]** Instance id of the existing Dataflow Instance for artifact deployment.
    # @return [String]
    attr_accessor :instance_id

    # **[Required]** Contains the main file (py/jar) along with parameters & configuration to be passed to the DataFlow run.
    # @return [String]
    ...
    def hash
      [instance_id, execute, archive_uri].hash
    end
