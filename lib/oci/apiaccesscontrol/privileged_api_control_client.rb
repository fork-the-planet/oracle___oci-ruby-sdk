...
module OCI
  ...
  class Apiaccesscontrol::PrivilegedApiControlClient
    ...
    # Creates a new PrivilegedApiControlClient.
    # Notes:
    ...
    def region=(new_region)
      ...
      logger.info "PrivilegedApiControlClient endpoint set to '#{@endpoint} from region #{@region}'." if logger
    end
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apiaccesscontrol/change_privileged_api_control_compartment.rb.html) to see an example of how to use change_privileged_api_control_compartment API.
    ...
    #   underscore, and dash.
    #
    # @return [Response] A Response object with data of type {OCI::Apiaccesscontrol::Models::PrivilegedApiControl PrivilegedApiControl}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apiaccesscontrol/create_privileged_api_control.rb.html) to see an example of how to use create_privileged_api_control API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :description reason for deletion of PrivilegedApiControl.
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the
    #   `if-match` parameter to the value of the etag from a previous GET or POST response for
    #   that resource. The resource will be updated or deleted only if the etag you provide
    #   matches the resource's current etag value.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apiaccesscontrol/delete_privileged_api_control.rb.html) to see an example of how to use delete_privileged_api_control API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Apiaccesscontrol::Models::PrivilegedApiControl PrivilegedApiControl}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apiaccesscontrol/get_privileged_api_control.rb.html) to see an example of how to use get_privileged_api_control API.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apiaccesscontrol/update_privileged_api_control.rb.html) to see an example of how to use update_privileged_api_control API.
