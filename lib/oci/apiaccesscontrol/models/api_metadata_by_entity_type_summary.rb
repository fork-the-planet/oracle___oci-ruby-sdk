...
module OCI
  ...
  class Apiaccesscontrol::Models::ApiMetadataByEntityTypeSummary
    ...
    # @return [Array<OCI::Apiaccesscontrol::Models::ApiMetadataSummary>]
    attr_accessor :api_metadatas
    ...
    def initialize(attributes = {})
      ...
      self.api_metadatas = attributes[:'apiMetadatas'] if attributes[:'apiMetadatas']

      raise 'You cannot provide both :apiMetadatas and :api_metadatas' if attributes.key?(:'apiMetadatas') && attributes.key?(:'api_metadatas')

      self.api_metadatas = attributes[:'api_metadatas'] if attributes[:'api_metadatas']
