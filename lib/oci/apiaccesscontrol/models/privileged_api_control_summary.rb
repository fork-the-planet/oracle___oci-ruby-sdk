...
module OCI
  ...
  class Apiaccesscontrol::Models::PrivilegedApiControlSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the PrivilegedApiControl.
    # @return [String]
    attr_accessor :id

    # **[Required]** Name of the privilegedApi control.
    # @return [String]
    ...
    def hash
      [id, display_name, compartment_id, resource_type, number_of_approvers, time_created, time_updated, time_deleted, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
