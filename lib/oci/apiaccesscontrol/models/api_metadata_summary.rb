...
module OCI
  ...
  class Apiaccesscontrol::Models::ApiMetadataSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ApiDetail.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The current state of the ApiMetadata.
    # @return [String]
    ...
    def hash
      [id, service_name, display_name, entity_type, api_name, attributes, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
