...
module OCI
  ...
  class DisasterRecovery::DisasterRecoveryClient
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    #
    # @return [Response] A Response object with data of type {OCI::DisasterRecovery::Models::AutomaticDrConfiguration AutomaticDrConfiguration}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/disasterrecovery/create_automatic_dr_configuration.rb.html) to see an example of how to use create_automatic_dr_configuration API.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/disasterrecovery/delete_automatic_dr_configuration.rb.html) to see an example of how to use delete_automatic_dr_configuration API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::DisasterRecovery::Models::AutomaticDrConfiguration AutomaticDrConfiguration}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/disasterrecovery/get_automatic_dr_configuration.rb.html) to see an example of how to use get_automatic_dr_configuration API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :automatic_dr_configuration_id The OCID of the automatic DR configuration.
    #
    #   Example: `ocid1.automaticDrConfiguration.oc1..uniqueID`
    #
    # @option opts [String] :lifecycle_state A filter to return only Automatic DR configurations that match the given lifecycle state.
    #
    # @option opts [String] :lifecycle_state_not_equal_to A filter to return only Automatic DR configurations that do not match the given lifecycle state.
    #
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    #
    # @return [Response] A Response object with data of type {OCI::DisasterRecovery::Models::AutomaticDrConfigurationCollection AutomaticDrConfigurationCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/disasterrecovery/list_automatic_dr_configurations.rb.html) to see an example of how to use list_automatic_dr_configurations API.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/disasterrecovery/update_automatic_dr_configuration.rb.html) to see an example of how to use update_automatic_dr_configuration API.
