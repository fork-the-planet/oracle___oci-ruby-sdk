...
module OCI
  ...
  class DisasterRecovery::Models::CreateAutomaticDrConfigurationDetails
    # **[Required]** The display name of the Automatic DR configuration being created.
    #
    ...
    # **[Required]** A list of members for Automatic DR configuration.
    #
    # @return [Array<OCI::DisasterRecovery::Models::CreateAutomaticDrConfigurationMemberDetails>]
    ...
    def self.swagger_types
      {
        ...
        'members': :'Array<OCI::DisasterRecovery::Models::CreateAutomaticDrConfigurationMemberDetails>',
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::CreateAutomaticDrConfigurationMemberDetails>] :members The value to assign to the {#members} property
    ...
    def hash
      [display_name, dr_protection_group_id, members, default_switchover_dr_plan_id, default_failover_dr_plan_id, freeform_tags, defined_tags].hash
    end
