...
module OCI
  ...
  class DisasterRecovery::Models::CreateOkeClusterResourceModifierMappingDetails
    # **[Required]** The OKE namespace where the config map resides.
    # Example: `namespace_string_5`
    #
    # @return [String]
    attr_accessor :namespace

    # **[Required]** The name of the config map containing resource modification details.
    ...
    # @option attributes [String] :config_map The value to assign to the {#config_map} property
