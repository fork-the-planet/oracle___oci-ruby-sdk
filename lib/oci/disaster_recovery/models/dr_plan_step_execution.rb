...
module OCI
  ...
  class DisasterRecovery::Models::DrPlanStepExecution
    TYPE_ENUM = [
      ...
      TYPE_MYSQL_DB_SYSTEM_SWITCHOVER_PRECHECK = 'MYSQL_DB_SYSTEM_SWITCHOVER_PRECHECK'.freeze,
      TYPE_MYSQL_DB_SYSTEM_SWITCHOVER = 'MYSQL_DB_SYSTEM_SWITCHOVER'.freeze,
      TYPE_MYSQL_DB_SYSTEM_FAILOVER_PRECHECK = 'MYSQL_DB_SYSTEM_FAILOVER_PRECHECK'.freeze,
      TYPE_MYSQL_DB_SYSTEM_FAILOVER = 'MYSQL_DB_SYSTEM_FAILOVER'.freeze,
      TYPE_MYSQL_DB_SYSTEM_START_DRILL_PRECHECK = 'MYSQL_DB_SYSTEM_START_DRILL_PRECHECK'.freeze,
      TYPE_MYSQL_DB_SYSTEM_START_DRILL = 'MYSQL_DB_SYSTEM_START_DRILL'.freeze,
      TYPE_MYSQL_DB_SYSTEM_STOP_DRILL_PRECHECK = 'MYSQL_DB_SYSTEM_STOP_DRILL_PRECHECK'.freeze,
      TYPE_MYSQL_DB_SYSTEM_STOP_DRILL = 'MYSQL_DB_SYSTEM_STOP_DRILL'.freeze,
      TYPE_INTEGRATION_INSTANCE_SWITCHOVER_PRECHECK = 'INTEGRATION_INSTANCE_SWITCHOVER_PRECHECK'.freeze,
      TYPE_INTEGRATION_INSTANCE_SWITCHOVER = 'INTEGRATION_INSTANCE_SWITCHOVER'.freeze,
      TYPE_INTEGRATION_INSTANCE_FAILOVER_PRECHECK = 'INTEGRATION_INSTANCE_FAILOVER_PRECHECK'.freeze,
      TYPE_INTEGRATION_INSTANCE_FAILOVER = 'INTEGRATION_INSTANCE_FAILOVER'.freeze,
