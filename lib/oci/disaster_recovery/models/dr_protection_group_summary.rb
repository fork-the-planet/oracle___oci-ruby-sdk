...
module OCI
  ...
  class DisasterRecovery::Models::DrProtectionGroupSummary
    ...
    LIFECYCLE_SUB_STATE_ENUM = [
      ...
      LIFECYCLE_SUB_STATE_DR_PLAN_EXECUTION_IN_PROGRESS = 'DR_PLAN_EXECUTION_IN_PROGRESS'.freeze,
      LIFECYCLE_SUB_STATE_AUTOMATIC_DR_PLAN_EXECUTION_IN_PROGRESS = 'AUTOMATIC_DR_PLAN_EXECUTION_IN_PROGRESS'.freeze,
