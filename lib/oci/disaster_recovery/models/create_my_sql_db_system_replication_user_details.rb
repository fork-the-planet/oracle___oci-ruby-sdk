...
module OCI
  ...
  class DisasterRecovery::Models::CreateMySqlDbSystemReplicationUserDetails
    # **[Required]** The user name for connecting to the HeatWave MySQL DB System node.
    #
    # Example: `user`
    #
    # @return [String]
    ...
    # **[Required]** The OCID of the vault secret where the HeatWave MySQL DB System password is stored.
    #
    ...
    def hash
      [username, password_vault_secret_id].hash
    end
