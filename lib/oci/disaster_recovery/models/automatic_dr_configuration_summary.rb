...
module OCI
  ...
  class DisasterRecovery::Models::AutomaticDrConfigurationSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, dr_protection_group_id, default_switchover_dr_plan_id, default_failover_dr_plan_id, lifecycle_state, lifecycle_sub_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
