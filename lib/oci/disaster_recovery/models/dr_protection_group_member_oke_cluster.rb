...
module OCI
  ...
  class DisasterRecovery::Models::DrProtectionGroupMemberOkeCluster < DisasterRecovery::Models::DrProtectionGroupMember
    ...
    # This property applies to the OKE cluster member in primary region.
    #
    # @return [Array<OCI::DisasterRecovery::Models::OkeClusterResourceModifierMapping>]
    ...
    def self.swagger_types
      {
        ...
        'resource_modifier_mappings': :'Array<OCI::DisasterRecovery::Models::OkeClusterResourceModifierMapping>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::OkeClusterResourceModifierMapping>] :resource_modifier_mappings The value to assign to the {#resource_modifier_mappings} property
