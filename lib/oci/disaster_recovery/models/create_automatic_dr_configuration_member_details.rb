...
module OCI
  ...
  class DisasterRecovery::Models::CreateAutomaticDrConfigurationMemberDetails
    MEMBER_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DisasterRecovery::Models::CreateAutomaticDrConfigurationMemberAutonomousDatabaseDetails' if type == 'AUTONOMOUS_DATABASE'
      return 'OCI::DisasterRecovery::Models::CreateAutomaticDrConfigurationMemberDatabaseDetails' if type == 'DATABASE'
      return 'OCI::DisasterRecovery::Models::CreateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails' if type == 'AUTONOMOUS_CONTAINER_DATABASE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DisasterRecovery::Models::CreateAutomaticDrConfigurationMemberDetails'
    end
