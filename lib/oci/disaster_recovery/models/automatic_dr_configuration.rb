...
module OCI
  ...
  class DisasterRecovery::Models::AutomaticDrConfiguration
    ...
    #
    # @return [Array<OCI::DisasterRecovery::Models::AutomaticDrConfigurationMember>]
    ...
    #
    # @return [String]
    attr_accessor :default_switchover_dr_plan_id
    ...
    #
    # @return [String]
    attr_accessor :default_failover_dr_plan_id
    ...
    #
    # @return [String]
    attr_reader :last_automatic_dr_execution_submit_status

    # A message describing the result of the most recent attempt made to submit an Automatic DR plan execution.
    #
    # @return [String]
    attr_accessor :last_automatic_dr_execution_submit_details
    ...
    #
    # @return [DateTime]
    attr_accessor :time_last_automatic_dr_execution_submit_attempt
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::AutomaticDrConfigurationMember>] :members The value to assign to the {#members} property
    # @option attributes [String] :default_switchover_dr_plan_id The value to assign to the {#default_switchover_dr_plan_id} property
    # @option attributes [String] :default_failover_dr_plan_id The value to assign to the {#default_failover_dr_plan_id} property
    ...
    # @option attributes [String] :last_automatic_dr_execution_submit_status The value to assign to the {#last_automatic_dr_execution_submit_status} property
    # @option attributes [String] :last_automatic_dr_execution_submit_details The value to assign to the {#last_automatic_dr_execution_submit_details} property
    # @option attributes [DateTime] :time_last_automatic_dr_execution_submit_attempt The value to assign to the {#time_last_automatic_dr_execution_submit_attempt} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] last_automatic_dr_execution_submit_status Object to be assigned
    def last_automatic_dr_execution_submit_status=(last_automatic_dr_execution_submit_status)
      # rubocop:disable Style/ConditionalAssignment
      if last_automatic_dr_execution_submit_status && !LAST_AUTOMATIC_DR_EXECUTION_SUBMIT_STATUS_ENUM.include?(last_automatic_dr_execution_submit_status)
        OCI.logger.debug("Unknown value for 'last_automatic_dr_execution_submit_status' [" + last_automatic_dr_execution_submit_status + "]. Mapping to 'LAST_AUTOMATIC_DR_EXECUTION_SUBMIT_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @last_automatic_dr_execution_submit_status = LAST_AUTOMATIC_DR_EXECUTION_SUBMIT_STATUS_UNKNOWN_ENUM_VALUE
      else
        @last_automatic_dr_execution_submit_status = last_automatic_dr_execution_submit_status
      end
      # rubocop:enable Style/ConditionalAssignment
    end
