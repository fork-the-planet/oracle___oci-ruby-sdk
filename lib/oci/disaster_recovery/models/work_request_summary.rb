...
module OCI
  ...
  class DisasterRecovery::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CREATE_AUTOMATIC_DR_CONFIGURATION = 'CREATE_AUTOMATIC_DR_CONFIGURATION'.freeze,
      OPERATION_TYPE_DELETE_AUTOMATIC_DR_CONFIGURATION = 'DELETE_AUTOMATIC_DR_CONFIGURATION'.freeze,
      OPERATION_TYPE_UPDATE_AUTOMATIC_DR_CONFIGURATION = 'UPDATE_AUTOMATIC_DR_CONFIGURATION'.freeze,
