...
module OCI
  ...
  class DisasterRecovery::Models::AutomaticExecutionDetails
    # **[Required]** The name of the OCI event that started the automatic DR plan execution.
    #
    ...
    # **[Required]** The OCID of the member that emitted the event that started the automatic DR plan execution.
    #
