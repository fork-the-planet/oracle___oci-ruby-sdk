...
module OCI
  ...
  class DisasterRecovery::Models::UpdateDrProtectionGroupMemberOkeClusterDetails < DisasterRecovery::Models::UpdateDrProtectionGroupMemberDetails
    ...
    # This property applies to the OKE cluster member in primary region.
    #
    # @return [Array<OCI::DisasterRecovery::Models::UpdateOkeClusterResourceModifierMappingDetails>]
    ...
    def self.swagger_types
      {
        ...
        'resource_modifier_mappings': :'Array<OCI::DisasterRecovery::Models::UpdateOkeClusterResourceModifierMappingDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::UpdateOkeClusterResourceModifierMappingDetails>] :resource_modifier_mappings The value to assign to the {#resource_modifier_mappings} property
