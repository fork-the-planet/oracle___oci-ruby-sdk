...
module OCI
  ...
  class DisasterRecovery::Models::UpdateDrProtectionGroupMemberFileSystemDetails < DisasterRecovery::Models::UpdateDrProtectionGroupMemberDetails
    ...
    def hash
      [member_id, member_type, destination_availability_domain, export_mappings, destination_encryption_key, destination_snapshot_policy_id, destination_compartment_id].hash
    end
