...
module OCI
  ...
  class DisasterRecovery::DisasterRecoveryClientCompositeOperations
    ...
    # Calls {OCI::DisasterRecovery::DisasterRecoveryClient#create_automatic_dr_configuration} and then waits for the {OCI::DisasterRecovery::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DisasterRecovery::Models::CreateAutomaticDrConfigurationDetails] create_automatic_dr_configuration_details Details for creating the new Automatic DR configuration.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DisasterRecovery::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DisasterRecovery::DisasterRecoveryClient#create_automatic_dr_configuration}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DisasterRecovery::Models::WorkRequest}
    def create_automatic_dr_configuration_and_wait_for_state(create_automatic_dr_configuration_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_automatic_dr_configuration(create_automatic_dr_configuration_details, base_operation_opts)
      use_util = OCI::DisasterRecovery::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DisasterRecovery::DisasterRecoveryClient#delete_automatic_dr_configuration} and then waits for the {OCI::DisasterRecovery::Models::AutomaticDrConfiguration} acted upon
    # to enter the given state(s).
    #
    # @param [String] automatic_dr_configuration_id The OCID of the Automatic DR configuration.
    #
    #   Example: `ocid1.automaticDrConfiguration.oc1..uniqueID`
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DisasterRecovery::Models::AutomaticDrConfiguration#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DisasterRecovery::DisasterRecoveryClient#delete_automatic_dr_configuration}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type nil
    def delete_automatic_dr_configuration_and_wait_for_state(automatic_dr_configuration_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      initial_get_result = @service_client.get_automatic_dr_configuration(automatic_dr_configuration_id)
      operation_result = @service_client.delete_automatic_dr_configuration(automatic_dr_configuration_id, base_operation_opts)
    ...
    # Calls {OCI::DisasterRecovery::DisasterRecoveryClient#update_automatic_dr_configuration} and then waits for the {OCI::DisasterRecovery::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DisasterRecovery::Models::UpdateAutomaticDrConfigurationDetails] update_automatic_dr_configuration_details Details for updating the Automatic DR configuration.
    # @param [String] automatic_dr_configuration_id The OCID of the Automatic DR configuration.
    #
    #   Example: `ocid1.automaticDrConfiguration.oc1..uniqueID`
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DisasterRecovery::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DisasterRecovery::DisasterRecoveryClient#update_automatic_dr_configuration}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DisasterRecovery::Models::WorkRequest}
    def update_automatic_dr_configuration_and_wait_for_state(update_automatic_dr_configuration_details, automatic_dr_configuration_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_automatic_dr_configuration(update_automatic_dr_configuration_details, automatic_dr_configuration_id, base_operation_opts)
      use_util = OCI::DisasterRecovery::Util.respond_to?(:wait_on_work_request)
