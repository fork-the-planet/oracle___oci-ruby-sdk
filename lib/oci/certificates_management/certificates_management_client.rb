...
module OCI
  ...
  class CertificatesManagement::CertificatesManagementClient
    ...
    def list_certificate_authorities(opts = {})
      ...
      if opts[:lifecycle_state] && !%w[CREATING ACTIVE UPDATING DELETING DELETED SCHEDULING_DELETION PENDING_DELETION CANCELLING_DELETION FAILED PENDING_ACTIVATION].include?(opts[:lifecycle_state])
        raise 'Invalid value for "lifecycle_state", must be one of CREATING, ACTIVE, UPDATING, DELETING, DELETED, SCHEDULING_DELETION, PENDING_DELETION, CANCELLING_DELETION, FAILED, PENDING_ACTIVATION.'
      end
