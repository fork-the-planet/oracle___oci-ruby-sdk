...
module OCI
  ...
  class CertificatesManagement::Models::UpdateCertificateAuthorityActionDetails
    ACTION_TYPE_ENUM = [
      ACTION_TYPE_UPDATE_CERTIFICATE = 'UPDATE_CERTIFICATE'.freeze,
      ACTION_TYPE_GENERATE_CSR = 'GENERATE_CSR'.freeze
    ].freeze

    # **[Required]** The type of certificate authority (CA) update request. Updates can either involve initiating renewal of the CA by generating a new certificate signing request (CSR) or updating the signed certificate contents of the latest CA version containing a CSR.
    #
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CertificatesManagement::Models::UpdateCertificateAuthorityCertificateDetails' if type == 'UPDATE_CERTIFICATE'
      return 'OCI::CertificatesManagement::Models::UpdateCertificateAuthorityGenerateCsrDetails' if type == 'GENERATE_CSR'

      # TODO: Log a warning when the subtype is not found.
      'OCI::CertificatesManagement::Models::UpdateCertificateAuthorityActionDetails'
    end
