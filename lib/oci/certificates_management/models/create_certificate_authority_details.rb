...
module OCI
  ...
  class CertificatesManagement::Models::CreateCertificateAuthorityDetails
    ...
    def hash
      [name, description, compartment_id, certificate_authority_rules, certificate_authority_config, certificate_revocation_list_details, kms_key_id, external_key_description, freeform_tags, defined_tags].hash
    end
