...
module OCI
  ...
  #
  class CertificatesManagement::Models::CreateRootCaManagedExternallyConfigDetails < CertificatesManagement::Models::CreateCertificateAuthorityConfigDetails
    # **[Required]** The externally signed certificate (in PEM format) for the imported root CA.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['configType'] = 'ROOT_CA_MANAGED_EXTERNALLY'
    ...
    def hash
      [config_type, version_name, certificate_pem].hash
    end
