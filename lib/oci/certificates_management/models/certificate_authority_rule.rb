...
module OCI
  ...
  class CertificatesManagement::Models::CertificateAuthorityRule
    RULE_TYPE_ENUM = [
      ...
      RULE_TYPE_CERTIFICATE_AUTHORITY_ISSUANCE_RULE = 'CERTIFICATE_AUTHORITY_ISSUANCE_RULE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CertificatesManagement::Models::CertificateAuthorityIssuanceRule' if type == 'CERTIFICATE_AUTHORITY_ISSUANCE_RULE'
