...
module OCI
  ...
  class CertificatesManagement::Models::CertificateAuthority
    LIFECYCLE_STATE_ENUM = [
      ...
      LIFECYCLE_STATE_PENDING_ACTIVATION = 'PENDING_ACTIVATION'.freeze,
    ...
    CONFIG_TYPE_ENUM = [
      ...
      CONFIG_TYPE_ROOT_CA_MANAGED_EXTERNALLY = 'ROOT_CA_MANAGED_EXTERNALLY'.freeze,
      CONFIG_TYPE_SUBORDINATE_CA_MANAGED_INTERNALLY_ISSUED_BY_EXTERNAL_CA = 'SUBORDINATE_CA_MANAGED_INTERNALLY_ISSUED_BY_EXTERNAL_CA'.freeze,
    ...
    # @return [String]
    attr_accessor :external_key_description
    ...
    def self.attribute_map
      {
        ...
        'external_key_description': :'externalKeyDescription',
    ...
    # @option attributes [String] :external_key_description The value to assign to the {#external_key_description} property
    ...
    def initialize(attributes = {})
      ...
      self.external_key_description = attributes[:'externalKeyDescription'] if attributes[:'externalKeyDescription']
      self.external_key_description = "null" if external_key_description.nil? && !attributes.key?(:'externalKeyDescription') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :externalKeyDescription and :external_key_description' if attributes.key?(:'externalKeyDescription') && attributes.key?(:'external_key_description')

      self.external_key_description = attributes[:'external_key_description'] if attributes[:'external_key_description']
      self.external_key_description = "null" if external_key_description.nil? && !attributes.key?(:'externalKeyDescription') && !attributes.key?(:'external_key_description') # rubocop:disable Style/StringLiterals
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        external_key_description == other.external_key_description &&
    ...
    def hash
      [id, issuer_certificate_authority_id, name, description, external_key_description, time_created, time_of_deletion, kms_key_id, lifecycle_state, lifecycle_details, compartment_id, certificate_authority_rules, current_version, certificate_revocation_list_details, config_type, subject, signing_algorithm, freeform_tags, defined_tags].hash
    end
