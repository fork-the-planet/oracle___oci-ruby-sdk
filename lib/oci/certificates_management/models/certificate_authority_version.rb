...
module OCI
  ...
  class CertificatesManagement::Models::CertificateAuthorityVersion
    ...
    def initialize(attributes = {})
      ...
      self.csr_pem = "null" if csr_pem.nil? && !attributes.key?(:'csrPem') # rubocop:disable Style/StringLiterals
      ...
      self.csr_pem = "null" if csr_pem.nil? && !attributes.key?(:'csrPem') && !attributes.key?(:'csr_pem') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [certificate_authority_id, serial_number, time_created, version_number, issuer_ca_version_number, version_name, subject_alternative_names, time_of_deletion, validity, stages, revocation_status, csr_pem].hash
    end
