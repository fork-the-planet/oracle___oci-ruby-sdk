...
require 'date'
require_relative 'update_certificate_authority_action_details'
...
module OCI
  ...
  #
  class CertificatesManagement::Models::UpdateCertificateAuthorityCertificateDetails < CertificatesManagement::Models::UpdateCertificateAuthorityActionDetails
    # **[Required]** The externally signed certificate (in PEM format) for the subordinate certificate authority (CA).
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['actionType'] = 'UPDATE_CERTIFICATE'
    ...
    def hash
      [action_type, certificate_pem].hash
    end
