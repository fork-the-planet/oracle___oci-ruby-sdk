...
module OCI
  ...
  #
  class CertificatesManagement::Models::NameConstraintSubtreeNode
    TYPE_ENUM = [
      TYPE_DIRECTORY_NAME = 'DIRECTORY_NAME'.freeze,
      TYPE_DNS = 'DNS'.freeze,
      TYPE_IP = 'IP'.freeze,
      TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The type of name constraint.
    # @return [String]
    attr_reader :type

    # **[Required]** Name restrictions for the corresponding type of name constraint.
    #
    # @return [String]
    attr_accessor :value
