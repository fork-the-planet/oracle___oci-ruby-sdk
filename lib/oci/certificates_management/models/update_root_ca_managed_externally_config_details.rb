...
module OCI
  ...
  #
  class CertificatesManagement::Models::UpdateRootCaManagedExternallyConfigDetails < CertificatesManagement::Models::UpdateCertificateAuthorityConfigDetails
    # **[Required]** The externally signed certificate (in PEM format) for the CA.
    # @return [String]
    ...
    def hash
      [config_type, version_name, stage, certificate_pem].hash
    end
