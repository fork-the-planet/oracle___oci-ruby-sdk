...
module OCI
  ...
  #
  class CertificatesManagement::Models::CreateSubordinateCaManagedInternallyIssuedByExternalCaConfigDetails < CertificatesManagement::Models::CreateCertificateAuthorityConfigDetails
    ...
    def hash
      [config_type, version_name, issuer_certificate_authority_id, subject, signing_algorithm].hash
    end
