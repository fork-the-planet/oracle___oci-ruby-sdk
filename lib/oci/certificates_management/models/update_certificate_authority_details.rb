...
module OCI
  ...
  class CertificatesManagement::Models::UpdateCertificateAuthorityDetails
    ...
    def hash
      [description, current_version_number, certificate_authority_config, certificate_revocation_list_details, external_key_description, freeform_tags, defined_tags, certificate_authority_rules].hash
    end
