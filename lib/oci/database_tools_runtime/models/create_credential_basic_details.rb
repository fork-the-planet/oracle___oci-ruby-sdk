...
require 'date'
require_relative 'create_credential_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details for the Credential for the Basic type.
  class DatabaseToolsRuntime::Models::CreateCredentialBasicDetails < DatabaseToolsRuntime::Models::CreateCredentialDetails
    # **[Required]** The username for the new credential.
    # @return [String]
    attr_accessor :user_name

    # **[Required]** The password for the new credential.
    # @return [String]
    ...
    # @option attributes [String] :key The value to assign to the {OCI::DatabaseToolsRuntime::Models::CreateCredentialDetails#key #key} proprety
    ...
    def hash
      [type, key, user_name, password].hash
    end
