...
module OCI
  ...
  class DatabaseToolsRuntime::Models::ExecuteSqlResponseItemBatch
    STATEMENT_TYPE_ENUM = [
    ...
    # @return [Array<String>]
    attr_accessor :batch_statement_texts
    ...
    # @option attributes [Array<String>] :batch_statement_texts The value to assign to the {#batch_statement_texts} property
    ...
    def initialize(attributes = {})
      ...
      self.batch_statement_texts = attributes[:'batchStatementTexts'] if attributes[:'batchStatementTexts']

      raise 'You cannot provide both :batchStatementTexts and :batch_statement_texts' if attributes.key?(:'batchStatementTexts') && attributes.key?(:'batch_statement_texts')

      self.batch_statement_texts = attributes[:'batch_statement_texts'] if attributes[:'batch_statement_texts']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        batch_statement_texts == other.batch_statement_texts &&
        error == other.error &&
    ...
    def hash
      [statement_id, statement_type, statement_pos, batch_statement_texts, error, dbms_output, properties, responses, results].hash
    end
