...
module OCI
  ...
  class DatabaseToolsRuntime::Models::CreateDatabaseToolsDatabaseApiGatewayConfigPoolDetails
    TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the related Database Tools connection. Specifies the OCI database tools connection ocid to build the connection pool from.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseToolsRuntime::Models::CreateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails' if type == 'DEFAULT'
