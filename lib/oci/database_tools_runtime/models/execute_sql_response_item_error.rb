...
module OCI
  # Error details.
  class DatabaseToolsRuntime::Models::ExecuteSqlResponseItemError
    # Error code.
    # @return [Integer]
    ...
    # @option attributes [Integer] :error_line The value to assign to the {#error_line} property
    # @option attributes [Integer] :error_column The value to assign to the {#error_column} property
    ...
    def initialize(attributes = {})
      ...
      self.error_line = attributes[:'errorLine'] if attributes[:'errorLine']

      raise 'You cannot provide both :errorLine and :error_line' if attributes.key?(:'errorLine') && attributes.key?(:'error_line')

      self.error_line = attributes[:'error_line'] if attributes[:'error_line']

      self.error_column = attributes[:'errorColumn'] if attributes[:'errorColumn']

      raise 'You cannot provide both :errorColumn and :error_column' if attributes.key?(:'errorColumn') && attributes.key?(:'error_column')

      self.error_column = attributes[:'error_column'] if attributes[:'error_column']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        error_line == other.error_line &&
        error_column == other.error_column &&
    ...
    def hash
      [error_code, error_line, error_column, error_message, error_details].hash
    end
