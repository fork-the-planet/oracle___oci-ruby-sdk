...
module OCI
  ...
  class DatabaseToolsRuntime::Models::ValidateDatabaseToolsIdentityCredentialResult
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseToolsRuntime::Models::ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult' if type == 'ORACLE_DATABASE_RESOURCE_PRINCIPAL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseToolsRuntime::Models::ValidateDatabaseToolsIdentityCredentialResult'
    end
