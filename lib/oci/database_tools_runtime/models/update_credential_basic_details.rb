...
require 'date'
require_relative 'update_credential_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Credential information to be updated for the BASIC type.
  class DatabaseToolsRuntime::Models::UpdateCredentialBasicDetails < DatabaseToolsRuntime::Models::UpdateCredentialDetails
