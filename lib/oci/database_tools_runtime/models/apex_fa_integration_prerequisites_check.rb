...
module OCI
  ...
  class DatabaseToolsRuntime::Models::ApexFaIntegrationPrerequisitesCheck
    STATUS_ENUM = [
    ...
    # @option attributes [Array<String>] :status_details The value to assign to the {#status_details} property
