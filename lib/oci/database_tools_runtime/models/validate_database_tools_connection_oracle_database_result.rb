...
module OCI
  ...
  class DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionOracleDatabaseResult < DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionResult
    ...
    # @return [Array<OCI::DatabaseToolsRuntime::Models::ValidationIdentityStatus>]
    ...
    # @return [Array<OCI::DatabaseToolsRuntime::Models::ValidationExternalAuthenticationStatus>]
    ...
    # @option attributes [String] :code The value to assign to the {OCI::DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionResult#code #code} proprety
    # @option attributes [String] :message The value to assign to the {OCI::DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionResult#message #message} proprety
    # @option attributes [String] :cause The value to assign to the {OCI::DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionResult#cause #cause} proprety
    # @option attributes [String] :action The value to assign to the {OCI::DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionResult#action #action} proprety
    ...
    # @option attributes [Array<OCI::DatabaseToolsRuntime::Models::ValidationIdentityStatus>] :database_tools_identity_statuses The value to assign to the {#database_tools_identity_statuses} property
    ...
    # @option attributes [Array<OCI::DatabaseToolsRuntime::Models::ValidationExternalAuthenticationStatus>] :external_authentication_statuses The value to assign to the {#external_authentication_statuses} property
