...
module OCI
  ...
  class DatabaseToolsRuntime::Models::UpdatePropertySetApexDocumentGeneratorDetails < DatabaseToolsRuntime::Models::UpdatePropertySetDetails
    # The print server type
    # @return [String]
    attr_accessor :print_server_type
    ...
    # @return [String]
    attr_accessor :autonomous_database_resource_principal_status
