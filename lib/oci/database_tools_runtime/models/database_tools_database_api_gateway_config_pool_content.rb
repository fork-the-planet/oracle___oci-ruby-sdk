...
module OCI
  ...
  class DatabaseToolsRuntime::Models::DatabaseToolsDatabaseApiGatewayConfigPoolContent
    TYPE_ENUM = [
    ...
    # @return [Array<OCI::DatabaseToolsRuntime::Models::DatabaseToolsDatabaseApiGatewayConfigPoolApiSpec>]
    attr_accessor :api_specs

    # Array of Database Tools database API gateway config auto API spec items.
    # @return [Array<OCI::DatabaseToolsRuntime::Models::DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec>]
    attr_accessor :auto_api_specs
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseToolsRuntime::Models::DatabaseToolsDatabaseApiGatewayConfigPoolContentDefault' if type == 'DEFAULT'
    ...
    # @option attributes [Array<OCI::DatabaseToolsRuntime::Models::DatabaseToolsDatabaseApiGatewayConfigPoolApiSpec>] :api_specs The value to assign to the {#api_specs} property
    # @option attributes [Array<OCI::DatabaseToolsRuntime::Models::DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec>] :auto_api_specs The value to assign to the {#auto_api_specs} property
    ...
    def initialize(attributes = {})
      ...
      self.api_specs = attributes[:'apiSpecs'] if attributes[:'apiSpecs']

      raise 'You cannot provide both :apiSpecs and :api_specs' if attributes.key?(:'apiSpecs') && attributes.key?(:'api_specs')

      self.api_specs = attributes[:'api_specs'] if attributes[:'api_specs']

      self.auto_api_specs = attributes[:'autoApiSpecs'] if attributes[:'autoApiSpecs']

      raise 'You cannot provide both :autoApiSpecs and :auto_api_specs' if attributes.key?(:'autoApiSpecs') && attributes.key?(:'auto_api_specs')

      self.auto_api_specs = attributes[:'auto_api_specs'] if attributes[:'auto_api_specs']
    ...
    def database_actions_status=(database_actions_status)
      raise "Invalid value for 'database_actions_status': this must be one of the values in DATABASE_ACTIONS_STATUS_ENUM." if database_actions_status && !DATABASE_ACTIONS_STATUS_ENUM.include?(database_actions_status)
    ...
    def rest_enabled_sql_status=(rest_enabled_sql_status)
      raise "Invalid value for 'rest_enabled_sql_status': this must be one of the values in REST_ENABLED_SQL_STATUS_ENUM." if rest_enabled_sql_status && !REST_ENABLED_SQL_STATUS_ENUM.include?(rest_enabled_sql_status)
