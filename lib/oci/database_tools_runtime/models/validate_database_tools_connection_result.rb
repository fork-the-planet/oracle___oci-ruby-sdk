...
module OCI
  ...
  class DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionResult
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionOracleDatabaseResult' if type == 'ORACLE_DATABASE'
      return 'OCI::DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionMySqlResult' if type == 'MYSQL'
      return 'OCI::DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionPostgresqlResult' if type == 'POSTGRESQL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseToolsRuntime::Models::ValidateDatabaseToolsConnectionResult'
    end
