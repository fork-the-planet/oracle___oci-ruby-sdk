...
module OCI
  ...
  class DatabaseToolsRuntime::Models::ExecuteSqlInputStandardDetails < DatabaseToolsRuntime::Models::ExecuteSqlInputDetails
    ...
    def hash
      [type, statement_text, limit, offset, binds, response_format, properties].hash
    end
