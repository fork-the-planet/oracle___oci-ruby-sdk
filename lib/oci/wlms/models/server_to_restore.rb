...
module OCI
  ...
  #
  class Wlms::Models::ServerToRestore
    ...
    #
    # @return [Array<OCI::Wlms::Models::BackupToRestore>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'server_id': :'String',
        'backups': :'Array<OCI::Wlms::Models::BackupToRestore>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Wlms::Models::BackupToRestore>] :backups The value to assign to the {#backups} property
    def initialize(attributes = {})
      ...
      self.backups = attributes[:'backups'] if attributes[:'backups']
    end
