...
module OCI
  ...
  class Wlms::Models::BackupContent
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Wlms::Models::BinaryBackupContent' if type == 'BINARY'

      # TODO: Log a warning when the subtype is not found.
      'OCI::Wlms::Models::BackupContent'
    end
