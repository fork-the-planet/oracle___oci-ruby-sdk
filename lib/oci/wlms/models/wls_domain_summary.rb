...
module OCI
  ...
  #
  class Wlms::Models::WlsDomainSummary
    ...
    # **[Required]** The current state of the WebLogic domain.
    # @return [String]
    ...
    def hash
      [id, display_name, compartment_id, middleware_type, weblogic_version, patch_readiness_status, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
