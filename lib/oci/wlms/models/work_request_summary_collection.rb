...
module OCI
  ...
  #
  class Wlms::Models::WorkRequestSummaryCollection
    # **[Required]** A list of work requests.
    # @return [Array<OCI::Wlms::Models::WorkRequestSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Wlms::Models::WorkRequestSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Wlms::Models::WorkRequestSummary>] :items The value to assign to the {#items} property
