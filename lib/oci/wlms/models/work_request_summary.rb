...
module OCI
  ...
  #
  class Wlms::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Wlms::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Wlms::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Wlms::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
