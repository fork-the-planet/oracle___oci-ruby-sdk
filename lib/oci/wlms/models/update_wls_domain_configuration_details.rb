...
module OCI
  ...
  #
  class Wlms::Models::UpdateWlsDomainConfigurationDetails
    ...
    def admin_server_control_mode=(admin_server_control_mode)
      raise "Invalid value for 'admin_server_control_mode': this must be one of the values in ADMIN_SERVER_CONTROL_MODE_ENUM." if admin_server_control_mode && !ADMIN_SERVER_CONTROL_MODE_ENUM.include?(admin_server_control_mode)
    ...
    def managed_server_control_mode=(managed_server_control_mode)
      raise "Invalid value for 'managed_server_control_mode': this must be one of the values in MANAGED_SERVER_CONTROL_MODE_ENUM." if managed_server_control_mode && !MANAGED_SERVER_CONTROL_MODE_ENUM.include?(managed_server_control_mode)
