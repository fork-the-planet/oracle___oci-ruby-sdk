...
module OCI
  ...
  #
  class Wlms::Models::ApplicablePatchSummary
    ...
    # @option attributes [Array<String>] :middleware_type The value to assign to the {#middleware_type} property
    ...
    # @param [Object] middleware_type Object to be assigned
    def middleware_type=(middleware_type)
      # rubocop:disable Style/ConditionalAssignment
      if middleware_type.nil?
        @middleware_type = nil
      else
        @middleware_type =
          middleware_type.collect do |item|
            if MIDDLEWARE_TYPE_ENUM.include?(item)
              item
            else
              OCI.logger.debug("Unknown value for 'middleware_type' [#{item}]. Mapping to 'MIDDLEWARE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
              MIDDLEWARE_TYPE_UNKNOWN_ENUM_VALUE
            end
          end
      end
