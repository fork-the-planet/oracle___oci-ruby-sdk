...
module OCI
  ...
  #
  class Wlms::Models::BackupSummary
    TYPE_ENUM = [
    ...
    CONTENT_TYPE_ENUM = [
      CONTENT_TYPE_BINARY = 'BINARY'.freeze,
    ...
    # **[Required]** The location of the backup. For backups of type LOCAL_FILE this is the absolute path of the backup file.
    # @return [String]
    ...
    # @option attributes [String] :backup_location The value to assign to the {#backup_location} property
    ...
    def hash
      [id, type, managed_instance_id, backup_location, content_type, time_created].hash
    end
