...
module OCI
  ...
  #
  class Wlms::Models::ManagedInstance
    ...
    # **[Required]** The FQDN of the managed instance.
    # @return [String]
    attr_accessor :host_name

    # **[Required]** The number of servers running in the managed instance.
    # @return [Integer]
    attr_accessor :server_count

    # **[Required]** The plugin status of the managed instance.
    # @return [String]
    attr_accessor :plugin_status

    # **[Required]** The date and time the managed instance was first reported (in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) format).
    #
    ...
    # **[Required]** The date and time the managed instance was last report (in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) format).
    #
    # Example: `2016-08-25T21:10:29.600Z`
    #
    # @return [DateTime]
    ...
    # @return [OCI::Wlms::Models::ManagedInstanceConfiguration]
    ...
    def self.swagger_types
      {
        ...
        'os_name': :'String',
        'os_arch': :'String',
        'configuration': :'OCI::Wlms::Models::ManagedInstanceConfiguration'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Integer] :server_count The value to assign to the {#server_count} property
    ...
    # @option attributes [String] :os_arch The value to assign to the {#os_arch} property
    # @option attributes [OCI::Wlms::Models::ManagedInstanceConfiguration] :configuration The value to assign to the {#configuration} property
    ...
    def hash
      [id, display_name, compartment_id, host_name, server_count, plugin_status, time_created, time_updated, os_name, os_arch, configuration].hash
    end
