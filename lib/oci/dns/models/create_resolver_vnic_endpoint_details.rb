...
module OCI
  ...
  class Dns::Models::CreateResolverVnicEndpointDetails < Dns::Models::CreateResolverEndpointDetails
    ...
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::Dns::Models::CreateResolverEndpointDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::Dns::Models::CreateResolverEndpointDetails#defined_tags #defined_tags} proprety
    ...
    def hash
      [name, endpoint_type, forwarding_address, is_forwarding, is_listening, listening_address, freeform_tags, defined_tags, subnet_id, nsg_ids, security_attributes].hash
    end
