...
module OCI
  ...
  class Dns::Models::ResolverRule
    ...
    # **[Required]** A list of CIDR blocks. In order for the rule action to apply, the query must come from a client within one of
    # the CIDR blocks.
    #
    # @return [Array<String>]
    attr_accessor :client_address_conditions

    # **[Required]** A list of domain names. In order for the rule action to apply, the query must either match or be a subdomain
