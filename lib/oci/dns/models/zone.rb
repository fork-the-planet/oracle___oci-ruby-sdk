...
module OCI
  ...
  class Dns::Models::Zone
    ...
    RESOLUTION_MODE_ENUM = [
      ...
      RESOLUTION_MODE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # **[Required]** The resolution mode of a zone defines behavior related to how query responses can be handled. See [Private DNS Zone Transparency](https://docs.cloud.oracle.com/Content/DNS/Tasks/privatedns.htm#use-cases__resolution) for more information.
    #
    # @return [String]
    ...
    def resolution_mode=(resolution_mode)
      # rubocop:disable Style/ConditionalAssignment
      if resolution_mode && !RESOLUTION_MODE_ENUM.include?(resolution_mode)
        OCI.logger.debug("Unknown value for 'resolution_mode' [" + resolution_mode + "]. Mapping to 'RESOLUTION_MODE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @resolution_mode = RESOLUTION_MODE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [name, zone_type, compartment_id, view_id, scope, freeform_tags, defined_tags, resolution_mode, dnssec_state, external_masters, external_downstreams, self_uri, id, time_created, version, serial, lifecycle_state, is_protected, dnssec_config, nameservers, zone_transfer_servers].hash
    end
