...
module OCI
  ...
  class Dns::Models::ResolverEndpoint
    ...
    # **[Required]** The OCID of the resolver endpoint.
    # @return [String]
    attr_accessor :id
    ...
    # @option attributes [String] :resolver_id The value to assign to the {#resolver_id} property
    ...
    def initialize(attributes = {})
      ...
      self.resolver_id = attributes[:'resolverId'] if attributes[:'resolverId']

      raise 'You cannot provide both :resolverId and :resolver_id' if attributes.key?(:'resolverId') && attributes.key?(:'resolver_id')

      self.resolver_id = attributes[:'resolver_id'] if attributes[:'resolver_id']
    ...
    def hash
      [name, endpoint_type, forwarding_address, is_forwarding, is_listening, listening_address, id, resolver_id, compartment_id, time_created, time_updated, lifecycle_state, _self, freeform_tags, defined_tags].hash
    end
