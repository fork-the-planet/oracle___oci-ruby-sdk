...
module OCI
  ...
  class Dns::Models::UpdateResolverVnicEndpointDetails < Dns::Models::UpdateResolverEndpointDetails
    ...
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::Dns::Models::UpdateResolverEndpointDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::Dns::Models::UpdateResolverEndpointDetails#defined_tags #defined_tags} proprety
    ...
    def hash
      [endpoint_type, freeform_tags, defined_tags, nsg_ids, security_attributes].hash
    end
