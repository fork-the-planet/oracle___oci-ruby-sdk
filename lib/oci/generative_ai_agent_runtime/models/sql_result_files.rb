...
module OCI
  ...
  #
  class GenerativeAiAgentRuntime::Models::SqlResultFiles
    ...
    # @option attributes [String] :status_file The value to assign to the {#status_file} property
    ...
    def initialize(attributes = {})
      ...
      self.status_file = attributes[:'statusFile'] if attributes[:'statusFile']

      raise 'You cannot provide both :statusFile and :status_file' if attributes.key?(:'statusFile') && attributes.key?(:'status_file')

      self.status_file = attributes[:'status_file'] if attributes[:'status_file']
