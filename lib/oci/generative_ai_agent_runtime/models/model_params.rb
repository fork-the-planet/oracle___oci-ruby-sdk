...
module OCI
  ...
  class GenerativeAiAgentRuntime::Models::ModelParams
    ...
    def hash
      [max_tokens, temperature, top_p, top_k, frequency_penalty, presence_penalty, seed, reasoning_effort, verbosity].hash
    end
