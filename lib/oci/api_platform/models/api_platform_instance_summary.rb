...
module OCI
  ...
  class ApiPlatform::Models::ApiPlatformInstanceSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance
    # @return [String]
    attr_accessor :id

    # **[Required]** A regionally unique, non-changeable instance name provided by the user during creation
    # @return [String]
    attr_accessor :name
    ...
    def hash
      [id, name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
