...
module OCI
  ...
  class GenerativeAiInference::Models::CohereDocumentContentV2 < GenerativeAiInference::Models::CohereContentV2
    ...
    # @option attributes [Object] :document The value to assign to the {#document} property
