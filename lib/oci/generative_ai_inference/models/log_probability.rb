...
module OCI
  ...
  class GenerativeAiInference::Models::LogProbability
    ...
    # @return [Array<Float>]
    attr_accessor :log_probabilities
    ...
    # @option attributes [Array<Integer>] :token_ids The value to assign to the {#token_ids} property
    # @option attributes [String] :text The value to assign to the {#text} property
    # @option attributes [Array<Float>] :log_probabilities The value to assign to the {#log_probabilities} property
    def initialize(attributes = {})
      ...
      self.token_ids = attributes[:'tokenIds'] if attributes[:'tokenIds']

      raise 'You cannot provide both :tokenIds and :token_ids' if attributes.key?(:'tokenIds') && attributes.key?(:'token_ids')

      self.token_ids = attributes[:'token_ids'] if attributes[:'token_ids']
    ...
    def hash
      [token_ids, text, log_probabilities].hash
    end
