...
module OCI
  ...
  class GenerativeAiInference::Models::CohereChatResponseV2 < GenerativeAiInference::Models::BaseChatResponse
    FINISH_REASON_ENUM = [
    ...
    # @return [OCI::GenerativeAiInference::Models::CohereAssistantMessageV2]
    ...
    # @return [Array<OCI::GenerativeAiInference::Models::LogProbability>]
    ...
    # @option attributes [OCI::GenerativeAiInference::Models::CohereAssistantMessageV2] :message The value to assign to the {#message} property
    # @option attributes [String] :finish_reason The value to assign to the {#finish_reason} property
    # @option attributes [Array<OCI::GenerativeAiInference::Models::LogProbability>] :log_probabilities The value to assign to the {#log_probabilities} property
