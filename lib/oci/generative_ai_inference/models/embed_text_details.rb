...
module OCI
  ...
  class GenerativeAiInference::Models::EmbedTextDetails
    EMBEDDING_TYPES_ENUM = [
      EMBEDDING_TYPES_FLOAT = 'float'.freeze,
      EMBEDDING_TYPES_INT8 = 'int8'.freeze,
      EMBEDDING_TYPES_UINT8 = 'uint8'.freeze,
      EMBEDDING_TYPES_BINARY = 'binary'.freeze,
      EMBEDDING_TYPES_UBINARY = 'ubinary'.freeze,
      EMBEDDING_TYPES_BASE64 = 'base64'.freeze
    ].freeze
    ...
    #
    # @return [Array<OCI::GenerativeAiInference::Models::EmbedContent>]
    attr_accessor :embed_contents
    ...
    # @return [Integer]
    attr_accessor :output_dimensions
    ...
    # @option attributes [Array<OCI::GenerativeAiInference::Models::EmbedContent>] :embed_contents The value to assign to the {#embed_contents} property
    ...
    # @option attributes [Array<String>] :embedding_types The value to assign to the {#embedding_types} property
    # @option attributes [Integer] :output_dimensions The value to assign to the {#output_dimensions} property
    ...
    def initialize(attributes = {})
      ...
      self.embed_contents = attributes[:'embedContents'] if attributes[:'embedContents']

      raise 'You cannot provide both :embedContents and :embed_contents' if attributes.key?(:'embedContents') && attributes.key?(:'embed_contents')

      self.embed_contents = attributes[:'embed_contents'] if attributes[:'embed_contents']
      ...
      self.embedding_types = attributes[:'embeddingTypes'] if attributes[:'embeddingTypes']

      raise 'You cannot provide both :embeddingTypes and :embedding_types' if attributes.key?(:'embeddingTypes') && attributes.key?(:'embedding_types')

      self.embedding_types = attributes[:'embedding_types'] if attributes[:'embedding_types']

      self.output_dimensions = attributes[:'outputDimensions'] if attributes[:'outputDimensions']

      raise 'You cannot provide both :outputDimensions and :output_dimensions' if attributes.key?(:'outputDimensions') && attributes.key?(:'output_dimensions')

      self.output_dimensions = attributes[:'output_dimensions'] if attributes[:'output_dimensions']
    ...
    # @param [Object] embedding_types Object to be assigned
    def embedding_types=(embedding_types)
      # rubocop:disable Style/ConditionalAssignment
      if embedding_types.nil?
        @embedding_types = nil
      else
        embedding_types.each do |item|
          raise "Invalid value for 'embedding_types': this must be one of the values in EMBEDDING_TYPES_ENUM." unless EMBEDDING_TYPES_ENUM.include?(item)
        end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        inputs == other.inputs &&
        embed_contents == other.embed_contents &&
        serving_mode == other.serving_mode &&
        compartment_id == other.compartment_id &&
        is_echo == other.is_echo &&
        embedding_types == other.embedding_types &&
        output_dimensions == other.output_dimensions &&
    ...
    def hash
      [inputs, embed_contents, serving_mode, compartment_id, is_echo, embedding_types, output_dimensions, truncate, input_type].hash
    end
