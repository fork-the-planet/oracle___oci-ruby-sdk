...
module OCI
  ...
  class GenerativeAiInference::GenerativeAiInferenceClient
    ...
    def region=(new_region)
      ...
      @endpoint = OCI::Regions.get_service_endpoint_for_template(@region, 'https://inference.generativeai.{region}.{dualStack?ds.:}oci.{secondLevelDomain}', 'inference.generativeai') + '/20231130'
    ...
    #
    # @param [OCI::GenerativeAiInference::Models::ApplyGuardrailsDetails] apply_guardrails_details Details for applying guardrails to the input content.
    ...
    #
    # @param [String] opc_compartment_id The client compartment ID.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @option opts [String] :state A filter to return only the guardrail versions whose state matches the given value.
    ...
    #   [List Pagination](https://docs.cloud.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    #
    # @return [Response] A Response object with data of type {OCI::GenerativeAiInference::Models::GuardrailVersionCollection GuardrailVersionCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/generativeaiinference/list_guardrail_versions.rb.html) to see an example of how to use list_guardrail_versions API.
    def list_guardrail_versions(opc_compartment_id, opts = {})
      logger.debug 'Calling operation GenerativeAiInferenceClient#list_guardrail_versions.' if logger

      raise "Missing the required parameter 'opc_compartment_id' when calling list_guardrail_versions." if opc_compartment_id.nil?

      if opts[:state] && !OCI::GenerativeAiInference::Models::GuardrailVersion::STATE_ENUM.include?(opts[:state])
        raise 'Invalid value for "state", must be one of the values in OCI::GenerativeAiInference::Models::GuardrailVersion::STATE_ENUM.'
      end
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'GenerativeAiInferenceClient#list_guardrail_versions') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::GenerativeAiInference::Models::GuardrailVersionCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
