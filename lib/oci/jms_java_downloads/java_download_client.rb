...
module OCI
  ...
  class JmsJavaDownloads::JavaDownloadClient
    ...
    def region=(new_region)
      ...
      @endpoint = OCI::Regions.get_service_endpoint_for_template(@region, 'https://{dualStack?download.javamanagement:javamanagementservice-download}.{region}.{dualStack?ds.:}oci.{secondLevelDomain}', 'download.javamanagement') + '/'
