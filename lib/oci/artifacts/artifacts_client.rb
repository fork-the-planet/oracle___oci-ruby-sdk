...
module OCI
  ...
  class Artifacts::ArtifactsClient
    ...
    # @param [OCI::Artifacts::Models::LookupContainerImageByUriDetails] lookup_container_image_by_uri_details Get container image metadata by URI.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique identifier for the request.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Artifacts::Models::ContainerImage ContainerImage}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/artifacts/lookup_container_image_by_uri.rb.html) to see an example of how to use lookup_container_image_by_uri API.
    def lookup_container_image_by_uri(lookup_container_image_by_uri_details, opts = {})
      logger.debug 'Calling operation ArtifactsClient#lookup_container_image_by_uri.' if logger

      raise "Missing the required parameter 'lookup_container_image_by_uri_details' when calling lookup_container_image_by_uri." if lookup_container_image_by_uri_details.nil?
      ...
      post_body = @api_client.object_to_http_body(lookup_container_image_by_uri_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ArtifactsClient#lookup_container_image_by_uri') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
