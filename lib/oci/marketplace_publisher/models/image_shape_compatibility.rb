...
module OCI
  ...
  class MarketplacePublisher::Models::ImageShapeCompatibility
    # **[Required]** Name of the shape.
    # @return [String]
    attr_accessor :shape

    # @return [OCI::MarketplacePublisher::Models::ImageMemoryConstraints]
    attr_accessor :memory_constraints

    # @return [OCI::MarketplacePublisher::Models::ImageOcpuConstraints]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'shape': :'String',
        'memory_constraints': :'OCI::MarketplacePublisher::Models::ImageMemoryConstraints',
        'ocpu_constraints': :'OCI::MarketplacePublisher::Models::ImageOcpuConstraints'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::MarketplacePublisher::Models::ImageMemoryConstraints] :memory_constraints The value to assign to the {#memory_constraints} property
    # @option attributes [OCI::MarketplacePublisher::Models::ImageOcpuConstraints] :ocpu_constraints The value to assign to the {#ocpu_constraints} property
    ...
    def hash
      [shape, memory_constraints, ocpu_constraints].hash
    end
