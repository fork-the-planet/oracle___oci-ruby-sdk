...
module OCI
  ...
  class MarketplacePublisher::Models::ReviewSupportDocumentAttachment < MarketplacePublisher::Models::ListingRevisionAttachment
    # **[Required]** Name of the review support document
    # @return [String]
    attr_accessor :document_name

    # **[Required]** Template code for the uploaded document
    # @return [String]
    ...
    # @option attributes [String] :document_name The value to assign to the {#document_name} property
    # @option attributes [String] :template_code The value to assign to the {#template_code} property
    ...
    def initialize(attributes = {})
      ...
      attributes['attachmentType'] = 'REVIEW_SUPPORT_DOCUMENT'
      ...
      self.document_name = attributes[:'documentName'] if attributes[:'documentName']

      raise 'You cannot provide both :documentName and :document_name' if attributes.key?(:'documentName') && attributes.key?(:'document_name')

      self.document_name = attributes[:'document_name'] if attributes[:'document_name']

      self.template_code = attributes[:'templateCode'] if attributes[:'templateCode']

      raise 'You cannot provide both :templateCode and :template_code' if attributes.key?(:'templateCode') && attributes.key?(:'template_code')

      self.template_code = attributes[:'template_code'] if attributes[:'template_code']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        document_name == other.document_name &&
    ...
    def hash
      [id, compartment_id, listing_revision_id, display_name, description, attachment_type, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, system_tags, document_name, template_code, content_url, mime_type].hash
    end
