...
module OCI
  ...
  class MarketplacePublisher::Models::Artifact
    ARTIFACT_TYPE_ENUM = [
      ...
      ARTIFACT_TYPE_MACHINE_IMAGE = 'MACHINE_IMAGE'.freeze,
      ARTIFACT_TYPE_STACK = 'STACK'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::MarketplacePublisher::Models::MachineImageArtifact' if type == 'MACHINE_IMAGE'
      return 'OCI::MarketplacePublisher::Models::StackArtifact' if type == 'STACK'
