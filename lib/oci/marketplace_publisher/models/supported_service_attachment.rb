...
module OCI
  ...
  class MarketplacePublisher::Models::SupportedServiceAttachment < MarketplacePublisher::Models::ListingRevisionAttachment
    TYPE_ENUM = [
      TYPE_IMPLEMENTATION_SERVICE = 'IMPLEMENTATION_SERVICE'.freeze,
      TYPE_CONSULTING_SERVICE = 'CONSULTING_SERVICE'.freeze,
      TYPE_APP_DEVELOPMENT_SERVICE = 'APP_DEVELOPMENT_SERVICE'.freeze,
      TYPE_MANAGED_SERVICE = 'MANAGED_SERVICE'.freeze,
    ...
    def initialize(attributes = {})
      ...
      attributes['attachmentType'] = 'SUPPORTED_SERVICES'
    ...
    def hash
      [id, compartment_id, listing_revision_id, display_name, description, attachment_type, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, system_tags, service_name, url, type, content_url, mime_type].hash
    end
