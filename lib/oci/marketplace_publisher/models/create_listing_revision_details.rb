...
module OCI
  ...
  class MarketplacePublisher::Models::CreateListingRevisionDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::MarketplacePublisher::Models::CreateOciListingRevisionDetails' if type == 'OCI_APPLICATION'
      return 'OCI::MarketplacePublisher::Models::CreateServiceListingRevisionDetails' if type == 'SERVICE'
      return 'OCI::MarketplacePublisher::Models::CreateLeadGenListingRevisionDetails' if type == 'LEAD_GENERATION'
    ...
    def hash
      [display_name, listing_id, listing_type, headline, tagline, keywords, short_description, usage_information, long_description, content_language, supportedlanguages, support_contacts, support_links, status, freeform_tags, defined_tags].hash
    end
