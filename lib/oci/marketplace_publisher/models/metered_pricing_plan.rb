...
module OCI
  ...
  #
  class MarketplacePublisher::Models::MeteredPricingPlan < MarketplacePublisher::Models::PricingPlan
    NAME_ENUM = [
      NAME_PER_INSTANCE = 'PER_INSTANCE'.freeze,
      NAME_PER_OCPU_MIN_BILLING_HRS = 'PER_OCPU_MIN_BILLING_HRS'.freeze,
      NAME_PER_OCPU_LINEAR = 'PER_OCPU_LINEAR'.freeze,
      NAME_PER_INSTANCE_MONTHLY_INCLUSIVE = 'PER_INSTANCE_MONTHLY_INCLUSIVE'.freeze,
      NAME_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The listing's pricing plan name.
    # @return [String]
    attr_reader :name
    ...
    def hash
      [plan_type, rates, name, extended_metadata].hash
    end
