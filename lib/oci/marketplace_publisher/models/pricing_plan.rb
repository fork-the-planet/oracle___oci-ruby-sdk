...
module OCI
  ...
  class MarketplacePublisher::Models::PricingPlan
    PLAN_TYPE_ENUM = [
      PLAN_TYPE_METERED = 'METERED'.freeze,
      PLAN_TYPE_FIXED = 'FIXED'.freeze,
      PLAN_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The listing's pricing plan type.
    # @return [String]
    attr_reader :plan_type

    # **[Required]** List of pricing rates provider by publisher.
    # @return [Array<OCI::MarketplacePublisher::Models::PricingRate>]
    attr_accessor :rates
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'planType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::MarketplacePublisher::Models::MeteredPricingPlan' if type == 'METERED'
      return 'OCI::MarketplacePublisher::Models::SaaSPricingPlan' if type == 'FIXED'

      # TODO: Log a warning when the subtype is not found.
      'OCI::MarketplacePublisher::Models::PricingPlan'
    end
    ...
    # @option attributes [Array<OCI::MarketplacePublisher::Models::PricingRate>] :rates The value to assign to the {#rates} property
