...
module OCI
  ...
  class MarketplacePublisher::Models::AvailableServiceSummary
    # @return [OCI::MarketplacePublisher::Models::ListingRevisionIconAttachment]
    attr_accessor :icon

    # **[Required]** Listing Id for the listing
    # @return [String]
    ...
    def hash
      [icon, listing_id, display_name, short_description, tagline].hash
    end
