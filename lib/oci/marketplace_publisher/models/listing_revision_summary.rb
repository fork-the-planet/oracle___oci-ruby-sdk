...
module OCI
  ...
  class MarketplacePublisher::Models::ListingRevisionSummary
    ...
    def hash
      [id, listing_id, compartment_id, listing_type, display_name, status, lifecycle_state, package_type, short_description, tagline, icon, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
