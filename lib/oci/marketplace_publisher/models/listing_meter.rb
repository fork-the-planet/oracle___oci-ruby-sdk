...
module OCI
  ...
  class MarketplacePublisher::Models::ListingMeter
    # **[Required]** The meter name, ex - MP_BOBO_AP.
    # @return [String]
    attr_accessor :name

    # **[Required]** rate allocation, these are calculated based on rate information at parent part/sku and listing revision.
    # @return [Float]
    attr_accessor :rate_allocation

    # **[Required]** Additional metadata key/value pairs for the listing meter.
    #
    # For example:
    #
