...
module OCI
  ...
  class MarketplacePublisher::Models::ListingRevisionAttachment
    ATTACHMENT_TYPE_ENUM = [
      ...
      ATTACHMENT_TYPE_REVIEW_SUPPORT_DOCUMENT = 'REVIEW_SUPPORT_DOCUMENT'.freeze,
      ATTACHMENT_TYPE_CUSTOMER_SUCCESS = 'CUSTOMER_SUCCESS'.freeze,
      ATTACHMENT_TYPE_SUPPORTED_SERVICES = 'SUPPORTED_SERVICES'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::MarketplacePublisher::Models::ReviewSupportDocumentAttachment' if type == 'REVIEW_SUPPORT_DOCUMENT'
      return 'OCI::MarketplacePublisher::Models::SupportedServiceAttachment' if type == 'SUPPORTED_SERVICES'
      return 'OCI::MarketplacePublisher::Models::VideoAttachment' if type == 'VIDEO'
      return 'OCI::MarketplacePublisher::Models::CustomerSuccessAttachment' if type == 'CUSTOMER_SUCCESS'
