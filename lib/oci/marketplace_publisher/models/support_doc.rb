...
module OCI
  ...
  class MarketplacePublisher::Models::SupportDoc
    ...
    # **[Required]** The name for the supportDoc.
    # @return [String]
    attr_accessor :name

    # **[Required]** The code for the supportDoc.
    # @return [String]
    attr_accessor :code

    # **[Required]** The supportDoc group for the supportDoc.
    # @return [String]
    attr_accessor :support_doc_group
    ...
    # **[Required]** The current state for the supportDoc.
    # @return [String]
    attr_reader :lifecycle_state

    # **[Required]** The date and time the supportDoc was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # **[Required]** The date and time the supportDoc was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    #
    # Example: `2022-09-15T21:10:29.600Z`
    #
    # @return [DateTime]
    ...
    # @option attributes [String] :support_doc_group The value to assign to the {#support_doc_group} property
    ...
    def initialize(attributes = {})
      ...
      self.support_doc_group = attributes[:'supportDocGroup'] if attributes[:'supportDocGroup']

      raise 'You cannot provide both :supportDocGroup and :support_doc_group' if attributes.key?(:'supportDocGroup') && attributes.key?(:'support_doc_group')

      self.support_doc_group = attributes[:'support_doc_group'] if attributes[:'support_doc_group']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        name == other.name &&
        code == other.code &&
        support_doc_group == other.support_doc_group &&
    ...
    def hash
      [name, code, support_doc_group, description, content_url, mime_type, file_name, lifecycle_state, time_created, time_updated].hash
    end
