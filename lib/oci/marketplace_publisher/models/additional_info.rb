...
module OCI
  ...
  class MarketplacePublisher::Models::AdditionalInfo
    # The company name
    # @return [String]
    ...
    # @option attributes [String] :company The value to assign to the {#company} property
    # @option attributes [String] :company_address The value to assign to the {#company_address} property
    ...
    def initialize(attributes = {})
      ...
      self.company = attributes[:'company'] if attributes[:'company']

      self.company_address = attributes[:'companyAddress'] if attributes[:'companyAddress']

      raise 'You cannot provide both :companyAddress and :company_address' if attributes.key?(:'companyAddress') && attributes.key?(:'company_address')

      self.company_address = attributes[:'company_address'] if attributes[:'company_address']
    ...
    def hash
      [company, company_address, email, first_name, last_name, phone, notes].hash
    end
