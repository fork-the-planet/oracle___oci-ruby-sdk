...
module OCI
  ...
  class MarketplacePublisher::MarketplacePublisherClientCompositeOperations
    ...
    # Calls {OCI::MarketplacePublisher::MarketplacePublisherClient#change_artifact_compartment} and then waits for the {OCI::MarketplacePublisher::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::MarketplacePublisher::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::MarketplacePublisher::MarketplacePublisherClient#change_artifact_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::MarketplacePublisher::Models::WorkRequest}
    def change_artifact_compartment_and_wait_for_state(artifact_id, change_artifact_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_artifact_compartment(artifact_id, change_artifact_compartment_details, base_operation_opts)
      use_util = OCI::MarketplacePublisher::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::MarketplacePublisher::MarketplacePublisherClient#change_listing_compartment} and then waits for the {OCI::MarketplacePublisher::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] listing_id listing OCID
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::MarketplacePublisher::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::MarketplacePublisher::MarketplacePublisherClient#change_listing_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::MarketplacePublisher::Models::WorkRequest}
    def change_listing_compartment_and_wait_for_state(listing_id, change_listing_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_listing_compartment(listing_id, change_listing_compartment_details, base_operation_opts)
      use_util = OCI::MarketplacePublisher::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::MarketplacePublisher::MarketplacePublisherClient#change_term_compartment} and then waits for the {OCI::MarketplacePublisher::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::MarketplacePublisher::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::MarketplacePublisher::MarketplacePublisherClient#change_term_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::MarketplacePublisher::Models::WorkRequest}
    def change_term_compartment_and_wait_for_state(term_id, change_term_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_term_compartment(term_id, change_term_compartment_details, base_operation_opts)
      use_util = OCI::MarketplacePublisher::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::MarketplacePublisher::MarketplacePublisherClient#update_listing_revision_note} and then waits for the {OCI::MarketplacePublisher::Models::ListingRevisionNote} acted upon
    # to enter the given state(s).
    #
    # @param [String] listing_revision_note_id Unique listing revision note identifier.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::MarketplacePublisher::Models::ListingRevisionNote#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::MarketplacePublisher::MarketplacePublisherClient#update_listing_revision_note}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::MarketplacePublisher::Models::ListingRevisionNote}
    def update_listing_revision_note_and_wait_for_state(listing_revision_note_id, update_listing_revision_note_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_listing_revision_note(listing_revision_note_id, update_listing_revision_note_details, base_operation_opts)
