...
module OCI
  ...
  class FleetSoftwareUpdate::Models::SoftwareComponentDiscoveryDetails
    COMPONENT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::GuestOsSoftwareComponentDiscoveryDetails' if type == 'GUEST_OS'
      return 'OCI::FleetSoftwareUpdate::Models::GiSoftwareComponentDiscoveryDetails' if type == 'GI'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetSoftwareUpdate::Models::SoftwareComponentDiscoveryDetails'
    end
