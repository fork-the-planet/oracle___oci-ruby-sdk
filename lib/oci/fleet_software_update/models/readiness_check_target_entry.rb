...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::ReadinessCheckTargetEntry
    ENTITY_TYPE_ENUM = [
    ...
    # **[Required]** Resource identifier [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)
    #
    # @return [String]
