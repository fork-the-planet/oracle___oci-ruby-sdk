...
module OCI
  ...
  class FleetSoftwareUpdate::Models::SoftwareComponentSummary
    COMPONENT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::GuestOsSoftwareComponentSummary' if type == 'GUEST_OS'
      return 'OCI::FleetSoftwareUpdate::Models::GiSoftwareComponentSummary' if type == 'GI'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetSoftwareUpdate::Models::SoftwareComponentSummary'
    end
