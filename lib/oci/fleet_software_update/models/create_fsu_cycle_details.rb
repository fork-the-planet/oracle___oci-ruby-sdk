...
module OCI
  ...
  class FleetSoftwareUpdate::Models::CreateFsuCycleDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata Fleet Update Collection which will be updated by the Exadata Fleet Update Cycle being created.
    #
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::CreateUpgradeFsuCycle' if type == 'UPGRADE'
