...
module OCI
  ...
  class FleetSoftwareUpdate::Models::SoftwareComponentDetails
    COMPONENT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::GiSoftwareComponentDetails' if type == 'GI'
      return 'OCI::FleetSoftwareUpdate::Models::GuestOsSoftwareComponentDetails' if type == 'GUEST_OS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetSoftwareUpdate::Models::SoftwareComponentDetails'
    end
