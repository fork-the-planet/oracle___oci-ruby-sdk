...
module OCI
  ...
  class FleetSoftwareUpdate::Models::UpgradeDetails
    ...
    # **[Required]** Type of Exadata Fleet Update collection being upgraded.
    #
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'collectionType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::FleetSoftwareUpdate::Models::UpgradeDbCollectionDetails' if type == 'DB'
      return 'OCI::FleetSoftwareUpdate::Models::UpgradeGiCollectionDetails' if type == 'GI'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetSoftwareUpdate::Models::UpgradeDetails'
    end
