...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::CreateUpgradeFsuCycle < FleetSoftwareUpdate::Models::CreateFsuCycleDetails
    # @return [OCI::FleetSoftwareUpdate::Models::UpgradeDetails]
    ...
    def self.swagger_types
      {
        ...
        'upgrade_details': :'OCI::FleetSoftwareUpdate::Models::UpgradeDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::UpgradeDetails] :upgrade_details The value to assign to the {#upgrade_details} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'UPGRADE'
      ...
      self.upgrade_details = attributes[:'upgradeDetails'] if attributes[:'upgradeDetails']

      raise 'You cannot provide both :upgradeDetails and :upgrade_details' if attributes.key?(:'upgradeDetails') && attributes.key?(:'upgrade_details')

      self.upgrade_details = attributes[:'upgrade_details'] if attributes[:'upgrade_details']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        upgrade_details == other.upgrade_details
    end
    ...
    def hash
      [display_name, compartment_id, type, fsu_collection_id, goal_version_details, batching_strategy, stage_action_schedule, apply_action_schedule, diagnostics_collection, freeform_tags, defined_tags, upgrade_details].hash
    end
