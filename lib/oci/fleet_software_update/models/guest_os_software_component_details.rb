...
require 'date'
require 'logger'
require_relative 'software_component_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details of 'GUEST_OS' component in an Exadata software stack.
  #
  class FleetSoftwareUpdate::Models::GuestOsSoftwareComponentDetails < FleetSoftwareUpdate::Models::SoftwareComponentDetails
