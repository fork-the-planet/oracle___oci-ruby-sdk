...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::GiSoftwareComponentDiscoveryDetails < FleetSoftwareUpdate::Models::SoftwareComponentDiscoveryDetails
    SOURCE_MAJOR_VERSION_ENUM = [
      ...
      SOURCE_MAJOR_VERSION_GI_26 = 'GI_26'.freeze
    ].freeze
