...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::PatchingIssueEntry
    # **[Required]** Name of the patching issue.
    #
    # @return [String]
    attr_accessor :name

    # **[Required]** Description of the patching issue.
    #
    # @return [String]
    attr_accessor :description

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the resource impacted by the patching issue.
    #
    # @return [String]
    ...
    def hash
      [name, description, impacted_resource_id, recommended_action].hash
    end
