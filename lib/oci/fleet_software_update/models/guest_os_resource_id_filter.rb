...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::GuestOsResourceIdFilter < FleetSoftwareUpdate::Models::GuestOsFleetDiscoveryFilter
    ENTITY_TYPE_ENUM = [
    ...
    # **[Required]** Type of associated resource.
    #
    # @return [String]
    attr_reader :entity_type

    # **[Required]** The [OCIDs](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of associated resources to include when discovering Exadata VM Cluster targets for a 'GUEST_OS' collection.
