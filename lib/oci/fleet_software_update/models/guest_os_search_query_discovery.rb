...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::GuestOsSearchQueryDiscovery < FleetSoftwareUpdate::Models::GuestOsFleetDiscoveryDetails
    # **[Required]** [OCI Search Service](https://docs.cloud.oracle.com/Content/Search/Concepts/queryoverview.htm) query string.
    #
    # @return [String]
    attr_accessor :query
