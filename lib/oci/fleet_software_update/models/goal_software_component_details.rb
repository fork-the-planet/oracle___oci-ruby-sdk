...
module OCI
  ...
  class FleetSoftwareUpdate::Models::GoalSoftwareComponentDetails
    COMPONENT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::GuestOsGoalSoftwareComponentDetails' if type == 'GUEST_OS'
      return 'OCI::FleetSoftwareUpdate::Models::GiGoalSoftwareComponentDetails' if type == 'GI'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetSoftwareUpdate::Models::GoalSoftwareComponentDetails'
    end
