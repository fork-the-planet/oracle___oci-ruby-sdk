...
module OCI
  ...
  class FleetSoftwareUpdate::Models::GuestOsFleetDiscoveryFilter
    TYPE_ENUM = [
      TYPE_COMPARTMENT_ID = 'COMPARTMENT_ID'.freeze,
      TYPE_VERSION = 'VERSION'.freeze,
      TYPE_EXADATA_RELEASE_VERSION = 'EXADATA_RELEASE_VERSION'.freeze,
    ...
    # **[Required]** Filters supported for searching Exadata VM Cluster targets for a 'GUEST_OS' collection.
    #
    # @return [String]
    attr_reader :type
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::GuestOsVersionFilter' if type == 'VERSION'
      return 'OCI::FleetSoftwareUpdate::Models::GuestOsExadataReleaseVersionFilter' if type == 'EXADATA_RELEASE_VERSION'
      return 'OCI::FleetSoftwareUpdate::Models::GuestOsFreeformTagsFilter' if type == 'FREEFORM_TAG'
      return 'OCI::FleetSoftwareUpdate::Models::GuestOsDefinedTagsFilter' if type == 'DEFINED_TAG'
      return 'OCI::FleetSoftwareUpdate::Models::GuestOsCompartmentIdFilter' if type == 'COMPARTMENT_ID'
      return 'OCI::FleetSoftwareUpdate::Models::GuestOsResourceIdFilter' if type == 'RESOURCE_ID'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetSoftwareUpdate::Models::GuestOsFleetDiscoveryFilter'
    end
