...
module OCI
  ...
  class FleetSoftwareUpdate::Models::TargetSummary
    ...
    #
    # @return [Array<OCI::FleetSoftwareUpdate::Models::MembershipSummary>]
    ...
    # @option attributes [Array<OCI::FleetSoftwareUpdate::Models::MembershipSummary>] :memberships The value to assign to the {#memberships} property
    def initialize(attributes = {})
      ...
      self.memberships = attributes[:'memberships'] if attributes[:'memberships']
    end
    ...
    def hash
      [target, current_version, status, executing_fsu_job_id, active_fsu_cycle_id, progress, memberships].hash
    end
