...
require 'date'
require_relative 'software_component_discovery_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Discovery filter details of 'GUEST_OS' component in an Exadata software stack.
  #
  class FleetSoftwareUpdate::Models::GuestOsSoftwareComponentDiscoveryDetails < FleetSoftwareUpdate::Models::SoftwareComponentDiscoveryDetails
    ...
    # **[Required]** Major version of Exadata Image (Guest OS) release for Exadata VM Cluster targets to be included in the results for an Exadata Fleet Update Discovery.
    ...
    def self.swagger_types
      {
        ...
        'criteria': :'OCI::FleetSoftwareUpdate::Models::GuestOsFleetDiscoveryDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::GuestOsFleetDiscoveryDetails] :criteria The value to assign to the {#criteria} property
    ...
    def hash
      [component_type, source_major_version, criteria].hash
    end
