...
module OCI
  ...
  class FleetSoftwareUpdate::Models::FsuGoalVersionDetails
    TYPE_ENUM = [
      ...
      TYPE_EXADB_STACK = 'EXADB_STACK'.freeze,
    ...
    # **[Required]** Type of goal version specified
    #
    # @return [String]
    attr_reader :type
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::ExadbStackFsuGoalVersionDetails' if type == 'EXADB_STACK'
