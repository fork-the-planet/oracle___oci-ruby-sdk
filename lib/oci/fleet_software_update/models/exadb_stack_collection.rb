...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::ExadbStackCollection < FleetSoftwareUpdate::Models::FsuCollection
    # **[Required]** Details of components in an Exadata software stack.
    #
    # @return [Array<OCI::FleetSoftwareUpdate::Models::SoftwareComponentDetails>]
    ...
    def self.swagger_types
      {
        ...
        'components': :'Array<OCI::FleetSoftwareUpdate::Models::SoftwareComponentDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::FleetSoftwareUpdate::Models::SoftwareComponentDetails>] :components The value to assign to the {#components} property
