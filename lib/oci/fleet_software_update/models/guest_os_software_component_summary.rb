...
require 'date'
require 'logger'
require_relative 'software_component_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Summary of 'GUEST_OS' component in Exadata software stack.
  #
  class FleetSoftwareUpdate::Models::GuestOsSoftwareComponentSummary < FleetSoftwareUpdate::Models::SoftwareComponentSummary
    ...
    def hash
      [component_type, source_major_version].hash
    end
