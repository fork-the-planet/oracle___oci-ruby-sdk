...
require 'date'
require_relative 'create_software_component_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details to create 'GUEST_OS' component in an Exadata software stack.
  #
  class FleetSoftwareUpdate::Models::CreateGuestOsSoftwareComponentDetails < FleetSoftwareUpdate::Models::CreateSoftwareComponentDetails
    SOURCE_MAJOR_VERSION_ENUM = [
      SOURCE_MAJOR_VERSION_EXA_OL_5 = 'EXA_OL_5'.freeze,
      SOURCE_MAJOR_VERSION_EXA_OL_6 = 'EXA_OL_6'.freeze,
      SOURCE_MAJOR_VERSION_EXA_OL_7 = 'EXA_OL_7'.freeze,
      SOURCE_MAJOR_VERSION_EXA_OL_8 = 'EXA_OL_8'.freeze
    ].freeze

    # **[Required]** Major version of Exadata Image (Guest OS) release for Exadata VM Cluster targets to be included in an Exadata Fleet Update Collection.
    ...
    # @return [OCI::FleetSoftwareUpdate::Models::GuestOsFleetDiscoveryDetails]
    ...
    def self.swagger_types
      {
        ...
        'fleet_discovery': :'OCI::FleetSoftwareUpdate::Models::GuestOsFleetDiscoveryDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::GuestOsFleetDiscoveryDetails] :fleet_discovery The value to assign to the {#fleet_discovery} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['componentType'] = 'GUEST_OS'
    ...
    def hash
      [component_type, source_major_version, fleet_discovery].hash
    end
