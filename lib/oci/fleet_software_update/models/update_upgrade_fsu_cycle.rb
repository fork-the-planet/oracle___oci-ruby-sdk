...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::UpdateUpgradeFsuCycle < FleetSoftwareUpdate::Models::UpdateFsuCycleDetails
    ...
    def hash
      [display_name, type, goal_version_details, batching_strategy, diagnostics_collection, freeform_tags, defined_tags, upgrade_details].hash
    end
