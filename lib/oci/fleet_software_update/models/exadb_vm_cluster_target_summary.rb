...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::ExadbVmClusterTargetSummary < FleetSoftwareUpdate::Models::TargetDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['entityType'] = 'EXADBVMCLUSTER'
    ...
    def hash
      [entity_type, id, compartment_id, exascale_db_storage_vault_id, software_image_id, system_version].hash
    end
