...
module OCI
  ...
  class FleetSoftwareUpdate::Models::FsuCycleSummary
    ...
    COLLECTION_TYPE_ENUM = [
      ...
      COLLECTION_TYPE_GUEST_OS = 'GUEST_OS'.freeze,
      COLLECTION_TYPE_EXADB_STACK = 'EXADB_STACK'.freeze,
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata Fleet Update Cycle.
    #
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata Fleet Update Collection being updated by this Exadata Fleet Update Cycle.
    #
    # @return [String]
    attr_accessor :fsu_collection_id

    # **[Required]** Type of Exadata Fleet Update Collection being updated by this Exadata Fleet Update Cycle.
    #
    # @return [String]
