...
module OCI
  ...
  class FleetSoftwareUpdate::FleetSoftwareUpdateClientCompositeOperations
    ...
    # Calls {OCI::FleetSoftwareUpdate::FleetSoftwareUpdateClient#create_fsu_readiness_check} and then waits for the {OCI::FleetSoftwareUpdate::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::FleetSoftwareUpdate::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::FleetSoftwareUpdate::FleetSoftwareUpdateClient#create_fsu_readiness_check}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::FleetSoftwareUpdate::Models::WorkRequest}
    def create_fsu_readiness_check_and_wait_for_state(create_fsu_readiness_check_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_fsu_readiness_check(create_fsu_readiness_check_details, base_operation_opts)
      use_util = OCI::FleetSoftwareUpdate::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::FleetSoftwareUpdate::FleetSoftwareUpdateClient#delete_fsu_readiness_check} and then waits for the {OCI::FleetSoftwareUpdate::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] fsu_readiness_check_id Unique Exadata Fleet Update Readiness Check identifier.
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::FleetSoftwareUpdate::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::FleetSoftwareUpdate::FleetSoftwareUpdateClient#delete_fsu_readiness_check}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::FleetSoftwareUpdate::Models::WorkRequest}
    def delete_fsu_readiness_check_and_wait_for_state(fsu_readiness_check_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_fsu_readiness_check(fsu_readiness_check_id, base_operation_opts)
      use_util = OCI::FleetSoftwareUpdate::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::FleetSoftwareUpdate::FleetSoftwareUpdateClient#update_fsu_readiness_check} and then waits for the {OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck} acted upon
    # to enter the given state(s).
    #
    # @param [String] fsu_readiness_check_id Unique Exadata Fleet Update Readiness Check identifier.
    #
    ...
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::FleetSoftwareUpdate::FleetSoftwareUpdateClient#update_fsu_readiness_check}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck}
    def update_fsu_readiness_check_and_wait_for_state(fsu_readiness_check_id, update_fsu_readiness_check_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_fsu_readiness_check(fsu_readiness_check_id, update_fsu_readiness_check_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_fsu_readiness_check(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
