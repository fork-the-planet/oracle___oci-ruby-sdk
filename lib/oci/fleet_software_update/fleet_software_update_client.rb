...
module OCI
  ...
  class FleetSoftwareUpdate::FleetSoftwareUpdateClient
    ...
    # When provided, If-Match is checked against ETag values of the resource.
    #
    # @param [String] fsu_readiness_check_id Unique Exadata Fleet Update Readiness Check identifier.
    #
    # @param [OCI::FleetSoftwareUpdate::Models::ChangeFsuReadinessCheckCompartmentDetails] change_fsu_readiness_check_compartment_details The compartment where the Exadata Fleet Update Readiness Check will be moved to
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/fleetsoftwareupdate/change_fsu_readiness_check_compartment.rb.html) to see an example of how to use change_fsu_readiness_check_compartment API.
    def change_fsu_readiness_check_compartment(fsu_readiness_check_id, change_fsu_readiness_check_compartment_details, opts = {})
      logger.debug 'Calling operation FleetSoftwareUpdateClient#change_fsu_readiness_check_compartment.' if logger

      raise "Missing the required parameter 'fsu_readiness_check_id' when calling change_fsu_readiness_check_compartment." if fsu_readiness_check_id.nil?
      raise "Missing the required parameter 'change_fsu_readiness_check_compartment_details' when calling change_fsu_readiness_check_compartment." if change_fsu_readiness_check_compartment_details.nil?
      raise "Parameter value for 'fsu_readiness_check_id' must not be blank" if OCI::Internal::Util.blank_string?(fsu_readiness_check_id)

      path = '/fsuReadinessChecks/{fsuReadinessCheckId}/actions/changeCompartment'.sub('{fsuReadinessCheckId}', fsu_readiness_check_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(change_fsu_readiness_check_compartment_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'FleetSoftwareUpdateClient#change_fsu_readiness_check_compartment') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [OCI::FleetSoftwareUpdate::Models::CreateFsuReadinessCheckDetails] create_fsu_readiness_check_details Details for the new Exadata Fleet Update Readiness Check.
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    #
    # @return [Response] A Response object with data of type {OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck FsuReadinessCheck}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/fleetsoftwareupdate/create_fsu_readiness_check.rb.html) to see an example of how to use create_fsu_readiness_check API.
    def create_fsu_readiness_check(create_fsu_readiness_check_details, opts = {})
      logger.debug 'Calling operation FleetSoftwareUpdateClient#create_fsu_readiness_check.' if logger

      raise "Missing the required parameter 'create_fsu_readiness_check_details' when calling create_fsu_readiness_check." if create_fsu_readiness_check_details.nil?
      ...
      post_body = @api_client.object_to_http_body(create_fsu_readiness_check_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'FleetSoftwareUpdateClient#create_fsu_readiness_check') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/fleetsoftwareupdate/delete_fsu_readiness_check.rb.html) to see an example of how to use delete_fsu_readiness_check API.
    def delete_fsu_readiness_check(fsu_readiness_check_id, opts = {})
      logger.debug 'Calling operation FleetSoftwareUpdateClient#delete_fsu_readiness_check.' if logger

      raise "Missing the required parameter 'fsu_readiness_check_id' when calling delete_fsu_readiness_check." if fsu_readiness_check_id.nil?
      raise "Parameter value for 'fsu_readiness_check_id' must not be blank" if OCI::Internal::Util.blank_string?(fsu_readiness_check_id)

      path = '/fsuReadinessChecks/{fsuReadinessCheckId}'.sub('{fsuReadinessCheckId}', fsu_readiness_check_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'FleetSoftwareUpdateClient#delete_fsu_readiness_check') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck FsuReadinessCheck}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/fleetsoftwareupdate/get_fsu_readiness_check.rb.html) to see an example of how to use get_fsu_readiness_check API.
    def get_fsu_readiness_check(fsu_readiness_check_id, opts = {})
      logger.debug 'Calling operation FleetSoftwareUpdateClient#get_fsu_readiness_check.' if logger

      raise "Missing the required parameter 'fsu_readiness_check_id' when calling get_fsu_readiness_check." if fsu_readiness_check_id.nil?
      raise "Parameter value for 'fsu_readiness_check_id' must not be blank" if OCI::Internal::Util.blank_string?(fsu_readiness_check_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'FleetSoftwareUpdateClient#get_fsu_readiness_check') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :resource_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the resource related to the Exadata Fleet Update Readiness Check.
    #
    # @option opts [String] :lifecycle_state A filter to return only resources whose lifecycleState matches the specified lifecycleState.
    #
    # @option opts [String] :display_name A filter to return only resources that match the entire display name given.
    #
    # @option opts [String] :type A filter to return only resources whose type matches the specified type.
    #
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page A token representing the position at which to start retrieving results.
    #   This must come from the `opc-next-page` header field of a previous response.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    #
    # @return [Response] A Response object with data of type {OCI::FleetSoftwareUpdate::Models::FsuReadinessCheckCollection FsuReadinessCheckCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/fleetsoftwareupdate/list_fsu_readiness_checks.rb.html) to see an example of how to use list_fsu_readiness_checks API.
    def list_fsu_readiness_checks(compartment_id, opts = {})
      logger.debug 'Calling operation FleetSoftwareUpdateClient#list_fsu_readiness_checks.' if logger

      raise "Missing the required parameter 'compartment_id' when calling list_fsu_readiness_checks." if compartment_id.nil?

      if opts[:lifecycle_state] && !OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck::LIFECYCLE_STATE_ENUM.include?(opts[:lifecycle_state])
        raise 'Invalid value for "lifecycle_state", must be one of the values in OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck::LIFECYCLE_STATE_ENUM.'
      end

      if opts[:type] && !OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck::TYPE_ENUM.include?(opts[:type])
        raise 'Invalid value for "type", must be one of the values in OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck::TYPE_ENUM.'
      end
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'FleetSoftwareUpdateClient#list_fsu_readiness_checks') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::FleetSoftwareUpdate::Models::FsuReadinessCheckCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @param [String] fsu_readiness_check_id Unique Exadata Fleet Update Readiness Check identifier.
    #
    # @param [OCI::FleetSoftwareUpdate::Models::UpdateFsuReadinessCheckDetails] update_fsu_readiness_check_details The Exadata Fleet Update Readiness Check details to be updated.
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FleetSoftwareUpdate::Models::FsuReadinessCheck FsuReadinessCheck}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/fleetsoftwareupdate/update_fsu_readiness_check.rb.html) to see an example of how to use update_fsu_readiness_check API.
    def update_fsu_readiness_check(fsu_readiness_check_id, update_fsu_readiness_check_details, opts = {})
      logger.debug 'Calling operation FleetSoftwareUpdateClient#update_fsu_readiness_check.' if logger

      raise "Missing the required parameter 'fsu_readiness_check_id' when calling update_fsu_readiness_check." if fsu_readiness_check_id.nil?
      raise "Missing the required parameter 'update_fsu_readiness_check_details' when calling update_fsu_readiness_check." if update_fsu_readiness_check_details.nil?
      raise "Parameter value for 'fsu_readiness_check_id' must not be blank" if OCI::Internal::Util.blank_string?(fsu_readiness_check_id)
      ...
      post_body = @api_client.object_to_http_body(update_fsu_readiness_check_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'FleetSoftwareUpdateClient#update_fsu_readiness_check') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
