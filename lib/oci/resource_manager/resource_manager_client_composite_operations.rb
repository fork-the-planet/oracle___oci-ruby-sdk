...
module OCI
  ...
  class ResourceManager::ResourceManagerClientCompositeOperations
    ...
    # Calls {OCI::ResourceManager::ResourceManagerClient#create_private_endpoint} and then waits for the {OCI::ResourceManager::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # Calls {OCI::ResourceManager::ResourceManagerClient#delete_private_endpoint} and then waits for the {OCI::ResourceManager::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # Calls {OCI::ResourceManager::ResourceManagerClient#update_private_endpoint} and then waits for the {OCI::ResourceManager::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] private_endpoint_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the private endpoint.
