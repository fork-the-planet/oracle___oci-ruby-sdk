...
module OCI
  ...
  class ResourceManager::Models::ConfigurationSourceProvider
    ...
    CONFIG_SOURCE_PROVIDER_TYPE_ENUM = [
      CONFIG_SOURCE_PROVIDER_TYPE_BITBUCKET_CLOUD_ACCESS_TOKEN = 'BITBUCKET_CLOUD_ACCESS_TOKEN'.freeze,
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_migration_required
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ResourceManager::Models::BitbucketCloudEmailApiTokenConfigurationSourceProvider' if type == 'BITBUCKET_CLOUD_ACCESS_TOKEN'
    ...
    # @option attributes [BOOLEAN] :is_migration_required The value to assign to the {#is_migration_required} property
    ...
    def initialize(attributes = {})
      ...
      self.is_migration_required = attributes[:'isMigrationRequired'] unless attributes[:'isMigrationRequired'].nil?

      raise 'You cannot provide both :isMigrationRequired and :is_migration_required' if attributes.key?(:'isMigrationRequired') && attributes.key?(:'is_migration_required')

      self.is_migration_required = attributes[:'is_migration_required'] unless attributes[:'is_migration_required'].nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        email == other.email &&
        is_migration_required == other.is_migration_required &&
    ...
    def hash
      [id, compartment_id, display_name, description, time_created, lifecycle_state, config_source_provider_type, private_server_config_details, username, email, is_migration_required, secret_id, freeform_tags, defined_tags, system_tags].hash
    end
