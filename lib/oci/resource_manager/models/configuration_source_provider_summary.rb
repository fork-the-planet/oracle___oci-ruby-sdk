...
module OCI
  ...
  class ResourceManager::Models::ConfigurationSourceProviderSummary
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ResourceManager::Models::BitbucketCloudEmailApiTokenConfigurationSourceProviderSummary' if type == 'BITBUCKET_CLOUD_ACCESS_TOKEN'
    ...
    def hash
      [id, compartment_id, display_name, description, time_created, lifecycle_state, config_source_provider_type, private_server_config_details, is_migration_required, freeform_tags, defined_tags, system_tags].hash
    end
