...
module OCI
  ...
  #
  class ResourceManager::Models::BitbucketCloudEmailApiTokenConfigurationSourceProvider < ResourceManager::Models::ConfigurationSourceProvider
    ...
    # @option attributes [String] :email The value to assign to the {OCI::ResourceManager::Models::ConfigurationSourceProvider#email #email} proprety
    # @option attributes [BOOLEAN] :is_migration_required The value to assign to the {OCI::ResourceManager::Models::ConfigurationSourceProvider#is_migration_required #is_migration_required} proprety
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::ResourceManager::Models::ConfigurationSourceProvider#system_tags #system_tags} proprety
    # @option attributes [String] :api_endpoint The value to assign to the {#api_endpoint} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['configSourceProviderType'] = 'BITBUCKET_CLOUD_ACCESS_TOKEN'
    ...
    def hash
      [id, compartment_id, display_name, description, time_created, lifecycle_state, config_source_provider_type, private_server_config_details, username, email, is_migration_required, secret_id, freeform_tags, defined_tags, system_tags, api_endpoint].hash
    end
