...
module OCI
  ...
  #
  class ResourceManager::Models::BitbucketCloudEmailApiTokenConfigurationSourceProviderSummary < ResourceManager::Models::ConfigurationSourceProviderSummary
    ...
    # @option attributes [BOOLEAN] :is_migration_required The value to assign to the {OCI::ResourceManager::Models::ConfigurationSourceProviderSummary#is_migration_required #is_migration_required} proprety
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::ResourceManager::Models::ConfigurationSourceProviderSummary#system_tags #system_tags} proprety
    ...
    def hash
      [id, compartment_id, display_name, description, time_created, lifecycle_state, config_source_provider_type, private_server_config_details, is_migration_required, freeform_tags, defined_tags, system_tags, api_endpoint].hash
    end
