...
module OCI
  ...
  class ResourceManager::Models::JobSummary
    ...
    def hash
      [id, stack_id, compartment_id, display_name, operation, job_operation_details, apply_job_plan_resolution, resolved_plan_job_id, time_created, time_finished, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
