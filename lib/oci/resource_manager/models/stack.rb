...
module OCI
  ...
  class ResourceManager::Models::Stack
    ...
    def hash
      [id, compartment_id, display_name, description, time_created, lifecycle_state, config_source, custom_terraform_provider, is_third_party_provider_experience_enabled, variables, terraform_version, stack_drift_status, time_drift_last_checked, freeform_tags, defined_tags, system_tags].hash
    end
