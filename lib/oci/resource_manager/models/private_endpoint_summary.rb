...
module OCI
  ...
  class ResourceManager::Models::PrivateEndpointSummary
    ...
    def hash
      [id, compartment_id, display_name, description, vcn_id, is_used_with_configuration_source_provider, dns_zones, time_created, lifecycle_state, freeform_tags, defined_tags, system_tags, security_attributes].hash
    end
