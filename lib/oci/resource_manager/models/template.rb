...
module OCI
  ...
  class ResourceManager::Models::Template
    ...
    def hash
      [id, compartment_id, category_id, display_name, description, long_description, is_free_tier, time_created, template_config_source, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
