...
module OCI
  ...
  #
  class ResourceManager::Models::CreateBitbucketCloudEmailApiTokenConfigurationSourceProviderDetails < ResourceManager::Models::CreateConfigurationSourceProviderDetails
    ...
    # **[Required]** Atlassian account email used for Bitbucket Cloud API token authentication.
    # @return [String]
    attr_accessor :email
    ...
    def hash
      [compartment_id, display_name, description, config_source_provider_type, private_server_config_details, freeform_tags, defined_tags, api_endpoint, email, secret_id].hash
    end
