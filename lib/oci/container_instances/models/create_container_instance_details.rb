...
module OCI
  ...
  class ContainerInstances::Models::CreateContainerInstanceDetails
    ...
    # @return [OCI::ContainerInstances::Models::CreateContainerInstanceSecurityContextDetails]
    ...
    def self.swagger_types
      {
        ...
        'security_context': :'OCI::ContainerInstances::Models::CreateContainerInstanceSecurityContextDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::ContainerInstances::Models::CreateContainerInstanceSecurityContextDetails] :security_context The value to assign to the {#security_context} property
    ...
    def hash
      [display_name, compartment_id, availability_domain, fault_domain, shape, shape_config, volumes, containers, vnics, dns_config, graceful_shutdown_timeout_in_seconds, image_pull_secrets, container_restart_policy, freeform_tags, defined_tags, security_context].hash
    end
