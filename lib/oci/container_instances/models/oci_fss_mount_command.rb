...
module OCI
  ...
  #
  class ContainerInstances::Models::OciFssMountCommand
    ...
    # @return [Array<OCI::ContainerInstances::Models::OciFssMountOption>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'mount_options': :'Array<OCI::ContainerInstances::Models::OciFssMountOption>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::ContainerInstances::Models::OciFssMountOption>] :mount_options The value to assign to the {#mount_options} property
