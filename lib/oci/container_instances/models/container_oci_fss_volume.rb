...
module OCI
  ...
  #
  class ContainerInstances::Models::ContainerOciFssVolume < ContainerInstances::Models::ContainerVolume
    # @return [OCI::ContainerInstances::Models::OciFssMountTarget]
    attr_accessor :mount_target

    # @return [OCI::ContainerInstances::Models::OciFssExport]
    attr_accessor :export

    # @return [OCI::ContainerInstances::Models::OciFssSecurity]
    attr_accessor :security

    # @return [OCI::ContainerInstances::Models::OciFssMountCommand]
    ...
    # @option attributes [OCI::ContainerInstances::Models::OciFssMountTarget] :mount_target The value to assign to the {#mount_target} property
    # @option attributes [OCI::ContainerInstances::Models::OciFssExport] :export The value to assign to the {#export} property
    # @option attributes [OCI::ContainerInstances::Models::OciFssSecurity] :security The value to assign to the {#security} property
    # @option attributes [OCI::ContainerInstances::Models::OciFssMountCommand] :mount_command The value to assign to the {#mount_command} property
