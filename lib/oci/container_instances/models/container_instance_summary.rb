...
module OCI
  ...
  class ContainerInstances::Models::ContainerInstanceSummary
    ...
    def hash
      [id, display_name, compartment_id, freeform_tags, defined_tags, system_tags, availability_domain, fault_domain, lifecycle_state, lifecycle_details, time_created, time_updated, shape, shape_config, container_count, graceful_shutdown_timeout_in_seconds, volume_count, container_restart_policy, security_context].hash
    end
