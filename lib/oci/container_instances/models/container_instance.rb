...
module OCI
  ...
  class ContainerInstances::Models::ContainerInstance
    ...
    # @return [OCI::ContainerInstances::Models::ContainerInstanceSecurityContext]
    ...
    def self.swagger_types
      {
        ...
        'security_context': :'OCI::ContainerInstances::Models::ContainerInstanceSecurityContext'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::ContainerInstances::Models::ContainerInstanceSecurityContext] :security_context The value to assign to the {#security_context} property
    ...
    def hash
      [id, display_name, compartment_id, tenant_id, freeform_tags, defined_tags, system_tags, availability_domain, fault_domain, lifecycle_state, lifecycle_details, volumes, volume_count, containers, container_count, time_created, time_updated, shape, shape_config, vnics, dns_config, graceful_shutdown_timeout_in_seconds, image_pull_secrets, container_restart_policy, security_context].hash
    end
