...
module OCI
  ...
  #
  class ContainerInstances::Models::CreateOciFssMountCommandDetails
    ...
    # @return [Array<OCI::ContainerInstances::Models::CreateOciFssMountOptionDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'mount_options': :'Array<OCI::ContainerInstances::Models::CreateOciFssMountOptionDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::ContainerInstances::Models::CreateOciFssMountOptionDetails>] :mount_options The value to assign to the {#mount_options} property
