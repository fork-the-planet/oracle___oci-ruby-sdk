...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::HttpEndpointBasicAuthScopeConfig < GenerativeAiAgent::Models::HttpEndpointAuthScopeConfig
    ...
    def initialize(attributes = {})
      ...
      attributes['httpEndpointAuthScopeConfigType'] = 'HTTP_ENDPOINT_BASIC_AUTH_SCOPE_CONFIG'
