...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::CustomGenAiModelLlmSelection < GenerativeAiAgent::Models::LlmSelection
    # **[Required]** The OCID of the GenAI model
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['llmSelectionType'] = 'CUSTOM_GEN_AI_MODEL'
    ...
    def hash
      [llm_selection_type, model_id].hash
    end
