...
require 'date'
require_relative 'llm_selection'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Custom LLM selection with specific Gen AI Endpoint.
  #
  class GenerativeAiAgent::Models::CustomGenAiEndpointLlmSelection < GenerativeAiAgent::Models::LlmSelection
    # **[Required]** The OCID of the GenAI endpoint
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['llmSelectionType'] = 'CUSTOM_GEN_AI_ENDPOINT'
    ...
    def hash
      [llm_selection_type, endpoint_id].hash
    end
