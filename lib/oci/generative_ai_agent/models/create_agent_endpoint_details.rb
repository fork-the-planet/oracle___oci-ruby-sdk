...
module OCI
  ...
  class GenerativeAiAgent::Models::CreateAgentEndpointDetails
    ...
    def hash
      [display_name, description, agent_id, content_moderation_config, guardrail_config, metadata, human_input_config, output_config, should_enable_trace, should_enable_citation, should_enable_session, should_enable_multi_language, session_config, compartment_id, provisioned_capacity_config, freeform_tags, defined_tags].hash
    end
