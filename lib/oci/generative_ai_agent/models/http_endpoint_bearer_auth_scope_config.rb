...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::HttpEndpointBearerAuthScopeConfig < GenerativeAiAgent::Models::HttpEndpointAuthScopeConfig
    ...
    def initialize(attributes = {})
      ...
      attributes['httpEndpointAuthScopeConfigType'] = 'HTTP_ENDPOINT_BEARER_AUTH_SCOPE_CONFIG'
    ...
    def hash
      [http_endpoint_auth_scope_config_type, vault_secret_id].hash
    end
