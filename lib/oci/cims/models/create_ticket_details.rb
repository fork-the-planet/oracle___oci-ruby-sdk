...
module OCI
  ...
  class Cims::Models::CreateTicketDetails
    ...
    # **[Required]** The severity of the support request.
    # @return [String]
    ...
    # **[Required]** The title of the support request. Avoid entering confidential information.
    # @return [String]
    attr_accessor :title

    # **[Required]** The description of the support request. Avoid entering confidential information.
    #
    # @return [String]
