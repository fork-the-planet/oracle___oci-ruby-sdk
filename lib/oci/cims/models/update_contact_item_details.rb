...
module OCI
  ...
  #
  class Cims::Models::UpdateContactItemDetails < Cims::Models::UpdateItemDetails
    ACTIVITY_TYPE_ENUM = [
      ...
      ACTIVITY_TYPE_ADD_CONTACT = 'ADD_CONTACT'.freeze
    ].freeze
    ...
    # @option attributes [String] :contact The value to assign to the {#contact} property
    ...
    def hash
      [type, contact, activity_type].hash
    end
