...
module OCI
  ...
  # For information about `TECH` support requests, see [Creating a Technical Support Request](https://docs.cloud.oracle.com/iaas/Content/GSG/support/create-incident-technical.htm).
  #
