...
module OCI
  ...
  class Cims::Models::ActivityItem < Cims::Models::Item
    ...
    ITEM_STATUS_ENUM = [
      ...
      ITEM_STATUS_REJECTED = 'REJECTED'.freeze,
      ITEM_STATUS_RECEIVED = 'RECEIVED'.freeze,
    ...
    def hash
      [item_key, name, type, category, sub_category, issue_type, id, comments, time_created, time_updated, activity_type, activity_author, item_type, item_status, attachment_id].hash
    end
