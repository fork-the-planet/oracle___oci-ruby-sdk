...
module OCI
  ...
  class JmsUtils::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    def hash
      [operation_type, status, id, compartment_id, resources, percent_complete, time_accepted, time_started, time_finished, time_updated, created_by].hash
    end
