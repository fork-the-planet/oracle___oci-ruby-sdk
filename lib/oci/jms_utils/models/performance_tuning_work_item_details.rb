...
module OCI
  ...
  class JmsUtils::Models::PerformanceTuningWorkItemDetails < JmsUtils::Models::WorkItemDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['kind'] = 'PERFORMANCE_TUNING'
    ...
    def hash
      [kind, work_item_type, artifact_object_storage_path, analysis_project_name].hash
    end
