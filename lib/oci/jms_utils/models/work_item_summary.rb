...
module OCI
  ...
  class JmsUtils::Models::WorkItemSummary
    STATUS_ENUM = [
    ...
    # @return [OCI::JmsUtils::Models::WorkItemDetails]
    ...
    def self.swagger_types
      {
        ...
        'status': :'String',
        'details': :'OCI::JmsUtils::Models::WorkItemDetails',
        'retry_count': :'Integer',
    ...
    # @option attributes [OCI::JmsUtils::Models::WorkItemDetails] :details The value to assign to the {#details} property
    ...
    def hash
      [id, work_request_id, status, details, retry_count, time_last_updated].hash
    end
