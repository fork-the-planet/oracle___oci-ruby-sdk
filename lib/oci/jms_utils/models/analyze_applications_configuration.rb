...
module OCI
  ...
  class JmsUtils::Models::AnalyzeApplicationsConfiguration
    # **[Required]** The Object Storage namespace used for analyzing applications.
    # @return [String]
    attr_accessor :namespace_name

    # **[Required]** The name of the bucket used for analyzing applications.
    # @return [String]
