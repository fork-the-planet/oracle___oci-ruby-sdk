...
module OCI
  ...
  class JmsUtils::Models::WorkRequestLogEntryCollection
    # **[Required]** A list of work request log entries.
    # @return [Array<OCI::JmsUtils::Models::WorkRequestLogEntry>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::JmsUtils::Models::WorkRequestLogEntry>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::JmsUtils::Models::WorkRequestLogEntry>] :items The value to assign to the {#items} property
