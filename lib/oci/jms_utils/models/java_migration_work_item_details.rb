...
module OCI
  ...
  class JmsUtils::Models::JavaMigrationWorkItemDetails < JmsUtils::Models::WorkItemDetails
    ...
    # **[Required]** Object storage path to the input artifact/s in the form of a serialized array.
    ...
    def self.swagger_types
      {
        ...
        'input_applications_object_storage_paths': :'String',
    ...
    # @option attributes [String] :work_item_type The value to assign to the {OCI::JmsUtils::Models::WorkItemDetails#work_item_type #work_item_type} proprety
    # @option attributes [String] :target_jdk_version The value to assign to the {#target_jdk_version} property
    # @option attributes [String] :input_applications_object_storage_paths The value to assign to the {#input_applications_object_storage_paths} property
    # @option attributes [String] :analysis_project_name The value to assign to the {#analysis_project_name} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['kind'] = 'JAVA_MIGRATION'
    ...
    def hash
      [kind, work_item_type, target_jdk_version, input_applications_object_storage_paths, analysis_project_name].hash
    end
