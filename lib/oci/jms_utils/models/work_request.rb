...
module OCI
  ...
  #
  class JmsUtils::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::JmsUtils::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::JmsUtils::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::JmsUtils::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [operation_type, status, id, compartment_id, resources, percent_complete, total_task_count, completed_task_count, time_accepted, time_started, time_finished, time_updated, created_by].hash
    end
