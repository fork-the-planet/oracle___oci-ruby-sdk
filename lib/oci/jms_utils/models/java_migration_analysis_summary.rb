...
module OCI
  ...
  class JmsUtils::Models::JavaMigrationAnalysisSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Java Migration Analysis.
    # @return [String]
    attr_accessor :id
    ...
    # @return [String]
    attr_accessor :analysis_result_object_storage_path

    # **[Required]** The analysis application file names result in the Object Storage.
    # @return [Array<String>]
    attr_accessor :analysis_result_files

    # **[Required]** The date and time the Java Migration Analysis was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # **[Required]** The date and time the Java Migration Analysis was started, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    # Example: `2016-08-25T21:10:29.600Z`
    #
    # @return [DateTime]
    ...
    # **[Required]** The date and time the Java Migration Analysis was finished, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    # Example: `2016-08-25T21:10:29.600Z`
    #
    # @return [DateTime]
    ...
    # @option attributes [String] :analysis_result_object_storage_path The value to assign to the {#analysis_result_object_storage_path} property
    # @option attributes [Array<String>] :analysis_result_files The value to assign to the {#analysis_result_files} property
    ...
    def hash
      [id, work_request_id, compartment_id, analysis_project_name, input_applications_object_storage_paths, target_jdk_version, namespace_name, bucket_name, analysis_result_object_storage_path, analysis_result_files, time_created, time_started, time_finished, created_by, metadata].hash
    end
