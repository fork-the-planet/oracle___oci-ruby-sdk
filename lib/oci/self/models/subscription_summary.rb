...
module OCI
  ...
  class Self::Models::SubscriptionSummary
    ...
    # **[Required]** The unique identifier for the compartment where subscription was created.
    # @return [String]
    ...
    # **[Required]** A message that describes the current state of the Subscription in more detail. For example,
    ...
    def hash
      [id, display_name, compartment_id, tenant_id, subscription_details, seller_id, product_id, time_created, time_updated, time_started, time_ended, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
