...
module OCI
  ...
  class Self::Models::Subscription
    SOURCE_TYPE_ENUM = [
    ...
    # **[Required]** The unique identifier for the subscription within a specific compartment.
    # @return [String]
    attr_accessor :id

    # **[Required]** The subscription name. Must be unique within the compartment. This value can be updated.
    # @return [String]
    attr_accessor :display_name

    # **[Required]** The unique identifier for the compartment where the subscription was purchased.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The unique identifier for the tenant where the subscription was purchased.
    # @return [String]
    attr_accessor :tenant_id

    # @return [OCI::Self::Models::SubscriptionDetails]
    ...
    # **[Required]** The date and time the Subscription was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # **[Required]** The current lifecycle state of the Subscription.
    # @return [String]
    ...
    # @option attributes [OCI::Self::Models::SubscriptionDetails] :subscription_details The value to assign to the {#subscription_details} property
    # @option attributes [String] :seller_id The value to assign to the {#seller_id} property
    ...
    def initialize(attributes = {})
      ...
      self.subscription_details = attributes[:'subscriptionDetails'] if attributes[:'subscriptionDetails']

      raise 'You cannot provide both :subscriptionDetails and :subscription_details' if attributes.key?(:'subscriptionDetails') && attributes.key?(:'subscription_details')

      self.subscription_details = attributes[:'subscription_details'] if attributes[:'subscription_details']

      self.seller_id = attributes[:'sellerId'] if attributes[:'sellerId']

      raise 'You cannot provide both :sellerId and :seller_id' if attributes.key?(:'sellerId') && attributes.key?(:'seller_id')

      self.seller_id = attributes[:'seller_id'] if attributes[:'seller_id']
    ...
    def hash
      [id, display_name, compartment_id, tenant_id, subscription_details, seller_id, source_type, product_id, additional_details, realm, region, time_created, time_updated, time_started, time_ended, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
