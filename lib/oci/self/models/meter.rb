...
module OCI
  ...
  class Self::Models::Meter
    # **[Required]** Name of meter.
    # @return [String]
    attr_accessor :name
    ...
    def self.swagger_types
      {
        ...
        'extended_metadata': :'Array<OCI::Self::Models::ExtendedMetadata>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Self::Models::ExtendedMetadata>] :extended_metadata The value to assign to the {#extended_metadata} property
    ...
    def hash
      [name, rate_allocation, extended_metadata].hash
    end
