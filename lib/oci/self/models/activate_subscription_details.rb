...
module OCI
  ...
  class Self::Models::ActivateSubscriptionDetails
    # **[Required]** The unique identifier of the marketplace product listing.
    #
    # @return [String]
    ...
    def hash
      [product_id, freeform_tags, defined_tags].hash
    end
