...
module OCI
  ...
  #
  class Self::Models::ListingSubscriptionSummary
    ...
    def hash
      [display_name, product_id, time_started, time_ended, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
