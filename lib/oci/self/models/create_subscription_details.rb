...
module OCI
  ...
  class Self::Models::CreateSubscriptionDetails
    SOURCE_TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the subscription in.
    #
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the tenant to create the subscription in.
    #
    # @return [String]
    ...
    def hash
      [display_name, compartment_id, tenant_id, subscription_details, seller_id, source_type, product_id, additional_details, realm, region, freeform_tags, defined_tags].hash
    end
