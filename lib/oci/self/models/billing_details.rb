...
module OCI
  ...
  class Self::Models::BillingDetails
    METRIC_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Self::Models::Meter>]
    ...
    # @option attributes [Array<OCI::Self::Models::Meter>] :meters The value to assign to the {#meters} property
