...
module OCI
  ...
  class Functions::Models::SuccessDestinationDetails
    KIND_ENUM = [
      KIND_NOTIFICATION = 'NOTIFICATION'.freeze,
      KIND_QUEUE = 'QUEUE'.freeze,
      KIND_STREAM = 'STREAM'.freeze,
      KIND_NONE = 'NONE'.freeze,
      KIND_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The type of destination for the response to a successful detached function invocation.
    #
    # @return [String]
    attr_reader :kind
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Functions::Models::StreamSuccessDestinationDetails' if type == 'STREAM'
      return 'OCI::Functions::Models::NotificationSuccessDestinationDetails' if type == 'NOTIFICATION'
      return 'OCI::Functions::Models::QueueSuccessDestinationDetails' if type == 'QUEUE'
      return 'OCI::Functions::Models::NoneSuccessDestinationDetails' if type == 'NONE'
