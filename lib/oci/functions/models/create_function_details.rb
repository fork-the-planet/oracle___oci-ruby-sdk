...
module OCI
  ...
  class Functions::Models::CreateFunctionDetails
    ...
    def hash
      [display_name, application_id, image, image_digest, source_details, memory_in_m_bs, config, timeout_in_seconds, provisioned_concurrency_config, detached_mode_timeout_in_seconds, failure_destination, success_destination, trace_config, freeform_tags, defined_tags].hash
    end
