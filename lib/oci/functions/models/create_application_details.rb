...
module OCI
  ...
  class Functions::Models::CreateApplicationDetails
    ...
    # @return [OCI::Functions::Models::ApplicationLoggingConfig]
    ...
    def self.swagger_types
      {
        ...
        'logging': :'OCI::Functions::Models::ApplicationLoggingConfig',
    ...
    # @option attributes [OCI::Functions::Models::ApplicationLoggingConfig] :logging The value to assign to the {#logging} property
    ...
    def hash
      [compartment_id, display_name, config, subnet_ids, shape, network_security_group_ids, syslog_url, trace_config, logging, freeform_tags, defined_tags, image_policy_config, security_attributes].hash
    end
