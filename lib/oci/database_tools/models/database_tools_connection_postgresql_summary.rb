...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionPostgresqlSummary < DatabaseTools::Models::DatabaseToolsConnectionSummary
    ...
    def hash
      [id, display_name, compartment_id, lifecycle_state, lifecycle_details, time_created, time_updated, defined_tags, freeform_tags, system_tags, locks, type, runtime_support, runtime_endpoint, runtime_identity, related_resource, connection_string, user_name, user_password, advanced_properties, key_stores, private_endpoint_id].hash
    end
