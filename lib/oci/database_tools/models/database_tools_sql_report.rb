...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsSqlReport
    TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Database Tools SQL report.
    # @return [String]
    attr_accessor :id

    # **[Required]** The Database Tools SQL report type.
    # @return [String]
    attr_reader :type

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment containing the Database Tools SQL report.
    # @return [String]
    ...
    # **[Required]** SQL query executed to generate the report.
    # @return [String]
    ...
    # @return [Array<OCI::DatabaseTools::Models::DatabaseToolsSqlReportVariable>]
    attr_accessor :variables

    # Descriptive information on columns referenced in the Database Tools SQL Report source.
    # @return [Array<OCI::DatabaseTools::Models::DatabaseToolsSqlReportColumn>]
    attr_accessor :columns

    # **[Required]** The current state of the Database Tools SQL report.
    # @return [String]
    ...
    # **[Required]** The time the Database Tools SQL report was created. An RFC3339 formatted datetime string.
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The time the Database Tools SQL report was updated. An RFC3339 formatted datetime string.
    # @return [DateTime]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseTools::Models::DatabaseToolsSqlReportOracleDatabase' if type == 'ORACLE_DATABASE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseTools::Models::DatabaseToolsSqlReport'
    end
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsSqlReportVariable>] :variables The value to assign to the {#variables} property
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsSqlReportColumn>] :columns The value to assign to the {#columns} property
