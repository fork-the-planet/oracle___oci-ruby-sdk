...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionOracleDatabaseSummary < DatabaseTools::Models::DatabaseToolsConnectionSummary
    ...
    # **[Required]** Specifies the authentication type used by the Database Tools service to authenticate with the database.
    # @return [String]
    ...
    # @option attributes [String] :runtime_endpoint The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#runtime_endpoint #runtime_endpoint} proprety
    # @option attributes [String] :runtime_identity The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#runtime_identity #runtime_identity} proprety
    ...
    def hash
      [id, display_name, compartment_id, lifecycle_state, lifecycle_details, time_created, time_updated, defined_tags, freeform_tags, system_tags, locks, type, runtime_support, runtime_endpoint, runtime_identity, related_resource, connection_string, user_name, user_password, advanced_properties, key_stores, private_endpoint_id, proxy_client, authentication_type].hash
    end
