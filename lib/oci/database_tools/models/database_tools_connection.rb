...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnection
    ...
    # **[Required]** Specifies the Database Tools Runtime endpoint.
    # @return [String]
    attr_accessor :runtime_endpoint

    # **[Required]** Specifies the identity used when accessing OCI resources at runtime. AUTHENTICATED_PRINCIPAL to use the caller\u2019s identity (On-Behalf-Of token), or RESOURCE_PRINCIPAL to use the connection\u2019s resource principal (RPST).
    #
    # @return [String]
    ...
    # @option attributes [String] :runtime_endpoint The value to assign to the {#runtime_endpoint} property
    ...
    def initialize(attributes = {})
      ...
      self.runtime_endpoint = attributes[:'runtimeEndpoint'] if attributes[:'runtimeEndpoint']

      raise 'You cannot provide both :runtimeEndpoint and :runtime_endpoint' if attributes.key?(:'runtimeEndpoint') && attributes.key?(:'runtime_endpoint')

      self.runtime_endpoint = attributes[:'runtime_endpoint'] if attributes[:'runtime_endpoint']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        runtime_endpoint == other.runtime_endpoint &&
    ...
    def hash
      [id, display_name, compartment_id, lifecycle_state, lifecycle_details, time_created, time_updated, defined_tags, freeform_tags, system_tags, locks, type, runtime_support, runtime_endpoint, runtime_identity].hash
    end
