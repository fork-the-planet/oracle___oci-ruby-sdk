...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsPrivateEndpointSummary
    ...
    def hash
      [compartment_id, defined_tags, freeform_tags, system_tags, security_attributes, locks, display_name, description, id, endpoint_service_id, time_created, time_updated, vcn_id, subnet_id, private_endpoint_vnic_id, private_endpoint_ip, endpoint_fqdn, additional_fqdns, lifecycle_state, lifecycle_details, nsg_ids, reverse_connection_configuration].hash
    end
