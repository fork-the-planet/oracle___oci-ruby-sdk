...
module OCI
  ...
  class DatabaseTools::Models::CreateDatabaseToolsConnectionOracleDatabaseDetails < DatabaseTools::Models::CreateDatabaseToolsConnectionDetails
    ...
    # @option attributes [String] :runtime_identity The value to assign to the {OCI::DatabaseTools::Models::CreateDatabaseToolsConnectionDetails#runtime_identity #runtime_identity} proprety
    ...
    def initialize(attributes = {})
      ...
      self.authentication_type = "PASSWORD" if authentication_type.nil? && !attributes.key?(:'authenticationType') # rubocop:disable Style/StringLiterals
      ...
      self.authentication_type = "PASSWORD" if authentication_type.nil? && !attributes.key?(:'authenticationType') && !attributes.key?(:'authentication_type') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [display_name, compartment_id, defined_tags, freeform_tags, locks, type, runtime_support, runtime_identity, related_resource, connection_string, user_name, user_password, advanced_properties, key_stores, private_endpoint_id, proxy_client, authentication_type].hash
    end
