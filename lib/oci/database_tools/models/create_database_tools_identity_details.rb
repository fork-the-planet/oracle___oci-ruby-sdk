...
module OCI
  ...
  class DatabaseTools::Models::CreateDatabaseToolsIdentityDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseTools::Models::CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails' if type == 'ORACLE_DATABASE_RESOURCE_PRINCIPAL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseTools::Models::CreateDatabaseToolsIdentityDetails'
    end
    ...
    def hash
      [type, compartment_id, display_name, database_tools_connection_id, defined_tags, freeform_tags, locks].hash
    end
