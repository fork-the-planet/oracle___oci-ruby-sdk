...
module OCI
  ...
  class DatabaseTools::Models::CreateDatabaseToolsConnectionPostgresqlDetails < DatabaseTools::Models::CreateDatabaseToolsConnectionDetails
    ...
    def hash
      [display_name, compartment_id, defined_tags, freeform_tags, locks, type, runtime_support, runtime_identity, related_resource, connection_string, user_name, user_password, advanced_properties, key_stores, private_endpoint_id].hash
    end
