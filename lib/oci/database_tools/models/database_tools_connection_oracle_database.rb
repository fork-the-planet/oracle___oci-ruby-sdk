...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionOracleDatabase < DatabaseTools::Models::DatabaseToolsConnection
    ...
    # **[Required]** Specifies the authentication type used to connect to the database.
    # @return [String]
    ...
    # @option attributes [String] :runtime_endpoint The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnection#runtime_endpoint #runtime_endpoint} proprety
    # @option attributes [String] :runtime_identity The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnection#runtime_identity #runtime_identity} proprety
