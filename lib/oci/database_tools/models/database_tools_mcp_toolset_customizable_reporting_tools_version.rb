...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsMcpToolsetCustomizableReportingToolsVersion
    ...
    # @return [Array<String>]
    attr_accessor :default_report_allowed_roles

    # **[Required]** The tools available in this version.
    # @return [Array<OCI::DatabaseTools::Models::DatabaseToolsMcpToolsetVersionTool>]
    attr_accessor :tools
    ...
    # @option attributes [Array<String>] :default_report_allowed_roles The value to assign to the {#default_report_allowed_roles} property
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsMcpToolsetVersionTool>] :tools The value to assign to the {#tools} property
