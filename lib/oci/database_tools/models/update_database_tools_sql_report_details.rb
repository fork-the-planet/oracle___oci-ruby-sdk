...
module OCI
  ...
  class DatabaseTools::Models::UpdateDatabaseToolsSqlReportDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseTools::Models::UpdateDatabaseToolsSqlReportDetailsOracleDatabase' if type == 'ORACLE_DATABASE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseTools::Models::UpdateDatabaseToolsSqlReportDetails'
    end
