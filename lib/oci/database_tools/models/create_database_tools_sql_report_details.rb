...
module OCI
  ...
  class DatabaseTools::Models::CreateDatabaseToolsSqlReportDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseTools::Models::CreateDatabaseToolsSqlReportOracleDatabaseDetails' if type == 'ORACLE_DATABASE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseTools::Models::CreateDatabaseToolsSqlReportDetails'
    end
