...
module OCI
  ...
  class DatabaseTools::Models::CreateDatabaseToolsPrivateEndpointDetails
    ...
    def hash
      [compartment_id, defined_tags, freeform_tags, security_attributes, locks, display_name, description, endpoint_service_id, subnet_id, private_endpoint_ip, nsg_ids].hash
    end
