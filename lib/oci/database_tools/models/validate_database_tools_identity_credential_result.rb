...
module OCI
  ...
  class DatabaseTools::Models::ValidateDatabaseToolsIdentityCredentialResult
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseTools::Models::ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult' if type == 'ORACLE_DATABASE_RESOURCE_PRINCIPAL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseTools::Models::ValidateDatabaseToolsIdentityCredentialResult'
    end
