...
module OCI
  ...
  class CloudBridge::Models::CreateOlvmAssetSourceDetails < CloudBridge::Models::CreateAssetSourceDetails
    ...
    # @option attributes [String] :environment_type The value to assign to the {OCI::CloudBridge::Models::CreateAssetSourceDetails#environment_type #environment_type} proprety
