...
module OCI
  ...
  class CloudBridge::Models::InventoryAsset < CloudBridge::Models::Asset
    ...
    # @option attributes [String] :environment_type The value to assign to the {OCI::CloudBridge::Models::Asset#environment_type #environment_type} proprety
    ...
    def hash
      [display_name, inventory_id, id, compartment_id, source_key, external_asset_key, asset_type, time_created, time_updated, asset_source_ids, lifecycle_state, freeform_tags, defined_tags, system_tags, environment_type, asset_class_name, asset_class_version, asset_details].hash
    end
