...
module OCI
  ...
  class CloudBridge::Models::UpdateOlvmAssetSourceDetails < CloudBridge::Models::UpdateAssetSourceDetails
    ...
    # @option attributes [String] :environment_type The value to assign to the {OCI::CloudBridge::Models::UpdateAssetSourceDetails#environment_type #environment_type} proprety
