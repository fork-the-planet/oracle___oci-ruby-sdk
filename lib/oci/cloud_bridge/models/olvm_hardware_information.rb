...
module OCI
  ...
  class CloudBridge::Models::OlvmHardwareInformation
    # Type of host\u2019s CPU.
    # @return [String]
    ...
    def self.swagger_types
      {
        ...
        'supported_rng_sources': :'Array<OCI::CloudBridge::Models::RngSource>',
        'uuid': :'String',
        'version': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    ...
    # @option attributes [Array<OCI::CloudBridge::Models::RngSource>] :supported_rng_sources The value to assign to the {#supported_rng_sources} property
