...
module OCI
  ...
  #
  class CloudBridge::Models::OlvmAssetSource < CloudBridge::Models::AssetSource
    ...
    # @option attributes [String] :environment_type The value to assign to the {OCI::CloudBridge::Models::AssetSource#environment_type #environment_type} proprety
