...
module OCI
  ...
  class CloudBridge::Models::OlvmCpu
    ARCHITECTURE_ENUM = [
    ...
    # @return [Array<OCI::CloudBridge::Models::OlvmCore>]
    attr_accessor :core

    # @return [OCI::CloudBridge::Models::OlvmCpuTune]
    ...
    # @return [OCI::CloudBridge::Models::OlvmCpuTopology]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'architecture': :'String',
        'core': :'Array<OCI::CloudBridge::Models::OlvmCore>',
        'cpu_tune': :'OCI::CloudBridge::Models::OlvmCpuTune',
        'level': :'Integer',
        'mode': :'String',
        'name': :'String',
        'speed': :'Float',
        'cpu_topology': :'OCI::CloudBridge::Models::OlvmCpuTopology',
        'type': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::CloudBridge::Models::OlvmCore>] :core The value to assign to the {#core} property
    # @option attributes [OCI::CloudBridge::Models::OlvmCpuTune] :cpu_tune The value to assign to the {#cpu_tune} property
    ...
    # @option attributes [OCI::CloudBridge::Models::OlvmCpuTopology] :cpu_topology The value to assign to the {#cpu_topology} property
