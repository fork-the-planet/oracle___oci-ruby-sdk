...
module OCI
  ...
  class CloudBridge::Models::OlvmPowerManagement
    STATUS_ENUM = [
    ...
    # @return [Array<OCI::CloudBridge::Models::OlvmAgent>]
    ...
    # @return [Array<OCI::CloudBridge::Models::OlvmPmProxy>]
    ...
    # @option attributes [Array<OCI::CloudBridge::Models::OlvmAgent>] :agents The value to assign to the {#agents} property
    ...
    # @option attributes [Array<OCI::CloudBridge::Models::OlvmPmProxy>] :pm_proxies The value to assign to the {#pm_proxies} property
