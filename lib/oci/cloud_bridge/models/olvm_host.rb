...
module OCI
  ...
  class CloudBridge::Models::OlvmHost
    ...
    # @return [OCI::CloudBridge::Models::OlvmHardwareInformation]
    attr_accessor :hardware_information

    # @return [OCI::CloudBridge::Models::OlvmHostedEngine]
    ...
    # @return [OCI::CloudBridge::Models::OlvmIscsiDetails]
    attr_accessor :iscsi
    ...
    # @return [OCI::CloudBridge::Models::OlvmPowerManagement]
    ...
    # @return [OCI::CloudBridge::Models::OlvmSelinux]
    attr_accessor :se_linux

    # @return [OCI::CloudBridge::Models::OlvmSpm]
    attr_accessor :spm

    # @return [OCI::CloudBridge::Models::OlvmHostStatus]
    ...
    # @return [OCI::CloudBridge::Models::OlvmVmSummary]
    ...
    # @return [OCI::CloudBridge::Models::OlvmHostType]
    attr_accessor :type
    ...
    def self.swagger_types
      {
        ...
        'hardware_information': :'OCI::CloudBridge::Models::OlvmHardwareInformation',
        'hosted_engine': :'OCI::CloudBridge::Models::OlvmHostedEngine',
        'id': :'String',
        'iscsi': :'OCI::CloudBridge::Models::OlvmIscsiDetails',
        'kdump_status': :'String',
        'ksm': :'OCI::CloudBridge::Models::Ksm',
        'libvirt_version': :'OCI::CloudBridge::Models::OlvmVersion',
        ...
        'port': :'Integer',
        'power_management': :'OCI::CloudBridge::Models::OlvmPowerManagement',
        'is_reinstallation_required': :'BOOLEAN',
        'se_linux': :'OCI::CloudBridge::Models::OlvmSelinux',
        'spm': :'OCI::CloudBridge::Models::OlvmSpm',
        'host_status': :'OCI::CloudBridge::Models::OlvmHostStatus',
        'status_detail': :'String',
        'summary': :'OCI::CloudBridge::Models::OlvmVmSummary',
        'is_transparent_huge_pages_enabled': :'BOOLEAN',
        'type': :'OCI::CloudBridge::Models::OlvmHostType',
    ...
    # @option attributes [OCI::CloudBridge::Models::OlvmHardwareInformation] :hardware_information The value to assign to the {#hardware_information} property
    # @option attributes [OCI::CloudBridge::Models::OlvmHostedEngine] :hosted_engine The value to assign to the {#hosted_engine} property
    # @option attributes [String] :id The value to assign to the {#id} property
    # @option attributes [OCI::CloudBridge::Models::OlvmIscsiDetails] :iscsi The value to assign to the {#iscsi} property
    ...
    # @option attributes [OCI::CloudBridge::Models::OlvmVersion] :libvirt_version The value to assign to the {#libvirt_version} property
    ...
    # @option attributes [OCI::CloudBridge::Models::OlvmPowerManagement] :power_management The value to assign to the {#power_management} property
    # @option attributes [BOOLEAN] :is_reinstallation_required The value to assign to the {#is_reinstallation_required} property
    # @option attributes [OCI::CloudBridge::Models::OlvmSelinux] :se_linux The value to assign to the {#se_linux} property
    # @option attributes [OCI::CloudBridge::Models::OlvmSpm] :spm The value to assign to the {#spm} property
    # @option attributes [OCI::CloudBridge::Models::OlvmHostStatus] :host_status The value to assign to the {#host_status} property
    # @option attributes [String] :status_detail The value to assign to the {#status_detail} property
    # @option attributes [OCI::CloudBridge::Models::OlvmVmSummary] :summary The value to assign to the {#summary} property
    ...
    # @option attributes [OCI::CloudBridge::Models::OlvmHostType] :type The value to assign to the {#type} property
