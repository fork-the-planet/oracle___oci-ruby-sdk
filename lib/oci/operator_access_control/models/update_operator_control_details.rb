...
module OCI
  ...
  class OperatorAccessControl::Models::UpdateOperatorControlDetails
    ...
    def hash
      [operator_control_name, description, approvers_list, approver_groups_list, pre_approved_op_action_list, is_fully_pre_approved, notification_topic_id, email_id_list, number_of_approvers, system_message, freeform_tags, defined_tags].hash
    end
