...
module OCI
  ...
  class OperatorAccessControl::Models::AccessRequestSummary
    RESOURCE_TYPE_ENUM = [
      ...
      RESOURCE_TYPE_CLOUDEXADATAINFRASTRUCTURE = 'CLOUDEXADATAINFRASTRUCTURE'.freeze,
    ...
    def hash
      [id, request_id, access_reason_summary, compartment_id, resource_id, resource_name, sub_resource_list, resource_type, action_requests_list, lifecycle_state, lifecycle_details, time_of_creation, time_of_modification, time_of_user_creation, duration, extend_duration, severity, is_auto_approved, time_requested_for_future_access, freeform_tags, defined_tags].hash
    end
