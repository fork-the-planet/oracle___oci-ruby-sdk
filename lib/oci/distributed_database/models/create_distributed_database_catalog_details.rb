...
module OCI
  ...
  class DistributedDatabase::Models::CreateDistributedDatabaseCatalogDetails
    SOURCE_ENUM = [
      ...
      SOURCE_NEW_VAULT_AND_CLUSTER = 'NEW_VAULT_AND_CLUSTER'.freeze,
      SOURCE_EXISTING_CLUSTER = 'EXISTING_CLUSTER'.freeze
    ].freeze

    # **[Required]** Type of Globally distributed database Shard or Catalog.
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DistributedDatabase::Models::CreateDistributedDatabaseCatalogWithExadbXsNewVaultAndClusterDetails' if type == 'NEW_VAULT_AND_CLUSTER'
