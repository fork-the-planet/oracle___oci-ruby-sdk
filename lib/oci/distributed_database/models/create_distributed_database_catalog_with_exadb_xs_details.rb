...
module OCI
  ...
  class DistributedDatabase::Models::CreateDistributedDatabaseCatalogWithExadbXsDetails < DistributedDatabase::Models::CreateDistributedDatabaseCatalogDetails
    ...
    # @return [Array<OCI::DistributedDatabase::Models::CreateCatalogPeerWithExadbXsDetails>]
    ...
    def self.swagger_types
      {
        ...
        'peer_details': :'Array<OCI::DistributedDatabase::Models::CreateCatalogPeerWithExadbXsDetails>',
        'shard_space': :'String',
        'vault_id': :'String',
        'kms_key_id': :'String',
    ...
    # @option attributes [Array<OCI::DistributedDatabase::Models::CreateCatalogPeerWithExadbXsDetails>] :peer_details The value to assign to the {#peer_details} property
