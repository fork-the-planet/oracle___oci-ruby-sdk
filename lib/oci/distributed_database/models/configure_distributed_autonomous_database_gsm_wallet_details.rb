...
module OCI
  ...
  #
  class DistributedDatabase::Models::ConfigureDistributedAutonomousDatabaseGsmWalletDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cluster certificate.
    # @return [String]
    attr_accessor :certificate_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the ca bundle id.
    # @return [String]
    ...
    def hash
      [certificate_id, ca_bundle_id].hash
    end
