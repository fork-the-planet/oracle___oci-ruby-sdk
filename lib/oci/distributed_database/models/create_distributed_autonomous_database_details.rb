...
module OCI
  ...
  class DistributedDatabase::Models::CreateDistributedAutonomousDatabaseDetails
    ...
    # **[Required]** The listener port number for the Globally distributed autonomous database. The listener port number
    ...
    # **[Required]** Ons local port number for Globally distributed autonomous database. The onsPortLocal has to be unique for
    ...
    # **[Required]** Ons remote port number for Globally distributed autonomous database. The onsPortRemote has to be unique for
    # a customer tenancy across all distributed autonomous databases. Same port number should not be re-used for
    # any other distributed autonomous database.
    #
    # @return [Integer]
    ...
    # @return [OCI::DistributedDatabase::Models::DistributedAutonomousDbBackupConfig]
    ...
    # @option attributes [OCI::DistributedDatabase::Models::DistributedAutonomousDbBackupConfig] :db_backup_config The value to assign to the {#db_backup_config} property
    ...
    def hash
      [compartment_id, display_name, database_version, prefix, private_endpoint_ids, sharding_method, db_workload, character_set, ncharacter_set, chunks, listener_port, listener_port_tls, ons_port_local, ons_port_remote, replication_method, replication_factor, replication_unit, db_deployment_type, shard_details, catalog_details, db_backup_config, freeform_tags, defined_tags].hash
    end
