...
module OCI
  ...
  #
  class DistributedDatabase::Models::VmClusterDetails
    LICENSE_MODEL_ENUM = [
    ...
    def hash
      [subnet_id, backup_subnet_id, enabled_e_cpu_count, total_e_cpu_count, vm_file_system_storage_size, ssh_public_keys, license_model, domain, private_zone_id, is_diagnostics_events_enabled, is_health_monitoring_enabled, is_incident_logs_enabled, nsg_ids, backup_network_nsg_ids].hash
    end
