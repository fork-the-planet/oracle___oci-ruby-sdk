...
module OCI
  ...
  class DistributedDatabase::Models::CreateCatalogPeerWithDedicatedInfraDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud Autonomous VM Cluster for the peer catalog.
    # @return [String]
    ...
    def hash
      [cloud_autonomous_vm_cluster_id, protection_mode, fast_start_fail_over_lag_limit_in_seconds, is_automatic_failover_enabled, standby_maintenance_buffer_in_days].hash
    end
