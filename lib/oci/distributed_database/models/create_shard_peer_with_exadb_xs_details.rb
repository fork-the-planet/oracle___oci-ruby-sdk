...
module OCI
  ...
  class DistributedDatabase::Models::CreateShardPeerWithExadbXsDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the VM Cluster for the shard peer.
    # @return [String]
