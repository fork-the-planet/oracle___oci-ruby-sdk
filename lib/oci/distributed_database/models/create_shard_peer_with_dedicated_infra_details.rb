...
module OCI
  ...
  class DistributedDatabase::Models::CreateShardPeerWithDedicatedInfraDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud Autonomous VM Cluster for the peer shard.
    # @return [String]
