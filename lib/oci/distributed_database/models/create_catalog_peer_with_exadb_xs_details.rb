...
module OCI
  ...
  class DistributedDatabase::Models::CreateCatalogPeerWithExadbXsDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the VM Cluster for the catalog peer.
    # @return [String]
    ...
    def hash
      [vm_cluster_id, protection_mode, transport_type].hash
    end
