...
module OCI
  ...
  class DistributedDatabase::Models::CreateDistributedDatabaseShardWithExadbXsDetails < DistributedDatabase::Models::CreateDistributedDatabaseShardDetails
    ...
    # @return [Array<OCI::DistributedDatabase::Models::CreateShardPeerWithExadbXsDetails>]
    ...
    def self.swagger_types
      {
        ...
        'peer_details': :'Array<OCI::DistributedDatabase::Models::CreateShardPeerWithExadbXsDetails>',
        'shard_space': :'String',
        'vault_id': :'String',
        'kms_key_id': :'String',
    ...
    # @option attributes [Array<OCI::DistributedDatabase::Models::CreateShardPeerWithExadbXsDetails>] :peer_details The value to assign to the {#peer_details} property
    ...
    def hash
      [source, vm_cluster_id, admin_password, peer_vm_cluster_ids, peer_details, shard_space, vault_id, kms_key_id, kms_key_version_id].hash
    end
