...
module OCI
  ...
  class DistributedDatabase::Models::CreateDistributedAutonomousDatabaseShardWithDedicatedInfraDetails < DistributedDatabase::Models::CreateDistributedAutonomousDatabaseShardDetails
    ...
    # @return [Array<OCI::DistributedDatabase::Models::CreateShardPeerWithDedicatedInfraDetails>]
    ...
    def self.swagger_types
      {
        ...
        'peer_details': :'Array<OCI::DistributedDatabase::Models::CreateShardPeerWithDedicatedInfraDetails>',
        'vault_id': :'String',
        'kms_key_id': :'String',
    ...
    # @option attributes [Array<OCI::DistributedDatabase::Models::CreateShardPeerWithDedicatedInfraDetails>] :peer_details The value to assign to the {#peer_details} property
    ...
    def hash
      [source, admin_password, compute_count, data_storage_size_in_gbs, shard_space, is_auto_scaling_enabled, cloud_autonomous_vm_cluster_id, peer_cloud_autonomous_vm_cluster_ids, peer_details, vault_id, kms_key_id, kms_key_version_id, okv_key_store_id, okv_end_point_group].hash
    end
