...
module OCI
  ...
  class DistributedDatabase::Models::DistributedAutonomousDbBackupDestination
    TYPE_ENUM = [
      TYPE_NFS = 'NFS'.freeze,
    ...
    def hash
      [type, id, vpc_user, vpc_password, internet_proxy, dbrs_policy_id, is_remote, remote_region].hash
    end
