...
module OCI
  ...
  class DistributedDatabase::Models::DistributedDatabaseCatalogWithExadbXsNewVaultAndCluster < DistributedDatabase::Models::DistributedDatabaseCatalog
    STATUS_ENUM = [
    ...
    # **[Required]** Status of EXADB_XS based catalog.
    # @return [String]
    attr_reader :status
    ...
    # @return [Array<OCI::DistributedDatabase::Models::CatalogPeerWithExadbXsNewVaultAndCluster>]
    ...
    def self.swagger_types
      {
        ...
        'peer_details': :'Array<OCI::DistributedDatabase::Models::CatalogPeerWithExadbXsNewVaultAndCluster>',
    ...
    # @option attributes [Array<OCI::DistributedDatabase::Models::CatalogPeerWithExadbXsNewVaultAndCluster>] :peer_details The value to assign to the {#peer_details} property
    ...
    def hash
      [source, name, time_created, time_updated, db_home_id, shard_group, vault_id, kms_key_id, kms_key_version_id, status, supporting_resource_id, container_database_id, availability_domain, db_storage_vault_details, vm_cluster_details, peer_details, metadata].hash
    end
