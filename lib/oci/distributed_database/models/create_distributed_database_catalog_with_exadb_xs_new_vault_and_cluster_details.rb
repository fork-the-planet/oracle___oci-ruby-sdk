...
module OCI
  ...
  class DistributedDatabase::Models::CreateDistributedDatabaseCatalogWithExadbXsNewVaultAndClusterDetails < DistributedDatabase::Models::CreateDistributedDatabaseCatalogDetails
    ...
    # @return [Array<OCI::DistributedDatabase::Models::CreateCatalogPeerWithExadbXsNewVaultAndClusterDetails>]
    ...
    # @option attributes [Array<OCI::DistributedDatabase::Models::CreateCatalogPeerWithExadbXsNewVaultAndClusterDetails>] :peer_details The value to assign to the {#peer_details} property
