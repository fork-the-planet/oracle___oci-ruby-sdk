...
module OCI
  ...
  class OspGateway::Models::SubscriptionSummary
    ...
    # @return [BOOLEAN]
    attr_accessor :is_corporate_conversion_allowed
    ...
    # @option attributes [BOOLEAN] :is_corporate_conversion_allowed The value to assign to the {#is_corporate_conversion_allowed} property
