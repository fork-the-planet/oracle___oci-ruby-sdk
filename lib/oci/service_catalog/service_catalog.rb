...
require 'oci/service_catalog/models/configuration'
...
require 'oci/service_catalog/models/service_catalog_mode_enum'
require 'oci/service_catalog/models/service_catalog_status_enum'
