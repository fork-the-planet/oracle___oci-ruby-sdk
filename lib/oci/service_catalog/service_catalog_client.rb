...
module OCI
  ...
  class ServiceCatalog::ServiceCatalogClient
    ...
    #   please provide the request ID.
    #
    # @return [Response] A Response object with data of type {OCI::ServiceCatalog::Models::Configuration Configuration}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/servicecatalog/get_configuration.rb.html) to see an example of how to use get_configuration API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/servicecatalog/list_all_applications.rb.html) to see an example of how to use list_all_applications API.
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :service_catalog_id The unique identifier for the service catalog.
    # @option opts [String] :status Status of the service catalog, use as a filter to filter out all active catalogs.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request,
    #   please provide the request ID.
    #
    # @option opts [Integer] :limit How many records to return. Specify a value greater than zero and less than or equal to 1000. The default is 30.
