...
module OCI
  ...
  class ServiceCatalog::Models::UpdateServiceCatalogDetails
    ...
    # **[Required]** The status of a service catalog.
    # @return [String]
    attr_reader :status
    ...
    def initialize(attributes = {})
      ...
      self.status = "INACTIVE" if status.nil? && !attributes.key?(:'status') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [display_name, status, defined_tags, freeform_tags].hash
    end
