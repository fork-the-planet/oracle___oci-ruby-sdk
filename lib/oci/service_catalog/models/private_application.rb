...
module OCI
  ...
  class ServiceCatalog::Models::PrivateApplication
    ...
    def hash
      [lifecycle_state, compartment_id, id, display_name, short_description, long_description, logo, package_type, time_created, time_updated, defined_tags, freeform_tags, system_tags].hash
    end
