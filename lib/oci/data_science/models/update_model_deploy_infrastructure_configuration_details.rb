...
module OCI
  ...
  class DataScience::Models::UpdateModelDeployInfrastructureConfigurationDetails
    INFRASTRUCTURE_TYPE_ENUM = [
      INFRASTRUCTURE_TYPE_MANAGED_COMPUTE_CLUSTER = 'MANAGED_COMPUTE_CLUSTER'.freeze
    ].freeze

    # **[Required]** The type of the infrastructure for model deployment.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'infrastructureType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::DataScience::Models::UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails' if type == 'MANAGED_COMPUTE_CLUSTER'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::UpdateModelDeployInfrastructureConfigurationDetails'
    end
