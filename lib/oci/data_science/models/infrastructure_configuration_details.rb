...
module OCI
  ...
  class DataScience::Models::InfrastructureConfigurationDetails
    INFRASTRUCTURE_TYPE_ENUM = [
      INFRASTRUCTURE_TYPE_INSTANCE_POOL = 'INSTANCE_POOL'.freeze,
      INFRASTRUCTURE_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The type of the model deployment infrastructure.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::InstancePoolInfrastructureConfigurationDetails' if type == 'INSTANCE_POOL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::InfrastructureConfigurationDetails'
    end
