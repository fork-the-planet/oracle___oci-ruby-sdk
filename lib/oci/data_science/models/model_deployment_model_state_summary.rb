...
module OCI
  ...
  class DataScience::Models::ModelDeploymentModelStateSummary
    STATE_ENUM = [
      STATE_SUCCESS = 'SUCCESS'.freeze,
      STATE_FAILED = 'FAILED'.freeze,
      STATE_INCONSISTENT = 'INCONSISTENT'.freeze,
      STATE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the deployed model in model deployment.
    # @return [String]
    ...
    # **[Required]** SaaS friendly name for the model OCID.
    # @return [String]
    attr_accessor :inference_key

    # **[Required]** The state of the deployed model in model deployment.
    # @return [String]
    attr_reader :state
    ...
    def hash
      [model_id, project_id, display_name, inference_key, state, freeform_tags, defined_tags, system_tags].hash
    end
