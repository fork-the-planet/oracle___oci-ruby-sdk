...
module OCI
  ...
  class DataScience::Models::MultiNodeJobInfrastructureConfigurationDetails < DataScience::Models::JobInfrastructureConfigurationDetails
    # **[Required]** The name that corresponds to the JobShapeSummary to use for the job node
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['jobInfrastructureType'] = 'MULTI_NODE'
