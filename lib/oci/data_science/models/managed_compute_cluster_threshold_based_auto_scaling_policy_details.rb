...
require 'date'
require_relative 'managed_compute_cluster_auto_scaling_policy_details'
...
module OCI
  ...
  class DataScience::Models::ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails < DataScience::Models::ManagedComputeClusterAutoScalingPolicyDetails
    # **[Required]** The list of autoscaling policy rules.
    # @return [Array<OCI::DataScience::Models::ManagedComputeClusterMetricExpressionRule>]
    attr_accessor :rules
    ...
    # **[Required]** For a threshold-based autoscaling policy, this value is the initial number of instances to launch in the managed compute cluster type compute target
    ...
    # @option attributes [Array<OCI::DataScience::Models::ManagedComputeClusterMetricExpressionRule>] :rules The value to assign to the {#rules} property
