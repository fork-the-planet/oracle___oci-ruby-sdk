...
module OCI
  ...
  class DataScience::Models::ModelDeploymentSummary
    ...
    def hash
      [id, time_created, display_name, description, project_id, created_by, compartment_id, model_deployment_configuration_details, category_log_details, model_deployment_url, lifecycle_state, model_deployment_system_data, freeform_tags, defined_tags].hash
    end
