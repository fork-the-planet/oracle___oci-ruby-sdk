...
module OCI
  ...
  class DataScience::Models::ModelGroupModelSummary
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model group.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** A user-friendly display name of the model.
    # @return [String]
    ...
    # @option attributes [String] :inference_key The value to assign to the {#inference_key} property
    ...
    def initialize(attributes = {})
      ...
      self.inference_key = attributes[:'inferenceKey'] if attributes[:'inferenceKey']

      raise 'You cannot provide both :inferenceKey and :inference_key' if attributes.key?(:'inferenceKey') && attributes.key?(:'inference_key')

      self.inference_key = attributes[:'inference_key'] if attributes[:'inference_key']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        inference_key == other.inference_key &&
    ...
    def hash
      [id, model_id, inference_key, compartment_id, project_id, display_name, created_by, time_created, time_updated, lifecycle_state, lifecycle_details, category, is_model_by_reference, freeform_tags, defined_tags, system_tags].hash
    end
