...
module OCI
  ...
  class DataScience::Models::ManagedComputeClusterScalingPolicy
    POLICY_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::ManagedComputeClusterAutoScalingPolicy' if type == 'AUTOSCALING'
      return 'OCI::DataScience::Models::ManagedComputeClusterFixedSizeScalingPolicy' if type == 'FIXED_SIZE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::ManagedComputeClusterScalingPolicy'
    end
