...
require 'date'
require_relative 'update_infrastructure_configuration_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Instance Pool based Infrastructure configuration details for update.
  class DataScience::Models::UpdateInstancePoolInfrastructureConfigurationDetails < DataScience::Models::UpdateInfrastructureConfigurationDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['infrastructureType'] = 'INSTANCE_POOL'
    ...
    def hash
      [infrastructure_type, instance_configuration, scaling_policy, bandwidth_mbps, maximum_bandwidth_mbps].hash
    end
