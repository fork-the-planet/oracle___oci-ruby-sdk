...
require 'date'
require_relative 'managed_compute_cluster_workload_auto_scaling_policy_details'
...
module OCI
  ...
  class DataScience::Models::ManagedComputeClusterWorkloadThresholdBasedPolicyDetails < DataScience::Models::ManagedComputeClusterWorkloadAutoScalingPolicyDetails
    # **[Required]** The list of autoscaling policy rules for workload scaling..
    # @return [Array<OCI::DataScience::Models::ManagedComputeClusterWorkloadMetricExpressionRule>]
    attr_accessor :rules
    ...
    # **[Required]** For a threshold-based autoscaling policy, this value is the initial number of workload instances to launch
    ...
    # @return [OCI::DataScience::Models::ManagedComputeClusterWorkloadScalePolicy]
    attr_accessor :scale_in_policy

    # @return [OCI::DataScience::Models::ManagedComputeClusterWorkloadScalePolicy]
    attr_accessor :scale_out_policy
    ...
    # @option attributes [Array<OCI::DataScience::Models::ManagedComputeClusterWorkloadMetricExpressionRule>] :rules The value to assign to the {#rules} property
    ...
    # @option attributes [OCI::DataScience::Models::ManagedComputeClusterWorkloadScalePolicy] :scale_in_policy The value to assign to the {#scale_in_policy} property
    # @option attributes [OCI::DataScience::Models::ManagedComputeClusterWorkloadScalePolicy] :scale_out_policy The value to assign to the {#scale_out_policy} property
