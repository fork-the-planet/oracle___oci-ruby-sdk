...
module OCI
  ...
  class DataScience::Models::ManagedComputeClusterWorkloadScalingPolicy
    POLICY_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::ManagedComputeClusterWorkloadAutoScalingPolicy' if type == 'AUTOSCALING'
      return 'OCI::DataScience::Models::ManagedComputeClusterWorkloadFixedSizeScalingPolicy' if type == 'FIXED_SIZE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::ManagedComputeClusterWorkloadScalingPolicy'
    end
