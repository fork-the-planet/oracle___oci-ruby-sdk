...
module OCI
  ...
  class DataScience::Models::PipelineStepOverrideDetails
    ...
    def hash
      [step_name, step_configuration_details, step_container_configuration_details, step_dataflow_configuration_details, step_infrastructure_configuration_details, step_storage_mount_configuration_details_list].hash
    end
