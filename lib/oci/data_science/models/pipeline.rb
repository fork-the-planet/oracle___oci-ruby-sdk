...
module OCI
  ...
  class DataScience::Models::Pipeline
    ...
    def hash
      [id, time_created, time_updated, created_by, project_id, compartment_id, display_name, description, configuration_details, log_configuration_details, infrastructure_configuration_details, storage_mount_configuration_details_list, parameters, step_details, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
