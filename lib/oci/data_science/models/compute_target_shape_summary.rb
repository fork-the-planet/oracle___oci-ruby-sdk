...
module OCI
  ...
  #
  class DataScience::Models::ComputeTargetShapeSummary
    SHAPE_SERIES_ENUM = [
    ...
    # **[Required]** The name of the compute target shape.
    #
    # @return [String]
    attr_accessor :name

    # **[Required]** The number of cores associated with this compute target shape.
    #
    # @return [Integer]
    attr_accessor :core_count

    # **[Required]** The amount of memory in GBs associated with this compute target shape.
    #
    # @return [Integer]
