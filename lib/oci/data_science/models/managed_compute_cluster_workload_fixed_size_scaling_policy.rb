...
module OCI
  ...
  class DataScience::Models::ManagedComputeClusterWorkloadFixedSizeScalingPolicy < DataScience::Models::ManagedComputeClusterWorkloadScalingPolicy
    # **[Required]** The number of instances of the workload.
    # @return [Integer]
