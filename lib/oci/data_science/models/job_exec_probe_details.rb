...
require 'date'
require_relative 'job_probe_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Runs a command in the job run to check whether application is healthy or not.
  class DataScience::Models::JobExecProbeDetails < DataScience::Models::JobProbeDetails
    # **[Required]** The commands to run in the target job run to perform the startup probe
    # @return [Array<String>]
    ...
    def initialize(attributes = {})
      ...
      attributes['jobProbeCheckType'] = 'EXEC'
    ...
    def hash
      [job_probe_check_type, command, period_in_seconds, failure_threshold, initial_delay_in_seconds].hash
    end
