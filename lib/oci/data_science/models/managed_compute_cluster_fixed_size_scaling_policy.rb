...
module OCI
  ...
  class DataScience::Models::ManagedComputeClusterFixedSizeScalingPolicy < DataScience::Models::ManagedComputeClusterScalingPolicy
    # **[Required]** The number of instances for the managed compute cluster type compute target.
    # @return [Integer]
