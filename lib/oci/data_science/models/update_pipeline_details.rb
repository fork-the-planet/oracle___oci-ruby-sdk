...
module OCI
  ...
  class DataScience::Models::UpdatePipelineDetails
    ...
    def hash
      [display_name, description, configuration_details, infrastructure_configuration_details, log_configuration_details, storage_mount_configuration_details_list, step_details, parameters, freeform_tags, defined_tags].hash
    end
