...
module OCI
  ...
  class DataScience::Models::UpdateSingleModelConfigurationDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of a model.
    # @return [String]
