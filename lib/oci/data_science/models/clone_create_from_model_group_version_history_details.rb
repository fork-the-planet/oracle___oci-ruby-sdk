...
module OCI
  ...
  class DataScience::Models::CloneCreateFromModelGroupVersionHistoryDetails < DataScience::Models::ModelGroupCloneSourceDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model group version history.
    # @return [String]
