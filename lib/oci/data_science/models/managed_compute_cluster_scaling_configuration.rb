...
module OCI
  ...
  class DataScience::Models::ManagedComputeClusterScalingConfiguration
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::ManagedComputeClusterCustomExpressionQueryScalingConfiguration' if type == 'QUERY'
      return 'OCI::DataScience::Models::ManagedComputeClusterPredefinedExpressionThresholdScalingConfiguration' if type == 'THRESHOLD'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::ManagedComputeClusterScalingConfiguration'
    end
