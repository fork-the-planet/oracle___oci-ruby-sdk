...
module OCI
  ...
  class DataScience::Models::PatchInstruction
    OPERATION_ENUM = [
      OPERATION_INSERT = 'INSERT'.freeze,
      OPERATION_REMOVE = 'REMOVE'.freeze
    ].freeze

    # **[Required]** A single instruction to be included as part of Patch request content. Enum type (INSERT and REMOVE).
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::PatchRemoveMemberModels' if type == 'REMOVE'
      return 'OCI::DataScience::Models::PatchInsertNewMemberModels' if type == 'INSERT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::PatchInstruction'
    end
