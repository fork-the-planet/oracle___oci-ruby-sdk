...
module OCI
  ...
  class DataScience::Models::UpdateOcirModelDeploymentEnvironmentConfigurationDetails < DataScience::Models::UpdateModelDeploymentEnvironmentConfigurationDetails
    ...
    def hash
      [environment_configuration_type, image, image_digest, image_signature_id, cmd, entrypoint, server_port, health_check_port, environment_variables, predict_api_specification, custom_http_endpoints].hash
    end
