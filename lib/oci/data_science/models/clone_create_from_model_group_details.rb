...
require 'date'
require_relative 'model_group_clone_source_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Parameters needed to cloning a model group from an existing model group.
  class DataScience::Models::CloneCreateFromModelGroupDetails < DataScience::Models::ModelGroupCloneSourceDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model group to be cloned.
    # @return [String]
    attr_accessor :source_id

    # @return [OCI::DataScience::Models::ModifyModelGroupDetails]
    attr_accessor :modify_model_group_details

    # @return [OCI::DataScience::Models::PatchModelGroupMemberModelDetails]
    attr_accessor :patch_model_group_member_model_details
    ...
    # @option attributes [OCI::DataScience::Models::ModifyModelGroupDetails] :modify_model_group_details The value to assign to the {#modify_model_group_details} property
    # @option attributes [OCI::DataScience::Models::PatchModelGroupMemberModelDetails] :patch_model_group_member_model_details The value to assign to the {#patch_model_group_member_model_details} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelGroupCloneSourceType'] = 'MODEL_GROUP'
