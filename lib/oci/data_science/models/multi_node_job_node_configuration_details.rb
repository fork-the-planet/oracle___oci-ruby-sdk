...
require 'date'
require 'logger'
require_relative 'job_node_configuration_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # MultiNodeJobNodeConfigurationDetails
  class DataScience::Models::MultiNodeJobNodeConfigurationDetails < DataScience::Models::JobNodeConfigurationDetails
    STARTUP_ORDER_ENUM = [
    ...
    # @return [OCI::DataScience::Models::JobNetworkConfiguration]
    attr_accessor :job_network_configuration

    # List of JobNodeGroupConfigurationDetails
    # @return [Array<OCI::DataScience::Models::JobNodeGroupConfigurationDetails>]
    attr_accessor :job_node_group_configuration_details_list
    ...
    # @option attributes [String] :startup_order The value to assign to the {#startup_order} property
    # @option attributes [Integer] :maximum_runtime_in_minutes The value to assign to the {#maximum_runtime_in_minutes} property
    # @option attributes [OCI::DataScience::Models::JobNetworkConfiguration] :job_network_configuration The value to assign to the {#job_network_configuration} property
    # @option attributes [Array<OCI::DataScience::Models::JobNodeGroupConfigurationDetails>] :job_node_group_configuration_details_list The value to assign to the {#job_node_group_configuration_details_list} property
    ...
    # @param [Object] startup_order Object to be assigned
    def startup_order=(startup_order)
      # rubocop:disable Style/ConditionalAssignment
      if startup_order && !STARTUP_ORDER_ENUM.include?(startup_order)
        OCI.logger.debug("Unknown value for 'startup_order' [" + startup_order + "]. Mapping to 'STARTUP_ORDER_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @startup_order = STARTUP_ORDER_UNKNOWN_ENUM_VALUE
      else
