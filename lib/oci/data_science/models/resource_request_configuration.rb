...
module OCI
  ...
  class DataScience::Models::ResourceRequestConfiguration
    # **[Required]** The ocpus required to be allocated to run the workload.
    #
    # @return [Float]
    attr_accessor :ocpus

    # **[Required]** The memory in Gbs required to be allocated to run the workload.
    #
    # @return [Float]
