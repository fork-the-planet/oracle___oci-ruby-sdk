...
require 'date'
require_relative 'infrastructure_configuration_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Instance Pool based Infrastructure configuration details.
  class DataScience::Models::InstancePoolInfrastructureConfigurationDetails < DataScience::Models::InfrastructureConfigurationDetails
