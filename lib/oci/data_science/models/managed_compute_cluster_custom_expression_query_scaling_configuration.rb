...
require 'date'
require 'logger'
require_relative 'managed_compute_cluster_scaling_configuration'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The scaling configuration for the custom metric expression rule.
  class DataScience::Models::ManagedComputeClusterCustomExpressionQueryScalingConfiguration < DataScience::Models::ManagedComputeClusterScalingConfiguration
    ...
    # @option attributes [String] :pending_duration The value to assign to the {OCI::DataScience::Models::ManagedComputeClusterScalingConfiguration#pending_duration #pending_duration} proprety
    # @option attributes [Integer] :instance_count_adjustment The value to assign to the {OCI::DataScience::Models::ManagedComputeClusterScalingConfiguration#instance_count_adjustment #instance_count_adjustment} proprety
