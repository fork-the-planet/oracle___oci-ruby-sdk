...
module OCI
  ...
  class FileStorage::Models::CreateSnapshotDetails
    ...
    # @return [OCI::FileStorage::Models::LockDurationDetails]
    attr_accessor :lock_duration_details
    ...
    # @option attributes [OCI::FileStorage::Models::LockDurationDetails] :lock_duration_details The value to assign to the {#lock_duration_details} property
    ...
    def hash
      [file_system_id, name, expiration_time, lock_duration_details, freeform_tags, defined_tags, locks].hash
    end
