...
module OCI
  ...
  class FileStorage::Models::CreateLdapBindAccountDetails < FileStorage::Models::CreateOutboundConnectorDetails
    ...
    def hash
      [availability_domain, compartment_id, display_name, connector_type, freeform_tags, defined_tags, locks, endpoints, bind_distinguished_name, password_secret_id, password_secret_version, trusted_certificate_secret_id, trusted_certificate_secret_version].hash
    end
