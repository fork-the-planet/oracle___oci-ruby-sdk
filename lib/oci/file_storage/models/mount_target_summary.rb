...
module OCI
  ...
  class FileStorage::Models::MountTargetSummary
    ...
    def hash
      [availability_domain, compartment_id, display_name, export_set_id, id, lifecycle_state, private_ip_ids, mount_target_ipv6_ids, subnet_id, nsg_ids, time_billing_cycle_end, observed_throughput, requested_throughput, reserved_storage_capacity, time_created, locks, freeform_tags, defined_tags, system_tags, security_attributes].hash
    end
