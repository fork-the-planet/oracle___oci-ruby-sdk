...
module OCI
  ...
  class DataFlow::Models::PrivateEndpointSummary
    ...
    def hash
      [compartment_id, defined_tags, display_name, dns_zones, freeform_tags, id, lifecycle_state, max_host_count, nsg_ids, owner_principal_id, owner_user_name, scan_details, subnet_id, time_created, time_updated, security_attributes].hash
    end
