...
module OCI
  ...
  class AiLanguage::Models::Endpoint
    ...
    def hash
      [id, _alias, display_name, compartment_id, project_id, description, time_created, time_updated, lifecycle_state, lifecycle_details, inference_units, model_id, freeform_tags, defined_tags, system_tags].hash
    end
