...
module OCI
  ...
  class Core::ComputeManagementClient
    ...
    #   may be rejected).
    #
    # @option opts [String] :opc_compute_cluster_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
    ...
    def launch_instance_configuration(instance_configuration_id, instance_configuration, opts = {})
      ...
      header_params[:'content-type'] = 'application/json'
      header_params[:'opc-retry-token'] = opts[:opc_retry_token] if opts[:opc_retry_token]
      header_params[:'opc-compute-cluster-id'] = opts[:opc_compute_cluster_id] if opts[:opc_compute_cluster_id]
      # rubocop:enable Style/NegatedIf
      header_params[:'opc-retry-token'] ||= OCI::Retry.generate_opc_retry_token
    ...
    #
    # @param [String] instance_pool_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance pool.
    # @param [OCI::Core::Models::TerminationProceedInstancePoolInstanceDetails] termination_proceed_instance_pool_instance_details Instance to be marked for terminating.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/core/termination_proceed_instance_pool_instance.rb.html) to see an example of how to use termination_proceed_instance_pool_instance API.
    def termination_proceed_instance_pool_instance(instance_pool_id, termination_proceed_instance_pool_instance_details, opts = {})
      logger.debug 'Calling operation ComputeManagementClient#termination_proceed_instance_pool_instance.' if logger

      raise "Missing the required parameter 'instance_pool_id' when calling termination_proceed_instance_pool_instance." if instance_pool_id.nil?
      raise "Missing the required parameter 'termination_proceed_instance_pool_instance_details' when calling termination_proceed_instance_pool_instance." if termination_proceed_instance_pool_instance_details.nil?
      raise "Parameter value for 'instance_pool_id' must not be blank" if OCI::Internal::Util.blank_string?(instance_pool_id)

      path = '/instancePools/{instancePoolId}/actions/terminationProceed'.sub('{instancePoolId}', instance_pool_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(termination_proceed_instance_pool_instance_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ComputeManagementClient#termination_proceed_instance_pool_instance') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
