...
module OCI
  ...
  class Core::VirtualNetworkClientCompositeOperations
    ...
    # Calls {OCI::Core::VirtualNetworkClient#add_ipv4_subnet_cidr} and then waits for the {OCI::Core::Models::WorkRequest}
    ...
    # @param [OCI::Core::Models::AddIpv4SubnetCidrDetails] add_ipv4_subnet_cidr_details Details object for adding an IPv4 prefix to a subnet.
    ...
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#add_ipv4_subnet_cidr}
    ...
    def add_ipv4_subnet_cidr_and_wait_for_state(subnet_id, add_ipv4_subnet_cidr_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.add_ipv4_subnet_cidr(subnet_id, add_ipv4_subnet_cidr_details, base_operation_opts)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#bulk_create_ipv6s} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Core::Models::BulkCreateIpv6sDetails] bulk_create_ipv6s_details Create Ipv6s in bulk.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#bulk_create_ipv6s}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def bulk_create_ipv6s_and_wait_for_state(bulk_create_ipv6s_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_create_ipv6s(bulk_create_ipv6s_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#bulk_create_private_ips} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Core::Models::BulkCreatePrivateIpsDetails] bulk_create_private_ips_details Details used to create secondary private IPs.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#bulk_create_private_ips}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def bulk_create_private_ips_and_wait_for_state(bulk_create_private_ips_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_create_private_ips(bulk_create_private_ips_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#bulk_delete_ipv6s} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Core::Models::BulkDeleteIpv6sDetails] bulk_delete_ipv6s_details Details of the IPv6s to delete.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#bulk_delete_ipv6s}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def bulk_delete_ipv6s_and_wait_for_state(bulk_delete_ipv6s_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_delete_ipv6s(bulk_delete_ipv6s_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#bulk_delete_private_ips} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Core::Models::BulkDeletePrivateIpsDetails] bulk_delete_private_ips_details Details of the secondary IPv4 addresses to delete.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#bulk_delete_private_ips}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def bulk_delete_private_ips_and_wait_for_state(bulk_delete_private_ips_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_delete_private_ips(bulk_delete_private_ips_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#bulk_detach_ipv6s} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Core::Models::BulkDetachIpv6sDetails] bulk_detach_ipv6s_details Details needed to detach IPv6s in bulk.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#bulk_detach_ipv6s}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def bulk_detach_ipv6s_and_wait_for_state(bulk_detach_ipv6s_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_detach_ipv6s(bulk_detach_ipv6s_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#bulk_detach_private_ips} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Core::Models::BulkDetachPrivateIpsDetails] bulk_detach_private_ips_details The secondary IPv4 addresses to detach.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#bulk_detach_private_ips}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def bulk_detach_private_ips_and_wait_for_state(bulk_detach_private_ips_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_detach_private_ips(bulk_detach_private_ips_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#bulk_update_ipv6s} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Core::Models::BulkUpdateIpv6sDetails] bulk_update_ipv6s_details Details of the IPv6s to update.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#bulk_update_ipv6s}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def bulk_update_ipv6s_and_wait_for_state(bulk_update_ipv6s_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_update_ipv6s(bulk_update_ipv6s_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#bulk_update_private_ips} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Core::Models::BulkUpdatePrivateIpsDetails] bulk_update_private_ips_details Details of the secondary IPv4 addresses to update.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#bulk_update_private_ips}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def bulk_update_private_ips_and_wait_for_state(bulk_update_private_ips_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_update_private_ips(bulk_update_private_ips_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#modify_ipv4_subnet_cidr} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] subnet_id Specify the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet.
    # @param [OCI::Core::Models::ModifyIpv4SubnetCidrDetails] modify_ipv4_subnet_cidr_details Details object for updating a SUBNET IPv4 prefix.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#modify_ipv4_subnet_cidr}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def modify_ipv4_subnet_cidr_and_wait_for_state(subnet_id, modify_ipv4_subnet_cidr_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.modify_ipv4_subnet_cidr(subnet_id, modify_ipv4_subnet_cidr_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#patch_subnet} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] subnet_id Specify the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet.
    # @param [OCI::Core::Models::PatchSubnetDetails] patch_subnet_details Details object for patching a subnet.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#patch_subnet}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def patch_subnet_and_wait_for_state(subnet_id, patch_subnet_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.patch_subnet(subnet_id, patch_subnet_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#patch_vcn} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] vcn_id Specify the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN.
    # @param [OCI::Core::Models::PatchVcnDetails] patch_vcn_details Details object for patching a VCN.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#patch_vcn}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def patch_vcn_and_wait_for_state(vcn_id, patch_vcn_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.patch_vcn(vcn_id, patch_vcn_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::VirtualNetworkClient#remove_ipv4_subnet_cidr} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] subnet_id Specify the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet.
    # @param [OCI::Core::Models::RemoveIpv4SubnetCidrDetails] remove_ipv4_subnet_cidr_details Details object for removing an IPv4 SUBNET prefix.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::VirtualNetworkClient#remove_ipv4_subnet_cidr}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def remove_ipv4_subnet_cidr_and_wait_for_state(subnet_id, remove_ipv4_subnet_cidr_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.remove_ipv4_subnet_cidr(subnet_id, remove_ipv4_subnet_cidr_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
