...
module OCI
  ...
  class Core::ComputeClientCompositeOperations
    ...
    # Calls {OCI::Core::ComputeClient#apply_host_configuration} and then waits for the {OCI::Core::Models::ComputeHost} acted upon
    ...
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#apply_host_configuration}
    ...
    def apply_host_configuration_and_wait_for_state(compute_host_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.apply_host_configuration(compute_host_id, base_operation_opts)
    ...
    # Calls {OCI::Core::ComputeClient#check_host_configuration} and then waits for the {OCI::Core::Models::ComputeHost} acted upon
    # to enter the given state(s).
    #
    # @param [String] compute_host_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host.
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeHost#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#check_host_configuration}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Core::Models::ComputeHost}
    def check_host_configuration_and_wait_for_state(compute_host_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.check_host_configuration(compute_host_id, base_operation_opts)
    ...
    # Calls {OCI::Core::ComputeClient#create_compute_image_capability_schema} and then waits for the {OCI::Core::Models::ComputeImageCapabilitySchema} acted upon
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeImageCapabilitySchema#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#create_compute_image_capability_schema}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Core::Models::ComputeImageCapabilitySchema}
    def create_compute_image_capability_schema_and_wait_for_state(create_compute_image_capability_schema_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_compute_image_capability_schema(create_compute_image_capability_schema_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_compute_image_capability_schema(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::Core::ComputeClient#delete_compute_image_capability_schema} and then waits for the {OCI::Core::Models::ComputeImageCapabilitySchema} acted upon
    # to enter the given state(s).
    #
    # @param [String] compute_image_capability_schema_id The id of the compute image capability schema or the image ocid
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeImageCapabilitySchema#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#delete_compute_image_capability_schema}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type nil
    def delete_compute_image_capability_schema_and_wait_for_state(compute_image_capability_schema_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      initial_get_result = @service_client.get_compute_image_capability_schema(compute_image_capability_schema_id)
      operation_result = @service_client.delete_compute_image_capability_schema(compute_image_capability_schema_id, base_operation_opts)
    ...
    # Calls {OCI::Core::ComputeClient#detach_volume} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # Calls {OCI::Core::ComputeClient#terminate_instance} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] instance_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    ...
    # Calls {OCI::Core::ComputeClient#update_compute_image_capability_schema} and then waits for the {OCI::Core::Models::ComputeImageCapabilitySchema} acted upon
    # to enter the given state(s).
    #
    # @param [String] compute_image_capability_schema_id The id of the compute image capability schema or the image ocid
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeImageCapabilitySchema#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#update_compute_image_capability_schema}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Core::Models::ComputeImageCapabilitySchema}
    def update_compute_image_capability_schema_and_wait_for_state(compute_image_capability_schema_id, update_compute_image_capability_schema_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_compute_image_capability_schema(compute_image_capability_schema_id, update_compute_image_capability_schema_details, base_operation_opts)
