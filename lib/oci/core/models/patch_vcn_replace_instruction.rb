...
require 'date'
require_relative 'patch_vcn_instruction'
...
module OCI
  ...
  #
  class Core::Models::PatchVcnReplaceInstruction < Core::Models::PatchVcnInstruction
    ...
    # @option attributes [String] :selection The value to assign to the {OCI::Core::Models::PatchVcnInstruction#selection #selection} proprety
