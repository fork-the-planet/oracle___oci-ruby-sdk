...
module OCI
  ...
  class Core::Models::CreatePrivateIpDetails
    ...
    def hash
      [defined_tags, display_name, freeform_tags, hostname_label, ip_address, cidr_prefix_length, vnic_id, vlan_id, subnet_id, ipv4_subnet_cidr_at_creation, lifetime, route_table_id].hash
    end
