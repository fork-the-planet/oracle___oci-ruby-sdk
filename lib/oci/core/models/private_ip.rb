...
module OCI
  ...
  class Core::Models::PrivateIp
    ...
    # @return [Integer]
    attr_accessor :cidr_prefix_length
    ...
    #
    # @return [String]
    attr_accessor :ipv4_subnet_cidr_at_creation
    ...
    def self.swagger_types
      {
        ...
        'ipv4_subnet_cidr_at_creation': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Integer] :cidr_prefix_length The value to assign to the {#cidr_prefix_length} property
    ...
    # @option attributes [String] :ipv4_subnet_cidr_at_creation The value to assign to the {#ipv4_subnet_cidr_at_creation} property
    def initialize(attributes = {})
      ...
      self.cidr_prefix_length = attributes[:'cidrPrefixLength'] if attributes[:'cidrPrefixLength']

      raise 'You cannot provide both :cidrPrefixLength and :cidr_prefix_length' if attributes.key?(:'cidrPrefixLength') && attributes.key?(:'cidr_prefix_length')

      self.cidr_prefix_length = attributes[:'cidr_prefix_length'] if attributes[:'cidr_prefix_length']
      ...
      self.ipv4_subnet_cidr_at_creation = attributes[:'ipv4SubnetCidrAtCreation'] if attributes[:'ipv4SubnetCidrAtCreation']

      raise 'You cannot provide both :ipv4SubnetCidrAtCreation and :ipv4_subnet_cidr_at_creation' if attributes.key?(:'ipv4SubnetCidrAtCreation') && attributes.key?(:'ipv4_subnet_cidr_at_creation')

      self.ipv4_subnet_cidr_at_creation = attributes[:'ipv4_subnet_cidr_at_creation'] if attributes[:'ipv4_subnet_cidr_at_creation']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        cidr_prefix_length == other.cidr_prefix_length &&
        ...
        ipv4_subnet_cidr_at_creation == other.ipv4_subnet_cidr_at_creation
    end
    ...
    def hash
      [availability_domain, compartment_id, defined_tags, display_name, freeform_tags, hostname_label, id, ip_address, cidr_prefix_length, is_primary, vlan_id, subnet_id, time_created, vnic_id, ip_state, lifetime, route_table_id, ipv4_subnet_cidr_at_creation].hash
    end
