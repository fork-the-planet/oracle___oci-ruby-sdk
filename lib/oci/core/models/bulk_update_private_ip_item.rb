...
module OCI
  ...
  class Core::Models::BulkUpdatePrivateIpItem
    LIFETIME_ENUM = [
      LIFETIME_EPHEMERAL = 'EPHEMERAL'.freeze,
      LIFETIME_RESERVED = 'RESERVED'.freeze
    ].freeze

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secondary Private IP.
    #
    # @return [String]
    ...
    def hash
      [private_ip_id, defined_tags, display_name, freeform_tags, hostname_label, lifetime, route_table_id].hash
    end
