...
module OCI
  ...
  class Core::Models::Shape
    ...
    # @option attributes [Array<String>] :platform_names The value to assign to the {#platform_names} property
    def initialize(attributes = {})
      ...
      self.platform_names = attributes[:'platformNames'] if attributes[:'platformNames']

      raise 'You cannot provide both :platformNames and :platform_names' if attributes.key?(:'platformNames') && attributes.key?(:'platform_names')

      self.platform_names = attributes[:'platform_names'] if attributes[:'platform_names']
    end
    ...
    def hash
      [baseline_ocpu_utilizations, min_total_baseline_ocpus_required, shape, processor_description, ocpus, memory_in_gbs, network_ports, networking_bandwidth_in_gbps, max_vnic_attachments, gpus, gpu_description, local_disks, local_disks_total_size_in_gbs, local_disk_description, rdma_ports, rdma_bandwidth_in_gbps, is_live_migration_supported, ocpu_options, memory_options, networking_bandwidth_options, max_vnic_attachment_options, platform_config_options, is_billed_for_stopped_instance, billing_type, quota_names, is_subcore, is_flexible, resize_compatible_shapes, recommended_alternatives, platform_names].hash
    end
