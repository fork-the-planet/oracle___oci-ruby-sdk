...
module OCI
  ...
  class Core::Models::CreateVnicDetails
    ...
    # @option attributes [String] :subnet_cidr The value to assign to the {#subnet_cidr} property
    ...
    def initialize(attributes = {})
      ...
      self.subnet_cidr = attributes[:'subnetCidr'] if attributes[:'subnetCidr']

      raise 'You cannot provide both :subnetCidr and :subnet_cidr' if attributes.key?(:'subnetCidr') && attributes.key?(:'subnet_cidr')

      self.subnet_cidr = attributes[:'subnet_cidr'] if attributes[:'subnet_cidr']
    ...
    def hash
      [assign_ipv6_ip, assign_public_ip, assign_private_dns_record, defined_tags, display_name, freeform_tags, security_attributes, hostname_label, ipv6_address_ipv6_subnet_cidr_pair_details, subnet_cidr, nsg_ids, private_ip, private_ip_id, skip_source_dest_check, subnet_id, vlan_id].hash
    end
