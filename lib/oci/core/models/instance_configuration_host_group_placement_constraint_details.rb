...
require 'date'
require_relative 'instance_configuration_placement_constraint_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The details for providing placement constraints using the compute host group OCID.
  #
  class Core::Models::InstanceConfigurationHostGroupPlacementConstraintDetails < Core::Models::InstanceConfigurationPlacementConstraintDetails
    # **[Required]** The OCID of the compute host group. This is only available for dedicated capacity customers.
    # @return [String]
