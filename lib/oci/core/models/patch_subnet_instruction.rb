...
module OCI
  ...
  class Core::Models::PatchSubnetInstruction
    OPERATION_ENUM = [
      OPERATION_REPLACE = 'REPLACE'.freeze
    ].freeze

    # **[Required]** The operation to apply. Values are capitalized per OCI convention but should be compared
    # case-insensitively.
    #
    # @return [String]
    attr_reader :operation

    # **[Required]** The set of values to which the operation applies as a [JMESPath expression](https://jmespath.org/specification.html) for evaluation
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Core::Models::PatchSubnetReplaceInstruction' if type == 'REPLACE'
