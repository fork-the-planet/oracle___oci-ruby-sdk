...
require 'date'
require_relative 'patch_subnet_instruction'
...
module OCI
  ...
  #
  class Core::Models::PatchSubnetReplaceInstruction < Core::Models::PatchSubnetInstruction
    # **[Required]** The desired final IPv6 CIDR value(s) to apply to the selected field. This field must
    ...
    # @option attributes [String] :selection The value to assign to the {OCI::Core::Models::PatchSubnetInstruction#selection #selection} proprety
