...
module OCI
  ...
  class Core::Models::LaunchInstanceShapeConfigDetails
    ...
    def resource_management=(resource_management)
      raise "Invalid value for 'resource_management': this must be one of the values in RESOURCE_MANAGEMENT_ENUM." if resource_management && !RESOURCE_MANAGEMENT_ENUM.include?(resource_management)
