...
module OCI
  ...
  class Core::Models::BulkCreateIpv6sItem
    LIFETIME_ENUM = [
    ...
    def hash
      [defined_tags, display_name, freeform_tags, ip_address, lifetime, route_table_id, ipv6_subnet_cidr, hostname, cidr_prefix_length].hash
    end
