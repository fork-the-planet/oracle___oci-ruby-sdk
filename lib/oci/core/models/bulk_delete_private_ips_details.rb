...
module OCI
  ...
  class Core::Models::BulkDeletePrivateIpsDetails
    ...
    # **[Required]** A secondary IPv4 address to delete.
    #
    # @return [Array<OCI::Core::Models::BulkDeletePrivateIpItem>]
    attr_accessor :bulk_delete_private_ip_item
    ...
    def self.swagger_types
      {
        ...
        'vlan_id': :'String',
        'subnet_id': :'String',
        'bulk_delete_private_ip_item': :'Array<OCI::Core::Models::BulkDeletePrivateIpItem>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Core::Models::BulkDeletePrivateIpItem>] :bulk_delete_private_ip_item The value to assign to the {#bulk_delete_private_ip_item} property
    def initialize(attributes = {})
      ...
      self.bulk_delete_private_ip_item = attributes[:'bulkDeletePrivateIpItem'] if attributes[:'bulkDeletePrivateIpItem']

      raise 'You cannot provide both :bulkDeletePrivateIpItem and :bulk_delete_private_ip_item' if attributes.key?(:'bulkDeletePrivateIpItem') && attributes.key?(:'bulk_delete_private_ip_item')

      self.bulk_delete_private_ip_item = attributes[:'bulk_delete_private_ip_item'] if attributes[:'bulk_delete_private_ip_item']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        bulk_delete_private_ip_item == other.bulk_delete_private_ip_item
    end
    ...
    def hash
      [vnic_id, vlan_id, subnet_id, bulk_delete_private_ip_item].hash
    end
