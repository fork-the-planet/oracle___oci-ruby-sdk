...
module OCI
  ...
  class Core::Models::BulkUpdateIpv6sItem
    LIFETIME_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IPv6 object.
    #
    # @return [String]
    attr_accessor :ipv6_id
    ...
    # @option attributes [String] :ipv6_id The value to assign to the {#ipv6_id} property
    ...
    def initialize(attributes = {})
      ...
      self.ipv6_id = attributes[:'ipv6Id'] if attributes[:'ipv6Id']

      raise 'You cannot provide both :ipv6Id and :ipv6_id' if attributes.key?(:'ipv6Id') && attributes.key?(:'ipv6_id')

      self.ipv6_id = attributes[:'ipv6_id'] if attributes[:'ipv6_id']
    ...
    def hash
      [defined_tags, display_name, freeform_tags, ipv6_id, lifetime, route_table_id, hostname].hash
    end
