...
module OCI
  # The data to update a [compute cluster](https://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/compute-clusters.htm).
  #
  ...
  class Core::Models::UpdateComputeClusterDetails
    ...
    def hash
      [display_name, defined_tags, freeform_tags, placement_constraint_details].hash
    end
