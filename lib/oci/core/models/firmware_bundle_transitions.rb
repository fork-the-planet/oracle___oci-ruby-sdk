...
module OCI
  ...
  class Core::Models::FirmwareBundleTransitions
    ...
    # @option attributes [Array<String>] :upgrades The value to assign to the {#upgrades} property
    # @option attributes [Array<String>] :downgrades The value to assign to the {#downgrades} property
    def initialize(attributes = {})
      ...
      self.upgrades = attributes[:'upgrades'] if attributes[:'upgrades']

      self.downgrades = attributes[:'downgrades'] if attributes[:'downgrades']
    end
