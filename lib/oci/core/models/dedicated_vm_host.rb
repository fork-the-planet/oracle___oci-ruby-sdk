...
module OCI
  ...
  class Core::Models::DedicatedVmHost
    ...
    # Run {#list_dedicated_vm_host_shapes list_dedicated_vm_host_shapes} API to see details of this capacity configuration.
    #
    # @return [String]
    ...
    #
    # @return [Float]
    attr_accessor :remaining_local_volume_in_gbs

    # A list of total and remaining CPU, memory, and local volume per capacity bucket.
    #
    # @return [Array<OCI::Core::Models::CapacityBin>]
    ...
    def self.swagger_types
      {
        ...
        'capacity_bins': :'Array<OCI::Core::Models::CapacityBin>',
    ...
    # @option attributes [Float] :remaining_local_volume_in_gbs The value to assign to the {#remaining_local_volume_in_gbs} property
    # @option attributes [Array<OCI::Core::Models::CapacityBin>] :capacity_bins The value to assign to the {#capacity_bins} property
    ...
    def initialize(attributes = {})
      ...
      self.capacity_config = attributes[:'capacityConfig'] if attributes[:'capacityConfig']

      raise 'You cannot provide both :capacityConfig and :capacity_config' if attributes.key?(:'capacityConfig') && attributes.key?(:'capacity_config')

      self.capacity_config = attributes[:'capacity_config'] if attributes[:'capacity_config']
