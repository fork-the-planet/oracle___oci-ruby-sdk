...
module OCI
  ...
  class Core::Models::UpdateComputeGpuMemoryClusterDetails
    ...
    # @return [OCI::Core::Models::UpdateComputeGpuMemoryClusterScaleConfig]
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'gpu_memory_cluster_scale_config': :'OCI::Core::Models::UpdateComputeGpuMemoryClusterScaleConfig',
    ...
    # @option attributes [OCI::Core::Models::UpdateComputeGpuMemoryClusterScaleConfig] :gpu_memory_cluster_scale_config The value to assign to the {#gpu_memory_cluster_scale_config} property
    ...
    def hash
      [instance_configuration_id, size, defined_tags, freeform_tags, display_name, gpu_memory_cluster_scale_config, private_ip_ids].hash
    end
