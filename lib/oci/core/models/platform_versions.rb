...
module OCI
  ...
  class Core::Models::PlatformVersions
    ...
    # @return [Array<OCI::Core::Models::ComponentVersion>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'platform': :'String',
        'versions': :'Array<OCI::Core::Models::ComponentVersion>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Core::Models::ComponentVersion>] :versions The value to assign to the {#versions} property
