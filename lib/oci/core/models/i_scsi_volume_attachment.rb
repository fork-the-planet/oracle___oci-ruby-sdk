...
module OCI
  ...
  class Core::Models::IScsiVolumeAttachment < Core::Models::VolumeAttachment
    ...
    # @option attributes [String] :ipv6 The value to assign to the {#ipv6} property
