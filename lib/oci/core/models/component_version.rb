...
module OCI
  ...
  class Core::Models::ComponentVersion
    # **[Required]** The type of component.
    # @return [String]
    attr_accessor :component_type

    # **[Required]** A list of firmware versions associated with this component type.
    # @return [Array<String>]
    ...
    # @option attributes [Array<String>] :version The value to assign to the {#version} property
