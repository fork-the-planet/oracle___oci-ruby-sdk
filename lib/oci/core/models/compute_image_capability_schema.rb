...
module OCI
  ...
  class Core::Models::ComputeImageCapabilitySchema
    ...
    def hash
      [id, compartment_id, compute_global_image_capability_schema_id, compute_global_image_capability_schema_version_name, image_id, lifecycle_state, defined_tags, display_name, freeform_tags, schema_data, time_created].hash
    end
