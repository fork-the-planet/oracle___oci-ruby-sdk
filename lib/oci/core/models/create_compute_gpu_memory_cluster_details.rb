...
module OCI
  ...
  class Core::Models::CreateComputeGpuMemoryClusterDetails
    ...
    # @return [OCI::Core::Models::CreateComputeGpuMemoryClusterScaleConfig]
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'gpu_memory_cluster_scale_config': :'OCI::Core::Models::CreateComputeGpuMemoryClusterScaleConfig',
    ...
    # @option attributes [OCI::Core::Models::CreateComputeGpuMemoryClusterScaleConfig] :gpu_memory_cluster_scale_config The value to assign to the {#gpu_memory_cluster_scale_config} property
    ...
    def hash
      [availability_domain, compartment_id, gpu_memory_fabric_id, compute_cluster_id, instance_configuration_id, size, defined_tags, freeform_tags, display_name, gpu_memory_cluster_scale_config, private_ip_ids].hash
    end
