...
module OCI
  ...
  class Core::Models::InstanceConfigurationLaunchInstanceDetails
    LAUNCH_MODE_ENUM = [
      ...
      LAUNCH_MODE_ACCELERATEDPV = 'ACCELERATEDPV'.freeze,
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_ai_enterprise_enabled

    # @return [OCI::Core::Models::InstanceConfigurationPlacementConstraintDetails]
    ...
    def self.swagger_types
      {
        ...
        'placement_constraint_details': :'OCI::Core::Models::InstanceConfigurationPlacementConstraintDetails',
    ...
    # @option attributes [BOOLEAN] :is_ai_enterprise_enabled The value to assign to the {#is_ai_enterprise_enabled} property
    # @option attributes [OCI::Core::Models::InstanceConfigurationPlacementConstraintDetails] :placement_constraint_details The value to assign to the {#placement_constraint_details} property
