...
module OCI
  ...
  class Core::Models::InstancePoolSummary
    ...
    def hash
      [id, compartment_id, display_name, instance_configuration_id, pool_type, lifecycle_state, availability_domains, size, time_created, defined_tags, freeform_tags, current_size].hash
    end
