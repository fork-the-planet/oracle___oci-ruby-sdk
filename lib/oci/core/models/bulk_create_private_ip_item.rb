...
module OCI
  ...
  class Core::Models::BulkCreatePrivateIpItem
    LIFETIME_ENUM = [
    ...
    def hash
      [defined_tags, display_name, freeform_tags, hostname_label, ip_address, lifetime, route_table_id, cidr_prefix_length, ipv4_subnet_cidr_at_creation].hash
    end
