...
module OCI
  ...
  class Core::Models::CreateSubnetDetails
    ...
    def hash
      [availability_domain, cidr_block, ipv4_cidr_blocks, compartment_id, defined_tags, dhcp_options_id, display_name, dns_label, freeform_tags, ipv6_cidr_block, ipv6_cidr_blocks, prohibit_internet_ingress, prohibit_public_ip_on_vnic, route_table_id, security_list_ids, vcn_id].hash
    end
