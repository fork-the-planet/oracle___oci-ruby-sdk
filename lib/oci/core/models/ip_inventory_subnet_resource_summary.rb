...
module OCI
  ...
  class Core::Models::IpInventorySubnetResourceSummary
    ...
    def initialize(attributes = {})
      ...
      self.is_primary = false if is_primary.nil? && !attributes.key?(:'isPrimary') # rubocop:disable Style/StringLiterals
      ...
      self.is_primary = false if is_primary.nil? && !attributes.key?(:'isPrimary') && !attributes.key?(:'is_primary') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [ip_id, ip_address, ip_address_lifetime, parent_cidr, associated_public_ip, public_ip_lifetime, associated_public_ip_pool, dns_host_name, assigned_resource_name, is_primary, assigned_resource_type, address_type, assigned_time].hash
    end
