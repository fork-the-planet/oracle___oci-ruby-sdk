...
module OCI
  # The data for creating a [compute cluster](https://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/compute-clusters.htm).
  #
  ...
  class Core::Models::ComputeCluster
    ...
    def hash
      [availability_domain, compartment_id, display_name, defined_tags, freeform_tags, placement_constraint_details, id, lifecycle_state, time_created, time_updated].hash
    end
