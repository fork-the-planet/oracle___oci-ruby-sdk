...
module OCI
  ...
  class Core::Models::Subnet
    ...
    #
    # @return [Array<String>]
    attr_accessor :ipv4_cidr_blocks
    ...
    # @option attributes [Array<String>] :ipv4_cidr_blocks The value to assign to the {#ipv4_cidr_blocks} property
    ...
    def initialize(attributes = {})
      ...
      self.ipv4_cidr_blocks = attributes[:'ipv4CidrBlocks'] if attributes[:'ipv4CidrBlocks']

      raise 'You cannot provide both :ipv4CidrBlocks and :ipv4_cidr_blocks' if attributes.key?(:'ipv4CidrBlocks') && attributes.key?(:'ipv4_cidr_blocks')

      self.ipv4_cidr_blocks = attributes[:'ipv4_cidr_blocks'] if attributes[:'ipv4_cidr_blocks']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        ipv4_cidr_blocks == other.ipv4_cidr_blocks &&
    ...
    def hash
      [availability_domain, cidr_block, ipv4_cidr_blocks, compartment_id, defined_tags, dhcp_options_id, display_name, dns_label, freeform_tags, id, ipv6_cidr_block, ipv6_cidr_blocks, ipv6_virtual_router_ip, lifecycle_state, prohibit_internet_ingress, prohibit_public_ip_on_vnic, route_table_id, security_list_ids, subnet_domain_name, time_created, vcn_id, virtual_router_ip, virtual_router_mac].hash
    end
