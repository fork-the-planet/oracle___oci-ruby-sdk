...
module OCI
  ...
  class ManagementAgent::ManagementAgentClient
    ...
    def region=(new_region)
      ...
      @endpoint = OCI::Regions.get_service_endpoint_for_template(@region, 'https://management-agent.{region}.{dualStack?ds.:}oci.{secondLevelDomain}', 'management-agent') + '/20200202'
    ...
    #
    # @param [OCI::ManagementAgent::Models::CreateNamedCredentialDetails] create_named_credential_details Details of Named Credential to be created for the given Management Agent.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    #   provide matches the resource's current etag value.
    #
    # @return [Response] A Response object with data of type {OCI::ManagementAgent::Models::NamedCredential NamedCredential}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/create_named_credential.rb.html) to see an example of how to use create_named_credential API.
    def create_named_credential(create_named_credential_details, opts = {})
      logger.debug 'Calling operation ManagementAgentClient#create_named_credential.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagementAgentClient#create_named_credential') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::ManagementAgent::Models::NamedCredential'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @param [String] named_credential_id Named credential ID
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/delete_named_credential.rb.html) to see an example of how to use delete_named_credential API.
    def delete_named_credential(named_credential_id, opts = {})
      logger.debug 'Calling operation ManagementAgentClient#delete_named_credential.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagementAgentClient#delete_named_credential') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::ManagementAgent::Models::NamedCredential NamedCredential}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/get_named_credential.rb.html) to see an example of how to use get_named_credential API.
    def get_named_credential(named_credential_id, opts = {})
      logger.debug 'Calling operation ManagementAgentClient#get_named_credential.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagementAgentClient#get_named_credential') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @option opts [String] :management_agent_id Filter the named credential metadata which is compatible with the given Management Agent identifier.
    # @return [Response] A Response object with data of type {OCI::ManagementAgent::Models::NamedCredentialsMetadatum NamedCredentialsMetadatum}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/get_named_credentials_metadatum.rb.html) to see an example of how to use get_named_credentials_metadatum API.
    def get_named_credentials_metadatum(compartment_id, opts = {})
      logger.debug 'Calling operation ManagementAgentClient#get_named_credentials_metadatum.' if logger

      raise "Missing the required parameter 'compartment_id' when calling get_named_credentials_metadatum." if compartment_id.nil?
      ...
      query_params = {}
      query_params[:compartmentId] = compartment_id
      query_params[:managementAgentId] = opts[:management_agent_id] if opts[:management_agent_id]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagementAgentClient#get_named_credentials_metadatum') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::ManagementAgent::Models::NamedCredentialsMetadatum'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    def list_management_agent_plugins(compartment_id, opts = {})
      ...
      platform_type_allowable_values = %w[LINUX WINDOWS SOLARIS MACOSX AIX]
      if opts[:platform_type] && !opts[:platform_type].empty?
        opts[:platform_type].each do |val_to_check|
          unless platform_type_allowable_values.include?(val_to_check)
            raise 'Invalid value for "platform_type", must be one of LINUX, WINDOWS, SOLARIS, MACOSX, AIX.'
          end
        end
      end
    ...
    # A list of Management Agent Data Sources for the given Management Agent Id.
    #
    # @param [String] management_agent_id The ManagementAgentID of the agent from which the named credentials are associated.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    ...
    # @option opts [String] :sort_order The sort order to use, either 'asc' or 'desc'.
    #   Allowed values are: ASC, DESC
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. If no value is specified timeCreated is default.
    #    (default to timeCreated)
    #   Allowed values are: name, type, timeCreated, lifecycleState
    # @option opts [Array<OCI::ManagementAgent::Models::OCI::ManagementAgent::Models::NamedCredentialLifecycleState>] :lifecycle_state Filter to return only Management Agents in the particular lifecycle state.
    # @option opts [Array<String>] :name Filter list for these name items.
    # @option opts [Array<String>] :type Filter list for these type values.
    # @option opts [Array<String>] :id Filter list for these Named credentials identifiers (ocid) values.
    # @return [Response] A Response object with data of type {OCI::ManagementAgent::Models::NamedCredentialCollection NamedCredentialCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/list_named_credentials.rb.html) to see an example of how to use list_named_credentials API.
    def list_named_credentials(management_agent_id, opts = {})
      logger.debug 'Calling operation ManagementAgentClient#list_named_credentials.' if logger

      raise "Missing the required parameter 'management_agent_id' when calling list_named_credentials." if management_agent_id.nil?

      if opts[:sort_order] && !%w[ASC DESC].include?(opts[:sort_order])
        raise 'Invalid value for "sort_order", must be one of ASC, DESC.'
      end

      if opts[:sort_by] && !%w[name type timeCreated lifecycleState].include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of name, type, timeCreated, lifecycleState.'
      end
      ...
      # Query Params
      query_params = {}
      query_params[:managementAgentId] = management_agent_id
      query_params[:page] = opts[:page] if opts[:page]
      query_params[:limit] = opts[:limit] if opts[:limit]
      query_params[:sortOrder] = opts[:sort_order] if opts[:sort_order]
      query_params[:sortBy] = opts[:sort_by] if opts[:sort_by]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagementAgentClient#list_named_credentials') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::ManagementAgent::Models::NamedCredentialCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    def list_work_requests(compartment_id, opts = {})
      ...
      type_allowable_values = %w[DEPLOY_PLUGIN UPGRADE_PLUGIN CREATE_PLUGIN CREATE_UPGRADE_PLUGINS AGENTIMAGE_UPGRADE CREATE_DATA_SOURCE UPDATE_DATA_SOURCE DELETE_DATA_SOURCE CREATE_NAMEDCREDENTIALS UPDATE_NAMEDCREDENTIALS DELETE_NAMEDCREDENTIALS AGENT_UPGRADE]
      if opts[:type] && !opts[:type].empty?
        opts[:type].each do |val_to_check|
          unless type_allowable_values.include?(val_to_check)
            raise 'Invalid value for "type", must be one of DEPLOY_PLUGIN, UPGRADE_PLUGIN, CREATE_PLUGIN, CREATE_UPGRADE_PLUGINS, AGENTIMAGE_UPGRADE, CREATE_DATA_SOURCE, UPDATE_DATA_SOURCE, DELETE_DATA_SOURCE, CREATE_NAMEDCREDENTIALS, UPDATE_NAMEDCREDENTIALS, DELETE_NAMEDCREDENTIALS, AGENT_UPGRADE.'
          end
        end
      end
    ...
    #
    # @param [String] named_credential_id Named credential ID
    # @param [OCI::ManagementAgent::Models::UpdateNamedCredentialDetails] update_named_credential_details Details of named credential to be updated.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    #
    # @return [Response] A Response object with data of type {OCI::ManagementAgent::Models::NamedCredential NamedCredential}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/update_named_credential.rb.html) to see an example of how to use update_named_credential API.
    def update_named_credential(named_credential_id, update_named_credential_details, opts = {})
      logger.debug 'Calling operation ManagementAgentClient#update_named_credential.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagementAgentClient#update_named_credential') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
