...
module OCI
  ...
  class ManagementAgent::Models::ManagementAgentSummary
    ...
    # @option attributes [String] :latest_supported_version The value to assign to the {#latest_supported_version} property
    ...
    def initialize(attributes = {})
      ...
      self.latest_supported_version = attributes[:'latestSupportedVersion'] if attributes[:'latestSupportedVersion']

      raise 'You cannot provide both :latestSupportedVersion and :latest_supported_version' if attributes.key?(:'latestSupportedVersion') && attributes.key?(:'latest_supported_version')

      self.latest_supported_version = attributes[:'latest_supported_version'] if attributes[:'latest_supported_version']
    ...
    def hash
      [id, install_key_id, display_name, platform_type, platform_name, platform_version, version, resource_artifact_version, is_agent_auto_upgradable, time_created, time_updated, host, host_id, plugin_list, compartment_id, time_last_heartbeat, availability_status, lifecycle_state, lifecycle_details, is_customer_deployed, install_type, latest_supported_version, data_source_summary_list, freeform_tags, defined_tags, system_tags].hash
    end
