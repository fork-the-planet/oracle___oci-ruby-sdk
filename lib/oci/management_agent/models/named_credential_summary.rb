...
module OCI
  ...
  #
  class ManagementAgent::Models::NamedCredentialSummary
    # **[Required]** Identifier for Named Credential. This is the NamedCredential resource OCID.
    # @return [String]
    attr_accessor :id

    # **[Required]** Name for Named Credential. This is unique for the Management Agent.
    # @return [String]
    attr_accessor :name

    # **[Required]** Type of the Named Credential
    # @return [String]
    attr_accessor :type

    # **[Required]** The Management Agent this named credential is associated with. This is the ManagementAgent resource OCID.
    # @return [String]
    ...
    # **[Required]** The time the Named Credential was created. An RFC3339 formatted datetime string
    # @return [DateTime]
    ...
    # **[Required]** Properties for the named credential
    # @return [Array<OCI::ManagementAgent::Models::NamedCredentialProperty>]
    attr_accessor :properties

    # **[Required]** The current state of the named credential
    # @return [String]
    ...
    def self.swagger_types
      {
        ...
        'properties': :'Array<OCI::ManagementAgent::Models::NamedCredentialProperty>',
    ...
    # @option attributes [Array<OCI::ManagementAgent::Models::NamedCredentialProperty>] :properties The value to assign to the {#properties} property
    ...
    def hash
      [id, name, type, management_agent_id, description, time_created, time_updated, properties, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
