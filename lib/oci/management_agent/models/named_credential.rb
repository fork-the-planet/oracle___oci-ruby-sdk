...
module OCI
  ...
  #
  class ManagementAgent::Models::NamedCredential
    ...
    # **[Required]** Identifier for Named Credential.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The Management Agent parent resource to associated with this named credential. This is the ManagementAgent resource OCID.
    # @return [String]
    ...
    def hash
      [id, name, type, management_agent_id, description, time_created, time_updated, lifecycle_state, properties, freeform_tags, defined_tags, system_tags].hash
    end
