...
module OCI
  ...
  #
  class ManagementAgent::Models::CreateNamedCredentialDetails
    # **[Required]** Identifier for Named Credential. This is unique for the Management Agent.
    # @return [String]
    attr_accessor :name
    ...
    # **[Required]** The Management Agent parent resource to associate this named credential with.  This is the ManagementAgent resource OCID.
    # @return [String]
    ...
    def hash
      [name, type, management_agent_id, description, properties, freeform_tags, defined_tags].hash
    end
