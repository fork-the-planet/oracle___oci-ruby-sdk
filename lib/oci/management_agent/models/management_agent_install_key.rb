...
module OCI
  ...
  class ManagementAgent::Models::ManagementAgentInstallKey
    ...
    def hash
      [id, display_name, key, created_by_principal_id, compartment_id, allowed_key_install_count, current_key_install_count, lifecycle_state, lifecycle_details, time_expires, time_created, time_updated, is_unlimited, freeform_tags, defined_tags, system_tags].hash
    end
