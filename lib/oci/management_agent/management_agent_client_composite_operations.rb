...
module OCI
  ...
  class ManagementAgent::ManagementAgentClientCompositeOperations
    ...
    # Calls {OCI::ManagementAgent::ManagementAgentClient#create_named_credential} and then waits for the {OCI::ManagementAgent::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::ManagementAgent::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::ManagementAgent::ManagementAgentClient#create_named_credential}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::ManagementAgent::ManagementAgentClient#delete_named_credential} and then waits for the {OCI::ManagementAgent::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] named_credential_id Named credential ID
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::ManagementAgent::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::ManagementAgent::ManagementAgentClient#delete_named_credential}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::ManagementAgent::ManagementAgentClient#update_named_credential} and then waits for the {OCI::ManagementAgent::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] named_credential_id Named credential ID
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::ManagementAgent::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::ManagementAgent::ManagementAgentClient#update_named_credential}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
