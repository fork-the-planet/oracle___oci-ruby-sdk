...
module OCI
  ...
  class AiSpeech::AIServiceSpeechClient
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :compartment_id The ID of the compartment in which to list resources.
    # @option opts [String] :model_name The model name to filter voices for given model name.
    # @option opts [String] :language_code The Code or Id of the language to filter voices for given language code.
