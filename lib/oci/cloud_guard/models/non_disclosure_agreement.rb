...
module OCI
  ...
  class CloudGuard::Models::NonDisclosureAgreement
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the non-disclosure agreement, which is assigned
    ...
    # **[Required]** The OCID of the principal that called [CreateNonDisclosureAgreement](https://docs.cloud.oracle.com/api/#/en/compliancedocs/release/NonDisclosureAgreement/CreateNonDisclosureAgreement).
    # @return [String]
    ...
    # @return [String]
    attr_accessor :agreement_content
    ...
    # @option attributes [String] :agreement_content The value to assign to the {#agreement_content} property
