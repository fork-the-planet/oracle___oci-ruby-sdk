...
module OCI
  ...
  class CloudGuard::Models::ManagedListSummary
    ...
    def hash
      [id, display_name, description, compartment_id, source_managed_list_id, list_type, group, feed_provider, is_editable, list_items, time_created, time_updated, lifecycle_state, lifecyle_details, freeform_tags, defined_tags, system_tags].hash
    end
