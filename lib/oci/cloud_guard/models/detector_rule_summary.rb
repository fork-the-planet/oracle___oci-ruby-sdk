...
module OCI
  ...
  class CloudGuard::Models::DetectorRuleSummary
    ...
    def hash
      [id, display_name, description, recommendation, detector, service_type, resource_type, rule_type, is_cloneable, managed_list_types, candidate_responder_rules, detector_details, time_created, time_updated, lifecycle_state, lifecycle_details].hash
    end
