...
module OCI
  ...
  class CloudGuard::Models::DetectorRecipeDetectorRule
    DETECTOR_ENUM = [
      ...
      DETECTOR_IAAS_CONTAINER_SECURITY_DETECTOR = 'IAAS_CONTAINER_SECURITY_DETECTOR'.freeze,
    ...
    MANAGED_LIST_TYPES_ENUM = [
      ...
      MANAGED_LIST_TYPES_NAMESPACE_SELECTOR = 'NAMESPACE_SELECTOR'.freeze,
      MANAGED_LIST_TYPES_POD_RESOURCE_SELECTOR = 'POD_RESOURCE_SELECTOR'.freeze,
    ...
    # Detector rule type
    # @return [Array<OCI::CloudGuard::Models::RuleType>]
    attr_accessor :rule_type

    # Is the rule cloneable?
    # @return [BOOLEAN]
    attr_accessor :is_cloneable
    ...
    def self.swagger_types
      {
        ...
        'rule_type': :'Array<OCI::CloudGuard::Models::RuleType>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::RuleType>] :rule_type The value to assign to the {#rule_type} property
    # @option attributes [BOOLEAN] :is_cloneable The value to assign to the {#is_cloneable} property
    ...
    def initialize(attributes = {})
      ...
      self.is_cloneable = attributes[:'isCloneable'] unless attributes[:'isCloneable'].nil?

      raise 'You cannot provide both :isCloneable and :is_cloneable' if attributes.key?(:'isCloneable') && attributes.key?(:'is_cloneable')

      self.is_cloneable = attributes[:'is_cloneable'] unless attributes[:'is_cloneable'].nil?
    ...
    def hash
      [detector_rule_id, display_name, description, recommendation, detector, service_type, resource_type, rule_type, is_cloneable, details, managed_list_types, candidate_responder_rules, time_created, time_updated, lifecycle_state, lifecycle_details, data_source_id, entities_mappings, locks].hash
    end
