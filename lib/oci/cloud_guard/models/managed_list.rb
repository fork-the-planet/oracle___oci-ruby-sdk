...
module OCI
  ...
  class CloudGuard::Models::ManagedList
    LIST_TYPE_ENUM = [
      ...
      LIST_TYPE_NAMESPACE_SELECTOR = 'NAMESPACE_SELECTOR'.freeze,
      LIST_TYPE_POD_RESOURCE_SELECTOR = 'POD_RESOURCE_SELECTOR'.freeze,
    ...
    def hash
      [id, display_name, description, compartment_id, source_managed_list_id, list_type, list_items, group, feed_provider, is_editable, time_created, time_updated, lifecycle_state, lifecyle_details, freeform_tags, defined_tags, system_tags].hash
    end
