...
module OCI
  ...
  class LustreFileStorage::Models::LustreFileSystem
    ...
    # @return [OCI::LustreFileStorage::Models::MaintenanceWindowMetadataDetails]
    attr_accessor :maintenance_window_metadata
    ...
    def self.swagger_types
      {
        ...
        'maintenance_window_metadata': :'OCI::LustreFileStorage::Models::MaintenanceWindowMetadataDetails',
    ...
    # @option attributes [OCI::LustreFileStorage::Models::MaintenanceWindowMetadataDetails] :maintenance_window_metadata The value to assign to the {#maintenance_window_metadata} property
    ...
    def initialize(attributes = {})
      ...
      self.maintenance_window_metadata = attributes[:'maintenanceWindowMetadata'] if attributes[:'maintenanceWindowMetadata']

      raise 'You cannot provide both :maintenanceWindowMetadata and :maintenance_window_metadata' if attributes.key?(:'maintenanceWindowMetadata') && attributes.key?(:'maintenance_window_metadata')

      self.maintenance_window_metadata = attributes[:'maintenance_window_metadata'] if attributes[:'maintenance_window_metadata']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        maintenance_window_metadata == other.maintenance_window_metadata &&
    ...
    def hash
      [id, compartment_id, availability_domain, display_name, file_system_description, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags, nsg_ids, kms_key_id, capacity_in_gbs, subnet_id, performance_tier, management_service_address, file_system_name, lnet, major_version, cluster_placement_group_id, time_billing_cycle_end, maintenance_window, maintenance_window_metadata, root_squash_configuration].hash
    end
