...
module OCI
  ...
  class LustreFileStorage::Models::SyncJobSummary
    JOB_TYPE_ENUM = [
    ...
    def hash
      [id, job_type, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags, is_overwrite, total_objects_scanned, objects_transferred, bytes_transferred, skipped_error_count, time_started, time_finished, lustre_file_system_path, object_storage_path].hash
    end
