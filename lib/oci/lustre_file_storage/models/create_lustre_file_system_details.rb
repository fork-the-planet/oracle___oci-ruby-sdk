...
module OCI
  ...
  class LustreFileStorage::Models::CreateLustreFileSystemDetails
    ...
    def hash
      [compartment_id, availability_domain, display_name, file_system_description, freeform_tags, defined_tags, nsg_ids, file_system_name, kms_key_id, capacity_in_gbs, subnet_id, performance_tier, cluster_placement_group_id, root_squash_configuration, maintenance_window].hash
    end
