...
module OCI
  ...
  #
  class Dbmulticloud::Models::MultiCloudResourceDiscoverySummary
    ...
    def hash
      [id, compartment_id, display_name, oracle_db_connector_id, resources, resource_type, lifecycle_state, lifecycle_state_details, time_created, time_updated, last_modification, freeform_tags, defined_tags, system_tags].hash
    end
