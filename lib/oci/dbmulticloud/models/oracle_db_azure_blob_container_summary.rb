...
module OCI
  ...
  #
  class Dbmulticloud::Models::OracleDbAzureBlobContainerSummary
    ...
    def hash
      [id, display_name, compartment_id, private_endpoint_ip_address, private_endpoint_dns_alias, azure_storage_account_name, azure_storage_container_name, lifecycle_state, lifecycle_state_details, time_created, time_updated, last_modification, freeform_tags, defined_tags, system_tags].hash
    end
