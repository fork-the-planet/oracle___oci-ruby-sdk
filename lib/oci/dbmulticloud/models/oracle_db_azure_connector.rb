...
module OCI
  ...
  #
  class Dbmulticloud::Models::OracleDbAzureConnector
    AZURE_IDENTITY_MECHANISM_ENUM = [
      AZURE_IDENTITY_MECHANISM_ARC_AGENT = 'ARC_AGENT'.freeze,
      AZURE_IDENTITY_MECHANISM_SERVICE_PRINCIPAL = 'SERVICE_PRINCIPAL'.freeze,
      AZURE_IDENTITY_MECHANISM_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    AZURE_IDENTITY_CONNECTIVITY_STATUS_ENUM = [
      AZURE_IDENTITY_CONNECTIVITY_STATUS_CONNECTED = 'CONNECTED'.freeze,
      AZURE_IDENTITY_CONNECTIVITY_STATUS_DISCONNECTED = 'DISCONNECTED'.freeze,
      AZURE_IDENTITY_CONNECTIVITY_STATUS_PARTIALLY_CONNECTED = 'PARTIALLY_CONNECTED'.freeze,
      AZURE_IDENTITY_CONNECTIVITY_STATUS_UNKNOWN = 'UNKNOWN'.freeze,
      AZURE_IDENTITY_CONNECTIVITY_STATUS_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Connector resource.
    # @return [String]
    attr_accessor :id
    ...
    # @return [String]
    attr_reader :azure_identity_mechanism
    ...
    # @return [String]
    attr_reader :azure_identity_connectivity_status
    ...
    # @param [Object] azure_identity_mechanism Object to be assigned
    def azure_identity_mechanism=(azure_identity_mechanism)
      # rubocop:disable Style/ConditionalAssignment
      if azure_identity_mechanism && !AZURE_IDENTITY_MECHANISM_ENUM.include?(azure_identity_mechanism)
        OCI.logger.debug("Unknown value for 'azure_identity_mechanism' [" + azure_identity_mechanism + "]. Mapping to 'AZURE_IDENTITY_MECHANISM_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @azure_identity_mechanism = AZURE_IDENTITY_MECHANISM_UNKNOWN_ENUM_VALUE
      else
        @azure_identity_mechanism = azure_identity_mechanism
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] azure_identity_connectivity_status Object to be assigned
    def azure_identity_connectivity_status=(azure_identity_connectivity_status)
      # rubocop:disable Style/ConditionalAssignment
      if azure_identity_connectivity_status && !AZURE_IDENTITY_CONNECTIVITY_STATUS_ENUM.include?(azure_identity_connectivity_status)
        OCI.logger.debug("Unknown value for 'azure_identity_connectivity_status' [" + azure_identity_connectivity_status + "]. Mapping to 'AZURE_IDENTITY_CONNECTIVITY_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @azure_identity_connectivity_status = AZURE_IDENTITY_CONNECTIVITY_STATUS_UNKNOWN_ENUM_VALUE
      else
        @azure_identity_connectivity_status = azure_identity_connectivity_status
      end
      # rubocop:enable Style/ConditionalAssignment
    end
    ...
    def hash
      [id, display_name, compartment_id, arc_agent_nodes, db_cluster_resource_id, azure_tenant_id, azure_subscription_id, azure_resource_group, access_token, private_endpoint_ip_address, private_endpoint_dns_alias, azure_identity_mechanism, lifecycle_state, lifecycle_state_details, azure_identity_connectivity_status, time_created, time_updated, last_modification, freeform_tags, defined_tags, system_tags].hash
    end
