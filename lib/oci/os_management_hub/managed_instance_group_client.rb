...
module OCI
  ...
  class OsManagementHub::ManagedInstanceGroupClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/list_managed_instance_group_managed_instances.rb.html) to see an example of how to use list_managed_instance_group_managed_instances API.
    def list_managed_instance_group_managed_instances(managed_instance_group_id, opts = {})
      logger.debug 'Calling operation ManagedInstanceGroupClient#list_managed_instance_group_managed_instances.' if logger

      raise "Missing the required parameter 'managed_instance_group_id' when calling list_managed_instance_group_managed_instances." if managed_instance_group_id.nil?
      ...
      path = '/managedInstanceGroups/{managedInstanceGroupId}/managedInstances'.sub('{managedInstanceGroupId}', managed_instance_group_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagedInstanceGroupClient#list_managed_instance_group_managed_instances') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/refresh_software_on_managed_instance_group.rb.html) to see an example of how to use refresh_software_on_managed_instance_group API.
    def refresh_software_on_managed_instance_group(managed_instance_group_id, opts = {})
      logger.debug 'Calling operation ManagedInstanceGroupClient#refresh_software_on_managed_instance_group.' if logger

      raise "Missing the required parameter 'managed_instance_group_id' when calling refresh_software_on_managed_instance_group." if managed_instance_group_id.nil?
      raise "Parameter value for 'managed_instance_group_id' must not be blank" if OCI::Internal::Util.blank_string?(managed_instance_group_id)

      path = '/managedInstanceGroups/{managedInstanceGroupId}/actions/refreshSoftware'.sub('{managedInstanceGroupId}', managed_instance_group_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagedInstanceGroupClient#refresh_software_on_managed_instance_group') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
