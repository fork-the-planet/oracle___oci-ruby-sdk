...
module OCI
  ...
  class OsManagementHub::SoftwareSourceClient
    ...
    #   provide matches the resource's current etag value.
    #
    # @return [Response] A Response object with data of type {OCI::OsManagementHub::Models::SoftwareSourceRepoCollection SoftwareSourceRepoCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/list_available_software_sources_to_add.rb.html) to see an example of how to use list_available_software_sources_to_add API.
    def list_available_software_sources_to_add(compartment_id, opts = {})
      logger.debug 'Calling operation SoftwareSourceClient#list_available_software_sources_to_add.' if logger

      raise "Missing the required parameter 'compartment_id' when calling list_available_software_sources_to_add." if compartment_id.nil?
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'SoftwareSourceClient#list_available_software_sources_to_add') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::OsManagementHub::Models::SoftwareSourceRepoCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
