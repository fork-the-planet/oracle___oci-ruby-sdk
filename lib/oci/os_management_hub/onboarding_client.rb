...
module OCI
  ...
  class OsManagementHub::OnboardingClient
    ...
    #
    # @param [String] profile_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the registration profile.
    # @param [OCI::OsManagementHub::Models::DetachManagementStationFromProfileDetails] detach_management_station_from_profile_details The management station [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to detach from the profile
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/detach_management_station_from_profile.rb.html) to see an example of how to use detach_management_station_from_profile API.
    def detach_management_station_from_profile(profile_id, detach_management_station_from_profile_details, opts = {})
      logger.debug 'Calling operation OnboardingClient#detach_management_station_from_profile.' if logger

      raise "Missing the required parameter 'profile_id' when calling detach_management_station_from_profile." if profile_id.nil?
      raise "Missing the required parameter 'detach_management_station_from_profile_details' when calling detach_management_station_from_profile." if detach_management_station_from_profile_details.nil?
      raise "Parameter value for 'profile_id' must not be blank" if OCI::Internal::Util.blank_string?(profile_id)

      path = '/profiles/{profileId}/actions/detachManagementStation'.sub('{profileId}', profile_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(detach_management_station_from_profile_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'OnboardingClient#detach_management_station_from_profile') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #   Allowed values are: SOFTWARESOURCE, GROUP, LIFECYCLE, STATION, WINDOWS_STANDALONE, UBUNTU_STANDALONE
    ...
    def list_profiles(opts = {})
      ...
      profile_type_allowable_values = %w[SOFTWARESOURCE GROUP LIFECYCLE STATION WINDOWS_STANDALONE UBUNTU_STANDALONE]
      if opts[:profile_type] && !opts[:profile_type].empty?
        opts[:profile_type].each do |val_to_check|
          unless profile_type_allowable_values.include?(val_to_check)
            raise 'Invalid value for "profile_type", must be one of SOFTWARESOURCE, GROUP, LIFECYCLE, STATION, WINDOWS_STANDALONE, UBUNTU_STANDALONE.'
          end
        end
      end
