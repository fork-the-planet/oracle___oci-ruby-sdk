...
module OCI
  ...
  class OsManagementHub::ManagedInstanceClient
    ...
    # @param [String] managed_instance_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance.
    # @param [OCI::OsManagementHub::Models::InstallSnapsOnManagedInstanceDetails] install_snaps_on_managed_instance_details Details about snaps to install.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/install_snaps_on_managed_instance.rb.html) to see an example of how to use install_snaps_on_managed_instance API.
    def install_snaps_on_managed_instance(managed_instance_id, install_snaps_on_managed_instance_details, opts = {})
      logger.debug 'Calling operation ManagedInstanceClient#install_snaps_on_managed_instance.' if logger

      raise "Missing the required parameter 'managed_instance_id' when calling install_snaps_on_managed_instance." if managed_instance_id.nil?
      raise "Missing the required parameter 'install_snaps_on_managed_instance_details' when calling install_snaps_on_managed_instance." if install_snaps_on_managed_instance_details.nil?
      raise "Parameter value for 'managed_instance_id' must not be blank" if OCI::Internal::Util.blank_string?(managed_instance_id)

      path = '/managedInstances/{managedInstanceId}/actions/installSnaps'.sub('{managedInstanceId}', managed_instance_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(install_snaps_on_managed_instance_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagedInstanceClient#install_snaps_on_managed_instance') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #   Allowed values are: name
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    # @return [Response] A Response object with data of type {OCI::OsManagementHub::Models::SnapCollection SnapCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/list_managed_instance_snaps.rb.html) to see an example of how to use list_managed_instance_snaps API.
    def list_managed_instance_snaps(managed_instance_id, opts = {})
      logger.debug 'Calling operation ManagedInstanceClient#list_managed_instance_snaps.' if logger

      raise "Missing the required parameter 'managed_instance_id' when calling list_managed_instance_snaps." if managed_instance_id.nil?
      ...
      path = '/managedInstances/{managedInstanceId}/snaps'.sub('{managedInstanceId}', managed_instance_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagedInstanceClient#list_managed_instance_snaps') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::OsManagementHub::Models::SnapCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    def list_managed_instances(opts = {})
      ...
      arch_type_allowable_values = %w[X86_64 AARCH64 I686 NOARCH SRC I386 AMD64 ARM64 ALL]
      if opts[:arch_type] && !opts[:arch_type].empty?
        opts[:arch_type].each do |val_to_check|
          unless arch_type_allowable_values.include?(val_to_check)
            raise 'Invalid value for "arch_type", must be one of X86_64, AARCH64, I686, NOARCH, SRC, I386, AMD64, ARM64, ALL.'
          end
        end
      end


      os_family_allowable_values = %w[ORACLE_LINUX_10 ORACLE_LINUX_9 ORACLE_LINUX_8 ORACLE_LINUX_7 ORACLE_LINUX_6 WINDOWS_SERVER_2016 WINDOWS_SERVER_2019 WINDOWS_SERVER_2022 WINDOWS_SERVER_2025 WINDOWS_11 ALL UBUNTU_20_04 UBUNTU_22_04 UBUNTU_24_04]
      if opts[:os_family] && !opts[:os_family].empty?
        opts[:os_family].each do |val_to_check|
          unless os_family_allowable_values.include?(val_to_check)
            raise 'Invalid value for "os_family", must be one of ORACLE_LINUX_10, ORACLE_LINUX_9, ORACLE_LINUX_8, ORACLE_LINUX_7, ORACLE_LINUX_6, WINDOWS_SERVER_2016, WINDOWS_SERVER_2019, WINDOWS_SERVER_2022, WINDOWS_SERVER_2025, WINDOWS_11, ALL, UBUNTU_20_04, UBUNTU_22_04, UBUNTU_24_04.'
          end
        end
      end
    ...
    # @param [String] managed_instance_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance.
    # @param [OCI::OsManagementHub::Models::RemoveSnapsFromManagedInstanceDetails] remove_snaps_from_managed_instance_details Details about snaps to install.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/remove_snaps_from_managed_instance.rb.html) to see an example of how to use remove_snaps_from_managed_instance API.
    def remove_snaps_from_managed_instance(managed_instance_id, remove_snaps_from_managed_instance_details, opts = {})
      logger.debug 'Calling operation ManagedInstanceClient#remove_snaps_from_managed_instance.' if logger

      raise "Missing the required parameter 'managed_instance_id' when calling remove_snaps_from_managed_instance." if managed_instance_id.nil?
      raise "Missing the required parameter 'remove_snaps_from_managed_instance_details' when calling remove_snaps_from_managed_instance." if remove_snaps_from_managed_instance_details.nil?
      raise "Parameter value for 'managed_instance_id' must not be blank" if OCI::Internal::Util.blank_string?(managed_instance_id)

      path = '/managedInstances/{managedInstanceId}/actions/removeSnaps'.sub('{managedInstanceId}', managed_instance_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(remove_snaps_from_managed_instance_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagedInstanceClient#remove_snaps_from_managed_instance') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [String] managed_instance_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance.
    # @param [OCI::OsManagementHub::Models::SwitchSnapChannelOnManagedInstanceDetails] switch_snap_channel_on_managed_instance_details Details about snaps to install.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/switch_snap_channel_on_managed_instance.rb.html) to see an example of how to use switch_snap_channel_on_managed_instance API.
    def switch_snap_channel_on_managed_instance(managed_instance_id, switch_snap_channel_on_managed_instance_details, opts = {})
      logger.debug 'Calling operation ManagedInstanceClient#switch_snap_channel_on_managed_instance.' if logger

      raise "Missing the required parameter 'managed_instance_id' when calling switch_snap_channel_on_managed_instance." if managed_instance_id.nil?
      raise "Missing the required parameter 'switch_snap_channel_on_managed_instance_details' when calling switch_snap_channel_on_managed_instance." if switch_snap_channel_on_managed_instance_details.nil?
      raise "Parameter value for 'managed_instance_id' must not be blank" if OCI::Internal::Util.blank_string?(managed_instance_id)

      path = '/managedInstances/{managedInstanceId}/actions/switchSnapChannel'.sub('{managedInstanceId}', managed_instance_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(switch_snap_channel_on_managed_instance_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagedInstanceClient#switch_snap_channel_on_managed_instance') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
