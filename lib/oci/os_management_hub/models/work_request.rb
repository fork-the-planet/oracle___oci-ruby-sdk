...
module OCI
  ...
  class OsManagementHub::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_REGISTER_MANAGED_INSTANCE = 'REGISTER_MANAGED_INSTANCE'.freeze,
      OPERATION_TYPE_LIST_SNAPS = 'LIST_SNAPS'.freeze,
    ...
    # @return [Array<OCI::OsManagementHub::Models::SnapSpecDetails>]
    attr_accessor :snap_specs
    ...
    def self.swagger_types
      {
        ...
        'snap_specs': :'Array<OCI::OsManagementHub::Models::SnapSpecDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::OsManagementHub::Models::SnapSpecDetails>] :snap_specs The value to assign to the {#snap_specs} property
    def initialize(attributes = {})
      ...
      self.snap_specs = attributes[:'snapSpecs'] if attributes[:'snapSpecs']

      raise 'You cannot provide both :snapSpecs and :snap_specs' if attributes.key?(:'snapSpecs') && attributes.key?(:'snap_specs')

      self.snap_specs = attributes[:'snap_specs'] if attributes[:'snap_specs']
    end
