...
module OCI
  ...
  class OsManagementHub::Models::RemoveSnapsFromManagedInstanceDetails
    # **[Required]** The array of snaps to remove.
    # @return [Array<OCI::OsManagementHub::Models::RemoveSnapDetails>]
    attr_accessor :snap_details
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'snap_details': :'Array<OCI::OsManagementHub::Models::RemoveSnapDetails>',
    ...
    # @option attributes [Array<OCI::OsManagementHub::Models::RemoveSnapDetails>] :snap_details The value to assign to the {#snap_details} property
    ...
    def initialize(attributes = {})
      ...
      self.snap_details = attributes[:'snapDetails'] if attributes[:'snapDetails']

      raise 'You cannot provide both :snapDetails and :snap_details' if attributes.key?(:'snapDetails') && attributes.key?(:'snap_details')

      self.snap_details = attributes[:'snap_details'] if attributes[:'snap_details']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        snap_details == other.snap_details &&
    ...
    def hash
      [snap_details, work_request_details].hash
    end
