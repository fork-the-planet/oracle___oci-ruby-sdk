...
module OCI
  ...
  class OsManagementHub::Models::CreateDynamicSetDetails
    MATCH_TYPE_ENUM = [
    ...
    def match_type=(match_type)
      raise "Invalid value for 'match_type': this must be one of the values in MATCH_TYPE_ENUM." if match_type && !MATCH_TYPE_ENUM.include?(match_type)
    ...
    def hash
      [display_name, description, compartment_id, target_compartments, match_type, matching_rule, freeform_tags, defined_tags].hash
    end
