...
module OCI
  ...
  class OsManagementHub::Models::CreateProfileDetails
    PROFILE_TYPE_ENUM = [
      ...
      PROFILE_TYPE_UBUNTU_STANDALONE = 'UBUNTU_STANDALONE'.freeze
    ].freeze

    # **[Required]** A user-friendly name. Must be unique and you can change the name later. Avoid entering
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::OsManagementHub::Models::CreateUbuntuStandAloneProfileDetails' if type == 'UBUNTU_STANDALONE'
