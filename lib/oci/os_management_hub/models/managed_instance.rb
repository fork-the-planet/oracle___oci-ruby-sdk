...
module OCI
  ...
  class OsManagementHub::Models::ManagedInstance
    ...
    ARCHITECTURE_ENUM = [
      ...
      ARCHITECTURE_AMD64 = 'AMD64'.freeze,
      ARCHITECTURE_ARM64 = 'ARM64'.freeze,
      ARCHITECTURE_ALL = 'ALL'.freeze,
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :are_sources_managed
    ...
    #
    # @return [DateTime]
    attr_accessor :time_last_software_refresh
    ...
    # @option attributes [BOOLEAN] :are_sources_managed The value to assign to the {#are_sources_managed} property
    # @option attributes [DateTime] :time_last_software_refresh The value to assign to the {#time_last_software_refresh} property
    def initialize(attributes = {})
      ...
      self.are_sources_managed = attributes[:'areSourcesManaged'] unless attributes[:'areSourcesManaged'].nil?

      raise 'You cannot provide both :areSourcesManaged and :are_sources_managed' if attributes.key?(:'areSourcesManaged') && attributes.key?(:'are_sources_managed')

      self.are_sources_managed = attributes[:'are_sources_managed'] unless attributes[:'are_sources_managed'].nil?

      self.time_last_software_refresh = attributes[:'timeLastSoftwareRefresh'] if attributes[:'timeLastSoftwareRefresh']

      raise 'You cannot provide both :timeLastSoftwareRefresh and :time_last_software_refresh' if attributes.key?(:'timeLastSoftwareRefresh') && attributes.key?(:'time_last_software_refresh')

      self.time_last_software_refresh = attributes[:'time_last_software_refresh'] if attributes[:'time_last_software_refresh']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        are_sources_managed == other.are_sources_managed &&
        time_last_software_refresh == other.time_last_software_refresh
    end
