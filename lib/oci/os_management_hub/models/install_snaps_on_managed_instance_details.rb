...
module OCI
  ...
  class OsManagementHub::Models::InstallSnapsOnManagedInstanceDetails
    # The array of snaps to install.
    # @return [Array<OCI::OsManagementHub::Models::InstallSnapDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'snap_details': :'Array<OCI::OsManagementHub::Models::InstallSnapDetails>',
    ...
    # @option attributes [Array<OCI::OsManagementHub::Models::InstallSnapDetails>] :snap_details The value to assign to the {#snap_details} property
