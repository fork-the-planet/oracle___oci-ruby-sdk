...
module OCI
  ...
  class OsManagementHub::Models::DynamicSet
    ...
    MATCH_TYPE_ENUM = [
      MATCH_TYPE_ANY = 'ANY'.freeze,
      MATCH_TYPE_ALL = 'ALL'.freeze,
      MATCH_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the dynamic set.
    #
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the dynamic set.
    #
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** User-friendly name for the dynamic set.
    # @return [String]
    ...
    # **[Required]** The date and time the dynamic set was created (in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) format).
    #
    # @return [DateTime]
    ...
    # @return [Array<OCI::OsManagementHub::Models::TargetCompartmentDetails>]
    ...
    # @return [OCI::OsManagementHub::Models::MatchingRule]
    ...
    def self.swagger_types
      {
        ...
        'target_compartments': :'Array<OCI::OsManagementHub::Models::TargetCompartmentDetails>',
        'match_type': :'String',
        'matching_rule': :'OCI::OsManagementHub::Models::MatchingRule',
    ...
    # @option attributes [String] :scheduled_job_count The value to assign to the {#scheduled_job_count} property
    # @option attributes [Array<OCI::OsManagementHub::Models::TargetCompartmentDetails>] :target_compartments The value to assign to the {#target_compartments} property
    # @option attributes [String] :match_type The value to assign to the {#match_type} property
    # @option attributes [OCI::OsManagementHub::Models::MatchingRule] :matching_rule The value to assign to the {#matching_rule} property
    ...
    def hash
      [id, compartment_id, display_name, description, time_created, time_updated, lifecycle_state, scheduled_job_count, target_compartments, match_type, matching_rule, freeform_tags, defined_tags, system_tags].hash
    end
