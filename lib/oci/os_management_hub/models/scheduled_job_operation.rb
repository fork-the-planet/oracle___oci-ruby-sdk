...
module OCI
  ...
  class OsManagementHub::Models::ScheduledJobOperation
    ...
    # @return [OCI::OsManagementHub::Models::InstallSnapDetails]
    attr_accessor :install_snap_details

    # @return [OCI::OsManagementHub::Models::RemoveSnapDetails]
    attr_accessor :remove_snap_details

    # @return [OCI::OsManagementHub::Models::SwitchSnapChannelDetails]
    attr_accessor :switch_snap_channel_details
    ...
    # @option attributes [OCI::OsManagementHub::Models::InstallSnapDetails] :install_snap_details The value to assign to the {#install_snap_details} property
    # @option attributes [OCI::OsManagementHub::Models::RemoveSnapDetails] :remove_snap_details The value to assign to the {#remove_snap_details} property
    # @option attributes [OCI::OsManagementHub::Models::SwitchSnapChannelDetails] :switch_snap_channel_details The value to assign to the {#switch_snap_channel_details} property
