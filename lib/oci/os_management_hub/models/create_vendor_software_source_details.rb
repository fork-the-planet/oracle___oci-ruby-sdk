...
module OCI
  ...
  class OsManagementHub::Models::CreateVendorSoftwareSourceDetails < OsManagementHub::Models::CreateSoftwareSourceDetails
    ...
    # @return [String]
    attr_accessor :origin_display_name
    ...
    # @option attributes [String] :origin_display_name The value to assign to the {#origin_display_name} property
    def initialize(attributes = {})
      ...
      self.origin_display_name = attributes[:'originDisplayName'] if attributes[:'originDisplayName']

      raise 'You cannot provide both :originDisplayName and :origin_display_name' if attributes.key?(:'originDisplayName') && attributes.key?(:'origin_display_name')

      self.origin_display_name = attributes[:'origin_display_name'] if attributes[:'origin_display_name']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        origin_display_name == other.origin_display_name
    end
    ...
    def hash
      [compartment_id, display_name, description, software_source_type, freeform_tags, defined_tags, origin_software_source_id, origin_display_name].hash
    end
