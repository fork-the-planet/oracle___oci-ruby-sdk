...
module OCI
  ...
  class OsManagementHub::Models::CreateUbuntuStandAloneProfileDetails < OsManagementHub::Models::CreateProfileDetails
    VENDOR_NAME_ENUM = [
      VENDOR_NAME_ORACLE = 'ORACLE'.freeze,
      VENDOR_NAME_MICROSOFT = 'MICROSOFT'.freeze,
      VENDOR_NAME_CANONICAL = 'CANONICAL'.freeze
    ].freeze
    ...
    def initialize(attributes = {})
      ...
      attributes['profileType'] = 'UBUNTU_STANDALONE'
