...
module OCI
  ...
  class OsManagementHub::Models::ScheduledJob
    ...
    # @option attributes [Array<String>] :dynamic_set_ids The value to assign to the {#dynamic_set_ids} property
    ...
    def initialize(attributes = {})
      ...
      self.dynamic_set_ids = attributes[:'dynamicSetIds'] if attributes[:'dynamicSetIds']

      raise 'You cannot provide both :dynamicSetIds and :dynamic_set_ids' if attributes.key?(:'dynamicSetIds') && attributes.key?(:'dynamic_set_ids')

      self.dynamic_set_ids = attributes[:'dynamic_set_ids'] if attributes[:'dynamic_set_ids']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        dynamic_set_ids == other.dynamic_set_ids &&
    ...
    def hash
      [id, display_name, compartment_id, description, schedule_type, locations, time_next_execution, time_last_execution, recurring_rule, managed_instance_ids, managed_instance_group_ids, managed_compartment_ids, lifecycle_stage_ids, dynamic_set_ids, is_subcompartment_included, operations, work_request_ids, time_created, time_updated, lifecycle_state, is_managed_by_autonomous_linux, freeform_tags, defined_tags, system_tags, is_restricted, retry_intervals, work_request_id].hash
    end
