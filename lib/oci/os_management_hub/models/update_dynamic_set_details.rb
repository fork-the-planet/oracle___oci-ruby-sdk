...
module OCI
  ...
  class OsManagementHub::Models::UpdateDynamicSetDetails
    MATCH_TYPE_ENUM = [
    ...
    def hash
      [display_name, description, target_compartments, match_type, matching_rule, freeform_tags, defined_tags].hash
    end
