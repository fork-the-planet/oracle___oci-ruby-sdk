...
module OCI
  ...
  class OsManagementHub::Models::DetachManagementStationFromProfileDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management station to detach from the profile.
    # @return [String]
