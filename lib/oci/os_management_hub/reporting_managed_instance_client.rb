...
module OCI
  ...
  class OsManagementHub::ReportingManagedInstanceClient
    ...
    # @option opts [Integer] :other_updates_available_equals_to A filter to return instances that have the specified number of available other updates.
    ...
    # @option opts [Integer] :other_updates_available_greater_than A filter to return instances that have more available other updates than the number specified.
    ...
    def get_managed_instance_analytic_content(opts = {}, &block)
      ...
      if opts[:report_type] && !%w[SECURITY BUGFIX ACTIVITY OTHER ALL].include?(opts[:report_type])
        raise 'Invalid value for "report_type", must be one of SECURITY, BUGFIX, ACTIVITY, OTHER, ALL.'
      end
      ...
      query_params[:otherUpdatesAvailableEqualsTo] = opts[:other_updates_available_equals_to] if opts[:other_updates_available_equals_to]
      ...
      query_params[:otherUpdatesAvailableGreaterThan] = opts[:other_updates_available_greater_than] if opts[:other_updates_available_greater_than]
