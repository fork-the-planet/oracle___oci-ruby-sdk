...
module OCI
  ...
  class Email::Models::EmailReturnPath
    ...
    def hash
      [name, id, parent_resource_id, compartment_id, lifecycle_state, lifecycle_details, description, dns_subdomain_name, cname_record_value, time_created, time_updated, freeform_tags, defined_tags, system_tags, locks].hash
    end
