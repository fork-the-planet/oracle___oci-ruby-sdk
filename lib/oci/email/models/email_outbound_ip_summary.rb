...
module OCI
  ...
  class Email::Models::EmailOutboundIpSummary
    ...
    # @option attributes [String] :outbound_ip The value to assign to the {#outbound_ip} property
    # @option attributes [String] :lifecycle_state The value to assign to the {#lifecycle_state} property
    # @option attributes [String] :lifecycle_details The value to assign to the {#lifecycle_details} property
    # @option attributes [String] :assignment_state The value to assign to the {#assignment_state} property
    # @option attributes [DateTime] :time_unassigned The value to assign to the {#time_unassigned} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] assignment_state Object to be assigned
    def assignment_state=(assignment_state)
      # rubocop:disable Style/ConditionalAssignment
      if assignment_state && !ASSIGNMENT_STATE_ENUM.include?(assignment_state)
        OCI.logger.debug("Unknown value for 'assignment_state' [" + assignment_state + "]. Mapping to 'ASSIGNMENT_STATE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @assignment_state = ASSIGNMENT_STATE_UNKNOWN_ENUM_VALUE
      else
