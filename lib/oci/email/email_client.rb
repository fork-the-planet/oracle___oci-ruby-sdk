...
module OCI
  ...
  class Email::EmailClient
    ...
    # @param [OCI::Email::Models::AddLockDetails] add_lock_details Details for adding a lock to a resource.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/add_email_domain_lock.rb.html) to see an example of how to use add_email_domain_lock API.
    def add_email_domain_lock(email_domain_id, add_lock_details, opts = {})
      logger.debug 'Calling operation EmailClient#add_email_domain_lock.' if logger

      raise "Missing the required parameter 'email_domain_id' when calling add_email_domain_lock." if email_domain_id.nil?
      raise "Missing the required parameter 'add_lock_details' when calling add_email_domain_lock." if add_lock_details.nil?
      raise "Parameter value for 'email_domain_id' must not be blank" if OCI::Internal::Util.blank_string?(email_domain_id)

      path = '/emailDomains/{emailDomainId}/actions/addLock'.sub('{emailDomainId}', email_domain_id.to_s)
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#add_email_domain_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # Adds a lock to a resource.
    # @param [String] email_ip_pool_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IpPool.
    # @param [OCI::Email::Models::AddLockDetails] add_lock_details Details for adding a lock to a resource.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #   will be updated or deleted only if the etag you provide matches the resource's current etag value.
    #
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailIpPool EmailIpPool}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/add_email_ip_pool_lock.rb.html) to see an example of how to use add_email_ip_pool_lock API.
    def add_email_ip_pool_lock(email_ip_pool_id, add_lock_details, opts = {})
      logger.debug 'Calling operation EmailClient#add_email_ip_pool_lock.' if logger

      raise "Missing the required parameter 'email_ip_pool_id' when calling add_email_ip_pool_lock." if email_ip_pool_id.nil?
      raise "Missing the required parameter 'add_lock_details' when calling add_email_ip_pool_lock." if add_lock_details.nil?
      raise "Parameter value for 'email_ip_pool_id' must not be blank" if OCI::Internal::Util.blank_string?(email_ip_pool_id)

      path = '/emailIpPools/{emailIpPoolId}/actions/addLock'.sub('{emailIpPoolId}', email_ip_pool_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#add_email_ip_pool_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Email::Models::EmailIpPool'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @param [OCI::Email::Models::AddEmailOutboundIpDetails] add_email_outbound_ip_details Details to add IPs to EmailIpPool.
    # @param [String] email_ip_pool_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IpPool.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/add_email_outbound_ip.rb.html) to see an example of how to use add_email_outbound_ip API.
    def add_email_outbound_ip(add_email_outbound_ip_details, email_ip_pool_id, opts = {})
      logger.debug 'Calling operation EmailClient#add_email_outbound_ip.' if logger

      raise "Missing the required parameter 'add_email_outbound_ip_details' when calling add_email_outbound_ip." if add_email_outbound_ip_details.nil?
      raise "Missing the required parameter 'email_ip_pool_id' when calling add_email_outbound_ip." if email_ip_pool_id.nil?
      raise "Parameter value for 'email_ip_pool_id' must not be blank" if OCI::Internal::Util.blank_string?(email_ip_pool_id)

      path = '/emailIpPools/{emailIpPoolId}/actions/addEmailOutboundIp'.sub('{emailIpPoolId}', email_ip_pool_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(add_email_outbound_ip_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#add_email_outbound_ip') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/add_return_path_lock.rb.html) to see an example of how to use add_return_path_lock API.
    def add_return_path_lock(email_return_path_id, add_lock_details, opts = {})
      logger.debug 'Calling operation EmailClient#add_return_path_lock.' if logger

      raise "Missing the required parameter 'email_return_path_id' when calling add_return_path_lock." if email_return_path_id.nil?
      raise "Missing the required parameter 'add_lock_details' when calling add_return_path_lock." if add_lock_details.nil?
      raise "Parameter value for 'email_return_path_id' must not be blank" if OCI::Internal::Util.blank_string?(email_return_path_id)

      path = '/emailReturnPaths/{emailReturnPathId}/actions/addLock'.sub('{emailReturnPathId}', email_return_path_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#add_return_path_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/add_sender_lock.rb.html) to see an example of how to use add_sender_lock API.
    def add_sender_lock(sender_id, add_lock_details, opts = {})
      logger.debug 'Calling operation EmailClient#add_sender_lock.' if logger

      raise "Missing the required parameter 'sender_id' when calling add_sender_lock." if sender_id.nil?
      raise "Missing the required parameter 'add_lock_details' when calling add_sender_lock." if add_lock_details.nil?
      raise "Parameter value for 'sender_id' must not be blank" if OCI::Internal::Util.blank_string?(sender_id)

      path = '/senders/{senderId}/actions/addLock'.sub('{senderId}', sender_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#add_sender_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [String] email_ip_pool_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IpPool.
    # @param [OCI::Email::Models::ChangeEmailIpPoolCompartmentDetails] change_email_ip_pool_compartment_details Details for the compartment move.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match Used for optimistic concurrency control. In the update or delete call for a resource, set the `if-match`
    ...
    # @option opts [BOOLEAN] :is_lock_override Whether to override locks (if any exist). (default to false)
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/change_email_ip_pool_compartment.rb.html) to see an example of how to use change_email_ip_pool_compartment API.
    def change_email_ip_pool_compartment(email_ip_pool_id, change_email_ip_pool_compartment_details, opts = {})
      logger.debug 'Calling operation EmailClient#change_email_ip_pool_compartment.' if logger

      raise "Missing the required parameter 'email_ip_pool_id' when calling change_email_ip_pool_compartment." if email_ip_pool_id.nil?
      raise "Missing the required parameter 'change_email_ip_pool_compartment_details' when calling change_email_ip_pool_compartment." if change_email_ip_pool_compartment_details.nil?
      raise "Parameter value for 'email_ip_pool_id' must not be blank" if OCI::Internal::Util.blank_string?(email_ip_pool_id)

      path = '/emailIpPools/{emailIpPoolId}/actions/changeCompartment'.sub('{emailIpPoolId}', email_ip_pool_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(change_email_ip_pool_compartment_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#change_email_ip_pool_compartment') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [OCI::Email::Models::CreateEmailIpPoolDetails] create_email_ip_pool_details Details for the new EmailIpPool.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    # @option opts [String] :opc_request_id The request ID for tracing from the system
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailIpPool EmailIpPool}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/create_email_ip_pool.rb.html) to see an example of how to use create_email_ip_pool API.
    def create_email_ip_pool(create_email_ip_pool_details, opts = {})
      logger.debug 'Calling operation EmailClient#create_email_ip_pool.' if logger

      raise "Missing the required parameter 'create_email_ip_pool_details' when calling create_email_ip_pool." if create_email_ip_pool_details.nil?
      ...
      post_body = @api_client.object_to_http_body(create_email_ip_pool_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#create_email_ip_pool') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @option opts [BOOLEAN] :is_lock_override Whether to override locks (if any exist). (default to false)
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/delete_email_ip_pool.rb.html) to see an example of how to use delete_email_ip_pool API.
    def delete_email_ip_pool(email_ip_pool_id, opts = {})
      logger.debug 'Calling operation EmailClient#delete_email_ip_pool.' if logger

      raise "Missing the required parameter 'email_ip_pool_id' when calling delete_email_ip_pool." if email_ip_pool_id.nil?
      raise "Parameter value for 'email_ip_pool_id' must not be blank" if OCI::Internal::Util.blank_string?(email_ip_pool_id)

      path = '/emailIpPools/{emailIpPoolId}'.sub('{emailIpPoolId}', email_ip_pool_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#delete_email_ip_pool') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id The request ID for tracing from the system
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailIpPool EmailIpPool}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/get_email_ip_pool.rb.html) to see an example of how to use get_email_ip_pool API.
    def get_email_ip_pool(email_ip_pool_id, opts = {})
      logger.debug 'Calling operation EmailClient#get_email_ip_pool.' if logger

      raise "Missing the required parameter 'email_ip_pool_id' when calling get_email_ip_pool." if email_ip_pool_id.nil?
      raise "Parameter value for 'email_ip_pool_id' must not be blank" if OCI::Internal::Util.blank_string?(email_ip_pool_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#get_email_ip_pool') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [String] :sort_order The sort order to use, either ascending or descending order.
    #
    # @option opts [String] :sort_by Specifies the attribute with which to sort the Email IpPools.
    #
    #   Default: `TIMECREATED`
    #
    #   * **TIMECREATED:** Sorts by timeCreated.
    ...
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailIpPoolCollection EmailIpPoolCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/list_email_ip_pools.rb.html) to see an example of how to use list_email_ip_pools API.
    def list_email_ip_pools(compartment_id, opts = {})
      logger.debug 'Calling operation EmailClient#list_email_ip_pools.' if logger

      raise "Missing the required parameter 'compartment_id' when calling list_email_ip_pools." if compartment_id.nil?

      if opts[:lifecycle_state] && !OCI::Email::Models::EmailIpPool::LIFECYCLE_STATE_ENUM.include?(opts[:lifecycle_state])
        raise 'Invalid value for "lifecycle_state", must be one of the values in OCI::Email::Models::EmailIpPool::LIFECYCLE_STATE_ENUM.'
      end
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#list_email_ip_pools') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Email::Models::EmailIpPoolCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The request ID for tracing from the system
    # @option opts [String] :outbound_ip The outbound IP address assigned to the tenancy.
    # @option opts [Integer] :limit For list pagination. The maximum number of results per page, or items to return in a
    #   paginated \"List\" call. `1` is the minimum, `1000` is the maximum. For important details about
    #   how pagination works, see [List Pagination](https://docs.cloud.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    #
    ...
    # @option opts [String] :lifecycle_state Filter returned list by specified lifecycle state. This parameter is case-insensitive.
    #
    # @option opts [String] :assignment_state Filter returned list by specified assignment state.
    #    (default to AVAILABLE)
    # @option opts [String] :sort_by The field to sort by. The `OUTBOUNDIP` value returns the list in
    ...
    #    (default to OUTBOUNDIP)
    #   Allowed values are: OUTBOUNDIP
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailOutboundIpCollection EmailOutboundIpCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/list_email_outbound_ips.rb.html) to see an example of how to use list_email_outbound_ips API.
    def list_email_outbound_ips(compartment_id, opts = {})
      logger.debug 'Calling operation EmailClient#list_email_outbound_ips.' if logger

      raise "Missing the required parameter 'compartment_id' when calling list_email_outbound_ips." if compartment_id.nil?

      if opts[:sort_order] && !OCI::Email::Models::SORT_ORDER_ENUM.include?(opts[:sort_order])
        raise 'Invalid value for "sort_order", must be one of the values in OCI::Email::Models::SORT_ORDER_ENUM.'
      end

      if opts[:lifecycle_state] && !OCI::Email::Models::EmailOutboundIpSummary::LIFECYCLE_STATE_ENUM.include?(opts[:lifecycle_state])
        raise 'Invalid value for "lifecycle_state", must be one of the values in OCI::Email::Models::EmailOutboundIpSummary::LIFECYCLE_STATE_ENUM.'
      end

      if opts[:assignment_state] && !OCI::Email::Models::EmailOutboundIpSummary::ASSIGNMENT_STATE_ENUM.include?(opts[:assignment_state])
      ...
      if opts[:sort_by] && !%w[OUTBOUNDIP].include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of OUTBOUNDIP.'
      end
      ...
      query_params = {}
      query_params[:compartmentId] = compartment_id
      query_params[:outboundIp] = opts[:outbound_ip] if opts[:outbound_ip]
      query_params[:limit] = opts[:limit] if opts[:limit]
      query_params[:page] = opts[:page] if opts[:page]
      query_params[:sortOrder] = opts[:sort_order] if opts[:sort_order]
      query_params[:lifecycleState] = opts[:lifecycle_state] if opts[:lifecycle_state]
      query_params[:assignmentState] = opts[:assignment_state] if opts[:assignment_state]
      query_params[:sortBy] = opts[:sort_by] if opts[:sort_by]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#list_email_outbound_ips') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Email::Models::EmailOutboundIpCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :email_ip_pool_id A filter to only return resources that match the given IpPool resource exactly.
    # @option opts [String] :page For list pagination. The value of the opc-next-page response header from the previous \"List\" call.
    #   For important details about how pagination works,
    #   see [List Pagination](https://docs.cloud.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    #
    ...
    def list_senders(compartment_id, opts = {})
      ...
      query_params[:emailIpPoolId] = opts[:email_ip_pool_id] if opts[:email_ip_pool_id]
      query_params[:page] = opts[:page] if opts[:page]
      query_params[:limit] = opts[:limit] if opts[:limit]
      query_params[:sortBy] = opts[:sort_by] if opts[:sort_by]
      query_params[:sortOrder] = opts[:sort_order] if opts[:sort_order]
    ...
    # @option opts [String] :sort_order The sort order to use, either ascending or descending order.
    #
    # @option opts [String] :operation_type A filter to return only resources matching the given operation type.
    ...
    def list_work_requests(compartment_id, opts = {})
      ...
      if opts[:status] && !OCI::Email::Models::OPERATION_STATUS_ENUM.include?(opts[:status])
        raise 'Invalid value for "status", must be one of the values in OCI::Email::Models::OPERATION_STATUS_ENUM.'
      end
      ...
      if opts[:operation_type] && !OCI::Email::Models::OPERATION_TYPE_ENUM.include?(opts[:operation_type])
        raise 'Invalid value for "operation_type", must be one of the values in OCI::Email::Models::OPERATION_TYPE_ENUM.'
      end
    ...
    # @param [String] email_domain_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this email domain.
    # @param [OCI::Email::Models::RemoveLockDetails] remove_lock_details Details for removing a lock from a resource.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The request ID for tracing from the system
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailDomain EmailDomain}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/remove_email_domain_lock.rb.html) to see an example of how to use remove_email_domain_lock API.
    def remove_email_domain_lock(email_domain_id, remove_lock_details, opts = {})
      logger.debug 'Calling operation EmailClient#remove_email_domain_lock.' if logger

      raise "Missing the required parameter 'email_domain_id' when calling remove_email_domain_lock." if email_domain_id.nil?
      raise "Missing the required parameter 'remove_lock_details' when calling remove_email_domain_lock." if remove_lock_details.nil?
      raise "Parameter value for 'email_domain_id' must not be blank" if OCI::Internal::Util.blank_string?(email_domain_id)

      path = '/emailDomains/{emailDomainId}/actions/removeLock'.sub('{emailDomainId}', email_domain_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#remove_email_domain_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # Remove a lock to a resource.
    # @param [String] email_ip_pool_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IpPool.
    # @param [OCI::Email::Models::RemoveLockDetails] remove_lock_details Details for removing a lock to a resource.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The request ID for tracing from the system
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailIpPool EmailIpPool}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/remove_email_ip_pool_lock.rb.html) to see an example of how to use remove_email_ip_pool_lock API.
    def remove_email_ip_pool_lock(email_ip_pool_id, remove_lock_details, opts = {})
      logger.debug 'Calling operation EmailClient#remove_email_ip_pool_lock.' if logger

      raise "Missing the required parameter 'email_ip_pool_id' when calling remove_email_ip_pool_lock." if email_ip_pool_id.nil?
      raise "Missing the required parameter 'remove_lock_details' when calling remove_email_ip_pool_lock." if remove_lock_details.nil?
      raise "Parameter value for 'email_ip_pool_id' must not be blank" if OCI::Internal::Util.blank_string?(email_ip_pool_id)

      path = '/emailIpPools/{emailIpPoolId}/actions/removeLock'.sub('{emailIpPoolId}', email_ip_pool_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#remove_email_ip_pool_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [OCI::Email::Models::RemoveEmailOutboundIpDetails] remove_email_outbound_ip_details Details to remove IPs from EmailIpPool.
    # @param [String] email_ip_pool_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IpPool.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/remove_email_outbound_ip.rb.html) to see an example of how to use remove_email_outbound_ip API.
    def remove_email_outbound_ip(remove_email_outbound_ip_details, email_ip_pool_id, opts = {})
      logger.debug 'Calling operation EmailClient#remove_email_outbound_ip.' if logger

      raise "Missing the required parameter 'remove_email_outbound_ip_details' when calling remove_email_outbound_ip." if remove_email_outbound_ip_details.nil?
      raise "Missing the required parameter 'email_ip_pool_id' when calling remove_email_outbound_ip." if email_ip_pool_id.nil?
      raise "Parameter value for 'email_ip_pool_id' must not be blank" if OCI::Internal::Util.blank_string?(email_ip_pool_id)

      path = '/emailIpPools/{emailIpPoolId}/actions/removeEmailOutboundIp'.sub('{emailIpPoolId}', email_ip_pool_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(remove_email_outbound_ip_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#remove_email_outbound_ip') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailReturnPath EmailReturnPath}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/remove_return_path_lock.rb.html) to see an example of how to use remove_return_path_lock API.
    def remove_return_path_lock(email_return_path_id, remove_lock_details, opts = {})
      logger.debug 'Calling operation EmailClient#remove_return_path_lock.' if logger

      raise "Missing the required parameter 'email_return_path_id' when calling remove_return_path_lock." if email_return_path_id.nil?
      raise "Missing the required parameter 'remove_lock_details' when calling remove_return_path_lock." if remove_lock_details.nil?
      raise "Parameter value for 'email_return_path_id' must not be blank" if OCI::Internal::Util.blank_string?(email_return_path_id)

      path = '/emailReturnPaths/{emailReturnPathId}/actions/removeLock'.sub('{emailReturnPathId}', email_return_path_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#remove_return_path_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Email::Models::Sender Sender}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/remove_sender_lock.rb.html) to see an example of how to use remove_sender_lock API.
    def remove_sender_lock(sender_id, remove_lock_details, opts = {})
      logger.debug 'Calling operation EmailClient#remove_sender_lock.' if logger

      raise "Missing the required parameter 'sender_id' when calling remove_sender_lock." if sender_id.nil?
      raise "Missing the required parameter 'remove_lock_details' when calling remove_sender_lock." if remove_lock_details.nil?
      raise "Parameter value for 'sender_id' must not be blank" if OCI::Internal::Util.blank_string?(sender_id)

      path = '/senders/{senderId}/actions/removeLock'.sub('{senderId}', sender_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#remove_sender_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [String] email_ip_pool_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IpPool.
    # @param [OCI::Email::Models::UpdateEmailIpPoolDetails] update_email_ip_pool_details The information to be updated.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match Used for optimistic concurrency control. In the update or delete call for a resource, set the `if-match`
    ...
    # @option opts [BOOLEAN] :is_lock_override Whether to override locks (if any exist). (default to false)
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/update_email_ip_pool.rb.html) to see an example of how to use update_email_ip_pool API.
    def update_email_ip_pool(email_ip_pool_id, update_email_ip_pool_details, opts = {})
      logger.debug 'Calling operation EmailClient#update_email_ip_pool.' if logger

      raise "Missing the required parameter 'email_ip_pool_id' when calling update_email_ip_pool." if email_ip_pool_id.nil?
      raise "Missing the required parameter 'update_email_ip_pool_details' when calling update_email_ip_pool." if update_email_ip_pool_details.nil?
      raise "Parameter value for 'email_ip_pool_id' must not be blank" if OCI::Internal::Util.blank_string?(email_ip_pool_id)
      ...
      post_body = @api_client.object_to_http_body(update_email_ip_pool_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#update_email_ip_pool') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
