...
require 'oci/email/models/add_email_outbound_ip_details'
require 'oci/email/models/add_lock_details'
require 'oci/email/models/change_email_domain_compartment_details'
require 'oci/email/models/change_email_ip_pool_compartment_details'
...
require 'oci/email/models/create_email_ip_pool_details'
...
require 'oci/email/models/email_ip_pool'
require 'oci/email/models/email_ip_pool_collection'
require 'oci/email/models/email_ip_pool_summary'
require 'oci/email/models/email_outbound_ip_collection'
require 'oci/email/models/email_outbound_ip_summary'
...
require 'oci/email/models/remove_email_outbound_ip_details'
require 'oci/email/models/remove_lock_details'
require 'oci/email/models/resource_lock'
...
require 'oci/email/models/update_email_ip_pool_details'
