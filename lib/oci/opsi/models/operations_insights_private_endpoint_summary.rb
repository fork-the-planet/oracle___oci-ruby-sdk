...
module OCI
  ...
  class Opsi::Models::OperationsInsightsPrivateEndpointSummary
    ...
    def hash
      [id, display_name, compartment_id, vcn_id, subnet_id, is_used_for_rac_dbs, description, time_created, freeform_tags, defined_tags, system_tags, security_attributes, lifecycle_state, lifecycle_details, private_endpoint_status_details].hash
    end
