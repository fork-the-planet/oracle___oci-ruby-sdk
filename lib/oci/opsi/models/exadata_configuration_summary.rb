...
module OCI
  ...
  class Opsi::Models::ExadataConfigurationSummary
    ...
    # @return [OCI::Opsi::Models::ChargebackPlanDetails]
    attr_accessor :chargeback_plan_details
    ...
    # @option attributes [OCI::Opsi::Models::ChargebackPlanDetails] :chargeback_plan_details The value to assign to the {#chargeback_plan_details} property
    def initialize(attributes = {})
      ...
      self.chargeback_plan_details = attributes[:'chargebackPlanDetails'] if attributes[:'chargebackPlanDetails']

      raise 'You cannot provide both :chargebackPlanDetails and :chargeback_plan_details' if attributes.key?(:'chargebackPlanDetails') && attributes.key?(:'chargeback_plan_details')

      self.chargeback_plan_details = attributes[:'chargeback_plan_details'] if attributes[:'chargeback_plan_details']
    end
    ...
    def hash
      [exadata_insight_id, entity_source, compartment_id, exadata_name, exadata_display_name, exadata_type, exadata_rack_type, defined_tags, freeform_tags, vmcluster_details, exadata_shape, chargeback_plan_details].hash
    end
