...
module OCI
  module Opsi::Models
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CHANGE_MACS_MANAGED_ADB_CONNECTION_DETAILS = 'CHANGE_MACS_MANAGED_ADB_CONNECTION_DETAILS'.freeze,
      OPERATION_TYPE_TEST_MACS_MANAGED_ADB_CONNECTION_DETAILS = 'TEST_MACS_MANAGED_ADB_CONNECTION_DETAILS'.freeze,
      OPERATION_TYPE_SYNCHRONIZE_AUTONOMOUS_DATABASE_TO_EXADATA = 'SYNCHRONIZE_AUTONOMOUS_DATABASE_TO_EXADATA'.freeze,
      OPERATION_TYPE_CREATE_CHARGE_BACK = 'CREATE_CHARGE_BACK'.freeze,
      OPERATION_TYPE_ENABLE_CHARGE_BACK = 'ENABLE_CHARGE_BACK'.freeze,
      OPERATION_TYPE_DISABLE_CHARGE_BACK = 'DISABLE_CHARGE_BACK'.freeze,
      OPERATION_TYPE_UPDATE_CHARGE_BACK = 'UPDATE_CHARGE_BACK'.freeze,
      OPERATION_TYPE_MOVE_CHARGE_BACK = 'MOVE_CHARGE_BACK'.freeze,
      OPERATION_TYPE_DELETE_CHARGE_BACK = 'DELETE_CHARGE_BACK'.freeze
    ].freeze
  end
end
