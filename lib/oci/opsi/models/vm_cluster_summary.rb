...
module OCI
  ...
  class Opsi::Models::VmClusterSummary
    ...
    def self.swagger_types
      {
        ...
        'storage_allocated_in_gbs': :'Integer',
    ...
    # @option attributes [Integer] :storage_allocated_in_gbs The value to assign to the {#storage_allocated_in_gbs} property
    ...
    def hash
      [vmcluster_name, memory_allocated_in_gbs, cpu_allocated, db_nodes_count, storage_allocated_in_gbs, vm_cluster_id].hash
    end
