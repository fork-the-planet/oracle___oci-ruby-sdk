...
module OCI
  ...
  class Opsi::Models::DatabaseConfigurationSummary
    ENTITY_SOURCE_ENUM = [
      ...
      ENTITY_SOURCE_MACS_MANAGED_AUTONOMOUS_DATABASE = 'MACS_MANAGED_AUTONOMOUS_DATABASE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::MacsManagedAutonomousDatabaseConfigurationSummary' if type == 'MACS_MANAGED_AUTONOMOUS_DATABASE'
    ...
    def hash
      [database_insight_id, entity_source, compartment_id, database_name, database_display_name, database_type, database_version, is_advanced_features_enabled, cdb_name, defined_tags, freeform_tags, processor_count].hash
    end
