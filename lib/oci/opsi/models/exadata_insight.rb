...
module OCI
  ...
  class Opsi::Models::ExadataInsight
    ...
    def hash
      [entity_source, id, compartment_id, exadata_name, exadata_display_name, exadata_type, exadata_rack_type, is_virtualized_exadata, status, chargeback_plan_details, freeform_tags, defined_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details, status_details].hash
    end
