...
module OCI
  ...
  class Opsi::Models::CredentialDetails
    CREDENTIAL_TYPE_ENUM = [
      ...
      CREDENTIAL_TYPE_CREDENTIALS_BY_NAMED_CREDS = 'CREDENTIALS_BY_NAMED_CREDS'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::CredentialByNamedCredentials' if type == 'CREDENTIALS_BY_NAMED_CREDS'
