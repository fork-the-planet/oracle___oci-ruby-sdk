...
module OCI
  ...
  class Opsi::Models::EnableMacsManagedAutonomousDatabaseInsightDetails < Opsi::Models::EnableDatabaseInsightDetails
    # **[Required]** The compartment [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Autonomous Database.
    # @return [String]
