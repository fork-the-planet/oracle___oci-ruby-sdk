...
module OCI
  ...
  class Opsi::Models::SynchronizeAutonomousDatabaseToExadataDetails
    ENTITY_SOURCE_ENUM = [
    ...
    # **[Required]** Source of the database entity. Currently only AUTONOMOUS_DATABASE source is supported.
    # @return [String]
