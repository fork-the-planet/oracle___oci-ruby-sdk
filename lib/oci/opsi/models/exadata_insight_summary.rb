...
module OCI
  ...
  class Opsi::Models::ExadataInsightSummary
    ...
    def hash
      [entity_source, id, compartment_id, exadata_name, exadata_display_name, exadata_type, exadata_rack_type, freeform_tags, defined_tags, system_tags, status, chargeback_plan_details, time_created, time_updated, lifecycle_state, lifecycle_details, status_details].hash
    end
