...
module OCI
  ...
  class Opsi::Models::OperationsInsightsPrivateEndpoint
    ...
    def hash
      [id, display_name, compartment_id, vcn_id, subnet_id, private_ip, description, time_created, lifecycle_state, lifecycle_details, private_endpoint_status_details, is_used_for_rac_dbs, nsg_ids, freeform_tags, defined_tags, system_tags, security_attributes].hash
    end
