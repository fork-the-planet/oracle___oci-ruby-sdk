...
module OCI
  ...
  class Opsi::OperationsInsightsClientCompositeOperations
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#change_chargeback_plan_compartment} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] chargebackplan_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Ops Insights chargeback plan.
    # @param [OCI::Opsi::Models::ChangeChargebackPlanCompartmentDetails] change_chargeback_plan_compartment_details The information to be updated.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#change_chargeback_plan_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def change_chargeback_plan_compartment_and_wait_for_state(chargebackplan_id, change_chargeback_plan_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_chargeback_plan_compartment(chargebackplan_id, change_chargeback_plan_compartment_details, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#change_macs_managed_autonomous_database_insight_connection} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] database_insight_id Unique database insight identifier
    # @param [OCI::Opsi::Models::ChangeMacsManagedAutonomousDatabaseInsightConnectionDetails] change_macs_managed_autonomous_database_insight_connection_details The information to be updated.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#change_macs_managed_autonomous_database_insight_connection}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def change_macs_managed_autonomous_database_insight_connection_and_wait_for_state(database_insight_id, change_macs_managed_autonomous_database_insight_connection_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_macs_managed_autonomous_database_insight_connection(database_insight_id, change_macs_managed_autonomous_database_insight_connection_details, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#create_chargeback_plan} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Opsi::Models::CreateChargebackPlanDetails] create_chargeback_plan_details Details to create a new chargeback plan resource.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#create_chargeback_plan}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def create_chargeback_plan_and_wait_for_state(create_chargeback_plan_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_chargeback_plan(create_chargeback_plan_details, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#create_chargeback_plan_report} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Opsi::Models::CreateChargebackPlanReportDetails] create_chargeback_plan_report_details Details for the chargeback plan report to be created in Ops Insights.
    # @param [String] id Unique Ops insight identifier
    # @param [String] resource_type Filter by resource type.
    #   Supported values are EXADATA_INSIGHT , HOST_INSIGHT, DATABASE_INSIGHT.
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#create_chargeback_plan_report}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def create_chargeback_plan_report_and_wait_for_state(create_chargeback_plan_report_details, id, resource_type, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_chargeback_plan_report(create_chargeback_plan_report_details, id, resource_type, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#delete_chargeback_plan} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] chargebackplan_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Ops Insights chargeback plan.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#delete_chargeback_plan}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def delete_chargeback_plan_and_wait_for_state(chargebackplan_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_chargeback_plan(chargebackplan_id, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#delete_chargeback_plan_report} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] chargeback_plan_report_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Ops Insights chargeback plan report
    # @param [String] id Unique Ops insight identifier
    # @param [String] resource_type Filter by resource type.
    #   Supported values are EXADATA_INSIGHT , HOST_INSIGHT, DATABASE_INSIGHT.
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#delete_chargeback_plan_report}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def delete_chargeback_plan_report_and_wait_for_state(chargeback_plan_report_id, id, resource_type, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_chargeback_plan_report(chargeback_plan_report_id, id, resource_type, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#disable_plan_exadata_insight} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] exadata_insight_id Unique Exadata insight identifier
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#disable_plan_exadata_insight}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def disable_plan_exadata_insight_and_wait_for_state(exadata_insight_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.disable_plan_exadata_insight(exadata_insight_id, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#enable_plan_exadata_insight} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Opsi::Models::EnablePlanExadataInsightDetails] enable_plan_exadata_insight_details Details for the Exadata system to be enabled in Operations Insights.
    # @param [String] exadata_insight_id Unique Exadata insight identifier
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#enable_plan_exadata_insight}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def enable_plan_exadata_insight_and_wait_for_state(enable_plan_exadata_insight_details, exadata_insight_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.enable_plan_exadata_insight(enable_plan_exadata_insight_details, exadata_insight_id, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#synchronize_autonomous_database_to_exadata} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Opsi::Models::SynchronizeAutonomousDatabaseToExadataDetails] synchronize_autonomous_database_to_exadata_details The information to be updated.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#synchronize_autonomous_database_to_exadata}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def synchronize_autonomous_database_to_exadata_and_wait_for_state(synchronize_autonomous_database_to_exadata_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.synchronize_autonomous_database_to_exadata(synchronize_autonomous_database_to_exadata_details, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#test_macs_managed_autonomous_database_insight_connection} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Opsi::Models::TestMacsManagedAutonomousDatabaseInsightConnectionDetails] test_macs_managed_autonomous_database_insight_connection_details The database connection information for the MACS-managed autonomous database.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#test_macs_managed_autonomous_database_insight_connection}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def test_macs_managed_autonomous_database_insight_connection_and_wait_for_state(test_macs_managed_autonomous_database_insight_connection_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.test_macs_managed_autonomous_database_insight_connection(test_macs_managed_autonomous_database_insight_connection_details, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#update_chargeback_plan} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] chargebackplan_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Ops Insights chargeback plan.
    # @param [OCI::Opsi::Models::UpdateChargebackPlanDetails] update_chargeback_plan_details The details used to update a chargeback plan.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#update_chargeback_plan}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def update_chargeback_plan_and_wait_for_state(chargebackplan_id, update_chargeback_plan_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_chargeback_plan(chargebackplan_id, update_chargeback_plan_details, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#update_chargeback_plan_report} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] chargeback_plan_report_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Ops Insights chargeback plan report
    # @param [String] id Unique Ops insight identifier
    ...
    #   Supported values are EXADATA_INSIGHT , HOST_INSIGHT, DATABASE_INSIGHT.
    #
    # @param [OCI::Opsi::Models::UpdateChargebackPlanReportDetails] update_chargeback_plan_report_details The details used to update a chargeback plan report.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#update_chargeback_plan_report}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def update_chargeback_plan_report_and_wait_for_state(chargeback_plan_report_id, id, resource_type, update_chargeback_plan_report_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_chargeback_plan_report(chargeback_plan_report_id, id, resource_type, update_chargeback_plan_report_details, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
