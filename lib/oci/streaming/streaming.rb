...
# Require models
require 'oci/streaming/models/action_type'
...
require 'oci/streaming/models/operation_status'
require 'oci/streaming/models/operation_type'
...
require 'oci/streaming/models/work_request'
require 'oci/streaming/models/work_request_error'
require 'oci/streaming/models/work_request_error_collection'
require 'oci/streaming/models/work_request_log_entry'
require 'oci/streaming/models/work_request_log_entry_collection'
require 'oci/streaming/models/work_request_resource'
require 'oci/streaming/models/work_request_summary'
require 'oci/streaming/models/work_request_summary_collection'
