...
module OCI
  ...
  class Streaming::StreamAdminClientCompositeOperations
    ...
    # Calls {OCI::Streaming::StreamAdminClient#change_connect_harness_compartment} and then waits for the {OCI::Streaming::Models::WorkRequest}
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Streaming::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Streaming::StreamAdminClient#change_connect_harness_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Streaming::Models::WorkRequest}
    def change_connect_harness_compartment_and_wait_for_state(connect_harness_id, change_connect_harness_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_connect_harness_compartment(connect_harness_id, change_connect_harness_compartment_details, base_operation_opts)
      use_util = OCI::Streaming::Util.respond_to?(:wait_on_work_request)
      ...
      begin
        if use_util
          waiter_result = OCI::Streaming::Util.wait_on_work_request(
            @service_client,
    ...
    # Calls {OCI::Streaming::StreamAdminClient#change_stream_compartment} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Streaming::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Streaming::StreamAdminClient#change_stream_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Streaming::Models::WorkRequest}
    def change_stream_compartment_and_wait_for_state(stream_id, change_stream_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_stream_compartment(stream_id, change_stream_compartment_details, base_operation_opts)
      use_util = OCI::Streaming::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Streaming::StreamAdminClient#change_stream_pool_compartment} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Streaming::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Streaming::StreamAdminClient#change_stream_pool_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Streaming::Models::WorkRequest}
    def change_stream_pool_compartment_and_wait_for_state(stream_pool_id, change_stream_pool_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_stream_pool_compartment(stream_pool_id, change_stream_pool_compartment_details, base_operation_opts)
      use_util = OCI::Streaming::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Streaming::StreamAdminClient#create_connect_harness} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # Calls {OCI::Streaming::StreamAdminClient#create_stream} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # Calls {OCI::Streaming::StreamAdminClient#create_stream_pool} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # Calls {OCI::Streaming::StreamAdminClient#delete_connect_harness} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] connect_harness_id The OCID of the connect harness.
    #
    ...
    # Calls {OCI::Streaming::StreamAdminClient#delete_stream} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] stream_id The OCID of the stream.
    #
    ...
    # Calls {OCI::Streaming::StreamAdminClient#delete_stream_pool} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] stream_pool_id The OCID of the stream pool.
    #
    ...
    # Calls {OCI::Streaming::StreamAdminClient#update_connect_harness} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] connect_harness_id The OCID of the connect harness.
    #
    ...
    # Calls {OCI::Streaming::StreamAdminClient#update_stream} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] stream_id The OCID of the stream.
    #
    ...
    # Calls {OCI::Streaming::StreamAdminClient#update_stream_pool} and then waits for the {OCI::Streaming::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] stream_pool_id The OCID of the stream pool.
    #
