...
module OCI
  ...
  class Streaming::Models::StreamPool
    ...
    def hash
      [id, compartment_id, name, lifecycle_state, lifecycle_state_details, time_created, kafka_settings, custom_encryption_key, is_private, endpoint_fqdn, private_endpoint_settings, freeform_tags, security_attributes, defined_tags].hash
    end
