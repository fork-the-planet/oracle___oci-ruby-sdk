...
module OCI
  ...
  class Streaming::Models::WorkRequestErrorCollection
    # **[Required]** A list of work request errors.
    # @return [Array<OCI::Streaming::Models::WorkRequestError>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Streaming::Models::WorkRequestError>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Streaming::Models::WorkRequestError>] :items The value to assign to the {#items} property
