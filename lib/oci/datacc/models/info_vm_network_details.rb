...
module OCI
  ...
  #
  class Datacc::Models::InfoVmNetworkDetails
    NETWORK_TYPE_ENUM = [
    ...
    # @option attributes [String] :starting_ip The value to assign to the {#starting_ip} property
    def initialize(attributes = {})
      ...
      self.starting_ip = attributes[:'startingIp'] if attributes[:'startingIp']

      raise 'You cannot provide both :startingIp and :starting_ip' if attributes.key?(:'startingIp') && attributes.key?(:'starting_ip')

      self.starting_ip = attributes[:'starting_ip'] if attributes[:'starting_ip']
    end
    ...
    def hash
      [vlan_id, network_type, netmask, gateway, domain_name, prefix, starting_ip].hash
    end
