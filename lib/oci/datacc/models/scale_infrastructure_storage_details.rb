...
module OCI
  ...
  class Datacc::Models::ScaleInfrastructureStorageDetails
    ...
    def ssd_configuration_requested=(ssd_configuration_requested)
      raise "Invalid value for 'ssd_configuration_requested': this must be one of the values in SSD_CONFIGURATION_REQUESTED_ENUM." if ssd_configuration_requested && !SSD_CONFIGURATION_REQUESTED_ENUM.include?(ssd_configuration_requested)
    ...
    def hash
      [ssd_configuration_requested].hash
    end
