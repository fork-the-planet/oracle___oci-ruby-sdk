...
module OCI
  ...
  class Datacc::Models::InfrastructureContact
    # **[Required]** The name of the Database Infrastructure contact.
    # @return [String]
    attr_accessor :name
    ...
    # **[Required]** The email for the Database Infrastructure contact.
    # @return [String]
    attr_accessor :email

    # **[Required]** If `true`, this Database Infrastructure contact is a primary contact.
