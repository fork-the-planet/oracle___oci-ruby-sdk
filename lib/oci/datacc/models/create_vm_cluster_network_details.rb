...
module OCI
  ...
  #
  class Datacc::Models::CreateVmClusterNetworkDetails
    CONSUMER_TYPE_ENUM = [
    ...
    def hash
      [compartment_id, infrastructure_id, display_name, node_count, scans, listener_port, listener_port_ssl, dns_servers, ntp_servers, vm_networks, consumer_type, freeform_tags, defined_tags].hash
    end
