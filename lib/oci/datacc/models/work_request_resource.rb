...
module OCI
  ...
  class Datacc::Models::WorkRequestResource
    ACTION_TYPE_ENUM = [
    ...
    # **[Required]** The type of resource being acted on by the work request.
    # @return [String]
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the resource being acted on by the work request.
    # @return [String]
