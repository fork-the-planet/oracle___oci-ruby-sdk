...
module OCI
  ...
  class Datacc::Models::CreateVmInstanceDetails
    ...
    def hash
      [compartment_id, display_name, description, infrastructure_id, cpus_enabled, memory_size_in_gbs, boot_storage_size_in_gbs, data_storage_size_in_gbs, image_id, server_id, ssh_public_keys, domain_name, time_zone, dns_servers, ntp_servers, hostname, ip_address, netmask, gateway, vlan_id, userdata, metadata, vm_network_id, defined_tags, freeform_tags, system_tags].hash
    end
