...
module OCI
  ...
  #
  class Datacc::Models::MaintenanceRunSummary
    ...
    PATCHING_STATUS_ENUM = [
      PATCHING_STATUS_CREATING = 'CREATING'.freeze,
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the maintenance run.
    # @return [String]
    attr_accessor :id
    ...
    # @return [DateTime]
    attr_accessor :initial_scheduled_time
    ...
    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Database Infrastructure on which the maintenance run execution occurs.
    # @return [String]
    ...
    # @return [String]
    attr_accessor :patch_identifier
    ...
    def self.swagger_types
      {
        ...
        'estimated_patching_time': :'Integer',
    ...
    # @option attributes [DateTime] :initial_scheduled_time The value to assign to the {#initial_scheduled_time} property
    ...
    # @option attributes [String] :patch_identifier The value to assign to the {#patch_identifier} property
    ...
    # @option attributes [Integer] :estimated_patching_time The value to assign to the {#estimated_patching_time} property
    ...
    def initialize(attributes = {})
      ...
      self.initial_scheduled_time = attributes[:'initialScheduledTime'] if attributes[:'initialScheduledTime']

      raise 'You cannot provide both :initialScheduledTime and :initial_scheduled_time' if attributes.key?(:'initialScheduledTime') && attributes.key?(:'initial_scheduled_time')

      self.initial_scheduled_time = attributes[:'initial_scheduled_time'] if attributes[:'initial_scheduled_time']
      ...
      self.patch_identifier = attributes[:'patchIdentifier'] if attributes[:'patchIdentifier']

      raise 'You cannot provide both :patchIdentifier and :patch_identifier' if attributes.key?(:'patchIdentifier') && attributes.key?(:'patch_identifier')

      self.patch_identifier = attributes[:'patch_identifier'] if attributes[:'patch_identifier']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        initial_scheduled_time == other.initial_scheduled_time &&
        ...
        patch_identifier == other.patch_identifier &&
    ...
    def hash
      [id, compartment_id, display_name, description, lifecycle_state, lifecycle_details, initial_scheduled_time, time_scheduled, time_started, time_ended, target_resource_type, infrastructure_id, maintenance_type, patch_identifier, maintenance_subtype, patching_mode, patch_failure_count, source_version, target_version, is_custom_action_timeout_enabled, custom_action_timeout_in_mins, patching_status, patching_start_time, patching_end_time, estimated_patching_time, current_patching_component, estimated_component_patching_start_time, system_tags, defined_tags, freeform_tags, total_time_taken_in_mins].hash
    end
