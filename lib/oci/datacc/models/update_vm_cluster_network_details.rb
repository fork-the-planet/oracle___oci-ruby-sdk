...
module OCI
  ...
  #
  class Datacc::Models::UpdateVmClusterNetworkDetails
    ...
    def hash
      [display_name, scans, listener_port, listener_port_ssl, dns_servers, ntp_servers, vm_networks, freeform_tags, defined_tags].hash
    end
