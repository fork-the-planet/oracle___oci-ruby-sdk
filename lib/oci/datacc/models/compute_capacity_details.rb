...
module OCI
  ...
  class Datacc::Models::ComputeCapacityDetails
    ...
    # @return [Integer]
    attr_accessor :used_memory_in_gbs

    # Reserved memory, in gigabytes (GB).
    # @return [Integer]
    attr_accessor :reserved_memory_in_gbs
    ...
    # @option attributes [Integer] :total_cores The value to assign to the {#total_cores} property
    # @option attributes [Integer] :allocated_cores The value to assign to the {#allocated_cores} property
    # @option attributes [Integer] :reserved_cores The value to assign to the {#reserved_cores} property
    # @option attributes [Integer] :available_cores The value to assign to the {#available_cores} property
    # @option attributes [Integer] :total_memory_in_gbs The value to assign to the {#total_memory_in_gbs} property
    # @option attributes [Integer] :used_memory_in_gbs The value to assign to the {#used_memory_in_gbs} property
    # @option attributes [Integer] :reserved_memory_in_gbs The value to assign to the {#reserved_memory_in_gbs} property
