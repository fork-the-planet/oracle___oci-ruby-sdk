...
module OCI
  ...
  class Datacc::Models::UpdateInfrastructureDetails
    SYSTEM_MODEL_ENUM = [
    ...
    def hash
      [display_name, description, system_model, shape, cloud_control_plane_server1, cloud_control_plane_server2, netmask, gateway, admin_networkcidr, data_disk_percentage, contacts, dns_servers, ntp_servers, client_network_bonding_mode, backup_network_bonding_mode, cps_network_bonding_mode, client_network_bonding_interface, backup_network_bonding_interface, cps_network_bonding_interface, acfs_file_system_storage_in_gbs, corporate_proxy, vlan_id, maintenance_window, defined_tags, freeform_tags].hash
    end
