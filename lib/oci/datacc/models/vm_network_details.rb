...
module OCI
  ...
  #
  class Datacc::Models::VmNetworkDetails
    NETWORK_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Datacc::Models::NodeDetails>]
    attr_accessor :nodes
    ...
    def self.swagger_types
      {
        ...
        'domain_name': :'String',
        'prefix': :'String',
        'nodes': :'Array<OCI::Datacc::Models::NodeDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Datacc::Models::NodeDetails>] :nodes The value to assign to the {#nodes} property
    ...
    def hash
      [vlan_id, network_type, netmask, gateway, domain_name, prefix, nodes].hash
    end
