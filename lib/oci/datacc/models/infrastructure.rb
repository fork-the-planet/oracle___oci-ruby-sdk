...
module OCI
  ...
  #
  class Datacc::Models::Infrastructure
    SYSTEM_MODEL_ENUM = [
    ...
    # @return [Integer]
    attr_accessor :reco_disk_percentage
    ...
    # @return [Array<OCI::Datacc::Models::InfrastructureServer>]
    ...
    #
    # @return [String]
    attr_accessor :network_adapter_configuration
    ...
    # @option attributes [Integer] :reco_disk_percentage The value to assign to the {#reco_disk_percentage} property
    ...
    # @option attributes [Array<OCI::Datacc::Models::InfrastructureServer>] :servers The value to assign to the {#servers} property
    ...
    # @option attributes [String] :network_adapter_configuration The value to assign to the {#network_adapter_configuration} property
