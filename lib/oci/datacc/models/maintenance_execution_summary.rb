...
module OCI
  ...
  #
  class Datacc::Models::MaintenanceExecutionSummary
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the maintenance run execution.
    # @return [String]
    attr_accessor :id
    ...
    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Database Infrastructure on which the maintenance run execution occurred.
    # @return [String]
    attr_accessor :infrastructure_id

    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the maintenance run to which this maintenance execution belongs.
    # @return [String]
    ...
    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the work request executed by this execution.
    # @return [String]
    ...
    # @option attributes [String] :maintenance_run_id The value to assign to the {#maintenance_run_id} property
    ...
    # @option attributes [String] :workflow_id The value to assign to the {#workflow_id} property
