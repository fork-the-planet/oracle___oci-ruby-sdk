...
module OCI
  ...
  #
  class Datacc::Models::MaintenanceWindow
    PREFERENCE_ENUM = [
    ...
    # See [Oracle-Managed Database Infrastructure Maintenance Updates](https://docs.cloud.oracle.com/iaas/Content/Database/Concepts/examaintenance.htm#Oracle)
    ...
    # @option attributes [Array<String>] :months The value to assign to the {#months} property
    # @option attributes [Array<Integer>] :weeks_of_month The value to assign to the {#weeks_of_month} property
    # @option attributes [Array<String>] :days_of_week The value to assign to the {#days_of_week} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] months Object to be assigned
    def months=(months)
      # rubocop:disable Style/ConditionalAssignment
      if months.nil?
        @months = nil
        ...
        @months =
          months.collect do |item|
            if MONTHS_ENUM.include?(item)
              item
            else
              OCI.logger.debug("Unknown value for 'months' [#{item}]. Mapping to 'MONTHS_UNKNOWN_ENUM_VALUE'") if OCI.logger
              MONTHS_UNKNOWN_ENUM_VALUE
            end
          end
      end
      # rubocop:enable Style/ConditionalAssignment
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] days_of_week Object to be assigned
    def days_of_week=(days_of_week)
      ...
      if days_of_week.nil?
        ...
        @days_of_week =
          days_of_week.collect do |item|
            if DAYS_OF_WEEK_ENUM.include?(item)
              item
            else
              OCI.logger.debug("Unknown value for 'days_of_week' [#{item}]. Mapping to 'DAYS_OF_WEEK_UNKNOWN_ENUM_VALUE'") if OCI.logger
              DAYS_OF_WEEK_UNKNOWN_ENUM_VALUE
            end
          end
      end
      # rubocop:enable Style/ConditionalAssignment
