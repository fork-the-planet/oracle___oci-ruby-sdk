...
module OCI
  ...
  class Certificates::CertificatesClient
    ...
    def get_certificate_authority_bundle(certificate_authority_id, opts = {})
      ...
      if opts[:stage] && !%w[CURRENT PENDING PENDING_ACTIVATION LATEST PREVIOUS DEPRECATED].include?(opts[:stage])
        raise 'Invalid value for "stage", must be one of CURRENT, PENDING, PENDING_ACTIVATION, LATEST, PREVIOUS, DEPRECATED.'
      end
