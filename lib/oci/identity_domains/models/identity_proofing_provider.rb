...
module OCI
  ...
  class IdentityDomains::Models::IdentityProofingProvider
    ...
    #  - uniqueness: none
    # @return [Array<String>]
    attr_reader :idcs_locked_operations

    # @return [OCI::IdentityDomains::Models::IdentityProofingProviderIdcsLockedBy]
    attr_accessor :idcs_locked_by
    ...
    #  - returned: default
    #  - type: complex
    # @return [Array<OCI::IdentityDomains::Models::IdentityProofingProviderRuntimeData>]
    attr_accessor :runtime_data
    ...
    #  - type: complex
    #  - uniqueness: server
    # @return [Array<OCI::IdentityDomains::Models::IdentityProofingProviderConfiguration>]
    ...
    #  - type: complex
    #  - uniqueness: server
    # @return [Array<OCI::IdentityDomains::Models::IdentityProofingProviderClaimMapping>]
    ...
    # @option attributes [Array<String>] :idcs_locked_operations The value to assign to the {#idcs_locked_operations} property
    # @option attributes [OCI::IdentityDomains::Models::IdentityProofingProviderIdcsLockedBy] :idcs_locked_by The value to assign to the {#idcs_locked_by} property
    # @option attributes [String] :idcs_locked_on The value to assign to the {#idcs_locked_on} property
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::IdentityProofingProviderRuntimeData>] :runtime_data The value to assign to the {#runtime_data} property
    # @option attributes [Array<OCI::IdentityDomains::Models::IdentityProofingProviderConfiguration>] :configuration The value to assign to the {#configuration} property
    # @option attributes [Array<OCI::IdentityDomains::Models::IdentityProofingProviderClaimMapping>] :claim_mapping The value to assign to the {#claim_mapping} property
    def initialize(attributes = {})
      ...
      self.runtime_data = attributes[:'runtimeData'] if attributes[:'runtimeData']

      raise 'You cannot provide both :runtimeData and :runtime_data' if attributes.key?(:'runtimeData') && attributes.key?(:'runtime_data')

      self.runtime_data = attributes[:'runtime_data'] if attributes[:'runtime_data']

      self.configuration = attributes[:'configuration'] if attributes[:'configuration']

      self.claim_mapping = attributes[:'claimMapping'] if attributes[:'claimMapping']

      raise 'You cannot provide both :claimMapping and :claim_mapping' if attributes.key?(:'claimMapping') && attributes.key?(:'claim_mapping')

      self.claim_mapping = attributes[:'claim_mapping'] if attributes[:'claim_mapping']
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] idcs_locked_operations Object to be assigned
    def idcs_locked_operations=(idcs_locked_operations)
      # rubocop:disable Style/ConditionalAssignment
      if idcs_locked_operations.nil?
        @idcs_locked_operations = nil
      else
        @idcs_locked_operations =
          idcs_locked_operations.collect do |item|
            if IDCS_LOCKED_OPERATIONS_ENUM.include?(item)
              item
            else
              OCI.logger.debug("Unknown value for 'idcs_locked_operations' [#{item}]. Mapping to 'IDCS_LOCKED_OPERATIONS_UNKNOWN_ENUM_VALUE'") if OCI.logger
              IDCS_LOCKED_OPERATIONS_UNKNOWN_ENUM_VALUE
            end
          end
      end
      # rubocop:enable Style/ConditionalAssignment
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        claim_mapping == other.claim_mapping
    end
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, idcs_locked_operations, idcs_locked_by, idcs_locked_on, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, provider, name, description, status, runtime_data, configuration, claim_mapping].hash
    end
