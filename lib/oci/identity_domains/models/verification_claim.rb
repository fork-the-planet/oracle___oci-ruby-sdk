...
module OCI
  ...
  class IdentityDomains::Models::VerificationClaim
    ...
    # @return [OCI::IdentityDomains::Models::VerificationClaimIdcsLockedBy]
    ...
    # **[Required]** The OIDC Identity Proofing Provide.
    #
    # **SCIM++ Properties:**
    #  - multiValued: false
    ...
    #  - uniqueness: none
    # @return [Array<String>]
    attr_accessor :verifiable_claims
    ...
    def self.swagger_types
      {
        ...
        'idcs_locked_by': :'OCI::IdentityDomains::Models::VerificationClaimIdcsLockedBy',
        ...
        'verifiable_claims': :'Array<String>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::IdentityDomains::Models::VerificationClaimIdcsLockedBy] :idcs_locked_by The value to assign to the {#idcs_locked_by} property
    ...
    # @option attributes [String] :oidc_provider The value to assign to the {#oidc_provider} property
    # @option attributes [Array<String>] :verifiable_claims The value to assign to the {#verifiable_claims} property
    def initialize(attributes = {})
      ...
      self.oidc_provider = attributes[:'oidcProvider'] if attributes[:'oidcProvider']

      raise 'You cannot provide both :oidcProvider and :oidc_provider' if attributes.key?(:'oidcProvider') && attributes.key?(:'oidc_provider')

      self.oidc_provider = attributes[:'oidc_provider'] if attributes[:'oidc_provider']

      self.verifiable_claims = attributes[:'verifiableClaims'] if attributes[:'verifiableClaims']

      raise 'You cannot provide both :verifiableClaims and :verifiable_claims' if attributes.key?(:'verifiableClaims') && attributes.key?(:'verifiable_claims')

      self.verifiable_claims = attributes[:'verifiable_claims'] if attributes[:'verifiable_claims']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        oidc_provider == other.oidc_provider &&
        verifiable_claims == other.verifiable_claims
    end
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, idcs_locked_operations, idcs_locked_by, idcs_locked_on, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, oidc_provider, verifiable_claims].hash
    end
