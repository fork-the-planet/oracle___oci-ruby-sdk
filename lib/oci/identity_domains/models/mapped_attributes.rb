...
module OCI
  ...
  class IdentityDomains::Models::MappedAttributes
    ...
    # @return [Array<OCI::IdentityDomains::Models::MappedAttribute>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MappedAttribute>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MappedAttribute>] :resources The value to assign to the {#resources} property
