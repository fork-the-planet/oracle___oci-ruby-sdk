...
module OCI
  ...
  class IdentityDomains::Models::MappedAttribute
    ...
    IDCS_RESOURCE_TYPE_ENUM = [
      IDCS_RESOURCE_TYPE_USER = 'User'.freeze,
      IDCS_RESOURCE_TYPE_GROUP = 'Group'.freeze,
      IDCS_RESOURCE_TYPE_CONTAINER = 'Container'.freeze,
      IDCS_RESOURCE_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    REF_RESOURCE_TYPE_ENUM = [
      REF_RESOURCE_TYPE_ACCOUNT_OBJECT_CLASS = 'AccountObjectClass'.freeze,
      REF_RESOURCE_TYPE_APP = 'App'.freeze,
      REF_RESOURCE_TYPE_MANAGED_OBJECT_CLASS = 'ManagedObjectClass'.freeze,
      REF_RESOURCE_TYPE_IDENTITY_PROVIDER = 'IdentityProvider'.freeze,
      REF_RESOURCE_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    DIRECTION_ENUM = [
      DIRECTION_INBOUND = 'inbound'.freeze,
      DIRECTION_OUTBOUND = 'outbound'.freeze,
    ...
    # **[Required]** The Oracle Identity Cloud Service Resource Type for which the mapping is being done
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
    ...
    #  - uniqueness: none
    # @return [String]
    attr_reader :idcs_resource_type

    # **[Required]** The Reference Resource Type that holds the mapping
    #
    # **Added In:** 17.4.2
    #
    # **SCIM++ Properties:**
    ...
    #  - uniqueness: none
    # @return [String]
    attr_reader :ref_resource_type

    # **[Required]** Soft Reference to store Resource ID that holds the mapping
    #
    # **Added In:** 17.4.6
    #
    # **SCIM++ Properties:**
    ...
    #  - uniqueness: none
    # @return [String]
    attr_accessor :ref_resource_id

    # **[Required]** Direction of the attribute mapping. inbound indicates mapping is from source ManagedObjectClass to Oracle Identity Cloud Service ResourceType. outbound indicates mapping is from Oracle Identity Cloud Service Resource Type to target ManagedObjectClass.
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::MappedAttributeAttributeMappings>]
    ...
    def self.swagger_types
      {
        ...
        'tenancy_ocid': :'String',
        'idcs_resource_type': :'String',
        'ref_resource_type': :'String',
        'ref_resource_id': :'String',
        'direction': :'String',
        'attribute_mappings': :'Array<OCI::IdentityDomains::Models::MappedAttributeAttributeMappings>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :idcs_resource_type The value to assign to the {#idcs_resource_type} property
    # @option attributes [String] :ref_resource_type The value to assign to the {#ref_resource_type} property
    # @option attributes [String] :ref_resource_id The value to assign to the {#ref_resource_id} property
    # @option attributes [String] :direction The value to assign to the {#direction} property
    # @option attributes [Array<OCI::IdentityDomains::Models::MappedAttributeAttributeMappings>] :attribute_mappings The value to assign to the {#attribute_mappings} property
    def initialize(attributes = {})
      ...
      self.idcs_resource_type = attributes[:'idcsResourceType'] if attributes[:'idcsResourceType']

      raise 'You cannot provide both :idcsResourceType and :idcs_resource_type' if attributes.key?(:'idcsResourceType') && attributes.key?(:'idcs_resource_type')

      self.idcs_resource_type = attributes[:'idcs_resource_type'] if attributes[:'idcs_resource_type']

      self.ref_resource_type = attributes[:'refResourceType'] if attributes[:'refResourceType']

      raise 'You cannot provide both :refResourceType and :ref_resource_type' if attributes.key?(:'refResourceType') && attributes.key?(:'ref_resource_type')

      self.ref_resource_type = attributes[:'ref_resource_type'] if attributes[:'ref_resource_type']

      self.ref_resource_id = attributes[:'refResourceID'] if attributes[:'refResourceID']

      raise 'You cannot provide both :refResourceID and :ref_resource_id' if attributes.key?(:'refResourceID') && attributes.key?(:'ref_resource_id')

      self.ref_resource_id = attributes[:'ref_resource_id'] if attributes[:'ref_resource_id']

      self.direction = attributes[:'direction'] if attributes[:'direction']

      self.attribute_mappings = attributes[:'attributeMappings'] if attributes[:'attributeMappings']

      raise 'You cannot provide both :attributeMappings and :attribute_mappings' if attributes.key?(:'attributeMappings') && attributes.key?(:'attribute_mappings')

      self.attribute_mappings = attributes[:'attribute_mappings'] if attributes[:'attribute_mappings']
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] idcs_resource_type Object to be assigned
    def idcs_resource_type=(idcs_resource_type)
      # rubocop:disable Style/ConditionalAssignment
      if idcs_resource_type && !IDCS_RESOURCE_TYPE_ENUM.include?(idcs_resource_type)
        OCI.logger.debug("Unknown value for 'idcs_resource_type' [" + idcs_resource_type + "]. Mapping to 'IDCS_RESOURCE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @idcs_resource_type = IDCS_RESOURCE_TYPE_UNKNOWN_ENUM_VALUE
      else
        @idcs_resource_type = idcs_resource_type
      end
      # rubocop:enable Style/ConditionalAssignment
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] ref_resource_type Object to be assigned
    def ref_resource_type=(ref_resource_type)
      # rubocop:disable Style/ConditionalAssignment
      if ref_resource_type && !REF_RESOURCE_TYPE_ENUM.include?(ref_resource_type)
        OCI.logger.debug("Unknown value for 'ref_resource_type' [" + ref_resource_type + "]. Mapping to 'REF_RESOURCE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @ref_resource_type = REF_RESOURCE_TYPE_UNKNOWN_ENUM_VALUE
      else
        @ref_resource_type = ref_resource_type
      end
      # rubocop:enable Style/ConditionalAssignment
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        idcs_resource_type == other.idcs_resource_type &&
        ref_resource_type == other.ref_resource_type &&
        ref_resource_id == other.ref_resource_id &&
        direction == other.direction &&
        attribute_mappings == other.attribute_mappings
    end
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, idcs_resource_type, ref_resource_type, ref_resource_id, direction, attribute_mappings].hash
    end
