...
module OCI
  ...
  class IdentityDomains::Models::IdentityProofingProviderTemplates
    ...
    # @return [Array<OCI::IdentityDomains::Models::IdentityProofingProviderTemplate>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::IdentityProofingProviderTemplate>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::IdentityProofingProviderTemplate>] :resources The value to assign to the {#resources} property
