...
module OCI
  ...
  class IdentityDomains::Models::IdentityProofingProviderTemplate
    ...
    # @return [OCI::IdentityDomains::Models::IdentityProofingProviderTemplateIdcsLockedBy]
    ...
    #  - returned: default
    #  - type: complex
    # @return [Array<OCI::IdentityDomains::Models::IdentityProofingProviderTemplateConfiguration>]
    ...
    # @option attributes [OCI::IdentityDomains::Models::IdentityProofingProviderTemplateIdcsLockedBy] :idcs_locked_by The value to assign to the {#idcs_locked_by} property
    ...
    # @option attributes [String] :verification_url The value to assign to the {#verification_url} property
    # @option attributes [Array<String>] :service_type The value to assign to the {#service_type} property
    # @option attributes [Array<OCI::IdentityDomains::Models::IdentityProofingProviderTemplateConfiguration>] :configuration The value to assign to the {#configuration} property
