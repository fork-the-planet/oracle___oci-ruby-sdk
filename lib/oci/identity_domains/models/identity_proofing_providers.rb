...
module OCI
  ...
  class IdentityDomains::Models::IdentityProofingProviders
    ...
    # @return [Array<OCI::IdentityDomains::Models::IdentityProofingProvider>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::IdentityProofingProvider>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::IdentityProofingProvider>] :resources The value to assign to the {#resources} property
