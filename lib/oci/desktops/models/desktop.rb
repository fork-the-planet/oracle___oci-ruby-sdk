...
module OCI
  ...
  class Desktops::Models::Desktop
    ...
    # @return [OCI::Desktops::Models::DesktopConnection]
    ...
    # @option attributes [OCI::Desktops::Models::DesktopConnection] :connection The value to assign to the {#connection} property
    ...
    def hash
      [id, lifecycle_state, time_created, display_name, device_policy, hosting_options, user_name, pool_id, freeform_tags, defined_tags, connection].hash
    end
