...
module OCI
  ...
  class Desktops::Models::DesktopPoolSummary
    ...
    def hash
      [id, display_name, lifecycle_state, maximum_size, active_desktops, freeform_tags, defined_tags, security_attributes, contact_details, compartment_id, time_created].hash
    end
