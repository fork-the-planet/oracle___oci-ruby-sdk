...
module OCI
  ...
  class ClusterPlacementGroups::Models::AdditionalCapabilityDetails
    SERVICE_TYPE_ENUM = [
      SERVICE_TYPE_COMPUTE = 'COMPUTE'.freeze,
      SERVICE_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Additional details about what service provides the capability. For example, `COMPUTE` means that the Oracle Cloud Infrastructure Compute service provides the selected capability.
    #
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'serviceType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::ClusterPlacementGroups::Models::AdditionalComputeCapabilityDetails' if type == 'COMPUTE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::ClusterPlacementGroups::Models::AdditionalCapabilityDetails'
    end
