...
require 'date'
require_relative 'additional_capability_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Additional details about the COMPUTE capability.
  class ClusterPlacementGroups::Models::AdditionalComputeCapabilityDetails < ClusterPlacementGroups::Models::AdditionalCapabilityDetails
    ...
    def initialize(attributes = {})
      ...
      self.count = 1 if count.nil? && !attributes.key?(:'count') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [service_type, memory_in_gbs, ocpus, nvmes, count].hash
    end
