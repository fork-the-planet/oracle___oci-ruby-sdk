...
module OCI
  ...
  class Nosql::NosqlClientCompositeOperations
    ...
    # Calls {OCI::Nosql::NosqlClient#unassign_kms_key} and then waits for the {OCI::Nosql::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] compartment_id The ID of a table's compartment.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Nosql::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Nosql::NosqlClient#unassign_kms_key}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Nosql::Models::WorkRequest}
    def unassign_kms_key_and_wait_for_state(compartment_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.unassign_kms_key(compartment_id, base_operation_opts)
      use_util = OCI::Nosql::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Nosql::NosqlClient#update_configuration} and then waits for the {OCI::Nosql::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] compartment_id The ID of a table's compartment.
    # @param [OCI::Nosql::Models::UpdateConfigurationDetails] update_configuration_details The configuration details.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Nosql::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Nosql::NosqlClient#update_configuration}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
