...
module OCI
  ...
  class Nosql::NosqlClient
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Nosql::Models::Configuration Configuration}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/nosql/get_configuration.rb.html) to see an example of how to use get_configuration API.
    def get_configuration(compartment_id, opts = {})
      logger.debug 'Calling operation NosqlClient#get_configuration.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'NosqlClient#get_configuration') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Nosql::Models::Configuration'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #   provide matches the resource's current etag value.
    #    (default to false)
    # @option opts [BOOLEAN] :is_opc_dry_run If true, indicates that the request is a dry run
    ...
    #    (default to false)
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/nosql/unassign_kms_key.rb.html) to see an example of how to use unassign_kms_key API.
    def unassign_kms_key(compartment_id, opts = {})
      logger.debug 'Calling operation NosqlClient#unassign_kms_key.' if logger

      raise "Missing the required parameter 'compartment_id' when calling unassign_kms_key." if compartment_id.nil?
      ...
      header_params[:'opc-request-id'] = opts[:opc_request_id] if opts[:opc_request_id]
      header_params[:'if-match'] = opts[:if_match] if opts[:if_match]
      header_params[:'is-opc-dry-run'] = opts[:is_opc_dry_run] if !opts[:is_opc_dry_run].nil?
      # rubocop:enable Style/NegatedIf

      post_body = nil

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'NosqlClient#unassign_kms_key') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] compartment_id The ID of a table's compartment.
    # @param [OCI::Nosql::Models::UpdateConfigurationDetails] update_configuration_details The configuration details.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    ...
    #    (default to false)
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/nosql/update_configuration.rb.html) to see an example of how to use update_configuration API.
    def update_configuration(compartment_id, update_configuration_details, opts = {})
      logger.debug 'Calling operation NosqlClient#update_configuration.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'NosqlClient#update_configuration') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
