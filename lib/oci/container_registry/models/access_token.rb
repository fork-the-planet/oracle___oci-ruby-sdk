...
module OCI
  ...
  class ContainerRegistry::Models::AccessToken
    # **[Required]** Access token string.
    # @return [String]
    attr_accessor :token

    # **[Required]** Access token string (alias for token).
    # @return [String]
    attr_accessor :access_token

    # **[Required]** Scope that restricts access to resources.
    # @return [String]
    attr_accessor :scope

    # **[Required]** Seconds until the token expires.
    # @return [Integer]
    ...
    # @option attributes [Integer] :expires_in The value to assign to the {#expires_in} property
    ...
    def hash
      [token, access_token, scope, expires_in].hash
    end
