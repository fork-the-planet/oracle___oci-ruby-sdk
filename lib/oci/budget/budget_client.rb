...
module OCI
  ...
  class Budget::BudgetClient
    ...
    def list_alert_rules(budget_id, opts = {})
      ...
      if opts[:sort_by] && !OCI::Budget::Models::SORT_BY_FOR_BUDGET_ENUM.include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of the values in OCI::Budget::Models::SORT_BY_FOR_BUDGET_ENUM.'
      end
