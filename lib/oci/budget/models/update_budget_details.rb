...
module OCI
  ...
  class Budget::Models::UpdateBudgetDetails
    ...
    def hash
      [display_name, description, amount, budget_processing_period_start_offset, processing_period_type, start_date, end_date, reset_period, freeform_tags, defined_tags, system_tags].hash
    end
