...
module OCI
  ...
  class ContainerEngine::ContainerEngineClient
    ...
    #
    # @param [String] cluster_id The OCID of the cluster.
    # @param [OCI::ContainerEngine::Models::ExtendEndpointDecommissionRollbackDeadlineDetails] extend_endpoint_decommission_rollback_deadline_details The details for a kubernetes cluster to extend public api endpoint decommission rollback deadline.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token you supply to uniquely identify the request and provide idempotency if
    ...
    #   will be updated or deleted only if the etag you provide matches the resource's current etag value.
    #
    # @return [Response] A Response object with data of type {OCI::ContainerEngine::Models::PublicApiEndpointDecommissionStatus PublicApiEndpointDecommissionStatus}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/containerengine/extend_endpoint_decommission_rollback_deadline.rb.html) to see an example of how to use extend_endpoint_decommission_rollback_deadline API.
    def extend_endpoint_decommission_rollback_deadline(cluster_id, extend_endpoint_decommission_rollback_deadline_details, opts = {})
      logger.debug 'Calling operation ContainerEngineClient#extend_endpoint_decommission_rollback_deadline.' if logger

      raise "Missing the required parameter 'cluster_id' when calling extend_endpoint_decommission_rollback_deadline." if cluster_id.nil?
      raise "Missing the required parameter 'extend_endpoint_decommission_rollback_deadline_details' when calling extend_endpoint_decommission_rollback_deadline." if extend_endpoint_decommission_rollback_deadline_details.nil?
      raise "Parameter value for 'cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(cluster_id)

      path = '/clusters/{clusterId}/actions/extendEndpointDecommissionRollbackDeadline'.sub('{clusterId}', cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(extend_endpoint_decommission_rollback_deadline_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ContainerEngineClient#extend_endpoint_decommission_rollback_deadline') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::ContainerEngine::Models::PublicApiEndpointDecommissionStatus'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [BOOLEAN] :should_list_all_patch_versions Option to show all kubernetes patch versions (default to true)
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact
    #   Oracle about a particular request, please provide the request ID.
    #
    ...
    def get_cluster_options(cluster_option_id, opts = {})
      ...
      query_params[:shouldListAllPatchVersions] = opts[:should_list_all_patch_versions] if !opts[:should_list_all_patch_versions].nil?
    ...
    # @option opts [String] :compartment_id The OCID of the compartment.
    # @option opts [BOOLEAN] :should_list_all_patch_versions Option to show all kubernetes patch versions (default to true)
    # @option opts [String] :node_pool_os_type Filter node pool options by OS type.
    #   Allowed values are: OL7, OL8, UBUNTU
    # @option opts [String] :node_pool_os_arch Filter node pool options by OS architecture.
    #   Allowed values are: X86_64, AARCH64
    # @option opts [String] :node_pool_k8s_version Filter node pool options by Kubernetes version.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact
    #   Oracle about a particular request, please provide the request ID.
    #
    ...
    def get_node_pool_options(node_pool_option_id, opts = {})
      ...
      if opts[:node_pool_os_type] && !%w[OL7 OL8 UBUNTU].include?(opts[:node_pool_os_type])
        raise 'Invalid value for "node_pool_os_type", must be one of OL7, OL8, UBUNTU.'
      end

      if opts[:node_pool_os_arch] && !%w[X86_64 AARCH64].include?(opts[:node_pool_os_arch])
        raise 'Invalid value for "node_pool_os_arch", must be one of X86_64, AARCH64.'
      end
      ...
      query_params[:compartmentId] = opts[:compartment_id] if opts[:compartment_id]
      query_params[:shouldListAllPatchVersions] = opts[:should_list_all_patch_versions] if !opts[:should_list_all_patch_versions].nil?
      query_params[:nodePoolOsType] = opts[:node_pool_os_type] if opts[:node_pool_os_type]
      query_params[:nodePoolOsArch] = opts[:node_pool_os_arch] if opts[:node_pool_os_arch]
      query_params[:nodePoolK8sVersion] = opts[:node_pool_k8s_version] if opts[:node_pool_k8s_version]
    ...
    #
    # @return [Response] A Response object with data of type {OCI::ContainerEngine::Models::PublicApiEndpointDecommissionStatus PublicApiEndpointDecommissionStatus}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/containerengine/get_public_api_endpoint_decommission_status.rb.html) to see an example of how to use get_public_api_endpoint_decommission_status API.
    def get_public_api_endpoint_decommission_status(cluster_id, opts = {})
      logger.debug 'Calling operation ContainerEngineClient#get_public_api_endpoint_decommission_status.' if logger

      raise "Missing the required parameter 'cluster_id' when calling get_public_api_endpoint_decommission_status." if cluster_id.nil?
      raise "Parameter value for 'cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(cluster_id)

      path = '/clusters/{clusterId}/publicApiEndpointDecommissionStatus'.sub('{clusterId}', cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ContainerEngineClient#get_public_api_endpoint_decommission_status') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [BOOLEAN] :should_show_all_versions Specifies whether all add-on versions should be displayed. The default value is false. If set to true, the API will return all available add-on versions, including deprecated versions and detailed build numbers.
    ...
    def list_addon_options(kubernetes_version, opts = {})
      ...
      query_params[:shouldShowAllVersions] = opts[:should_show_all_versions] if !opts[:should_show_all_versions].nil?
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/containerengine/rollback_public_api_endpoint_decommission.rb.html) to see an example of how to use rollback_public_api_endpoint_decommission API.
    def rollback_public_api_endpoint_decommission(cluster_id, opts = {})
      logger.debug 'Calling operation ContainerEngineClient#rollback_public_api_endpoint_decommission.' if logger

      raise "Missing the required parameter 'cluster_id' when calling rollback_public_api_endpoint_decommission." if cluster_id.nil?
      raise "Parameter value for 'cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(cluster_id)

      path = '/clusters/{clusterId}/actions/rollbackPublicApiEndpointDecommission'.sub('{clusterId}', cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ContainerEngineClient#rollback_public_api_endpoint_decommission') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/containerengine/start_public_api_endpoint_decommission.rb.html) to see an example of how to use start_public_api_endpoint_decommission API.
    def start_public_api_endpoint_decommission(cluster_id, opts = {})
      logger.debug 'Calling operation ContainerEngineClient#start_public_api_endpoint_decommission.' if logger

      raise "Missing the required parameter 'cluster_id' when calling start_public_api_endpoint_decommission." if cluster_id.nil?
      raise "Parameter value for 'cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(cluster_id)

      path = '/clusters/{clusterId}/actions/startPublicApiEndpointDecommission'.sub('{clusterId}', cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ContainerEngineClient#start_public_api_endpoint_decommission') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
