...
module OCI
  ...
  class ContainerEngine::Models::CreateVirtualNodePoolDetails
    ...
    # **[Required]** The number of Virtual Nodes that should be in the Virtual Node Pool. The placement configurations determine where these virtual nodes are placed.
    # @return [Integer]
    attr_accessor :size
    ...
    # **[Required]** The pod configuration for pods run on virtual nodes of this virtual node pool.
    ...
    # @return [OCI::ContainerEngine::Models::VirtualNodePoolCyclingDetails]
    attr_accessor :virtual_node_pool_cycling_details
    ...
    def self.swagger_types
      {
        ...
        'virtual_node_pool_cycling_details': :'OCI::ContainerEngine::Models::VirtualNodePoolCyclingDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::ContainerEngine::Models::VirtualNodePoolCyclingDetails] :virtual_node_pool_cycling_details The value to assign to the {#virtual_node_pool_cycling_details} property
    def initialize(attributes = {})
      ...
      self.virtual_node_pool_cycling_details = attributes[:'virtualNodePoolCyclingDetails'] if attributes[:'virtualNodePoolCyclingDetails']

      raise 'You cannot provide both :virtualNodePoolCyclingDetails and :virtual_node_pool_cycling_details' if attributes.key?(:'virtualNodePoolCyclingDetails') && attributes.key?(:'virtual_node_pool_cycling_details')

      self.virtual_node_pool_cycling_details = attributes[:'virtual_node_pool_cycling_details'] if attributes[:'virtual_node_pool_cycling_details']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        virtual_node_pool_cycling_details == other.virtual_node_pool_cycling_details
    end
    ...
    def hash
      [compartment_id, cluster_id, display_name, initial_virtual_node_labels, taints, size, placement_configurations, nsg_ids, pod_configuration, freeform_tags, defined_tags, virtual_node_tags, virtual_node_pool_cycling_details].hash
    end
