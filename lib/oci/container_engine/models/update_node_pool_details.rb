...
module OCI
  ...
  class ContainerEngine::Models::UpdateNodePoolDetails
    ...
    def network_launch_type=(network_launch_type)
      raise "Invalid value for 'network_launch_type': this must be one of the values in NETWORK_LAUNCH_TYPE_ENUM." if network_launch_type && !NETWORK_LAUNCH_TYPE_ENUM.include?(network_launch_type)
