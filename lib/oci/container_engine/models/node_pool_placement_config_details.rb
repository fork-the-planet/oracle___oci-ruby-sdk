...
module OCI
  ...
  class ContainerEngine::Models::NodePoolPlacementConfigDetails
    ...
    # @option attributes [String] :host_group_id The value to assign to the {#host_group_id} property
    ...
    def initialize(attributes = {})
      ...
      self.host_group_id = attributes[:'hostGroupId'] if attributes[:'hostGroupId']

      raise 'You cannot provide both :hostGroupId and :host_group_id' if attributes.key?(:'hostGroupId') && attributes.key?(:'host_group_id')

      self.host_group_id = attributes[:'host_group_id'] if attributes[:'host_group_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        host_group_id == other.host_group_id &&
    ...
    def hash
      [availability_domain, subnet_id, capacity_reservation_id, host_group_id, preemptible_node_config, fault_domains].hash
    end
