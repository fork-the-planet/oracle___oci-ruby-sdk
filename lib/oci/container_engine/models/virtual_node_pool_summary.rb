...
module OCI
  ...
  class ContainerEngine::Models::VirtualNodePoolSummary
    ...
    def hash
      [id, compartment_id, cluster_id, display_name, kubernetes_version, initial_virtual_node_labels, taints, size, placement_configurations, nsg_ids, pod_configuration, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags, virtual_node_tags, virtual_node_pool_cycling_details].hash
    end
