...
module OCI
  module ContainerEngine::Models
    WORK_REQUEST_OPERATION_TYPE_ENUM = [
      ...
      WORK_REQUEST_OPERATION_TYPE_VIRTUALNODEPOOL_CYCLING = 'VIRTUALNODEPOOL_CYCLING'.freeze,
      ...
      WORK_REQUEST_OPERATION_TYPE_START_PUBLIC_API_ENDPOINT_DECOMMISSION = 'START_PUBLIC_API_ENDPOINT_DECOMMISSION'.freeze,
      WORK_REQUEST_OPERATION_TYPE_ROLLBACK_PUBLIC_API_ENDPOINT_DECOMMISSION = 'ROLLBACK_PUBLIC_API_ENDPOINT_DECOMMISSION'.freeze
    ].freeze
  end
end
