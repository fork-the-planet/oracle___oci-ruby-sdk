...
module OCI
  ...
  class ContainerEngine::Models::VirtualNodePoolCyclingDetails
    ...
    # @return [BOOLEAN]
    attr_accessor :is_virtual_node_cycling_enabled
    ...
    def self.attribute_map
      {
        ...
        'is_virtual_node_cycling_enabled': :'isVirtualNodeCyclingEnabled'
    ...
    def self.swagger_types
      {
        ...
        'is_virtual_node_cycling_enabled': :'BOOLEAN'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [BOOLEAN] :is_virtual_node_cycling_enabled The value to assign to the {#is_virtual_node_cycling_enabled} property
    def initialize(attributes = {})
      ...
      self.is_virtual_node_cycling_enabled = attributes[:'isVirtualNodeCyclingEnabled'] unless attributes[:'isVirtualNodeCyclingEnabled'].nil?
      self.is_virtual_node_cycling_enabled = false if is_virtual_node_cycling_enabled.nil? && !attributes.key?(:'isVirtualNodeCyclingEnabled') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isVirtualNodeCyclingEnabled and :is_virtual_node_cycling_enabled' if attributes.key?(:'isVirtualNodeCyclingEnabled') && attributes.key?(:'is_virtual_node_cycling_enabled')

      self.is_virtual_node_cycling_enabled = attributes[:'is_virtual_node_cycling_enabled'] unless attributes[:'is_virtual_node_cycling_enabled'].nil?
      self.is_virtual_node_cycling_enabled = false if is_virtual_node_cycling_enabled.nil? && !attributes.key?(:'isVirtualNodeCyclingEnabled') && !attributes.key?(:'is_virtual_node_cycling_enabled') # rubocop:disable Style/StringLiterals
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_virtual_node_cycling_enabled == other.is_virtual_node_cycling_enabled
    end
    ...
    def hash
      [maximum_unavailable, maximum_surge, is_virtual_node_cycling_enabled].hash
    end
