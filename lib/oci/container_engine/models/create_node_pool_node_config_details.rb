...
module OCI
  ...
  class ContainerEngine::Models::CreateNodePoolNodeConfigDetails
    ...
    def hash
      [size, nsg_ids, kms_key_id, is_pv_encryption_in_transit_enabled, compute_cluster_id, freeform_tags, defined_tags, placement_configs, node_pool_pod_network_option_details].hash
    end
