...
module OCI
  ...
  class ContainerEngine::Models::NodePool
    ...
    NETWORK_LAUNCH_TYPE_ENUM = [
      NETWORK_LAUNCH_TYPE_VFIO = 'VFIO'.freeze,
      NETWORK_LAUNCH_TYPE_E1000 = 'E1000'.freeze,
      NETWORK_LAUNCH_TYPE_PARAVIRTUALIZED = 'PARAVIRTUALIZED'.freeze,
      NETWORK_LAUNCH_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @return [Array<OCI::ContainerEngine::Models::NodePoolSecondaryVnicDetails>]
    attr_accessor :secondary_vnics

    # Emulation type for the physical network interface card (NIC) for nodes
    # @return [String]
    attr_reader :network_launch_type

    # @return [OCI::ContainerEngine::Models::NodePoolPrimaryVnicDetails]
    attr_accessor :primary_vnic
    ...
    def self.swagger_types
      {
        ...
        'secondary_vnics': :'Array<OCI::ContainerEngine::Models::NodePoolSecondaryVnicDetails>',
        'network_launch_type': :'String',
        'primary_vnic': :'OCI::ContainerEngine::Models::NodePoolPrimaryVnicDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::ContainerEngine::Models::NodePoolSecondaryVnicDetails>] :secondary_vnics The value to assign to the {#secondary_vnics} property
    # @option attributes [String] :network_launch_type The value to assign to the {#network_launch_type} property
    # @option attributes [OCI::ContainerEngine::Models::NodePoolPrimaryVnicDetails] :primary_vnic The value to assign to the {#primary_vnic} property
    def initialize(attributes = {})
      ...
      self.network_launch_type = attributes[:'networkLaunchType'] if attributes[:'networkLaunchType']

      raise 'You cannot provide both :networkLaunchType and :network_launch_type' if attributes.key?(:'networkLaunchType') && attributes.key?(:'network_launch_type')

      self.network_launch_type = attributes[:'network_launch_type'] if attributes[:'network_launch_type']

      self.primary_vnic = attributes[:'primaryVnic'] if attributes[:'primaryVnic']

      raise 'You cannot provide both :primaryVnic and :primary_vnic' if attributes.key?(:'primaryVnic') && attributes.key?(:'primary_vnic')

      self.primary_vnic = attributes[:'primary_vnic'] if attributes[:'primary_vnic']
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] network_launch_type Object to be assigned
    def network_launch_type=(network_launch_type)
      # rubocop:disable Style/ConditionalAssignment
      if network_launch_type && !NETWORK_LAUNCH_TYPE_ENUM.include?(network_launch_type)
        OCI.logger.debug("Unknown value for 'network_launch_type' [" + network_launch_type + "]. Mapping to 'NETWORK_LAUNCH_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @network_launch_type = NETWORK_LAUNCH_TYPE_UNKNOWN_ENUM_VALUE
      else
        @network_launch_type = network_launch_type
      end
      # rubocop:enable Style/ConditionalAssignment
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        network_launch_type == other.network_launch_type &&
        primary_vnic == other.primary_vnic
    end
