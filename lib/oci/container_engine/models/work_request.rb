...
module OCI
  ...
  class ContainerEngine::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_VIRTUALNODEPOOL_CYCLING = 'VIRTUALNODEPOOL_CYCLING'.freeze,
      ...
      OPERATION_TYPE_START_PUBLIC_API_ENDPOINT_DECOMMISSION = 'START_PUBLIC_API_ENDPOINT_DECOMMISSION'.freeze,
      OPERATION_TYPE_ROLLBACK_PUBLIC_API_ENDPOINT_DECOMMISSION = 'ROLLBACK_PUBLIC_API_ENDPOINT_DECOMMISSION'.freeze,
