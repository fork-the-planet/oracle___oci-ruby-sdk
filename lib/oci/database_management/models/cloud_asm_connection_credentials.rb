...
module OCI
  ...
  class DatabaseManagement::Models::CloudAsmConnectionCredentials
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::CloudAsmConnectionCredentialsByDetails' if type == 'DETAILS'
      return 'OCI::DatabaseManagement::Models::CloudAsmConnectionCredentialsByName' if type == 'NAME_REFERENCE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::CloudAsmConnectionCredentials'
    end
