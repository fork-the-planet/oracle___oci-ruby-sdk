...
module OCI
  ...
  class DatabaseManagement::Models::CloudDbSystemConnector
    CONNECTOR_TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system connector.
    # @return [String]
    attr_accessor :id

    # **[Required]** The user-friendly name for the cloud connector. The name does not have to be unique.
    # @return [String]
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system that the connector is a part of.
    # @return [String]
    ...
    # **[Required]** The current lifecycle state of the cloud DB system connector.
    # @return [String]
    ...
    # **[Required]** The date and time the cloud DB system connector was created.
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The date and time the cloud DB system connector was last updated.
    # @return [DateTime]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::CloudDbSystemMacsConnector' if type == 'MACS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::CloudDbSystemConnector'
    end
    ...
    def hash
      [connector_type, id, display_name, compartment_id, cloud_db_system_id, connection_status, connection_failure_message, lifecycle_state, lifecycle_details, time_connection_status_last_updated, time_created, time_updated].hash
    end
