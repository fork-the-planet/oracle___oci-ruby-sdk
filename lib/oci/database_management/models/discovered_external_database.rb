...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredExternalDatabase < DatabaseManagement::Models::DiscoveredExternalDbSystemComponent
    ...
    # @return [Array<OCI::DatabaseManagement::Models::DiscoveredExternalDbInstance>]
    ...
    def self.swagger_types
      {
        ...
        'db_instances': :'Array<OCI::DatabaseManagement::Models::DiscoveredExternalDbInstance>',
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::DiscoveredExternalDbInstance>] :db_instances The value to assign to the {#db_instances} property
    ...
    def hash
      [component_id, display_name, component_name, component_type, resource_id, is_selected_for_monitoring, status, associated_components, compartment_id, db_unique_name, db_type, is_cluster, db_edition, db_id, db_packs, db_role, db_version, pluggable_databases, db_instances, connector, can_enable_all_current_pdbs, is_auto_enable_pluggable_database].hash
    end
