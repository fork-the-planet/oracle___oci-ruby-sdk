...
module OCI
  ...
  class DatabaseManagement::Models::DbManagementPrivateEndpoint
    ...
    def hash
      [id, name, compartment_id, is_cluster, is_dns_resolution_enabled, vcn_id, subnet_id, private_ip, description, time_created, lifecycle_state, nsg_ids, freeform_tags, defined_tags, system_tags, security_attributes].hash
    end
