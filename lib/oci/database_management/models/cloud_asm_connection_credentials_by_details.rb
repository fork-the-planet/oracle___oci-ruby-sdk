...
require 'date'
require 'logger'
require_relative 'cloud_asm_connection_credentials'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The credentials used to connect to the ASM instance.
  class DatabaseManagement::Models::CloudAsmConnectionCredentialsByDetails < DatabaseManagement::Models::CloudAsmConnectionCredentials
    ROLE_ENUM = [
