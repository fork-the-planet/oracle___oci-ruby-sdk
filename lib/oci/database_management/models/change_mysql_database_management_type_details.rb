...
module OCI
  ...
  class DatabaseManagement::Models::ChangeMysqlDatabaseManagementTypeDetails
    OPERATION_ENUM = [
      OPERATION_ENABLE_DBMGMT = 'ENABLE_DBMGMT'.freeze,
      OPERATION_UPDATE_DBMGMT_TYPE = 'UPDATE_DBMGMT_TYPE'.freeze,
      OPERATION_DISABLE_DBMGMT = 'DISABLE_DBMGMT'.freeze
    ].freeze

    # **[Required]** The type of HeatWave management.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      self.operation = "UPDATE_DBMGMT_TYPE" if operation.nil? && !attributes.key?(:'operation') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [management_type, operation].hash
    end
