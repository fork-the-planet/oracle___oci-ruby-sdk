...
module OCI
  ...
  class DatabaseManagement::Models::ExadataFleetMetricSummaryDefinition
    ...
    # @return [Array<OCI::DatabaseManagement::Models::ExadataMetricDimensionDefinition>]
    ...
    def self.swagger_types
      {
        ...
        'dimensions': :'Array<OCI::DatabaseManagement::Models::ExadataMetricDimensionDefinition>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::ExadataMetricDimensionDefinition>] :dimensions The value to assign to the {#dimensions} property
