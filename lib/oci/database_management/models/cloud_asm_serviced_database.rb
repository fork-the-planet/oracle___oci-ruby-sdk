...
module OCI
  ...
  class DatabaseManagement::Models::CloudAsmServicedDatabase
    DATABASE_TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud database.
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the existing DBaas OCI resource matching the discovered DB system component.
    # @return [String]
    ...
    def hash
      [disk_groups, id, dbaas_id, display_name, db_unique_name, compartment_id, database_type, database_sub_type, is_managed].hash
    end
