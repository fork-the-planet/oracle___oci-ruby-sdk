...
require 'date'
require_relative 'cloud_db_system_discovery_connector'
...
module OCI
  ...
  #
  class DatabaseManagement::Models::CloudDbSystemDiscoveryMacsConnector < DatabaseManagement::Models::CloudDbSystemDiscoveryConnector
    ...
    # @option attributes [String] :display_name The value to assign to the {OCI::DatabaseManagement::Models::CloudDbSystemDiscoveryConnector#display_name #display_name} proprety
    # @option attributes [String] :connection_status The value to assign to the {OCI::DatabaseManagement::Models::CloudDbSystemDiscoveryConnector#connection_status #connection_status} proprety
    # @option attributes [String] :connection_failure_message The value to assign to the {OCI::DatabaseManagement::Models::CloudDbSystemDiscoveryConnector#connection_failure_message #connection_failure_message} proprety
    # @option attributes [DateTime] :time_connection_status_last_updated The value to assign to the {OCI::DatabaseManagement::Models::CloudDbSystemDiscoveryConnector#time_connection_status_last_updated #time_connection_status_last_updated} proprety
