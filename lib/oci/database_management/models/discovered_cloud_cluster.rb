...
require 'date'
require_relative 'discovered_cloud_db_system_component'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The details of a cloud cluster discovered in a cloud DB system discovery run.
  class DatabaseManagement::Models::DiscoveredCloudCluster < DatabaseManagement::Models::DiscoveredCloudDbSystemComponent
    ...
    # @return [Array<OCI::DatabaseManagement::Models::CloudClusterNetworkConfiguration>]
    attr_accessor :network_configurations

    # The list of Virtual IP (VIP) configurations of the cloud cluster.
    # @return [Array<OCI::DatabaseManagement::Models::CloudClusterVipConfiguration>]
    attr_accessor :vip_configurations

    # The list of Single Client Access Name (SCAN) configurations of the cloud cluster.
    # @return [Array<OCI::DatabaseManagement::Models::CloudClusterScanListenerConfiguration>]
    ...
    # @return [Array<OCI::DatabaseManagement::Models::DiscoveredCloudClusterInstance>]
    ...
    # @option attributes [String] :component_id The value to assign to the {OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent#component_id #component_id} proprety
    # @option attributes [String] :display_name The value to assign to the {OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent#display_name #display_name} proprety
    # @option attributes [String] :component_name The value to assign to the {OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent#component_name #component_name} proprety
    # @option attributes [String] :resource_id The value to assign to the {OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent#resource_id #resource_id} proprety
    # @option attributes [String] :dbaas_id The value to assign to the {OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent#dbaas_id #dbaas_id} proprety
    # @option attributes [BOOLEAN] :is_selected_for_monitoring The value to assign to the {OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent#is_selected_for_monitoring #is_selected_for_monitoring} proprety
    # @option attributes [String] :status The value to assign to the {OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent#status #status} proprety
    # @option attributes [Array<OCI::DatabaseManagement::Models::AssociatedCloudComponent>] :associated_components The value to assign to the {OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent#associated_components #associated_components} proprety
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::CloudClusterNetworkConfiguration>] :network_configurations The value to assign to the {#network_configurations} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::CloudClusterVipConfiguration>] :vip_configurations The value to assign to the {#vip_configurations} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::CloudClusterScanListenerConfiguration>] :scan_configurations The value to assign to the {#scan_configurations} property
    # @option attributes [String] :ocr_file_location The value to assign to the {#ocr_file_location} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::DiscoveredCloudClusterInstance>] :cluster_instances The value to assign to the {#cluster_instances} property
    ...
    def hash
      [component_id, display_name, component_name, component_type, resource_id, dbaas_id, is_selected_for_monitoring, status, associated_components, grid_home, version, is_flex_cluster, network_configurations, vip_configurations, scan_configurations, ocr_file_location, cluster_instances].hash
    end
