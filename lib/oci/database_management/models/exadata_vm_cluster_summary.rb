...
module OCI
  ...
  class DatabaseManagement::Models::ExadataVmClusterSummary < DatabaseManagement::Models::DbmResource
    LICENSE_MODEL_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      attributes['resourceType'] = 'VM_CLUSTER_SUMMARY'
    ...
    def hash
      [id, display_name, version, internal_id, status, lifecycle_state, time_created, time_updated, lifecycle_details, additional_details, resource_type, compartment_id, license_model, home_directory, deployment_type].hash
    end
