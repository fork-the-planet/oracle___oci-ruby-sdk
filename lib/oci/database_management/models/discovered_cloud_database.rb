...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredCloudDatabase < DatabaseManagement::Models::DiscoveredCloudDbSystemComponent
    DB_TYPE_ENUM = [
    ...
    # @return [Array<OCI::DatabaseManagement::Models::DiscoveredCloudPluggableDatabase>]
    attr_accessor :pluggable_databases

    # The list of database instances.
    # @return [Array<OCI::DatabaseManagement::Models::DiscoveredCloudDbInstance>]
    attr_accessor :db_instances
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::DiscoveredCloudPluggableDatabase>] :pluggable_databases The value to assign to the {#pluggable_databases} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::DiscoveredCloudDbInstance>] :db_instances The value to assign to the {#db_instances} property
