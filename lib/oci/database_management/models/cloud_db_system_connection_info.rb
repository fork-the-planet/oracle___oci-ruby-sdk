...
module OCI
  ...
  class DatabaseManagement::Models::CloudDbSystemConnectionInfo
    COMPONENT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::CloudAsmConnectionInfo' if type == 'ASM'
      return 'OCI::DatabaseManagement::Models::CloudDatabaseConnectionInfo' if type == 'DATABASE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::CloudDbSystemConnectionInfo'
    end
