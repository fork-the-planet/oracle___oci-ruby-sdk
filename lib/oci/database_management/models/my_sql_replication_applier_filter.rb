...
module OCI
  ...
  class DatabaseManagement::Models::MySqlReplicationApplierFilter
    # **[Required]** The type of replication filter that has been configured for the replication channel.
    # @return [String]
    attr_accessor :filter_name

    # The rules configured for the replication filter type.
    # @return [String]
    attr_accessor :filter_rule
    ...
    # @option attributes [String] :filter_rule The value to assign to the {#filter_rule} property
    def initialize(attributes = {})
      ...
      self.filter_rule = attributes[:'filterRule'] if attributes[:'filterRule']

      raise 'You cannot provide both :filterRule and :filter_rule' if attributes.key?(:'filterRule') && attributes.key?(:'filter_rule')

      self.filter_rule = attributes[:'filter_rule'] if attributes[:'filter_rule']
    end
