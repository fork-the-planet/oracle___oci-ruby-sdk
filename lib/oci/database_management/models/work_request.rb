...
module OCI
  ...
  class DatabaseManagement::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_UPDATE_CLOUD_DB_SYSTEM_CONNECTOR = 'UPDATE_CLOUD_DB_SYSTEM_CONNECTOR'.freeze,
      OPERATION_TYPE_CHANGE_CLOUD_DB_SYSTEM_COMPARTMENT = 'CHANGE_CLOUD_DB_SYSTEM_COMPARTMENT'.freeze,
