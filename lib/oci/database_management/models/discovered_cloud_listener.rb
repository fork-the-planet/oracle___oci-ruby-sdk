...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredCloudListener < DatabaseManagement::Models::DiscoveredCloudDbSystemComponent
    LISTENER_TYPE_ENUM = [
    ...
    # @return [OCI::DatabaseManagement::Models::CloudDbSystemDiscoveryConnector]
    ...
    # @option attributes [OCI::DatabaseManagement::Models::CloudDbSystemDiscoveryConnector] :connector The value to assign to the {#connector} property
    ...
    def hash
      [component_id, display_name, component_name, component_type, resource_id, dbaas_id, is_selected_for_monitoring, status, associated_components, db_node_name, oracle_home, listener_alias, adr_home_directory, log_directory, trace_directory, version, listener_type, host_name, endpoints, connector].hash
    end
