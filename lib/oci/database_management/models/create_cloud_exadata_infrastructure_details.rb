...
module OCI
  ...
  class DatabaseManagement::Models::CreateCloudExadataInfrastructureDetails
    LICENSE_MODEL_ENUM = [
    ...
    # **[Required]** The list of VM Clusters in the Exadata infrastructure.
    # @return [Array<String>]
    ...
    def hash
      [discovery_key, license_model, compartment_id, display_name, vm_cluster_ids, storage_server_names, freeform_tags, defined_tags].hash
    end
