...
module OCI
  ...
  class DatabaseManagement::Models::EnableCloudExadataInfrastructureManagementDetails
    LICENSE_MODEL_ENUM = [
      LICENSE_MODEL_LICENSE_INCLUDED = 'LICENSE_INCLUDED'.freeze,
      LICENSE_MODEL_BRING_YOUR_OWN_LICENSE = 'BRING_YOUR_OWN_LICENSE'.freeze
    ].freeze

    # **[Required]** The Oracle license model that applies to the database management resources.
    #
    # @return [String]
