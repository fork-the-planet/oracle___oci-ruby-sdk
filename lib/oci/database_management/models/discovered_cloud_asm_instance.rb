...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredCloudAsmInstance < DatabaseManagement::Models::DiscoveredCloudDbSystemComponent
    ...
    def hash
      [component_id, display_name, component_name, component_type, resource_id, dbaas_id, is_selected_for_monitoring, status, associated_components, host_name, instance_name, adr_home_directory].hash
    end
