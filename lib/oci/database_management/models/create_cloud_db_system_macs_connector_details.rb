...
require 'date'
require_relative 'create_cloud_db_system_connector_details'
...
module OCI
  ...
  #
  class DatabaseManagement::Models::CreateCloudDbSystemMacsConnectorDetails < DatabaseManagement::Models::CreateCloudDbSystemConnectorDetails
    ...
    # @option attributes [String] :display_name The value to assign to the {OCI::DatabaseManagement::Models::CreateCloudDbSystemConnectorDetails#display_name #display_name} proprety
    # @option attributes [String] :cloud_db_system_id The value to assign to the {OCI::DatabaseManagement::Models::CreateCloudDbSystemConnectorDetails#cloud_db_system_id #cloud_db_system_id} proprety
    ...
    def hash
      [connector_type, display_name, cloud_db_system_id, agent_id, connection_info, freeform_tags, defined_tags].hash
    end
