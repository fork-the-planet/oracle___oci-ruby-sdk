...
module OCI
  ...
  class DatabaseManagement::Models::CloudDbSystemDiscovery
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system discovery.
    # @return [String]
    attr_accessor :id
    ...
    # @return [Array<OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent>]
    ...
    # **[Required]** The current lifecycle state of the cloud DB system discovery resource.
    # @return [String]
    ...
    # **[Required]** The date and time the cloud DB system discovery was created.
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The date and time the cloud DB system discovery was last updated.
    # @return [DateTime]
    ...
    def self.swagger_types
      {
        ...
        'grid_home': :'String',
        'discovered_components': :'Array<OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent>',
        'resource_id': :'String',
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::DiscoveredCloudDbSystemComponent>] :discovered_components The value to assign to the {#discovered_components} property
    ...
    def hash
      [id, display_name, compartment_id, agent_id, dbaas_parent_infrastructure_id, deployment_type, grid_home, discovered_components, resource_id, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
