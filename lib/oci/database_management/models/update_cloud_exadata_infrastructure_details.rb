...
module OCI
  ...
  class DatabaseManagement::Models::UpdateCloudExadataInfrastructureDetails
    LICENSE_MODEL_ENUM = [
    ...
    def hash
      [discovery_key, license_model, display_name, vm_cluster_ids, storage_server_names, freeform_tags, defined_tags].hash
    end
