...
module OCI
  ...
  class DatabaseManagement::Models::CloudExadataStorageServerSummary < DatabaseManagement::Models::DbmResource
    ...
    def initialize(attributes = {})
      ...
      attributes['resourceType'] = 'CLOUD_STORAGE_SERVER_SUMMARY'
