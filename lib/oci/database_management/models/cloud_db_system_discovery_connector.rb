...
module OCI
  ...
  class DatabaseManagement::Models::CloudDbSystemDiscoveryConnector
    CONNECTOR_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::CloudDbSystemDiscoveryMacsConnector' if type == 'MACS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::CloudDbSystemDiscoveryConnector'
    end
