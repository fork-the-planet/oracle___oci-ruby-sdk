...
module OCI
  ...
  class DatabaseManagement::Models::CloudExadataInfrastructureSummary < DatabaseManagement::Models::DbmResource
    RACK_SIZE_ENUM = [
    ...
    INFRASTRUCTURE_TYPE_ENUM = [
      INFRASTRUCTURE_TYPE_EXADATA = 'EXADATA'.freeze,
      INFRASTRUCTURE_TYPE_EXADATA_CC = 'EXADATA_CC'.freeze,
    ...
    def initialize(attributes = {})
      ...
      attributes['resourceType'] = 'CLOUD_INFRASTRUCTURE_SUMMARY'
    ...
    def hash
      [id, display_name, version, internal_id, status, lifecycle_state, time_created, time_updated, lifecycle_details, additional_details, resource_type, rack_size, infrastructure_type, compartment_id, license_model, grid_home_path, freeform_tags, defined_tags, system_tags].hash
    end
