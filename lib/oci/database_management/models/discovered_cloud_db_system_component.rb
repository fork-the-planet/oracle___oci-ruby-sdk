...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredCloudDbSystemComponent
    COMPONENT_TYPE_ENUM = [
    ...
    # @return [Array<OCI::DatabaseManagement::Models::AssociatedCloudComponent>]
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AssociatedCloudComponent>] :associated_components The value to assign to the {#associated_components} property
