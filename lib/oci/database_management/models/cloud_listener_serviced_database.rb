...
module OCI
  ...
  class DatabaseManagement::Models::CloudListenerServicedDatabase
    DATABASE_TYPE_ENUM = [
    ...
    def hash
      [id, dbaas_id, display_name, db_unique_name, compartment_id, database_type, database_sub_type, is_managed].hash
    end
