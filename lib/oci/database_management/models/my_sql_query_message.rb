...
module OCI
  ...
  class DatabaseManagement::Models::MySqlQueryMessage
    LEVEL_ENUM = [
      LEVEL_ERROR = 'ERROR'.freeze,
      LEVEL_WARNING = 'WARNING'.freeze,
      LEVEL_NOTE = 'NOTE'.freeze,
      LEVEL_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The level of severity of the MySQL message.
    # @return [String]
    attr_reader :level

    # **[Required]** The MySQL code of the raised error, warning, or note.
    # @return [Integer]
    attr_accessor :code

    # **[Required]** The MySQL message text of the raised error, warning, or note.
    # @return [String]
    ...
    # @option attributes [String] :message_text The value to assign to the {#message_text} property
    def initialize(attributes = {})
      ...
      self.message_text = attributes[:'messageText'] if attributes[:'messageText']

      raise 'You cannot provide both :messageText and :message_text' if attributes.key?(:'messageText') && attributes.key?(:'message_text')

      self.message_text = attributes[:'message_text'] if attributes[:'message_text']
    end
