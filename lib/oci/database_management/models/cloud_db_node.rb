...
module OCI
  ...
  class DatabaseManagement::Models::CloudDbNode
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB node.
    # @return [String]
    attr_accessor :id

    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB node in DBaas service.
    # @return [String]
    attr_accessor :dbaas_id

    # **[Required]** The user-friendly name for the cloud DB node. The name does not have to be unique.
    # @return [String]
    attr_accessor :display_name

    # **[Required]** The name of the cloud DB node.
    # @return [String]
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system that the DB node is a part of.
    # @return [String]
    ...
    # **[Required]** The current lifecycle state of the cloud DB node.
    # @return [String]
    ...
    # **[Required]** The date and time the cloud DB node was created.
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The date and time the cloud DB node was last updated.
    # @return [DateTime]
    ...
    def hash
      [id, dbaas_id, display_name, component_name, compartment_id, cloud_db_system_id, cloud_connector_id, host_name, cpu_core_count, memory_size_in_gbs, additional_details, lifecycle_state, lifecycle_details, domain_name, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
