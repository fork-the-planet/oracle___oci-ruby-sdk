...
module OCI
  ...
  class DatabaseManagement::Models::CloudExadataInfrastructureDiscovery < DatabaseManagement::Models::EntityDiscovered
    LICENSE_MODEL_ENUM = [
    ...
    # @return [Array<OCI::DatabaseManagement::Models::VMClusterDiscoverySummary>]
    attr_accessor :vm_clusters

    # @return [OCI::DatabaseManagement::Models::StorageGridDiscoverySummary]
    attr_accessor :storage_grid

    # The list of storage servers in the Exadata infrastructure.
    # @return [Array<OCI::DatabaseManagement::Models::StorageServerDiscoverySummary>]
    ...
    def self.swagger_types
      {
        ...
        'vm_clusters': :'Array<OCI::DatabaseManagement::Models::VMClusterDiscoverySummary>',
        'storage_grid': :'OCI::DatabaseManagement::Models::StorageGridDiscoverySummary',
        'storage_servers': :'Array<OCI::DatabaseManagement::Models::StorageServerDiscoverySummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::VMClusterDiscoverySummary>] :vm_clusters The value to assign to the {#vm_clusters} property
    # @option attributes [OCI::DatabaseManagement::Models::StorageGridDiscoverySummary] :storage_grid The value to assign to the {#storage_grid} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::StorageServerDiscoverySummary>] :storage_servers The value to assign to the {#storage_servers} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['entityType'] = 'CLOUD_INFRASTRUCTURE_DISCOVER'
      ...
      self.vm_clusters = attributes[:'vmClusters'] if attributes[:'vmClusters']

      raise 'You cannot provide both :vmClusters and :vm_clusters' if attributes.key?(:'vmClusters') && attributes.key?(:'vm_clusters')

      self.vm_clusters = attributes[:'vm_clusters'] if attributes[:'vm_clusters']
    ...
    def hash
      [id, agent_id, connector_id, display_name, version, internal_id, status, discover_status, discover_error_code, discover_error_msg, entity_type, discovery_key, license_model, compartment_id, rack_size, grid_home_path, vm_clusters, storage_grid, storage_servers].hash
    end
