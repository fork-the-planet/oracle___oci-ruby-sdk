...
module OCI
  ...
  class DatabaseManagement::Models::CreateCloudExadataStorageConnectorDetails
    ...
    def hash
      [storage_server_id, agent_id, display_name, connection_uri, credential_info, freeform_tags, defined_tags].hash
    end
