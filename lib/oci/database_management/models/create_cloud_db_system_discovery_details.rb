...
module OCI
  ...
  class DatabaseManagement::Models::CreateCloudDbSystemDiscoveryDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment in which the cloud DB system resides.
    # @return [String]
    ...
    def hash
      [display_name, agent_id, compartment_id, dbaas_parent_infrastructure_id, deployment_type, freeform_tags, defined_tags].hash
    end
