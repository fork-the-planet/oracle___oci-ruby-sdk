...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredExternalDbInstance < DatabaseManagement::Models::DiscoveredExternalDbSystemComponent
    ...
    def hash
      [component_id, display_name, component_name, component_type, resource_id, is_selected_for_monitoring, status, associated_components, instance_name, host_name, node_name, oracle_home, adr_home_directory].hash
    end
