...
module OCI
  ...
  class DatabaseManagement::Models::CloudAsm
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud ASM.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The user-friendly name for the cloud ASM. The name does not have to be unique.
    # @return [String]
    attr_accessor :display_name

    # **[Required]** The name of the cloud ASM.
    # @return [String]
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system that the ASM is a part of.
    # @return [String]
    ...
    # **[Required]** The current lifecycle state of the cloud ASM.
    # @return [String]
    ...
    # @return [Array<OCI::DatabaseManagement::Models::CloudAsmServicedDatabase>]
    ...
    # **[Required]** The date and time the cloud ASM was created.
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The date and time the cloud ASM was last updated.
    # @return [DateTime]
    ...
    def self.swagger_types
      {
        ...
        'serviced_databases': :'Array<OCI::DatabaseManagement::Models::CloudAsmServicedDatabase>',
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::CloudAsmServicedDatabase>] :serviced_databases The value to assign to the {#serviced_databases} property
    ...
    def hash
      [id, dbaas_id, display_name, component_name, compartment_id, cloud_db_system_id, cloud_connector_id, grid_home, is_cluster, is_flex_enabled, lifecycle_state, lifecycle_details, serviced_databases, additional_details, time_created, time_updated, version, freeform_tags, defined_tags, system_tags].hash
    end
