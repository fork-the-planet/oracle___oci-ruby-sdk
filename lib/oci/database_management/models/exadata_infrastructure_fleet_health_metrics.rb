...
module OCI
  ...
  class DatabaseManagement::Models::ExadataInfrastructureFleetHealthMetrics
    COMPARE_TYPE_ENUM = [
    ...
    # @return [OCI::DatabaseManagement::Models::ExadataInfrastructureFleetSummary]
    attr_accessor :exadata_infrastructure_fleet_summary

    # **[Required]** A list of the Exadata infrastructures present in the fleet and their usage metrics.
    # @return [Array<OCI::DatabaseManagement::Models::ExadataInfrastructureUsageMetrics>]
    attr_accessor :fleet_exadata_infrastructures
    ...
    def self.swagger_types
      {
        ...
        'compare_type': :'String',
        'exadata_infrastructure_fleet_summary': :'OCI::DatabaseManagement::Models::ExadataInfrastructureFleetSummary',
        'fleet_exadata_infrastructures': :'Array<OCI::DatabaseManagement::Models::ExadataInfrastructureUsageMetrics>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DatabaseManagement::Models::ExadataInfrastructureFleetSummary] :exadata_infrastructure_fleet_summary The value to assign to the {#exadata_infrastructure_fleet_summary} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::ExadataInfrastructureUsageMetrics>] :fleet_exadata_infrastructures The value to assign to the {#fleet_exadata_infrastructures} property
    def initialize(attributes = {})
      ...
      self.exadata_infrastructure_fleet_summary = attributes[:'exadataInfrastructureFleetSummary'] if attributes[:'exadataInfrastructureFleetSummary']

      raise 'You cannot provide both :exadataInfrastructureFleetSummary and :exadata_infrastructure_fleet_summary' if attributes.key?(:'exadataInfrastructureFleetSummary') && attributes.key?(:'exadata_infrastructure_fleet_summary')

      self.exadata_infrastructure_fleet_summary = attributes[:'exadata_infrastructure_fleet_summary'] if attributes[:'exadata_infrastructure_fleet_summary']

      self.fleet_exadata_infrastructures = attributes[:'fleetExadataInfrastructures'] if attributes[:'fleetExadataInfrastructures']

      raise 'You cannot provide both :fleetExadataInfrastructures and :fleet_exadata_infrastructures' if attributes.key?(:'fleetExadataInfrastructures') && attributes.key?(:'fleet_exadata_infrastructures')

      self.fleet_exadata_infrastructures = attributes[:'fleet_exadata_infrastructures'] if attributes[:'fleet_exadata_infrastructures']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        exadata_infrastructure_fleet_summary == other.exadata_infrastructure_fleet_summary &&
        fleet_exadata_infrastructures == other.fleet_exadata_infrastructures
    end
    ...
    def hash
      [compare_baseline_time, compare_target_time, compare_type, exadata_infrastructure_fleet_summary, fleet_exadata_infrastructures].hash
    end
