...
module OCI
  ...
  class DatabaseManagement::Models::CloudDbSystemDiscoverySummary
    ...
    def hash
      [id, display_name, compartment_id, agent_id, dbaas_parent_infrastructure_id, deployment_type, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
