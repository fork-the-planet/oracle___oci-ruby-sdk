...
module OCI
  ...
  class DatabaseManagement::Models::ExadataInfrastructureDiscoverySummary < DatabaseManagement::Models::EntityDiscovered
    RACK_SIZE_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      attributes['entityType'] = 'MANAGED_INFRASTRUCTURE_DISCOVER_SUMMARY'
