...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredCloudDbInstance < DatabaseManagement::Models::DiscoveredCloudDbSystemComponent
    # **[Required]** The name of the DB instance.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['componentType'] = 'DATABASE_INSTANCE'
    ...
    def hash
      [component_id, display_name, component_name, component_type, resource_id, dbaas_id, is_selected_for_monitoring, status, associated_components, instance_name, host_name, node_name, oracle_home, adr_home_directory].hash
    end
