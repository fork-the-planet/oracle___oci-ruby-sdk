...
module OCI
  ...
  class DatabaseManagement::Models::CloudListener
    LISTENER_TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud listener.
    # @return [String]
    attr_accessor :id

    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) in DBaas service.
    # @return [String]
    attr_accessor :dbaas_id

    # **[Required]** The user-friendly name for the cloud listener. The name does not have to be unique.
    # @return [String]
    attr_accessor :display_name

    # **[Required]** The name of the cloud listener.
    # @return [String]
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system that the listener is a part of.
    # @return [String]
    attr_accessor :cloud_db_system_id
    ...
    # @return [String]
    attr_accessor :cloud_db_node_id

    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB home.
    # @return [String]
    attr_accessor :cloud_db_home_id
    ...
    # **[Required]** The current lifecycle state of the cloud listener.
    # @return [String]
    ...
    # @return [Array<OCI::DatabaseManagement::Models::CloudListenerEndpoint>]
    attr_accessor :endpoints

    # The list of databases that are serviced by the listener.
    # @return [Array<OCI::DatabaseManagement::Models::CloudListenerServicedDatabase>]
    attr_accessor :serviced_databases

    # The list of ASMs that are serviced by the listener.
    # @return [Array<OCI::DatabaseManagement::Models::CloudServicedAsm>]
    attr_accessor :serviced_asms

    # **[Required]** The date and time the cloud listener was created.
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The date and time the cloud listener was last updated.
    # @return [DateTime]
    ...
    def self.swagger_types
      {
        ...
        'version': :'String',
        'endpoints': :'Array<OCI::DatabaseManagement::Models::CloudListenerEndpoint>',
        'serviced_databases': :'Array<OCI::DatabaseManagement::Models::CloudListenerServicedDatabase>',
        'serviced_asms': :'Array<OCI::DatabaseManagement::Models::CloudServicedAsm>',
    ...
    # @option attributes [String] :dbaas_id The value to assign to the {#dbaas_id} property
    ...
    # @option attributes [String] :cloud_db_system_id The value to assign to the {#cloud_db_system_id} property
    # @option attributes [String] :cloud_connector_id The value to assign to the {#cloud_connector_id} property
    # @option attributes [String] :cloud_db_node_id The value to assign to the {#cloud_db_node_id} property
    # @option attributes [String] :cloud_db_home_id The value to assign to the {#cloud_db_home_id} property
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::CloudListenerEndpoint>] :endpoints The value to assign to the {#endpoints} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::CloudListenerServicedDatabase>] :serviced_databases The value to assign to the {#serviced_databases} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::CloudServicedAsm>] :serviced_asms The value to assign to the {#serviced_asms} property
    ...
    def initialize(attributes = {})
      ...
      self.cloud_db_system_id = attributes[:'cloudDbSystemId'] if attributes[:'cloudDbSystemId']

      raise 'You cannot provide both :cloudDbSystemId and :cloud_db_system_id' if attributes.key?(:'cloudDbSystemId') && attributes.key?(:'cloud_db_system_id')

      self.cloud_db_system_id = attributes[:'cloud_db_system_id'] if attributes[:'cloud_db_system_id']

      self.cloud_connector_id = attributes[:'cloudConnectorId'] if attributes[:'cloudConnectorId']

      raise 'You cannot provide both :cloudConnectorId and :cloud_connector_id' if attributes.key?(:'cloudConnectorId') && attributes.key?(:'cloud_connector_id')

      self.cloud_connector_id = attributes[:'cloud_connector_id'] if attributes[:'cloud_connector_id']

      self.cloud_db_node_id = attributes[:'cloudDbNodeId'] if attributes[:'cloudDbNodeId']

      raise 'You cannot provide both :cloudDbNodeId and :cloud_db_node_id' if attributes.key?(:'cloudDbNodeId') && attributes.key?(:'cloud_db_node_id')

      self.cloud_db_node_id = attributes[:'cloud_db_node_id'] if attributes[:'cloud_db_node_id']

      self.cloud_db_home_id = attributes[:'cloudDbHomeId'] if attributes[:'cloudDbHomeId']

      raise 'You cannot provide both :cloudDbHomeId and :cloud_db_home_id' if attributes.key?(:'cloudDbHomeId') && attributes.key?(:'cloud_db_home_id')

      self.cloud_db_home_id = attributes[:'cloud_db_home_id'] if attributes[:'cloud_db_home_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        cloud_db_system_id == other.cloud_db_system_id &&
        cloud_connector_id == other.cloud_connector_id &&
        cloud_db_node_id == other.cloud_db_node_id &&
        cloud_db_home_id == other.cloud_db_home_id &&
