...
module OCI
  ...
  class DatabaseManagement::Models::CloudExadataInfrastructure < DatabaseManagement::Models::DbmResource
    RACK_SIZE_ENUM = [
    ...
    # @return [OCI::DatabaseManagement::Models::CloudExadataStorageGridSummary]
    ...
    # @return [Array<OCI::DatabaseManagement::Models::ExadataVmClusterSummary>]
    ...
    def self.swagger_types
      {
        ...
        'storage_grid': :'OCI::DatabaseManagement::Models::CloudExadataStorageGridSummary',
        'deployment_type': :'String',
        'vm_clusters': :'Array<OCI::DatabaseManagement::Models::ExadataVmClusterSummary>',
    ...
    # @option attributes [OCI::DatabaseManagement::Models::CloudExadataStorageGridSummary] :storage_grid The value to assign to the {#storage_grid} property
    # @option attributes [String] :deployment_type The value to assign to the {#deployment_type} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::ExadataVmClusterSummary>] :vm_clusters The value to assign to the {#vm_clusters} property
    ...
    def initialize(attributes = {})
      ...
      attributes['resourceType'] = 'CLOUD_INFRASTRUCTURE'
    ...
    def hash
      [id, display_name, version, internal_id, status, lifecycle_state, time_created, time_updated, lifecycle_details, additional_details, resource_type, rack_size, compartment_id, license_model, storage_grid, deployment_type, vm_clusters, database_compartments, freeform_tags, defined_tags, system_tags].hash
    end
