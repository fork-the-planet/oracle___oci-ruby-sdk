...
module OCI
  ...
  class DatabaseManagement::DbManagementClientCompositeOperations
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#change_cloud_exadata_infrastructure_compartment} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_exadata_infrastructure_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata infrastructure.
    # @param [OCI::DatabaseManagement::Models::ChangeCloudExadataInfrastructureCompartmentDetails] change_cloud_exadata_infrastructure_compartment_details The details required to move the Exadata infrastructure from one compartment to another.
    ...
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#change_cloud_exadata_infrastructure_compartment}
    ...
    def change_cloud_exadata_infrastructure_compartment_and_wait_for_state(cloud_exadata_infrastructure_id, change_cloud_exadata_infrastructure_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_cloud_exadata_infrastructure_compartment(cloud_exadata_infrastructure_id, change_cloud_exadata_infrastructure_compartment_details, base_operation_opts)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#check_cloud_db_system_connector_connection_status} and then waits for the {OCI::DatabaseManagement::Models::CloudDbSystemConnector} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_connector_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud connector.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudDbSystemConnector#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#check_cloud_db_system_connector_connection_status}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudDbSystemConnector}
    def check_cloud_db_system_connector_connection_status_and_wait_for_state(cloud_db_system_connector_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.check_cloud_db_system_connector_connection_status(cloud_db_system_connector_id, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_cloud_db_system_connector(wait_for_resource_id).wait_until(
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#create_cloud_db_system} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DatabaseManagement::Models::CreateCloudDbSystemDetails] create_cloud_db_system_details The details required to create a cloud DB system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#create_cloud_db_system}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def create_cloud_db_system_and_wait_for_state(create_cloud_db_system_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_cloud_db_system(create_cloud_db_system_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#create_cloud_db_system_connector} and then waits for the {OCI::DatabaseManagement::Models::CloudDbSystemConnector} acted upon
    # to enter the given state(s).
    #
    # @param [OCI::DatabaseManagement::Models::CreateCloudDbSystemConnectorDetails] create_cloud_db_system_connector_details The details required to create a cloud connector.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudDbSystemConnector#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#create_cloud_db_system_connector}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudDbSystemConnector}
    def create_cloud_db_system_connector_and_wait_for_state(create_cloud_db_system_connector_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_cloud_db_system_connector(create_cloud_db_system_connector_details, base_operation_opts)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#create_cloud_db_system_discovery} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DatabaseManagement::Models::CreateCloudDbSystemDiscoveryDetails] create_cloud_db_system_discovery_details The details required to create a cloud DB system discovery.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#create_cloud_db_system_discovery}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def create_cloud_db_system_discovery_and_wait_for_state(create_cloud_db_system_discovery_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_cloud_db_system_discovery(create_cloud_db_system_discovery_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#create_cloud_exadata_infrastructure} and then waits for the {OCI::DatabaseManagement::Models::CloudExadataInfrastructure} acted upon
    # to enter the given state(s).
    #
    # @param [OCI::DatabaseManagement::Models::CreateCloudExadataInfrastructureDetails] create_cloud_exadata_infrastructure_details The details required to create the managed Exadata infrastructure resources.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudExadataInfrastructure#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#create_cloud_exadata_infrastructure}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudExadataInfrastructure}
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#create_cloud_exadata_storage_connector} and then waits for the {OCI::DatabaseManagement::Models::CloudExadataStorageConnector} acted upon
    # to enter the given state(s).
    #
    # @param [OCI::DatabaseManagement::Models::CreateCloudExadataStorageConnectorDetails] create_cloud_exadata_storage_connector_details The details required to add connections to the Exadata storage servers.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudExadataStorageConnector#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#create_cloud_exadata_storage_connector}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudExadataStorageConnector}
    def create_cloud_exadata_storage_connector_and_wait_for_state(create_cloud_exadata_storage_connector_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_cloud_exadata_storage_connector(create_cloud_exadata_storage_connector_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_cloud_exadata_storage_connector(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#delete_cloud_db_system} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#delete_cloud_db_system}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def delete_cloud_db_system_and_wait_for_state(cloud_db_system_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_cloud_db_system(cloud_db_system_id, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#delete_cloud_db_system_connector} and then waits for the {OCI::DatabaseManagement::Models::CloudDbSystemConnector} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_connector_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud connector.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudDbSystemConnector#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#delete_cloud_db_system_connector}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type nil
    def delete_cloud_db_system_connector_and_wait_for_state(cloud_db_system_connector_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      initial_get_result = @service_client.get_cloud_db_system_connector(cloud_db_system_connector_id)
      operation_result = @service_client.delete_cloud_db_system_connector(cloud_db_system_connector_id, base_operation_opts)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#delete_cloud_db_system_discovery} and then waits for the {OCI::DatabaseManagement::Models::CloudDbSystemDiscovery} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_discovery_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system discovery.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudDbSystemDiscovery#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#delete_cloud_db_system_discovery}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type nil
    def delete_cloud_db_system_discovery_and_wait_for_state(cloud_db_system_discovery_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      initial_get_result = @service_client.get_cloud_db_system_discovery(cloud_db_system_discovery_id)
      operation_result = @service_client.delete_cloud_db_system_discovery(cloud_db_system_discovery_id, base_operation_opts)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#delete_cloud_exadata_infrastructure} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_exadata_infrastructure_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata infrastructure.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#delete_cloud_exadata_infrastructure}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#delete_cloud_exadata_storage_connector} and then waits for the {OCI::DatabaseManagement::Models::CloudExadataStorageConnector} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_exadata_storage_connector_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the connector to the Exadata storage server.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudExadataStorageConnector#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#delete_cloud_exadata_storage_connector}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type nil
    def delete_cloud_exadata_storage_connector_and_wait_for_state(cloud_exadata_storage_connector_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      initial_get_result = @service_client.get_cloud_exadata_storage_connector(cloud_exadata_storage_connector_id)
      operation_result = @service_client.delete_cloud_exadata_storage_connector(cloud_exadata_storage_connector_id, base_operation_opts)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#disable_cloud_db_system_database_management} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#disable_cloud_db_system_database_management}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def disable_cloud_db_system_database_management_and_wait_for_state(cloud_db_system_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.disable_cloud_db_system_database_management(cloud_db_system_id, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#disable_cloud_db_system_stack_monitoring} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#disable_cloud_db_system_stack_monitoring}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def disable_cloud_db_system_stack_monitoring_and_wait_for_state(cloud_db_system_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.disable_cloud_db_system_stack_monitoring(cloud_db_system_id, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#disable_cloud_exadata_infrastructure_management} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_exadata_infrastructure_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata infrastructure.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#disable_cloud_exadata_infrastructure_management}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def disable_cloud_exadata_infrastructure_management_and_wait_for_state(cloud_exadata_infrastructure_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.disable_cloud_exadata_infrastructure_management(cloud_exadata_infrastructure_id, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#enable_cloud_db_system_database_management} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system.
    # @param [OCI::DatabaseManagement::Models::EnableCloudDbSystemDatabaseManagementDetails] enable_cloud_db_system_database_management_details The details required to enable Stack Monitoring for a cloud DB system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#enable_cloud_db_system_database_management}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def enable_cloud_db_system_database_management_and_wait_for_state(cloud_db_system_id, enable_cloud_db_system_database_management_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.enable_cloud_db_system_database_management(cloud_db_system_id, enable_cloud_db_system_database_management_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#enable_cloud_db_system_stack_monitoring} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system.
    # @param [OCI::DatabaseManagement::Models::EnableCloudDbSystemStackMonitoringDetails] enable_cloud_db_system_stack_monitoring_details The details required to enable Stack Monitoring for a cloud DB system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#enable_cloud_db_system_stack_monitoring}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def enable_cloud_db_system_stack_monitoring_and_wait_for_state(cloud_db_system_id, enable_cloud_db_system_stack_monitoring_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.enable_cloud_db_system_stack_monitoring(cloud_db_system_id, enable_cloud_db_system_stack_monitoring_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#enable_cloud_exadata_infrastructure_management} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_exadata_infrastructure_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata infrastructure.
    # @param [OCI::DatabaseManagement::Models::EnableCloudExadataInfrastructureManagementDetails] enable_cloud_exadata_infrastructure_management_details The details required to enable management for the Exadata infrastructure.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#enable_cloud_exadata_infrastructure_management}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def enable_cloud_exadata_infrastructure_management_and_wait_for_state(cloud_exadata_infrastructure_id, enable_cloud_exadata_infrastructure_management_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.enable_cloud_exadata_infrastructure_management(cloud_exadata_infrastructure_id, enable_cloud_exadata_infrastructure_management_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_asm} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_asm_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud ASM.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudAsmDetails] update_cloud_asm_details The details required to update a cloud ASM.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_asm}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def update_cloud_asm_and_wait_for_state(cloud_asm_id, update_cloud_asm_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_asm(cloud_asm_id, update_cloud_asm_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_asm_instance} and then waits for the {OCI::DatabaseManagement::Models::CloudAsmInstance} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_asm_instance_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud ASM instance.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudAsmInstanceDetails] update_cloud_asm_instance_details The details required to update a cloud ASM instance.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudAsmInstance#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_asm_instance}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudAsmInstance}
    def update_cloud_asm_instance_and_wait_for_state(cloud_asm_instance_id, update_cloud_asm_instance_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_asm_instance(cloud_asm_instance_id, update_cloud_asm_instance_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_cloud_asm_instance(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_cluster} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_cluster_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud cluster.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudClusterDetails] update_cloud_cluster_details The details required to update a cloud cluster.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_cluster}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def update_cloud_cluster_and_wait_for_state(cloud_cluster_id, update_cloud_cluster_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_cluster(cloud_cluster_id, update_cloud_cluster_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_cluster_instance} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_cluster_instance_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud cluster instance.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudClusterInstanceDetails] update_cloud_cluster_instance_details The details required to update a cloud cluster instance.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_cluster_instance}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def update_cloud_cluster_instance_and_wait_for_state(cloud_cluster_instance_id, update_cloud_cluster_instance_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_cluster_instance(cloud_cluster_instance_id, update_cloud_cluster_instance_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_db_home} and then waits for the {OCI::DatabaseManagement::Models::CloudDbHome} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_db_home_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud database home.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudDbHomeDetails] update_cloud_db_home_details The details required to update a cloud DB home.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudDbHome#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_db_home}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudDbHome}
    def update_cloud_db_home_and_wait_for_state(cloud_db_home_id, update_cloud_db_home_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_db_home(cloud_db_home_id, update_cloud_db_home_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_cloud_db_home(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_db_node} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_db_node_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud database node.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudDbNodeDetails] update_cloud_db_node_details The details required to update a cloud DB node.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_db_node}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def update_cloud_db_node_and_wait_for_state(cloud_db_node_id, update_cloud_db_node_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_db_node(cloud_db_node_id, update_cloud_db_node_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_db_system} and then waits for the {OCI::DatabaseManagement::Models::CloudDbSystem} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudDbSystemDetails] update_cloud_db_system_details The details required to update a cloud DB system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudDbSystem#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_db_system}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudDbSystem}
    def update_cloud_db_system_and_wait_for_state(cloud_db_system_id, update_cloud_db_system_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_db_system(cloud_db_system_id, update_cloud_db_system_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_cloud_db_system(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_db_system_connector} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_connector_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud connector.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudDbSystemConnectorDetails] update_cloud_db_system_connector_details The details required to update a cloud connector.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_db_system_connector}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def update_cloud_db_system_connector_and_wait_for_state(cloud_db_system_connector_id, update_cloud_db_system_connector_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_db_system_connector(cloud_db_system_connector_id, update_cloud_db_system_connector_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_db_system_discovery} and then waits for the {OCI::DatabaseManagement::Models::CloudDbSystemDiscovery} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_db_system_discovery_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud DB system discovery.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudDbSystemDiscoveryDetails] update_cloud_db_system_discovery_details The details required to update a cloud DB system discovery.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudDbSystemDiscovery#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_db_system_discovery}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudDbSystemDiscovery}
    def update_cloud_db_system_discovery_and_wait_for_state(cloud_db_system_discovery_id, update_cloud_db_system_discovery_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_db_system_discovery(cloud_db_system_discovery_id, update_cloud_db_system_discovery_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_cloud_db_system_discovery(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_exadata_infrastructure} and then waits for the {OCI::DatabaseManagement::Models::CloudExadataInfrastructure} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_exadata_infrastructure_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata infrastructure.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudExadataInfrastructureDetails] update_cloud_exadata_infrastructure_details The details required to update the managed Exadata infrastructure resources.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudExadataInfrastructure#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_exadata_infrastructure}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_exadata_storage_connector} and then waits for the {OCI::DatabaseManagement::Models::CloudExadataStorageConnector} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_exadata_storage_connector_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the connector to the Exadata storage server.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudExadataStorageConnectorDetails] update_cloud_exadata_storage_connector_details The details required to update connections to the Exadata storage servers.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudExadataStorageConnector#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_exadata_storage_connector}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudExadataStorageConnector}
    def update_cloud_exadata_storage_connector_and_wait_for_state(cloud_exadata_storage_connector_id, update_cloud_exadata_storage_connector_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_exadata_storage_connector(cloud_exadata_storage_connector_id, update_cloud_exadata_storage_connector_details, base_operation_opts)
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_exadata_storage_grid} and then waits for the {OCI::DatabaseManagement::Models::CloudExadataStorageGrid} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_exadata_storage_grid_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata storage grid.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudExadataStorageGridDetails] update_cloud_exadata_storage_grid_details The details required to update an Exadata storage grid.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudExadataStorageGrid#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_exadata_storage_grid}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudExadataStorageGrid}
    def update_cloud_exadata_storage_grid_and_wait_for_state(cloud_exadata_storage_grid_id, update_cloud_exadata_storage_grid_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_exadata_storage_grid(cloud_exadata_storage_grid_id, update_cloud_exadata_storage_grid_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_cloud_exadata_storage_grid(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_exadata_storage_server} and then waits for the {OCI::DatabaseManagement::Models::CloudExadataStorageServer} acted upon
    # to enter the given state(s).
    #
    # @param [String] cloud_exadata_storage_server_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Exadata storage server.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudExadataStorageServerDetails] update_cloud_exadata_storage_server_details The details required to update an Exadata storage server.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::CloudExadataStorageServer#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_exadata_storage_server}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::DatabaseManagement::Models::CloudExadataStorageServer}
    def update_cloud_exadata_storage_server_and_wait_for_state(cloud_exadata_storage_server_id, update_cloud_exadata_storage_server_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_exadata_storage_server(cloud_exadata_storage_server_id, update_cloud_exadata_storage_server_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_cloud_exadata_storage_server(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::DatabaseManagement::DbManagementClient#update_cloud_listener} and then waits for the {OCI::DatabaseManagement::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] cloud_listener_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud listener.
    # @param [OCI::DatabaseManagement::Models::UpdateCloudListenerDetails] update_cloud_listener_details The details required to update a cloud listener.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DatabaseManagement::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DatabaseManagement::DbManagementClient#update_cloud_listener}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DatabaseManagement::Models::WorkRequest}
    def update_cloud_listener_and_wait_for_state(cloud_listener_id, update_cloud_listener_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_cloud_listener(cloud_listener_id, update_cloud_listener_details, base_operation_opts)
      use_util = OCI::DatabaseManagement::Util.respond_to?(:wait_on_work_request)
