...
module OCI
  ...
  class AiVision::Models::VideoStreamObject
    ...
    # @return [OCI::AiVision::Models::ObjectProperties]
    ...
    def self.swagger_types
      {
        ...
        'properties': :'OCI::AiVision::Models::ObjectProperties'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::AiVision::Models::ObjectProperties] :properties The value to assign to the {#properties} property
    ...
    def hash
      [name, object_id, confidence, bounding_polygon, properties].hash
    end
