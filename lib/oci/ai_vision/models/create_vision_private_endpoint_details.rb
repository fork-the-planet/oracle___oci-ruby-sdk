...
module OCI
  ...
  class AiVision::Models::CreateVisionPrivateEndpointDetails
    ...
    def initialize(attributes = {})
      ...
      self.description = "The description of the visionPrivateEndpoint." if description.nil? && !attributes.key?(:'description') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [display_name, subnet_id, description, compartment_id, freeform_tags, defined_tags].hash
    end
