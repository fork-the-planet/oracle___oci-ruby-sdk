...
module OCI
  ...
  class AiVision::Models::ObjectProperties
    ...
    # @option attributes [Array<Float>] :embeddings The value to assign to the {#embeddings} property
    ...
    def hash
      [quality_score, landmarks, embeddings].hash
    end
