...
require 'date'
require_relative 'stream_network_access_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details of private endpoint to connect to stream
  class AiVision::Models::PrivateStreamNetworkAccessDetails < AiVision::Models::StreamNetworkAccessDetails
    # **[Required]** [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the private Endpoint
    #
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['streamAccessType'] = 'PRIVATE'
    ...
    def hash
      [stream_access_type, private_endpoint_id].hash
    end
