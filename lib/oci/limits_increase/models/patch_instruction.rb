...
module OCI
  ...
  class LimitsIncrease::Models::PatchInstruction
    OPERATION_ENUM = [
      OPERATION_INSERT = 'INSERT'.freeze
    ].freeze

    # **[Required]** Operation to perform on an element in the list.
    #
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::LimitsIncrease::Models::PatchInsertInstruction' if type == 'INSERT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::LimitsIncrease::Models::PatchInstruction'
    end
