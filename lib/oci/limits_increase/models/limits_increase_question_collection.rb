...
module OCI
  ...
  #
  class LimitsIncrease::Models::LimitsIncreaseQuestionCollection
    # **[Required]** List of questions to be asked for certain limits.
    # @return [Array<OCI::LimitsIncrease::Models::LimitsIncreaseQuestionSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::LimitsIncrease::Models::LimitsIncreaseQuestionSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LimitsIncrease::Models::LimitsIncreaseQuestionSummary>] :items The value to assign to the {#items} property
