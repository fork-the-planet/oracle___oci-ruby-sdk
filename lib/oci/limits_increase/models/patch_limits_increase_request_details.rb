...
module OCI
  ...
  #
  class LimitsIncrease::Models::PatchLimitsIncreaseRequestDetails
    # List of patch instructions for adding comments.
    # @return [Array<OCI::LimitsIncrease::Models::PatchInstruction>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::LimitsIncrease::Models::PatchInstruction>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LimitsIncrease::Models::PatchInstruction>] :items The value to assign to the {#items} property
