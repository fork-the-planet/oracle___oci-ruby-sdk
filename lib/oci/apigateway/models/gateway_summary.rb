...
module OCI
  ...
  class Apigateway::Models::GatewaySummary
    ...
    def hash
      [id, display_name, compartment_id, endpoint_type, subnet_id, network_security_group_ids, time_created, time_updated, lifecycle_state, lifecycle_details, locks, hostname, certificate_id, freeform_tags, defined_tags, system_tags, ip_mode].hash
    end
