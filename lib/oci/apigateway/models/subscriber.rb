...
module OCI
  ...
  class Apigateway::Models::Subscriber
    ...
    def hash
      [id, compartment_id, display_name, clients, usage_plans, time_created, time_updated, lifecycle_state, lifecycle_details, locks, freeform_tags, defined_tags, system_tags].hash
    end
