...
module OCI
  ...
  class Apigateway::Models::OAuth2ResponseValidationFailurePolicy < Apigateway::Models::ValidationFailurePolicy
    ...
    # @option attributes [String] :login_path The value to assign to the {#login_path} property
    def initialize(attributes = {})
      ...
      self.login_path = attributes[:'loginPath'] if attributes[:'loginPath']

      raise 'You cannot provide both :loginPath and :login_path' if attributes.key?(:'loginPath') && attributes.key?(:'login_path')

      self.login_path = attributes[:'login_path'] if attributes[:'login_path']
    end
    ...
    def hash
      [type, client_details, source_uri_details, scopes, max_expiry_duration_in_hours, use_cookies_for_session, use_cookies_for_intermediate_steps, use_pkce, response_type, fallback_redirect_path, logout_path, login_path].hash
    end
