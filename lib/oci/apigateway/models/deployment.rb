...
module OCI
  ...
  class Apigateway::Models::Deployment
    ...
    def hash
      [id, gateway_id, display_name, compartment_id, path_prefix, endpoint, specification, time_created, time_updated, lifecycle_state, lifecycle_details, locks, freeform_tags, defined_tags, system_tags].hash
    end
