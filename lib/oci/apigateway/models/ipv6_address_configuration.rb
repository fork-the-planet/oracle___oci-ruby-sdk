...
module OCI
  ...
  class Apigateway::Models::Ipv6AddressConfiguration
    ...
    # @option attributes [Array<String>] :subnet_cidrs The value to assign to the {#subnet_cidrs} property
    def initialize(attributes = {})
      ...
      self.subnet_cidrs = attributes[:'subnetCidrs'] if attributes[:'subnetCidrs']

      raise 'You cannot provide both :subnetCidrs and :subnet_cidrs' if attributes.key?(:'subnetCidrs') && attributes.key?(:'subnet_cidrs')

      self.subnet_cidrs = attributes[:'subnet_cidrs'] if attributes[:'subnet_cidrs']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        subnet_cidrs == other.subnet_cidrs
    end
