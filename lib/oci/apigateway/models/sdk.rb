...
module OCI
  ...
  class Apigateway::Models::Sdk
    ...
    def hash
      [id, api_id, compartment_id, time_created, time_updated, display_name, target_language, artifact_url, time_artifact_url_expires_at, lifecycle_state, lifecycle_details, locks, freeform_tags, defined_tags, system_tags, parameters].hash
    end
