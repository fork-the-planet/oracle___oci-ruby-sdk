...
module OCI
  ...
  class Apigateway::Models::CreateGatewayDetails
    ...
    # @return [Array<OCI::Apigateway::Models::AddResourceLockDetails>]
    attr_accessor :locks
    ...
    def self.swagger_types
      {
        ...
        'locks': :'Array<OCI::Apigateway::Models::AddResourceLockDetails>',
    ...
    # @option attributes [Array<OCI::Apigateway::Models::AddResourceLockDetails>] :locks The value to assign to the {#locks} property
    ...
    def hash
      [display_name, compartment_id, endpoint_type, subnet_id, network_security_group_ids, certificate_id, response_cache_details, locks, freeform_tags, defined_tags, ca_bundles, ip_mode, ipv6_address_configuration, ipv4_address_configuration].hash
    end
