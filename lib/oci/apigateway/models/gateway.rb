...
module OCI
  ...
  class Apigateway::Models::Gateway
    ...
    IP_MODE_ENUM = [
      ...
      IP_MODE_DUAL_STACK = 'DUAL_STACK'.freeze,
      IP_MODE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @return [Array<OCI::Apigateway::Models::ResourceLock>]
    attr_accessor :locks
    ...
    # @return [OCI::Apigateway::Models::Ipv6AddressConfiguration]
    attr_accessor :ipv6_address_configuration

    # @return [OCI::Apigateway::Models::Ipv4AddressConfiguration]
    attr_accessor :ipv4_address_configuration
    ...
    def self.swagger_types
      {
        ...
        'locks': :'Array<OCI::Apigateway::Models::ResourceLock>',
        'hostname': :'String',
        ...
        'ip_mode': :'String',
        'ipv6_address_configuration': :'OCI::Apigateway::Models::Ipv6AddressConfiguration',
        'ipv4_address_configuration': :'OCI::Apigateway::Models::Ipv4AddressConfiguration'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Apigateway::Models::ResourceLock>] :locks The value to assign to the {#locks} property
    ...
    # @option attributes [OCI::Apigateway::Models::Ipv6AddressConfiguration] :ipv6_address_configuration The value to assign to the {#ipv6_address_configuration} property
    # @option attributes [OCI::Apigateway::Models::Ipv4AddressConfiguration] :ipv4_address_configuration The value to assign to the {#ipv4_address_configuration} property
    def initialize(attributes = {})
      ...
      self.ipv6_address_configuration = attributes[:'ipv6AddressConfiguration'] if attributes[:'ipv6AddressConfiguration']

      raise 'You cannot provide both :ipv6AddressConfiguration and :ipv6_address_configuration' if attributes.key?(:'ipv6AddressConfiguration') && attributes.key?(:'ipv6_address_configuration')

      self.ipv6_address_configuration = attributes[:'ipv6_address_configuration'] if attributes[:'ipv6_address_configuration']

      self.ipv4_address_configuration = attributes[:'ipv4AddressConfiguration'] if attributes[:'ipv4AddressConfiguration']

      raise 'You cannot provide both :ipv4AddressConfiguration and :ipv4_address_configuration' if attributes.key?(:'ipv4AddressConfiguration') && attributes.key?(:'ipv4_address_configuration')

      self.ipv4_address_configuration = attributes[:'ipv4_address_configuration'] if attributes[:'ipv4_address_configuration']
    end
    ...
    def ip_mode=(ip_mode)
      # rubocop:disable Style/ConditionalAssignment
      if ip_mode && !IP_MODE_ENUM.include?(ip_mode)
        OCI.logger.debug("Unknown value for 'ip_mode' [" + ip_mode + "]. Mapping to 'IP_MODE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @ip_mode = IP_MODE_UNKNOWN_ENUM_VALUE
      else
        @ip_mode = ip_mode
      end
      # rubocop:enable Style/ConditionalAssignment
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        ipv6_address_configuration == other.ipv6_address_configuration &&
        ipv4_address_configuration == other.ipv4_address_configuration
    end
    ...
    def hash
      [id, display_name, compartment_id, endpoint_type, subnet_id, network_security_group_ids, time_created, time_updated, lifecycle_state, lifecycle_details, locks, hostname, certificate_id, ip_addresses, response_cache_details, freeform_tags, defined_tags, system_tags, ca_bundles, ip_mode, ipv6_address_configuration, ipv4_address_configuration].hash
    end
