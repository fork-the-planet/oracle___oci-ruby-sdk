...
module OCI
  ...
  class Apigateway::Models::UsagePlanSummary
    ...
    def hash
      [id, display_name, entitlements, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, locks, freeform_tags, defined_tags, system_tags].hash
    end
