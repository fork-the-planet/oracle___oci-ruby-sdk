...
module OCI
  ...
  class Apigateway::GatewayClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apigateway/add_gateway_lock.rb.html) to see an example of how to use add_gateway_lock API.
    def add_gateway_lock(gateway_id, add_resource_lock_details, opts = {})
      logger.debug 'Calling operation GatewayClient#add_gateway_lock.' if logger

      raise "Missing the required parameter 'gateway_id' when calling add_gateway_lock." if gateway_id.nil?
      raise "Missing the required parameter 'add_resource_lock_details' when calling add_gateway_lock." if add_resource_lock_details.nil?
      raise "Parameter value for 'gateway_id' must not be blank" if OCI::Internal::Util.blank_string?(gateway_id)

      path = '/gateways/{gatewayId}/actions/addLock'.sub('{gatewayId}', gateway_id.to_s)
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'GatewayClient#add_gateway_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Apigateway::Models::Gateway Gateway}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apigateway/remove_gateway_lock.rb.html) to see an example of how to use remove_gateway_lock API.
    def remove_gateway_lock(gateway_id, remove_resource_lock_details, opts = {})
      logger.debug 'Calling operation GatewayClient#remove_gateway_lock.' if logger

      raise "Missing the required parameter 'gateway_id' when calling remove_gateway_lock." if gateway_id.nil?
      raise "Missing the required parameter 'remove_resource_lock_details' when calling remove_gateway_lock." if remove_resource_lock_details.nil?
      raise "Parameter value for 'gateway_id' must not be blank" if OCI::Internal::Util.blank_string?(gateway_id)

      path = '/gateways/{gatewayId}/actions/removeLock'.sub('{gatewayId}', gateway_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'GatewayClient#remove_gateway_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
