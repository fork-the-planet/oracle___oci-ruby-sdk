...
module OCI
  ...
  class Apigateway::UsagePlansClientCompositeOperations
    ...
    # Calls {OCI::Apigateway::UsagePlansClient#add_usage_plan_lock} and then waits for the {OCI::Apigateway::Models::UsagePlan} acted upon
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Apigateway::Models::UsagePlan#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Apigateway::UsagePlansClient#add_usage_plan_lock}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Apigateway::Models::UsagePlan}
    def add_usage_plan_lock_and_wait_for_state(usage_plan_id, add_resource_lock_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.add_usage_plan_lock(usage_plan_id, add_resource_lock_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_usage_plan(wait_for_resource_id).wait_until(
    ...
    # Calls {OCI::Apigateway::UsagePlansClient#remove_usage_plan_lock} and then waits for the {OCI::Apigateway::Models::UsagePlan} acted upon
    # to enter the given state(s).
    #
    # @param [String] usage_plan_id The ocid of the usage plan.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Apigateway::Models::UsagePlan#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Apigateway::UsagePlansClient#remove_usage_plan_lock}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Apigateway::Models::UsagePlan}
    def remove_usage_plan_lock_and_wait_for_state(usage_plan_id, remove_resource_lock_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.remove_usage_plan_lock(usage_plan_id, remove_resource_lock_details, base_operation_opts)
