...
module OCI
  ...
  class Apigateway::ApiGatewayClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apigateway/add_api_lock.rb.html) to see an example of how to use add_api_lock API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apigateway/add_certificate_lock.rb.html) to see an example of how to use add_certificate_lock API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apigateway/add_sdk_lock.rb.html) to see an example of how to use add_sdk_lock API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :sdk_id The ocid of the SDK. This value must be present unless apiId is present. (default to null)
    # @option opts [String] :display_name A user-friendly name. Does not have to be unique, and it's changeable.
    #
    #   Example: `My new resource`
    #    (default to null)
    ...
    #    (default to timeCreated)
    #   Allowed values are: timeCreated, displayName
    # @option opts [String] :api_id The ocid of the API. This value must be present unless sdkId is present. (default to null)
    # @option opts [String] :opc_request_id The client request id for tracing. (default to null)
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Apigateway::Models::Api Api}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apigateway/remove_api_lock.rb.html) to see an example of how to use remove_api_lock API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Apigateway::Models::Certificate Certificate}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apigateway/remove_certificate_lock.rb.html) to see an example of how to use remove_certificate_lock API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Apigateway::Models::Sdk Sdk}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apigateway/remove_sdk_lock.rb.html) to see an example of how to use remove_sdk_lock API.
