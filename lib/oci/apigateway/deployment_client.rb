...
module OCI
  ...
  class Apigateway::DeploymentClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apigateway/add_deployment_lock.rb.html) to see an example of how to use add_deployment_lock API.
    def add_deployment_lock(deployment_id, add_resource_lock_details, opts = {})
      logger.debug 'Calling operation DeploymentClient#add_deployment_lock.' if logger
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DeploymentClient#add_deployment_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Apigateway::Models::Deployment Deployment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apigateway/remove_deployment_lock.rb.html) to see an example of how to use remove_deployment_lock API.
    def remove_deployment_lock(deployment_id, remove_resource_lock_details, opts = {})
      logger.debug 'Calling operation DeploymentClient#remove_deployment_lock.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DeploymentClient#remove_deployment_lock') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
