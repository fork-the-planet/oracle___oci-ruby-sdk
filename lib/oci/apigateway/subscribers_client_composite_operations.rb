...
module OCI
  ...
  class Apigateway::SubscribersClientCompositeOperations
    ...
    # Calls {OCI::Apigateway::SubscribersClient#add_subscriber_lock} and then waits for the {OCI::Apigateway::Models::Subscriber} acted upon
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Apigateway::Models::Subscriber#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Apigateway::SubscribersClient#add_subscriber_lock}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Apigateway::Models::Subscriber}
    ...
    # Calls {OCI::Apigateway::SubscribersClient#remove_subscriber_lock} and then waits for the {OCI::Apigateway::Models::Subscriber} acted upon
    # to enter the given state(s).
    #
    # @param [String] subscriber_id The ocid of the subscriber.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Apigateway::Models::Subscriber#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Apigateway::SubscribersClient#remove_subscriber_lock}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
