...
module OCI
  ...
  class Apigateway::GatewayClientCompositeOperations
    ...
    # Calls {OCI::Apigateway::GatewayClient#add_gateway_lock} and then waits for the {OCI::Apigateway::Models::Gateway} acted upon
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Apigateway::Models::Gateway#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Apigateway::GatewayClient#add_gateway_lock}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Apigateway::Models::Gateway}
    def add_gateway_lock_and_wait_for_state(gateway_id, add_resource_lock_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.add_gateway_lock(gateway_id, add_resource_lock_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_gateway(wait_for_resource_id).wait_until(
    ...
    # Calls {OCI::Apigateway::GatewayClient#remove_gateway_lock} and then waits for the {OCI::Apigateway::Models::Gateway} acted upon
    # to enter the given state(s).
    #
    # @param [String] gateway_id The ocid of the gateway.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Apigateway::Models::Gateway#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Apigateway::GatewayClient#remove_gateway_lock}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Apigateway::Models::Gateway}
    def remove_gateway_lock_and_wait_for_state(gateway_id, remove_resource_lock_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.remove_gateway_lock(gateway_id, remove_resource_lock_details, base_operation_opts)
