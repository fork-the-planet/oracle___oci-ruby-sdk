...
module OCI
  ...
  class Marketplace::MarketplaceClient
    ...
    # @param [OCI::Marketplace::Models::CreateMarketplaceExternalAttestedMetadataDetails] create_marketplace_external_attested_metadata_details Payload that customer will use to generate JWT for launched instance associated with Marketplace listing
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request,
    ...
    #   then a retry of the original creation request might be rejected).
    #
    # @return [Response] A Response object with data of type {OCI::Marketplace::Models::MarketplaceExternalAttestedMetadata MarketplaceExternalAttestedMetadata}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/marketplace/create_marketplace_external_attested_metadata.rb.html) to see an example of how to use create_marketplace_external_attested_metadata API.
    def create_marketplace_external_attested_metadata(create_marketplace_external_attested_metadata_details, opts = {})
      logger.debug 'Calling operation MarketplaceClient#create_marketplace_external_attested_metadata.' if logger

      raise "Missing the required parameter 'create_marketplace_external_attested_metadata_details' when calling create_marketplace_external_attested_metadata." if create_marketplace_external_attested_metadata_details.nil?
      ...
      post_body = @api_client.object_to_http_body(create_marketplace_external_attested_metadata_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'MarketplaceClient#create_marketplace_external_attested_metadata') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Marketplace::Models::MarketplaceExternalAttestedMetadata'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :sort_order The sort order to use, either `ASC` or `DESC`. (default to DESC)
    #   Allowed values are: ASC, DESC
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. Default order for keyId is descending.
    #    (default to keyId)
    #   Allowed values are: keyId
    # @option opts [String] :compartment_id The unique identifier for the compartment.
    # @return [Response] A Response object with data of type Array<{OCI::Marketplace::Models::MarketplaceMetadataPublicKeySummary MarketplaceMetadataPublicKeySummary}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/marketplace/list_marketplace_metadata_public_keys.rb.html) to see an example of how to use list_marketplace_metadata_public_keys API.
    def list_marketplace_metadata_public_keys(opts = {})
      logger.debug 'Calling operation MarketplaceClient#list_marketplace_metadata_public_keys.' if logger
      ...
      if opts[:sort_by] && !%w[keyId].include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of keyId.'
      end
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'MarketplaceClient#list_marketplace_metadata_public_keys') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'Array<OCI::Marketplace::Models::MarketplaceMetadataPublicKeySummary>'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
