...
module OCI
  ...
  class Marketplace::Models::ListingSummary
    ...
    # @return [Array<OCI::Marketplace::Models::PricingTypeEnum>]
    attr_accessor :pricing_types
    ...
    # @option attributes [Array<OCI::Marketplace::Models::PricingTypeEnum>] :pricing_types The value to assign to the {#pricing_types} property
