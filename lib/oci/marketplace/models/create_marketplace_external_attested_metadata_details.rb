...
module OCI
  ...
  class Marketplace::Models::CreateMarketplaceExternalAttestedMetadataDetails
    # **[Required]** unique id that identifies the associated instance
    # @return [String]
    attr_accessor :instance_id

    # **[Required]** compartment that associated instance is in
    # @return [String]
    ...
    def hash
      [instance_id, compartment_id].hash
    end
