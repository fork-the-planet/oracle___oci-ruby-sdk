...
module OCI
  ...
  class VnMonitoring::Models::VirtualCircuitDrgAttachmentNetworkUpdateDetails < VnMonitoring::Models::DrgAttachmentNetworkUpdateDetails
    ...
    def hash
      [type, is_ffab, regional_oci_asn, is_edge_pop, region_name, transport_only_mode].hash
    end
