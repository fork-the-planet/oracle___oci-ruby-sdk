...
module OCI
  ...
  class VnMonitoring::Models::RemotePeeringConnectionDrgAttachmentNetworkDetails < VnMonitoring::Models::DrgAttachmentNetworkDetails
    ...
    # @return [String]
    attr_accessor :peer_attachment_route_target
    ...
    # @option attributes [String] :peer_attachment_route_target The value to assign to the {#peer_attachment_route_target} property
