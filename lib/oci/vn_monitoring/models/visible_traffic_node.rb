...
module OCI
  ...
  class VnMonitoring::Models::VisibleTrafficNode < VnMonitoring::Models::TrafficNode
    ...
    # @option attributes [OCI::VnMonitoring::Models::SecurityAction] :zpr_egress_security_action The value to assign to the {OCI::VnMonitoring::Models::TrafficNode#zpr_egress_security_action #zpr_egress_security_action} proprety
    # @option attributes [OCI::VnMonitoring::Models::SecurityAction] :zpr_ingress_security_action The value to assign to the {OCI::VnMonitoring::Models::TrafficNode#zpr_ingress_security_action #zpr_ingress_security_action} proprety
    ...
    def hash
      [type, egress_traffic, next_hop_routing_action, egress_security_action, ingress_security_action, zpr_egress_security_action, zpr_ingress_security_action, entity_id, transformation_description].hash
    end
