...
module OCI
  ...
  class VnMonitoring::Models::DrgPromotionStatusResponse
    ...
    # @option attributes [String] :drg_promotion_status The value to assign to the {#drg_promotion_status} property
    # @option attributes [Hash<String, String>] :rpc_promotion_status The value to assign to the {#rpc_promotion_status} property
    # @option attributes [Hash<String, String>] :vc_promotion_status The value to assign to the {#vc_promotion_status} property
    # @option attributes [Hash<String, String>] :ipsec_promotion_status The value to assign to the {#ipsec_promotion_status} property
    ...
    # @param [Object] drg_promotion_status Object to be assigned
    def drg_promotion_status=(drg_promotion_status)
      raise "Invalid value for 'drg_promotion_status': this must be one of the values in DRG_PROMOTION_STATUS_ENUM." if drg_promotion_status && !DRG_PROMOTION_STATUS_ENUM.include?(drg_promotion_status)

      @drg_promotion_status = drg_promotion_status
    end
