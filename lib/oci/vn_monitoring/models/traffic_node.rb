...
module OCI
  ...
  class VnMonitoring::Models::TrafficNode
    ...
    # @return [OCI::VnMonitoring::Models::SecurityAction]
    attr_accessor :zpr_egress_security_action

    # @return [OCI::VnMonitoring::Models::SecurityAction]
    attr_accessor :zpr_ingress_security_action
    ...
    def self.swagger_types
      {
        ...
        'zpr_egress_security_action': :'OCI::VnMonitoring::Models::SecurityAction',
        'zpr_ingress_security_action': :'OCI::VnMonitoring::Models::SecurityAction'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::VnMonitoring::Models::SecurityAction] :zpr_egress_security_action The value to assign to the {#zpr_egress_security_action} property
    # @option attributes [OCI::VnMonitoring::Models::SecurityAction] :zpr_ingress_security_action The value to assign to the {#zpr_ingress_security_action} property
    def initialize(attributes = {})
      ...
      self.zpr_egress_security_action = attributes[:'zprEgressSecurityAction'] if attributes[:'zprEgressSecurityAction']

      raise 'You cannot provide both :zprEgressSecurityAction and :zpr_egress_security_action' if attributes.key?(:'zprEgressSecurityAction') && attributes.key?(:'zpr_egress_security_action')

      self.zpr_egress_security_action = attributes[:'zpr_egress_security_action'] if attributes[:'zpr_egress_security_action']

      self.zpr_ingress_security_action = attributes[:'zprIngressSecurityAction'] if attributes[:'zprIngressSecurityAction']

      raise 'You cannot provide both :zprIngressSecurityAction and :zpr_ingress_security_action' if attributes.key?(:'zprIngressSecurityAction') && attributes.key?(:'zpr_ingress_security_action')

      self.zpr_ingress_security_action = attributes[:'zpr_ingress_security_action'] if attributes[:'zpr_ingress_security_action']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        zpr_egress_security_action == other.zpr_egress_security_action &&
        zpr_ingress_security_action == other.zpr_ingress_security_action
    end
    ...
    def hash
      [type, egress_traffic, next_hop_routing_action, egress_security_action, ingress_security_action, zpr_egress_security_action, zpr_ingress_security_action].hash
    end
