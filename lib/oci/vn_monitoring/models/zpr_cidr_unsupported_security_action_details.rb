...
module OCI
  ...
  #
  class VnMonitoring::Models::ZprCidrUnsupportedSecurityActionDetails
    # **[Required]** If true, the evaluated zpr policy ID details are incomplete.
    # @return [BOOLEAN]
    attr_accessor :is_restricted_or_partial

    # The list of evaluated zpr policies associated with the OCI resource.
    #
    # @return [Array<OCI::VnMonitoring::Models::ZprPolicy>]
    attr_accessor :evaluated_zpr_policies
    ...
    def self.swagger_types
      {
        ...
        'evaluated_zpr_policies': :'Array<OCI::VnMonitoring::Models::ZprPolicy>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::ZprPolicy>] :evaluated_zpr_policies The value to assign to the {#evaluated_zpr_policies} property
    def initialize(attributes = {})
      ...
      self.evaluated_zpr_policies = attributes[:'evaluatedZprPolicies'] if attributes[:'evaluatedZprPolicies']

      raise 'You cannot provide both :evaluatedZprPolicies and :evaluated_zpr_policies' if attributes.key?(:'evaluatedZprPolicies') && attributes.key?(:'evaluated_zpr_policies')

      self.evaluated_zpr_policies = attributes[:'evaluated_zpr_policies'] if attributes[:'evaluated_zpr_policies']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        evaluated_zpr_policies == other.evaluated_zpr_policies
    end
    ...
    def hash
      [is_restricted_or_partial, evaluated_zpr_policies].hash
    end
