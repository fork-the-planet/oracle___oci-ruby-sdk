...
module OCI
  ...
  class VnMonitoring::Models::IpsecTunnelDrgAttachmentNetworkCreateDetails < VnMonitoring::Models::DrgAttachmentNetworkCreateDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the IPSec connection.
    # @return [String]
    ...
    # **[Required]** The IPSec connection that contains the attached IPSec tunnel.
    # @return [String]
    ...
    def hash
      [type, id, compartment_id, regional_oci_asn, ipsec_connection_id, transport_attachment_id].hash
    end
