...
module OCI
  ...
  class TenantManagerControlPlane::Models::RecipientInvitationSummary
    ...
    def hash
      [id, compartment_id, display_name, subjects, sender_invitation_id, sender_tenancy_id, lifecycle_state, status, time_created, time_updated, recipient_email_address, features, freeform_tags, defined_tags, system_tags].hash
    end
