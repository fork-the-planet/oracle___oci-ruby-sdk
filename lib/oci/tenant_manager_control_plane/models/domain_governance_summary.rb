...
module OCI
  ...
  class TenantManagerControlPlane::Models::DomainGovernanceSummary
    ...
    def hash
      [id, owner_id, compartment_id, domain_id, lifecycle_state, is_governance_enabled, subscription_email, ons_topic_id, ons_subscription_id, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
