...
module OCI
  ...
  class TenantManagerControlPlane::Models::SenderInvitation
    ...
    def hash
      [id, compartment_id, subjects, recipient_invitation_id, recipient_tenancy_id, lifecycle_state, status, display_name, time_created, time_updated, recipient_email_address, invitation_features, freeform_tags, defined_tags, system_tags].hash
    end
