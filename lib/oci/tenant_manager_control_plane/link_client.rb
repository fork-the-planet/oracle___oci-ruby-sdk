...
module OCI
  ...
  class TenantManagerControlPlane::LinkClient
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::TenantManagerControlPlane::Models::LinkWithTenancyNames LinkWithTenancyNames}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/tenantmanagercontrolplane/get_link_with_tenancy_names.rb.html) to see an example of how to use get_link_with_tenancy_names API.
    def get_link_with_tenancy_names(link_id, opts = {})
      logger.debug 'Calling operation LinkClient#get_link_with_tenancy_names.' if logger

      raise "Missing the required parameter 'link_id' when calling get_link_with_tenancy_names." if link_id.nil?
      raise "Parameter value for 'link_id' must not be blank" if OCI::Internal::Util.blank_string?(link_id)

      path = '/links/{linkId}/tenancyNames'.sub('{linkId}', link_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'LinkClient#get_link_with_tenancy_names') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::TenantManagerControlPlane::Models::LinkWithTenancyNames'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :feature The feature associated with this link.
