...
module OCI
  ...
  #
  class GoldenGate::Models::CreateGoogleCloudStorageIcebergStorageDetails < GoldenGate::Models::CreateIcebergStorageDetails
    # **[Required]** Google Cloud Storage bucket where Iceberg stores metadata and data files.
    # @return [String]
    attr_accessor :bucket

    # **[Required]** The Google Cloud Project where the bucket exists.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['storageType'] = 'GOOGLE_CLOUD_STORAGE'
    ...
    def hash
      [storage_type, bucket, project_id, service_account_key_file_secret_id, service_account_key_file, endpoint].hash
    end
