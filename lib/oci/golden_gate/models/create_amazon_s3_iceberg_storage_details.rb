...
module OCI
  ...
  #
  class GoldenGate::Models::CreateAmazonS3IcebergStorageDetails < GoldenGate::Models::CreateIcebergStorageDetails
    ...
    def hash
      [storage_type, scheme_type, endpoint, access_key_id, secret_access_key_secret_id, secret_access_key, region, bucket].hash
    end
