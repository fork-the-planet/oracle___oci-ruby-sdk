...
module OCI
  ...
  class GoldenGate::Models::MysqlConnection < GoldenGate::Models::Connection
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, locks, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, does_use_secret_ids, subscription_id, cluster_placement_group_id, security_attributes, technology_type, username, host, port, database_name, security_protocol, ssl_mode, ssl_ca, ssl_crl, ssl_cert, private_ip, additional_attributes, db_system_id, password_secret_id, ssl_key_secret_id].hash
    end
