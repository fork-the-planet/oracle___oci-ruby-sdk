...
module OCI
  ...
  #
  class GoldenGate::Models::UpdateOracleAiDataPlatformConnectionDetails < GoldenGate::Models::UpdateConnectionDetails
    # Connection URL.
