...
module OCI
  ...
  class GoldenGate::Models::CreateKafkaConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    #
    # @return [Array<OCI::GoldenGate::Models::CreateKafkaBootstrapServer>]
    ...
    def self.swagger_types
      {
        ...
        'cluster_id': :'String',
        'bootstrap_servers': :'Array<OCI::GoldenGate::Models::CreateKafkaBootstrapServer>',
    ...
    # @option attributes [Array<OCI::GoldenGate::Models::CreateKafkaBootstrapServer>] :bootstrap_servers The value to assign to the {#bootstrap_servers} property
