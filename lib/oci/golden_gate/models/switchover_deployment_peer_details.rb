...
module OCI
  ...
  class GoldenGate::Models::SwitchoverDeploymentPeerDetails
    MODE_ENUM = [
      MODE_SWITCHOVER = 'SWITCHOVER'.freeze,
      MODE_FAILOVER = 'FAILOVER'.freeze
    ].freeze
    ...
    def initialize(attributes = {})
      ...
      self.mode = "SWITCHOVER" if mode.nil? && !attributes.key?(:'mode') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [availability_domain, fault_domain, mode].hash
    end
