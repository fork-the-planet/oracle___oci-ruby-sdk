...
module OCI
  ...
  class GoldenGate::Models::OggDeployment
    ...
    def hash
      [deployment_name, admin_username, ogg_version, certificate, credential_store, identity_domain_id, password_secret_id, key_secret_id, group_to_roles_mapping].hash
    end
