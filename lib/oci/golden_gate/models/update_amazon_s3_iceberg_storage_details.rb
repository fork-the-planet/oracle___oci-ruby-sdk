...
require 'date'
require_relative 'update_iceberg_storage_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The information to update the Amazon S3 storage used in the Iceberg connection.
  #
  class GoldenGate::Models::UpdateAmazonS3IcebergStorageDetails < GoldenGate::Models::UpdateIcebergStorageDetails
