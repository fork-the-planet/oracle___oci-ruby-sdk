...
module OCI
  ...
  #
  class GoldenGate::Models::UpdateIcebergConnectionDetails < GoldenGate::Models::UpdateConnectionDetails
    # @return [OCI::GoldenGate::Models::UpdateIcebergCatalogDetails]
    attr_accessor :catalog

    # @return [OCI::GoldenGate::Models::UpdateIcebergStorageDetails]
    ...
    def self.swagger_types
      {
        ...
        'catalog': :'OCI::GoldenGate::Models::UpdateIcebergCatalogDetails',
        'storage': :'OCI::GoldenGate::Models::UpdateIcebergStorageDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GoldenGate::Models::UpdateIcebergCatalogDetails] :catalog The value to assign to the {#catalog} property
    # @option attributes [OCI::GoldenGate::Models::UpdateIcebergStorageDetails] :storage The value to assign to the {#storage} property
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, does_use_secret_ids, security_attributes, catalog, storage].hash
    end
