...
module OCI
  ...
  class GoldenGate::Models::AmazonKinesisConnection < GoldenGate::Models::Connection
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, locks, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, does_use_secret_ids, subscription_id, cluster_placement_group_id, security_attributes, technology_type, access_key_id, secret_access_key_secret_id, endpoint, region].hash
    end
