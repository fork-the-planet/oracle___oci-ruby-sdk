...
module OCI
  ...
  #
  class GoldenGate::Models::CreateAzureDataLakeStorageIcebergStorageDetails < GoldenGate::Models::CreateIcebergStorageDetails
    ...
    def hash
      [storage_type, account_name, container, account_key_secret_id, account_key, endpoint].hash
    end
