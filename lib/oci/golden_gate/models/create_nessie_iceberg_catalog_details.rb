...
module OCI
  ...
  #
  class GoldenGate::Models::CreateNessieIcebergCatalogDetails < GoldenGate::Models::CreateIcebergCatalogDetails
    # **[Required]** Nessie URI.
    ...
    # **[Required]** The active branch of the Nessie catalog from which Iceberg reads and writes table metadata.
    # @return [String]
