...
module OCI
  ...
  #
  class GoldenGate::Models::CreatePolarisIcebergCatalogDetails < GoldenGate::Models::CreateIcebergCatalogDetails
    # **[Required]** The URL endpoint for the Polaris API.
    # e.g.: 'https://<your-snowflake-account>.snowflakecomputing.com/polaris/api/catalog'
    #
    # @return [String]
    attr_accessor :uri

    # **[Required]** The catalog name within Polaris where Iceberg tables are registered.
    # @return [String]
    attr_accessor :name

    # **[Required]** The OAuth client ID used for authentication.
    # @return [String]
    ...
    # **[Required]** The Snowflake role used to access Polaris.
    # @return [String]
    ...
    # @option attributes [String] :principal_role The value to assign to the {#principal_role} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['catalogType'] = 'POLARIS'
      ...
      self.principal_role = attributes[:'principalRole'] if attributes[:'principalRole']

      raise 'You cannot provide both :principalRole and :principal_role' if attributes.key?(:'principalRole') && attributes.key?(:'principal_role')

      self.principal_role = attributes[:'principal_role'] if attributes[:'principal_role']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        principal_role == other.principal_role
    end
    ...
    def hash
      [catalog_type, uri, name, client_id, client_secret_secret_id, client_secret, principal_role].hash
    end
