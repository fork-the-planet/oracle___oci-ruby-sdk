...
module OCI
  ...
  class GoldenGate::Models::Pipeline
    ...
    def hash
      [recipe_type, id, display_name, description, compartment_id, license_model, cpu_core_count, is_auto_scaling_enabled, source_connection_details, target_connection_details, pipeline_diagnostic_data, freeform_tags, defined_tags, system_tags, locks, lifecycle_state, lifecycle_sub_state, lifecycle_details, time_created, time_updated, subnet_id, ingress_ips].hash
    end
