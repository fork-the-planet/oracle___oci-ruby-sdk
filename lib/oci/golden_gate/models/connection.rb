...
module OCI
  ...
  class GoldenGate::Models::Connection
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::IcebergConnection' if type == 'ICEBERG'
      ...
      return 'OCI::GoldenGate::Models::OracleAiDataPlatformConnection' if type == 'ORACLE_AI_DATA_PLATFORM'
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, locks, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, does_use_secret_ids, subscription_id, cluster_placement_group_id, security_attributes].hash
    end
