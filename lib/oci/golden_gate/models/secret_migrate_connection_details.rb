...
require 'date'
require_relative 'migrate_connection_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Definition of the additional attributes for secret Connection migrate.
  class GoldenGate::Models::SecretMigrateConnectionDetails < GoldenGate::Models::MigrateConnectionDetails
    ...
    def hash
      [type, secret_compartment_id, vault_id, key_id].hash
    end
