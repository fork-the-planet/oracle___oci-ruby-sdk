...
module OCI
  ...
  class GoldenGate::Models::CreateIcebergConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    # @return [OCI::GoldenGate::Models::CreateIcebergCatalogDetails]
    attr_accessor :catalog

    # This attribute is required.
    # @return [OCI::GoldenGate::Models::CreateIcebergStorageDetails]
    ...
    def self.swagger_types
      {
        ...
        'catalog': :'OCI::GoldenGate::Models::CreateIcebergCatalogDetails',
        'storage': :'OCI::GoldenGate::Models::CreateIcebergStorageDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GoldenGate::Models::CreateIcebergCatalogDetails] :catalog The value to assign to the {#catalog} property
    # @option attributes [OCI::GoldenGate::Models::CreateIcebergStorageDetails] :storage The value to assign to the {#storage} property
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, locks, vault_id, key_id, nsg_ids, subnet_id, routing_method, does_use_secret_ids, subscription_id, cluster_placement_group_id, security_attributes, technology_type, catalog, storage].hash
    end
