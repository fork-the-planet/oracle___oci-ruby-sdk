...
module OCI
  ...
  class GoldenGate::Models::CreateOggDeploymentDetails
    ...
    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Secret where the deployment ssl private key is stored in PEM format.
    #
    # @return [String]
    attr_accessor :key_secret_id
    ...
    # @option attributes [String] :key_secret_id The value to assign to the {#key_secret_id} property
    ...
    def initialize(attributes = {})
      ...
      self.key_secret_id = attributes[:'keySecretId'] if attributes[:'keySecretId']

      raise 'You cannot provide both :keySecretId and :key_secret_id' if attributes.key?(:'keySecretId') && attributes.key?(:'key_secret_id')

      self.key_secret_id = attributes[:'key_secret_id'] if attributes[:'key_secret_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        key == other.key &&
        key_secret_id == other.key_secret_id &&
    ...
    def hash
      [deployment_name, credential_store, identity_domain_id, password_secret_id, admin_username, admin_password, certificate, key, key_secret_id, ogg_version, group_to_roles_mapping].hash
    end
