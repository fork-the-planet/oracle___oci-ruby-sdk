...
module OCI
  ...
  #
  class GoldenGate::Models::IcebergConnectionSummary < GoldenGate::Models::ConnectionSummary
    # **[Required]** The Iceberg technology type.
    # @return [String]
    attr_accessor :technology_type

    # This attribute is required.
    # @return [OCI::GoldenGate::Models::IcebergCatalogSummary]
    attr_accessor :catalog

    # This attribute is required.
    # @return [OCI::GoldenGate::Models::IcebergStorageSummary]
    ...
    def self.swagger_types
      {
        ...
        'catalog': :'OCI::GoldenGate::Models::IcebergCatalogSummary',
        'storage': :'OCI::GoldenGate::Models::IcebergStorageSummary'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GoldenGate::Models::IcebergCatalogSummary] :catalog The value to assign to the {#catalog} property
    # @option attributes [OCI::GoldenGate::Models::IcebergStorageSummary] :storage The value to assign to the {#storage} property
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, locks, does_use_secret_ids, subscription_id, cluster_placement_group_id, security_attributes, technology_type, catalog, storage].hash
    end
