...
module OCI
  ...
  #
  class GoldenGate::Models::GoogleCloudStorageIcebergStorageSummary < GoldenGate::Models::IcebergStorageSummary
    ...
    def hash
      [storage_type, bucket, project_id, service_account_key_file_secret_id, endpoint].hash
    end
