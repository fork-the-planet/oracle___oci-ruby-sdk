...
module OCI
  ...
  #
  class GoldenGate::Models::PolarisIcebergCatalogSummary < GoldenGate::Models::IcebergCatalogSummary
    ...
    def hash
      [catalog_type, uri, name, client_id, client_secret_secret_id, principal_role].hash
    end
