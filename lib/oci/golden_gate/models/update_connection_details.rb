...
module OCI
  ...
  class GoldenGate::Models::UpdateConnectionDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::UpdateOracleAiDataPlatformConnectionDetails' if type == 'ORACLE_AI_DATA_PLATFORM'
      ...
      return 'OCI::GoldenGate::Models::UpdateIcebergConnectionDetails' if type == 'ICEBERG'
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, does_use_secret_ids, security_attributes].hash
    end
