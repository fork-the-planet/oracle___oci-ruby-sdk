...
module OCI
  ...
  class AiDocument::Models::ObjectStorageDocumentDetails < AiDocument::Models::DocumentDetails
    ...
    # @option attributes [Array<String>] :page_range The value to assign to the {#page_range} property
    def initialize(attributes = {})
      ...
      self.page_range = attributes[:'pageRange'] if attributes[:'pageRange']

      raise 'You cannot provide both :pageRange and :page_range' if attributes.key?(:'pageRange') && attributes.key?(:'page_range')

      self.page_range = attributes[:'page_range'] if attributes[:'page_range']
    end
    ...
    def hash
      [source, namespace_name, bucket_name, object_name, page_range].hash
    end
