...
module OCI
  ...
  class AiDocument::Models::AnalyzeDocumentResult
    ...
    # @return [String]
    attr_accessor :signature_extraction_model_version

    # The document bar code extraction model version.
    # @return [String]
    attr_accessor :bar_code_extraction_model_version
    ...
    # @option attributes [String] :signature_extraction_model_version The value to assign to the {#signature_extraction_model_version} property
    # @option attributes [String] :bar_code_extraction_model_version The value to assign to the {#bar_code_extraction_model_version} property
    ...
    def initialize(attributes = {})
      ...
      self.signature_extraction_model_version = attributes[:'signatureExtractionModelVersion'] if attributes[:'signatureExtractionModelVersion']

      raise 'You cannot provide both :signatureExtractionModelVersion and :signature_extraction_model_version' if attributes.key?(:'signatureExtractionModelVersion') && attributes.key?(:'signature_extraction_model_version')

      self.signature_extraction_model_version = attributes[:'signature_extraction_model_version'] if attributes[:'signature_extraction_model_version']

      self.bar_code_extraction_model_version = attributes[:'barCodeExtractionModelVersion'] if attributes[:'barCodeExtractionModelVersion']

      raise 'You cannot provide both :barCodeExtractionModelVersion and :bar_code_extraction_model_version' if attributes.key?(:'barCodeExtractionModelVersion') && attributes.key?(:'bar_code_extraction_model_version')

      self.bar_code_extraction_model_version = attributes[:'bar_code_extraction_model_version'] if attributes[:'bar_code_extraction_model_version']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        signature_extraction_model_version == other.signature_extraction_model_version &&
        bar_code_extraction_model_version == other.bar_code_extraction_model_version &&
        errors == other.errors &&
    ...
    def hash
      [document_metadata, pages, detected_document_types, detected_languages, document_classification_model_version, language_classification_model_version, text_extraction_model_version, key_value_extraction_model_version, table_extraction_model_version, signature_extraction_model_version, bar_code_extraction_model_version, errors, searchable_pdf].hash
    end
