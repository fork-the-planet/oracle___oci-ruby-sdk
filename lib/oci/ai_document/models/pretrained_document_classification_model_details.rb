...
module OCI
  ...
  class AiDocument::Models::PretrainedDocumentClassificationModelDetails < AiDocument::Models::ModelMetrics
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'PRE_TRAINED_DOCUMENT_CLASSIFICATION'
