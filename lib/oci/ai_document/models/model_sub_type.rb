...
module OCI
  ...
  class AiDocument::Models::ModelSubType
    MODEL_TYPE_ENUM = [
    ...
    # **[Required]** Sub type model based on the model type.
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiDocument::Models::KvModelSubType' if type == 'PRE_TRAINED_KEY_VALUE_EXTRACTION'
      return 'OCI::AiDocument::Models::DocumentElementsSubType' if type == 'PRE_TRAINED_DOCUMENT_ELEMENTS_EXTRACTION'

      # TODO: Log a warning when the subtype is not found.
      'OCI::AiDocument::Models::ModelSubType'
    end
