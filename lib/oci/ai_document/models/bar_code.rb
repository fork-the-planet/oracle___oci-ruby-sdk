...
module OCI
  # A single bar code.
  class AiDocument::Models::BarCode
    # **[Required]** the confidence score between 0 and 1.
    # @return [Float]
    attr_accessor :confidence

    # **[Required]** the bar code value.
    # @return [String]
    attr_accessor :value
    ...
    # @option attributes [String] :code_type The value to assign to the {#code_type} property
    ...
    def initialize(attributes = {})
      ...
      self.code_type = attributes[:'codeType'] if attributes[:'codeType']

      raise 'You cannot provide both :codeType and :code_type' if attributes.key?(:'codeType') && attributes.key?(:'code_type')

      self.code_type = attributes[:'code_type'] if attributes[:'code_type']
    ...
    def hash
      [confidence, value, code_type, bounding_polygon].hash
    end
