...
module OCI
  ...
  class AiDocument::Models::ModelTypeInfo
    ...
    def self.swagger_types
      {
        ...
        'capabilities': :'Hash<String, OCI::AiDocument::Models::Capabilities>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Hash<String, OCI::AiDocument::Models::Capabilities>] :capabilities The value to assign to the {#capabilities} property
