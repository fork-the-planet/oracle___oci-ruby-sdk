...
module OCI
  ...
  class AiDocument::Models::FieldValue
    ...
    # @return [Float]
    attr_accessor :normalized_confidence
    ...
    # @option attributes [String] :normalized_value The value to assign to the {#normalized_value} property
    # @option attributes [Float] :normalized_confidence The value to assign to the {#normalized_confidence} property
    def initialize(attributes = {})
      ...
      self.normalized_value = attributes[:'normalizedValue'] if attributes[:'normalizedValue']

      raise 'You cannot provide both :normalizedValue and :normalized_value' if attributes.key?(:'normalizedValue') && attributes.key?(:'normalized_value')

      self.normalized_value = attributes[:'normalized_value'] if attributes[:'normalized_value']

      self.normalized_confidence = attributes[:'normalizedConfidence'] if attributes[:'normalizedConfidence']

      raise 'You cannot provide both :normalizedConfidence and :normalized_confidence' if attributes.key?(:'normalizedConfidence') && attributes.key?(:'normalized_confidence')

      self.normalized_confidence = attributes[:'normalized_confidence'] if attributes[:'normalized_confidence']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        normalized_confidence == other.normalized_confidence
    end
    ...
    def hash
      [value_type, text, confidence, bounding_polygon, word_indexes, normalized_value, normalized_confidence].hash
    end
