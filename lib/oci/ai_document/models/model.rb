...
module OCI
  ...
  class AiDocument::Models::Model
    MODEL_TYPE_ENUM = [
      ...
      MODEL_TYPE_PRE_TRAINED_TEXT_EXTRACTION = 'PRE_TRAINED_TEXT_EXTRACTION'.freeze,
      MODEL_TYPE_PRE_TRAINED_TABLE_EXTRACTION = 'PRE_TRAINED_TABLE_EXTRACTION'.freeze,
      MODEL_TYPE_PRE_TRAINED_KEY_VALUE_EXTRACTION = 'PRE_TRAINED_KEY_VALUE_EXTRACTION'.freeze,
      MODEL_TYPE_PRE_TRAINED_DOCUMENT_CLASSIFICATION = 'PRE_TRAINED_DOCUMENT_CLASSIFICATION'.freeze,
      MODEL_TYPE_PRE_TRAINED_DOCUMENT_ELEMENTS_EXTRACTION = 'PRE_TRAINED_DOCUMENT_ELEMENTS_EXTRACTION'.freeze,
    ...
    # @return [OCI::AiDocument::Models::ModelSubType]
    attr_accessor :model_sub_type
    ...
    def self.swagger_types
      {
        ...
        'model_type': :'String',
        'model_sub_type': :'OCI::AiDocument::Models::ModelSubType',
    ...
    # @option attributes [OCI::AiDocument::Models::ModelSubType] :model_sub_type The value to assign to the {#model_sub_type} property
    ...
    def hash
      [id, display_name, description, compartment_id, model_type, model_sub_type, inference_units, tenancy_id, alias_name, labels, is_quick_mode, max_training_time_in_hours, language, trained_time_in_hours, training_dataset, testing_dataset, validation_dataset, component_models, is_composed_model, model_version, project_id, time_created, time_updated, lifecycle_state, lifecycle_details, metrics, freeform_tags, defined_tags, system_tags, locks].hash
    end
