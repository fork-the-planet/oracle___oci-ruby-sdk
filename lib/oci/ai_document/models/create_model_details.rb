...
module OCI
  ...
  class AiDocument::Models::CreateModelDetails
    ...
    def hash
      [display_name, description, model_version, model_type, model_sub_type, inference_units, compartment_id, is_quick_mode, max_training_time_in_hours, language, training_dataset, testing_dataset, validation_dataset, component_models, alias_name, project_id, freeform_tags, defined_tags].hash
    end
