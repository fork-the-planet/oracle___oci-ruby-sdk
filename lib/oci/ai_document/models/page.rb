...
module OCI
  ...
  class AiDocument::Models::Page
    ...
    # @return [Array<OCI::AiDocument::Models::Signature>]
    attr_accessor :signatures

    # The bar codes detected on the page.
    # @return [Array<OCI::AiDocument::Models::BarCode>]
    attr_accessor :bar_codes

    # The checkboxes and selection marks detected on the page.
    # @return [Array<OCI::AiDocument::Models::SelectionMark>]
    attr_accessor :selection_marks
    ...
    # @option attributes [Array<OCI::AiDocument::Models::Signature>] :signatures The value to assign to the {#signatures} property
    # @option attributes [Array<OCI::AiDocument::Models::BarCode>] :bar_codes The value to assign to the {#bar_codes} property
    # @option attributes [Array<OCI::AiDocument::Models::SelectionMark>] :selection_marks The value to assign to the {#selection_marks} property
