...
module OCI
  ...
  class AiDocument::Models::DocumentFeature
    FEATURE_TYPE_ENUM = [
      ...
      FEATURE_TYPE_DOCUMENT_ELEMENTS_EXTRACTION = 'DOCUMENT_ELEMENTS_EXTRACTION'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiDocument::Models::DocumentElementsExtractionFeature' if type == 'DOCUMENT_ELEMENTS_EXTRACTION'
