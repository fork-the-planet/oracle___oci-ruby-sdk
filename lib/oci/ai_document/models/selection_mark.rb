...
module OCI
  ...
  class AiDocument::Models::SelectionMark
    STATE_ENUM = [
      STATE_UNSELECTED = 'UNSELECTED'.freeze,
      STATE_SELECTED = 'SELECTED'.freeze,
      STATE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** String to display if checkbox is selected or not selected.
    # @return [String]
    attr_reader :state

    # **[Required]** The confidence score, a float value between 0 and 1.
    # @return [Float]
    ...
    def hash
      [state, confidence, bounding_polygon].hash
    end
