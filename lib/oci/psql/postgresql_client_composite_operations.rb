...
module OCI
  ...
  class Psql::PostgresqlClientCompositeOperations
    ...
    # Calls {OCI::Psql::PostgresqlClient#change_role_to_replica} and then waits for the {OCI::Psql::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [String] db_system_id A unique identifier for the database system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Psql::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Psql::PostgresqlClient#change_role_to_replica}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Psql::Models::WorkRequest}
    def change_role_to_replica_and_wait_for_state(change_role_to_replica_details, db_system_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_role_to_replica(change_role_to_replica_details, db_system_id, base_operation_opts)
      use_util = OCI::Psql::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Psql::PostgresqlClient#change_role_to_standalone} and then waits for the {OCI::Psql::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [String] db_system_id A unique identifier for the database system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Psql::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Psql::PostgresqlClient#change_role_to_standalone}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Psql::Models::WorkRequest}
    def change_role_to_standalone_and_wait_for_state(change_role_to_standalone_details, db_system_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_role_to_standalone(change_role_to_standalone_details, db_system_id, base_operation_opts)
      use_util = OCI::Psql::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Psql::PostgresqlClient#start_db_system} and then waits for the {OCI::Psql::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] db_system_id A unique identifier for the database system.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Psql::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Psql::PostgresqlClient#start_db_system}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Psql::Models::WorkRequest}
    def start_db_system_and_wait_for_state(db_system_id, start_db_system_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.start_db_system(db_system_id, start_db_system_details, base_operation_opts)
      use_util = OCI::Psql::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Psql::PostgresqlClient#stop_db_system} and then waits for the {OCI::Psql::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] db_system_id A unique identifier for the database system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Psql::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Psql::PostgresqlClient#stop_db_system}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Psql::Models::WorkRequest}
    def stop_db_system_and_wait_for_state(db_system_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.stop_db_system(db_system_id, base_operation_opts)
      use_util = OCI::Psql::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Psql::PostgresqlClient#switch_over} and then waits for the {OCI::Psql::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Psql::Models::SwitchOverDetails] switch_over_details Switchover the primary and replica role parameters.
    # @param [String] db_system_id A unique identifier for the database system.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Psql::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Psql::PostgresqlClient#switch_over}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Psql::Models::WorkRequest}
    def switch_over_and_wait_for_state(switch_over_details, db_system_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.switch_over(switch_over_details, db_system_id, base_operation_opts)
      use_util = OCI::Psql::Util.respond_to?(:wait_on_work_request)
