...
module OCI
  ...
  class Psql::Models::SourceDetails
    SOURCE_TYPE_ENUM = [
      ...
      SOURCE_TYPE_POINT_IN_TIME_DB_SYSTEM = 'POINT_IN_TIME_DB_SYSTEM'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Psql::Models::PrimaryDbSystemSourceDetails' if type == 'DB_SYSTEM'
      return 'OCI::Psql::Models::NoneSourceDetails' if type == 'NONE'
      return 'OCI::Psql::Models::PointInTimeDbSystemSourceDetails' if type == 'POINT_IN_TIME_DB_SYSTEM'
