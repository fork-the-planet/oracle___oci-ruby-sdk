...
module OCI
  ...
  class Psql::Models::DbSystemReplicaSummary
    # **[Required]** A unique identifier for the replica database system.
    # @return [String]
    attr_accessor :id

    # **[Required]** Region name of the replica database system region.
