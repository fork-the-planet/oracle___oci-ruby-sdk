...
module OCI
  ...
  class Psql::Models::ConfigurationSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, lifecycle_state, lifecycle_details, db_version, shape, is_flexible, instance_ocpu_count, instance_memory_size_in_gbs, compatible_shapes, default_config_id, freeform_tags, defined_tags, system_tags].hash
    end
