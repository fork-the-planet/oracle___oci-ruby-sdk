...
module OCI
  ...
  class Psql::Models::OdspInsightDetails
    KIND_ENUM = [
    ...
    # **[Required]** Specifies the management of Insight for the dbSystem.
    # @return [String]
    attr_reader :kind
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Psql::Models::DisabledInsightDetails' if type == 'DISABLED'
      return 'OCI::Psql::Models::EnabledInsightDetails' if type == 'ENABLED'
