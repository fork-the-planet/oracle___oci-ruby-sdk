...
module OCI
  ...
  class Psql::Models::Configuration
    ...
    # **[Required]** Indicates the collection of compatible shapes for this configuration.
    #
    # @return [Array<String>]
    attr_accessor :compatible_shapes

    # **[Required]** The Default configuration used for this configuration.
    # @return [String]
    attr_accessor :default_config_id
    ...
    # @option attributes [String] :default_config_id The value to assign to the {#default_config_id} property
    ...
    def initialize(attributes = {})
      ...
      self.default_config_id = attributes[:'defaultConfigId'] if attributes[:'defaultConfigId']

      raise 'You cannot provide both :defaultConfigId and :default_config_id' if attributes.key?(:'defaultConfigId') && attributes.key?(:'default_config_id')

      self.default_config_id = attributes[:'default_config_id'] if attributes[:'default_config_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        default_config_id == other.default_config_id &&
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, lifecycle_state, lifecycle_details, db_version, config_type, shape, is_flexible, instance_ocpu_count, instance_memory_size_in_gbs, compatible_shapes, default_config_id, configuration_details, freeform_tags, defined_tags, system_tags].hash
    end
