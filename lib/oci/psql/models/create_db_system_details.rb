...
module OCI
  ...
  class Psql::Models::CreateDbSystemDetails
    ...
    # @return [OCI::Psql::Models::CreateReplicationConfigDetails]
    ...
    # @option attributes [OCI::Psql::Models::CreateReplicationConfigDetails] :replication_config The value to assign to the {#replication_config} property
    ...
    def hash
      [display_name, description, compartment_id, system_type, db_version, config_id, storage_details, shape, instance_ocpu_count, instance_memory_size_in_gbs, instance_count, instances_details, credentials, network_details, management_policy, source, replication_config, odsp_insight_details, freeform_tags, defined_tags].hash
    end
