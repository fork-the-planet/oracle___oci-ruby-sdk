...
module OCI
  ...
  class Psql::Models::DbSystem
    ...
    SYSTEM_ROLE_ENUM = [
      SYSTEM_ROLE_STANDALONE_DB_SYSTEM = 'STANDALONE_DB_SYSTEM'.freeze,
      SYSTEM_ROLE_PRIMARY_DB_SYSTEM = 'PRIMARY_DB_SYSTEM'.freeze,
      SYSTEM_ROLE_WARM_STANDBY_DB_SYSTEM = 'WARM_STANDBY_DB_SYSTEM'.freeze,
      SYSTEM_ROLE_PILOT_LIGHT_DB_SYSTEM = 'PILOT_LIGHT_DB_SYSTEM'.freeze,
      SYSTEM_ROLE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # **[Required]** Type of the database system.
    # @return [String]
    attr_reader :system_role

    # @return [OCI::Psql::Models::ReplicationConfig]
    attr_accessor :replication_config
    ...
    # @return [OCI::Psql::Models::KerberosAuthDetails]
    attr_accessor :kerberos_auth_details

    # @return [OCI::Psql::Models::OdspInsightDetails]
    attr_accessor :odsp_insight_details
    ...
    def self.swagger_types
      {
        ...
        'system_type': :'String',
        'system_role': :'String',
        'replication_config': :'OCI::Psql::Models::ReplicationConfig',
        'db_version': :'String',
        'config_id': :'String',
        'shape': :'String',
        ...
        'kerberos_auth_details': :'OCI::Psql::Models::KerberosAuthDetails',
        'odsp_insight_details': :'OCI::Psql::Models::OdspInsightDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :system_role The value to assign to the {#system_role} property
    # @option attributes [OCI::Psql::Models::ReplicationConfig] :replication_config The value to assign to the {#replication_config} property
    ...
    # @option attributes [OCI::Psql::Models::KerberosAuthDetails] :kerberos_auth_details The value to assign to the {#kerberos_auth_details} property
    # @option attributes [OCI::Psql::Models::OdspInsightDetails] :odsp_insight_details The value to assign to the {#odsp_insight_details} property
    def initialize(attributes = {})
      ...
      self.system_role = attributes[:'systemRole'] if attributes[:'systemRole']

      raise 'You cannot provide both :systemRole and :system_role' if attributes.key?(:'systemRole') && attributes.key?(:'system_role')

      self.system_role = attributes[:'system_role'] if attributes[:'system_role']

      self.replication_config = attributes[:'replicationConfig'] if attributes[:'replicationConfig']

      raise 'You cannot provide both :replicationConfig and :replication_config' if attributes.key?(:'replicationConfig') && attributes.key?(:'replication_config')

      self.replication_config = attributes[:'replication_config'] if attributes[:'replication_config']
      ...
      self.kerberos_auth_details = attributes[:'kerberosAuthDetails'] if attributes[:'kerberosAuthDetails']

      raise 'You cannot provide both :kerberosAuthDetails and :kerberos_auth_details' if attributes.key?(:'kerberosAuthDetails') && attributes.key?(:'kerberos_auth_details')

      self.kerberos_auth_details = attributes[:'kerberos_auth_details'] if attributes[:'kerberos_auth_details']

      self.odsp_insight_details = attributes[:'odspInsightDetails'] if attributes[:'odspInsightDetails']

      raise 'You cannot provide both :odspInsightDetails and :odsp_insight_details' if attributes.key?(:'odspInsightDetails') && attributes.key?(:'odsp_insight_details')

      self.odsp_insight_details = attributes[:'odsp_insight_details'] if attributes[:'odsp_insight_details']
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] system_role Object to be assigned
    def system_role=(system_role)
      # rubocop:disable Style/ConditionalAssignment
      if system_role && !SYSTEM_ROLE_ENUM.include?(system_role)
        OCI.logger.debug("Unknown value for 'system_role' [" + system_role + "]. Mapping to 'SYSTEM_ROLE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @system_role = SYSTEM_ROLE_UNKNOWN_ENUM_VALUE
      else
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        replication_config == other.replication_config &&
        ...
        source == other.source &&
        kerberos_auth_details == other.kerberos_auth_details &&
        odsp_insight_details == other.odsp_insight_details
    end
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, admin_username, freeform_tags, defined_tags, system_tags, system_type, system_role, replication_config, db_version, config_id, shape, instance_ocpu_count, instance_memory_size_in_gbs, instance_count, instances, storage_details, network_details, management_policy, source, kerberos_auth_details, odsp_insight_details].hash
    end
