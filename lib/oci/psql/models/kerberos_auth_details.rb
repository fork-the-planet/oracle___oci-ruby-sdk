...
module OCI
  ...
  class Psql::Models::KerberosAuthDetails
    KIND_ENUM = [
      KIND_ENABLED = 'ENABLED'.freeze,
      KIND_DISABLED = 'DISABLED'.freeze,
      KIND_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Specifies the management of Kerberos Authentication for the dbSystem.
    # @return [String]
    attr_reader :kind
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Psql::Models::DisabledKerberosAuthDetails' if type == 'DISABLED'
      return 'OCI::Psql::Models::EnabledKerberosAuthDetails' if type == 'ENABLED'
