...
module OCI
  ...
  class Psql::Models::InsightDataContract
    KIND_ENUM = [
      KIND_TIME_SERIES = 'TIME_SERIES'.freeze,
      KIND_TABLE = 'TABLE'.freeze,
      KIND_SUMMARY = 'SUMMARY'.freeze,
      KIND_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Indicates the structure of the insight data payload.
    # @return [String]
    attr_reader :kind
