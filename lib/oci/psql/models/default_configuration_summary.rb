...
module OCI
  ...
  class Psql::Models::DefaultConfigurationSummary
    ...
    def hash
      [id, display_name, time_created, lifecycle_state, lifecycle_details, db_version, shape, is_flexible, instance_ocpu_count, instance_memory_size_in_gbs, compatible_shapes].hash
    end
