...
module OCI
  ...
  class Psql::PostgresqlClient
    ...
    # @param [OCI::Psql::Models::ChangeRoleToReplicaDetails] change_role_to_replica_details Change a standalone database system's role to warm-standby replica parameters.
    # @param [String] db_system_id A unique identifier for the database system.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/psql/change_role_to_replica.rb.html) to see an example of how to use change_role_to_replica API.
    def change_role_to_replica(change_role_to_replica_details, db_system_id, opts = {})
      logger.debug 'Calling operation PostgresqlClient#change_role_to_replica.' if logger

      raise "Missing the required parameter 'change_role_to_replica_details' when calling change_role_to_replica." if change_role_to_replica_details.nil?
      raise "Missing the required parameter 'db_system_id' when calling change_role_to_replica." if db_system_id.nil?
      raise "Parameter value for 'db_system_id' must not be blank" if OCI::Internal::Util.blank_string?(db_system_id)

      path = '/dbSystems/{dbSystemId}/actions/changeRoleToReplica'.sub('{dbSystemId}', db_system_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(change_role_to_replica_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'PostgresqlClient#change_role_to_replica') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [OCI::Psql::Models::ChangeRoleToStandaloneDetails] change_role_to_standalone_details Change a replica database system's role to standalone parameters.
    # @param [String] db_system_id A unique identifier for the database system.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/psql/change_role_to_standalone.rb.html) to see an example of how to use change_role_to_standalone API.
    def change_role_to_standalone(change_role_to_standalone_details, db_system_id, opts = {})
      logger.debug 'Calling operation PostgresqlClient#change_role_to_standalone.' if logger

      raise "Missing the required parameter 'change_role_to_standalone_details' when calling change_role_to_standalone." if change_role_to_standalone_details.nil?
      raise "Missing the required parameter 'db_system_id' when calling change_role_to_standalone." if db_system_id.nil?
      raise "Parameter value for 'db_system_id' must not be blank" if OCI::Internal::Util.blank_string?(db_system_id)

      path = '/dbSystems/{dbSystemId}/actions/changeRoleToStandalone'.sub('{dbSystemId}', db_system_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(change_role_to_standalone_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'PostgresqlClient#change_role_to_standalone') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Psql::Models::PitrDetails PitrDetails}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/psql/get_pitr_details.rb.html) to see an example of how to use get_pitr_details API.
    def get_pitr_details(db_system_id, opts = {})
      logger.debug 'Calling operation PostgresqlClient#get_pitr_details.' if logger

      raise "Missing the required parameter 'db_system_id' when calling get_pitr_details." if db_system_id.nil?
      raise "Parameter value for 'db_system_id' must not be blank" if OCI::Internal::Util.blank_string?(db_system_id)

      path = '/dbSystems/{dbSystemId}/pitrDetails'.sub('{dbSystemId}', db_system_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'PostgresqlClient#get_pitr_details') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Psql::Models::PitrDetails'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @option opts [String] :backup_source_type A filter to return only backups whose backupSourceType matches the given backupSourceType
    ...
    def list_backups(opts = {})
      ...
      query_params[:backupSourceType] = opts[:backup_source_type] if opts[:backup_source_type]
    ...
    # @option opts [String] :shape The compute name of the shape for the configuration.
    #
    # @option opts [String] :configuration_id A unique identifier for the configuration.
    # @option opts [Integer] :instance_ocpu_count The instance ocpu count for the configuration.
    # @option opts [Integer] :instance_memory_size_in_gbs The instance memory size in GBs for the configuration.
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page A token representing the position at which to start retrieving results. This must come from the `opc-next-page` header field of a previous response.
    # @option opts [String] :sort_order The sort order to use, either 'ASC' or 'DESC'.
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. Default order for timeCreated is descending. Default order for displayName is ascending.
    ...
    def list_configurations(opts = {})
      ...
      query_params[:instanceOcpuCount] = opts[:instance_ocpu_count] if opts[:instance_ocpu_count]
      query_params[:instanceMemorySizeInGBs] = opts[:instance_memory_size_in_gbs] if opts[:instance_memory_size_in_gbs]
      query_params[:limit] = opts[:limit] if opts[:limit]
      query_params[:page] = opts[:page] if opts[:page]
      query_params[:sortOrder] = opts[:sort_order] if opts[:sort_order]
      query_params[:sortBy] = opts[:sort_by] if opts[:sort_by]
    ...
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page A token representing the position at which to start retrieving results. This must come from the `opc-next-page` header field of a previous response.
    # @return [Response] A Response object with data of type {OCI::Psql::Models::DbSystemReplicaCollection DbSystemReplicaCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/psql/list_db_system_replicas.rb.html) to see an example of how to use list_db_system_replicas API.
    def list_db_system_replicas(db_system_id, opts = {})
      logger.debug 'Calling operation PostgresqlClient#list_db_system_replicas.' if logger

      raise "Missing the required parameter 'db_system_id' when calling list_db_system_replicas." if db_system_id.nil?
      raise "Parameter value for 'db_system_id' must not be blank" if OCI::Internal::Util.blank_string?(db_system_id)

      path = '/dbSystems/{dbSystemId}/replicas'.sub('{dbSystemId}', db_system_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'PostgresqlClient#list_db_system_replicas') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Psql::Models::DbSystemReplicaCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #    (default to timeCreated)
    #   Allowed values are: timeCreated, displayName
    # @option opts [String] :system_role A filter to return only DbSystem resources if their `systemRole` matches the given value.
    # @option opts [String] :opc_request_id The client request ID for tracing.
    ...
    def list_db_systems(opts = {})
      ...
      if opts[:system_role] && !OCI::Psql::Models::DbSystem::SYSTEM_ROLE_ENUM.include?(opts[:system_role])
        raise 'Invalid value for "system_role", must be one of the values in OCI::Psql::Models::DbSystem::SYSTEM_ROLE_ENUM.'
      end
      ...
      query_params[:sortOrder] = opts[:sort_order] if opts[:sort_order]
      query_params[:sortBy] = opts[:sort_by] if opts[:sort_by]
      query_params[:systemRole] = opts[:system_role] if opts[:system_role]
    ...
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page A token representing the position at which to start retrieving results. This must come from the `opc-next-page` header field of a previous response.
    # @return [Response] A Response object with data of type {OCI::Psql::Models::InsightCapabilityCollection InsightCapabilityCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/psql/list_insight_capabilities.rb.html) to see an example of how to use list_insight_capabilities API.
    def list_insight_capabilities(opts = {})
      logger.debug 'Calling operation PostgresqlClient#list_insight_capabilities.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'PostgresqlClient#list_insight_capabilities') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Psql::Models::InsightCapabilityCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # Start the DB System.
    # @param [String] db_system_id A unique identifier for the database system.
    # @param [OCI::Psql::Models::StartDbSystemDetails] start_db_system_details The information to be updated the DB System while starting DB System after stop.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/psql/start_db_system.rb.html) to see an example of how to use start_db_system API.
    def start_db_system(db_system_id, start_db_system_details, opts = {})
      logger.debug 'Calling operation PostgresqlClient#start_db_system.' if logger

      raise "Missing the required parameter 'db_system_id' when calling start_db_system." if db_system_id.nil?
      raise "Missing the required parameter 'start_db_system_details' when calling start_db_system." if start_db_system_details.nil?
      raise "Parameter value for 'db_system_id' must not be blank" if OCI::Internal::Util.blank_string?(db_system_id)
      ...
      post_body = @api_client.object_to_http_body(start_db_system_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'PostgresqlClient#start_db_system') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/psql/stop_db_system.rb.html) to see an example of how to use stop_db_system API.
    def stop_db_system(db_system_id, opts = {})
      logger.debug 'Calling operation PostgresqlClient#stop_db_system.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'PostgresqlClient#stop_db_system') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [OCI::Psql::Models::SwitchOverDetails] switch_over_details Switchover the primary and replica role parameters.
    # @param [String] db_system_id A unique identifier for the database system.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/psql/switch_over.rb.html) to see an example of how to use switch_over API.
    def switch_over(switch_over_details, db_system_id, opts = {})
      logger.debug 'Calling operation PostgresqlClient#switch_over.' if logger

      raise "Missing the required parameter 'switch_over_details' when calling switch_over." if switch_over_details.nil?
      raise "Missing the required parameter 'db_system_id' when calling switch_over." if db_system_id.nil?
      raise "Parameter value for 'db_system_id' must not be blank" if OCI::Internal::Util.blank_string?(db_system_id)

      path = '/dbSystems/{dbSystemId}/actions/switchover'.sub('{dbSystemId}', db_system_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(switch_over_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'PostgresqlClient#switch_over') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
