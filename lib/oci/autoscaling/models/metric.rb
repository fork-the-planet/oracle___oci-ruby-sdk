...
module OCI
  ...
  #
  class Autoscaling::Models::Metric < Autoscaling::Models::MetricBase
    METRIC_TYPE_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      attributes['metricSource'] = 'COMPUTE_AGENT'
    ...
    def hash
      [pending_duration, metric_source, metric_type, threshold].hash
    end
