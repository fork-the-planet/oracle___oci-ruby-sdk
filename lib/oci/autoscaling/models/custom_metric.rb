...
require 'date'
require_relative 'metric_base'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Metric details for triggering an autoscaling action based on a custom MQL query.
  #
  class Autoscaling::Models::CustomMetric < Autoscaling::Models::MetricBase
    ...
    # **[Required]** The namespace for the query.
    # @return [String]
    ...
    # **[Required]** The OCID of the compartment containing the metrics.
    # @return [String]
    ...
    # @option attributes [String] :pending_duration The value to assign to the {OCI::Autoscaling::Models::MetricBase#pending_duration #pending_duration} proprety
    ...
    def initialize(attributes = {})
      ...
      attributes['metricSource'] = 'CUSTOM_QUERY'
    ...
    def hash
      [pending_duration, metric_source, query, namespace, resource_group, metric_compartment_id].hash
    end
