...
module OCI
  ...
  class Autoscaling::Models::CreateConditionDetails
    ...
    # This attribute is required.
    # @return [OCI::Autoscaling::Models::MetricBase]
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'metric': :'OCI::Autoscaling::Models::MetricBase'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Autoscaling::Models::MetricBase] :metric The value to assign to the {#metric} property
