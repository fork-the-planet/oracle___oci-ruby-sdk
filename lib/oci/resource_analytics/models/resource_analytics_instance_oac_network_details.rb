...
module OCI
  ...
  #
  class ResourceAnalytics::Models::ResourceAnalyticsInstanceOacNetworkDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet for the private network details.
    # @return [String]
