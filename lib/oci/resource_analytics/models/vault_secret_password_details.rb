...
module OCI
  ...
  class ResourceAnalytics::Models::VaultSecretPasswordDetails < ResourceAnalytics::Models::AdwAdminPasswordDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the vault secret to use as the ADW admin password.
    # @return [String]
