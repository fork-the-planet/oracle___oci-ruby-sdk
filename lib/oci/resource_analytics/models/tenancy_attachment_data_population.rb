...
module OCI
  ...
  class ResourceAnalytics::Models::TenancyAttachmentDataPopulation
    # **[Required]** The overall status of the data population from the monitored region of the tenancy.
    # @return [String]
    attr_accessor :status

    # **[Required]** The date and time the data population task was started, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # **[Required]** The number of data population tasks currently in progress.
    # @return [Integer]
    attr_accessor :in_progress_count

    # **[Required]** The number of data population tasks that have succeeded.
    # @return [Integer]
    attr_accessor :succeeded_count

    # **[Required]** The total number of data population tasks.
    # @return [Integer]
    ...
    # @option attributes [Integer] :succeeded_count The value to assign to the {#succeeded_count} property
    ...
    def hash
      [status, time_started, time_ended, in_progress_count, succeeded_count, total_count].hash
    end
