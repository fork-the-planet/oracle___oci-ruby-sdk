...
module OCI
  ...
  class ResourceAnalytics::Models::CreateTenancyAttachmentDetails
    ...
    def initialize(attributes = {})
      ...
      self.description = "A tenancy to collect analytics from" if description.nil? && !attributes.key?(:'description') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [description, resource_analytics_instance_id, tenancy_id].hash
    end
