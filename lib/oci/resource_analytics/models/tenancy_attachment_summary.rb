...
module OCI
  ...
  class ResourceAnalytics::Models::TenancyAttachmentSummary
    ...
    # @return [String]
    attr_accessor :data_population_status
    ...
    def hash
      [id, description, resource_analytics_instance_id, tenancy_id, is_reporting_tenancy, data_population_status, time_data_population_started, time_data_population_ended, time_created, time_updated, lifecycle_state, lifecycle_details, system_tags].hash
    end
