...
module OCI
  ...
  #
  class ResourceAnalytics::Models::ResourceAnalyticsInstance
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ResourceAnalyticsInstance.
    # @return [String]
    attr_accessor :id
    ...
    # @return [String]
    attr_accessor :oac_id

    # **[Required]** The date and time the ResourceAnalyticsInstance was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    ...
    # **[Required]** The current state of the ResourceAnalyticsInstance.
    # @return [String]
    ...
    # @option attributes [String] :adw_id The value to assign to the {#adw_id} property
    # @option attributes [String] :oac_id The value to assign to the {#oac_id} property
    ...
    def initialize(attributes = {})
      ...
      self.adw_id = attributes[:'adwId'] if attributes[:'adwId']

      raise 'You cannot provide both :adwId and :adw_id' if attributes.key?(:'adwId') && attributes.key?(:'adw_id')

      self.adw_id = attributes[:'adw_id'] if attributes[:'adw_id']

      self.oac_id = attributes[:'oacId'] if attributes[:'oacId']

      raise 'You cannot provide both :oacId and :oac_id' if attributes.key?(:'oacId') && attributes.key?(:'oac_id')

      self.oac_id = attributes[:'oac_id'] if attributes[:'oac_id']
    ...
    def hash
      [id, display_name, compartment_id, description, adw_id, oac_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
