...
module OCI
  ...
  class Redis::Models::OciCacheConfigSetSummary
    ...
    def hash
      [id, default_config_set_id, display_name, compartment_id, lifecycle_state, software_version, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
