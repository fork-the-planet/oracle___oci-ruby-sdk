...
module OCI
  ...
  class Redis::Models::DefaultConfigurationInfo
    ...
    # @option attributes [BOOLEAN] :is_modifiable The value to assign to the {#is_modifiable} property
    ...
    def initialize(attributes = {})
      ...
      self.is_modifiable = attributes[:'isModifiable'] unless attributes[:'isModifiable'].nil?

      raise 'You cannot provide both :isModifiable and :is_modifiable' if attributes.key?(:'isModifiable') && attributes.key?(:'is_modifiable')

      self.is_modifiable = attributes[:'is_modifiable'] unless attributes[:'is_modifiable'].nil?
    ...
    def hash
      [config_key, default_config_value, allowed_values, data_type, is_modifiable, description].hash
    end
