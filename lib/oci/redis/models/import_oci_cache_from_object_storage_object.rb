...
module OCI
  ...
  class Redis::Models::ImportOciCacheFromObjectStorageObject
    # **[Required]** The name of the object in the bucket (for example, 'customerA/exports/backup_ocid/dump.rdb').
    # @return [String]
