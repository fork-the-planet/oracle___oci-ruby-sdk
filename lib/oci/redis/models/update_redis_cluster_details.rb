...
module OCI
  ...
  class Redis::Models::UpdateRedisClusterDetails
    ...
    def hash
      [oci_cache_config_set_id, shard_count, display_name, node_count, node_memory_in_gbs, software_version, nsg_ids, security_attributes, freeform_tags, defined_tags].hash
    end
