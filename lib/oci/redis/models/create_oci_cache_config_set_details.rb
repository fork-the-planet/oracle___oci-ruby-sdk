...
module OCI
  ...
  class Redis::Models::CreateOciCacheConfigSetDetails
    ...
    def hash
      [display_name, compartment_id, description, software_version, configuration_details, freeform_tags, defined_tags].hash
    end
