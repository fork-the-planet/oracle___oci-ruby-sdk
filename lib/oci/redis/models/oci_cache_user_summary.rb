...
module OCI
  ...
  class Redis::Models::OciCacheUserSummary
    ...
    # **[Required]** OCI Cache user authentication type.
    # @return [String]
    attr_accessor :authentication_type

    # **[Required]** OCI Cache user status. ON enables and OFF disables the OCI cache user to use the cluster.
    # @return [String]
    ...
    def hash
      [id, name, compartment_id, authentication_type, status, lifecycle_state, time_created, description, freeform_tags, defined_tags, system_tags].hash
    end
