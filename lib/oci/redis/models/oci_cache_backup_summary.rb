...
module OCI
  ...
  class Redis::Models::OciCacheBackupSummary
    BACKUP_TYPE_ENUM = [
    ...
    # **[Required]** The date and time the backup was created. An [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) formatted datetime string.
    # @return [DateTime]
    ...
    def hash
      [id, display_name, compartment_id, source_cluster_id, time_created, time_updated, lifecycle_state, cluster_mode, backup_source, retention_period_in_days, backup_size_in_gbs, backup_type, freeform_tags, defined_tags, system_tags].hash
    end
