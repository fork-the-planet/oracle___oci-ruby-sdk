...
module OCI
  ...
  class Redis::Models::ConfigurationInfo
    # **[Required]** Key is the configuration key.
    # @return [String]
    attr_accessor :config_key

    # **[Required]** Value of the configuration as a string. Can represent a string, boolean, or number.
    ...
    # @option attributes [String] :config_value The value to assign to the {#config_value} property
    def initialize(attributes = {})
      ...
      self.config_value = attributes[:'configValue'] if attributes[:'configValue']

      raise 'You cannot provide both :configValue and :config_value' if attributes.key?(:'configValue') && attributes.key?(:'config_value')

      self.config_value = attributes[:'config_value'] if attributes[:'config_value']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        config_value == other.config_value
    end
