...
module OCI
  ...
  class Redis::Models::ImportOciCacheFromObjectStorageDetails
    ...
    # **[Required]** The list of objects to import from the specified bucket.
    # @return [Array<OCI::Redis::Models::ImportOciCacheFromObjectStorageObject>]
    ...
    def self.swagger_types
      {
        ...
        'bucket_name': :'String',
        'objects': :'Array<OCI::Redis::Models::ImportOciCacheFromObjectStorageObject>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Redis::Models::ImportOciCacheFromObjectStorageObject>] :objects The value to assign to the {#objects} property
    ...
    def hash
      [namespace_name, bucket_name, objects].hash
    end
