...
module OCI
  ...
  class Redis::Models::RedisClusterSummary
    ...
    def hash
      [id, display_name, compartment_id, lifecycle_state, lifecycle_details, node_count, node_memory_in_gbs, primary_fqdn, primary_endpoint_ip_address, replicas_fqdn, replicas_endpoint_ip_address, discovery_fqdn, discovery_endpoint_ip_address, software_version, subnet_id, time_created, time_updated, oci_cache_config_set_id, cluster_mode, shard_count, nsg_ids, backup_id, security_attributes, freeform_tags, defined_tags, system_tags].hash
    end
