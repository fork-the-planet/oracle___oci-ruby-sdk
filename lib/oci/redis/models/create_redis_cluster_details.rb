...
module OCI
  ...
  class Redis::Models::CreateRedisClusterDetails
    ...
    def hash
      [oci_cache_config_set_id, cluster_mode, shard_count, display_name, compartment_id, node_count, software_version, node_memory_in_gbs, subnet_id, nsg_ids, security_attributes, backup_id, import_from_object_storage_details, freeform_tags, defined_tags].hash
    end
