...
module OCI
  ...
  class Redis::Models::AuthenticationMode
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Redis::Models::IamAuthenticationMode' if type == 'IAM'
      return 'OCI::Redis::Models::PasswordAuthenticationMode' if type == 'PASSWORD'
