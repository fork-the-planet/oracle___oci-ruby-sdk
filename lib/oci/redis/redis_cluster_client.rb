...
module OCI
  ...
  class Redis::RedisClusterClient
    ...
    # @param [OCI::Redis::Models::AttachOciCacheUsersDetails] attach_oci_cache_users_details The parameter details to attach the OCI cache users to the redis cluster.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/redis/attach_oci_cache_users.rb.html) to see an example of how to use attach_oci_cache_users API.
    def attach_oci_cache_users(redis_cluster_id, attach_oci_cache_users_details, opts = {})
      logger.debug 'Calling operation RedisClusterClient#attach_oci_cache_users.' if logger

      raise "Missing the required parameter 'redis_cluster_id' when calling attach_oci_cache_users." if redis_cluster_id.nil?
      raise "Missing the required parameter 'attach_oci_cache_users_details' when calling attach_oci_cache_users." if attach_oci_cache_users_details.nil?
      raise "Parameter value for 'redis_cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(redis_cluster_id)

      path = '/redisClusters/{redisClusterId}/actions/attachOciCacheUsers'.sub('{redisClusterId}', redis_cluster_id.to_s)
      ...
      post_body = @api_client.object_to_http_body(attach_oci_cache_users_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'RedisClusterClient#attach_oci_cache_users') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [String] redis_cluster_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm#Oracle) of the cluster.
    # @param [OCI::Redis::Models::DetachOciCacheUsersDetails] detach_oci_cache_users_details The parameter details to detach the OCI cache users to the redis cluster.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/redis/detach_oci_cache_users.rb.html) to see an example of how to use detach_oci_cache_users API.
    def detach_oci_cache_users(redis_cluster_id, detach_oci_cache_users_details, opts = {})
      logger.debug 'Calling operation RedisClusterClient#detach_oci_cache_users.' if logger

      raise "Missing the required parameter 'redis_cluster_id' when calling detach_oci_cache_users." if redis_cluster_id.nil?
      raise "Missing the required parameter 'detach_oci_cache_users_details' when calling detach_oci_cache_users." if detach_oci_cache_users_details.nil?
      raise "Parameter value for 'redis_cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(redis_cluster_id)

      path = '/redisClusters/{redisClusterId}/actions/detachOciCacheUsers'.sub('{redisClusterId}', redis_cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(detach_oci_cache_users_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'RedisClusterClient#detach_oci_cache_users') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type Array<{OCI::Redis::Models::AttachedOciCacheUser AttachedOciCacheUser}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/redis/list_attached_oci_cache_users.rb.html) to see an example of how to use list_attached_oci_cache_users API.
    def list_attached_oci_cache_users(redis_cluster_id, opts = {})
      logger.debug 'Calling operation RedisClusterClient#list_attached_oci_cache_users.' if logger

      raise "Missing the required parameter 'redis_cluster_id' when calling list_attached_oci_cache_users." if redis_cluster_id.nil?
      ...
      path = '/redisClusters/{redisClusterId}/actions/getOciCacheUsers'.sub('{redisClusterId}', redis_cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'RedisClusterClient#list_attached_oci_cache_users') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'Array<OCI::Redis::Models::AttachedOciCacheUser>'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
