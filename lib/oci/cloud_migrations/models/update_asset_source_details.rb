...
module OCI
  ...
  class CloudMigrations::Models::UpdateAssetSourceDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudMigrations::Models::UpdateOlvmAssetSourceDetails' if type == 'OLVM'
      return 'OCI::CloudMigrations::Models::UpdateAwsAssetSourceDetails' if type == 'AWS'
    ...
    def hash
      [type, display_name, assets_compartment_id, discovery_schedule_id, freeform_tags, defined_tags, system_tags, environment_type].hash
    end
