...
module OCI
  ...
  class CloudMigrations::Models::MigrationAsset
    ...
    # @return [OCI::CloudMigrations::Models::ReplicationLocationDetail]
    attr_accessor :replication_location_detail

    # Mapping of source disk id to destination disk details
    # @return [Hash<String, OCI::CloudMigrations::Models::DestinationDisk>]
    attr_accessor :destination_disks
    ...
    def self.swagger_types
      {
        ...
        'replication_location_detail': :'OCI::CloudMigrations::Models::ReplicationLocationDetail',
        'destination_disks': :'Hash<String, OCI::CloudMigrations::Models::DestinationDisk>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::CloudMigrations::Models::ReplicationLocationDetail] :replication_location_detail The value to assign to the {#replication_location_detail} property
    # @option attributes [Hash<String, OCI::CloudMigrations::Models::DestinationDisk>] :destination_disks The value to assign to the {#destination_disks} property
    def initialize(attributes = {})
      ...
      self.replication_location_detail = attributes[:'replicationLocationDetail'] if attributes[:'replicationLocationDetail']

      raise 'You cannot provide both :replicationLocationDetail and :replication_location_detail' if attributes.key?(:'replicationLocationDetail') && attributes.key?(:'replication_location_detail')

      self.replication_location_detail = attributes[:'replication_location_detail'] if attributes[:'replication_location_detail']

      self.destination_disks = attributes[:'destinationDisks'] if attributes[:'destinationDisks']

      raise 'You cannot provide both :destinationDisks and :destination_disks' if attributes.key?(:'destinationDisks') && attributes.key?(:'destination_disks')

      self.destination_disks = attributes[:'destination_disks'] if attributes[:'destination_disks']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        replication_location_detail == other.replication_location_detail &&
        destination_disks == other.destination_disks
    end
    ...
    def hash
      [id, type, display_name, compartment_id, lifecycle_state, lifecycle_details, time_created, time_updated, migration_id, snapshots, parent_snapshot, source_asset_data, notifications, source_asset_id, replication_schedule_id, availability_domain, replication_compartment_id, tenancy_id, snap_shot_bucket_name, depended_on_by, depends_on, replication_location_detail, destination_disks].hash
    end
