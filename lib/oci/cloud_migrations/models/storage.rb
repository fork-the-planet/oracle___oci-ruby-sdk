...
module OCI
  ...
  class CloudMigrations::Models::Storage
    NFS_VERSION_ENUM = [
    ...
    # @return [Array<OCI::CloudMigrations::Models::LogicalUnit>]
    ...
    # @return [OCI::CloudMigrations::Models::VolumeGroup]
    ...
    def self.swagger_types
      {
        ...
        'driver_options': :'Array<OCI::CloudMigrations::Models::OlvmProperty>',
        'driver_sensitive_options': :'Array<OCI::CloudMigrations::Models::OlvmProperty>',
        'logical_units': :'Array<OCI::CloudMigrations::Models::LogicalUnit>',
        ...
        'type': :'String',
        'vfs_type': :'String',
        'volume_group': :'OCI::CloudMigrations::Models::VolumeGroup'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::CloudMigrations::Models::OlvmProperty>] :driver_options The value to assign to the {#driver_options} property
    # @option attributes [Array<OCI::CloudMigrations::Models::OlvmProperty>] :driver_sensitive_options The value to assign to the {#driver_sensitive_options} property
    # @option attributes [Array<OCI::CloudMigrations::Models::LogicalUnit>] :logical_units The value to assign to the {#logical_units} property
    ...
    # @option attributes [OCI::CloudMigrations::Models::VolumeGroup] :volume_group The value to assign to the {#volume_group} property
