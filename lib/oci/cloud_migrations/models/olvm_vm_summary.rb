...
module OCI
  ...
  class CloudMigrations::Models::OlvmVmSummary
    ...
    # @option attributes [Integer] :active The value to assign to the {#active} property
    # @option attributes [Integer] :migrating The value to assign to the {#migrating} property
    ...
    def initialize(attributes = {})
      ...
      self.active = attributes[:'active'] if attributes[:'active']

      self.migrating = attributes[:'migrating'] if attributes[:'migrating']
