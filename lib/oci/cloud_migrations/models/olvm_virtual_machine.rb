...
module OCI
  ...
  class CloudMigrations::Models::OlvmVirtualMachine
    ...
    # @return [OCI::CloudMigrations::Models::OlvmBios]
    attr_accessor :bios
    ...
    # @return [OCI::CloudMigrations::Models::OlvmConsole]
    ...
    # @return [Array<OCI::CloudMigrations::Models::OlvmCustomProperty>]
    ...
    # @return [OCI::CloudMigrations::Models::OlvmDomain]
    ...
    # @return [OCI::CloudMigrations::Models::OlvmGuestOperatingSystem]
    ...
    # @return [OCI::CloudMigrations::Models::OlvmHighAvailability]
    attr_accessor :high_availability

    # @return [OCI::CloudMigrations::Models::OlvmInitialization]
    ...
    # @return [OCI::CloudMigrations::Models::OlvmIcon]
    attr_accessor :large_icon

    # @return [OCI::CloudMigrations::Models::OlvmStorageDomainProperties]
    ...
    # @return [OCI::CloudMigrations::Models::OlvmMemoryPolicy]
    attr_accessor :memory_policy

    # @return [OCI::CloudMigrations::Models::OlvmMigrationOptions]
    ...
    # @return [OCI::CloudMigrations::Models::OlvmVmPlacementPolicy]
    ...
    # @return [OCI::CloudMigrations::Models::OlvmSerialNumber]
    ...
    # @return [OCI::CloudMigrations::Models::OlvmVmStatus]
    ...
    # @return [OCI::CloudMigrations::Models::OlvmVmType]
    attr_accessor :type

    # @return [OCI::CloudMigrations::Models::OlvmUsb]
    attr_accessor :usb
    ...
    # @option attributes [OCI::CloudMigrations::Models::OlvmBios] :bios The value to assign to the {#bios} property
    # @option attributes [String] :comment The value to assign to the {#comment} property
    # @option attributes [OCI::CloudMigrations::Models::OlvmConsole] :console The value to assign to the {#console} property
    ...
    # @option attributes [OCI::CloudMigrations::Models::OlvmVersion] :custom_compatibility_version The value to assign to the {#custom_compatibility_version} property
    ...
    # @option attributes [Array<OCI::CloudMigrations::Models::OlvmCustomProperty>] :custom_properties The value to assign to the {#custom_properties} property
    ...
    # @option attributes [OCI::CloudMigrations::Models::OlvmDomain] :domain The value to assign to the {#domain} property
    # @option attributes [String] :fqdn The value to assign to the {#fqdn} property
    # @option attributes [OCI::CloudMigrations::Models::OlvmGuestOperatingSystem] :guest_operating_system The value to assign to the {#guest_operating_system} property
    ...
    # @option attributes [OCI::CloudMigrations::Models::OlvmHighAvailability] :high_availability The value to assign to the {#high_availability} property
    # @option attributes [OCI::CloudMigrations::Models::OlvmInitialization] :initialization The value to assign to the {#initialization} property
    # @option attributes [Integer] :io_threads The value to assign to the {#io_threads} property
    # @option attributes [OCI::CloudMigrations::Models::OlvmIcon] :large_icon The value to assign to the {#large_icon} property
    # @option attributes [OCI::CloudMigrations::Models::OlvmStorageDomainProperties] :storage_domain_lease The value to assign to the {#storage_domain_lease} property
    # @option attributes [Integer] :memory_in_bytes The value to assign to the {#memory_in_bytes} property
    # @option attributes [OCI::CloudMigrations::Models::OlvmMemoryPolicy] :memory_policy The value to assign to the {#memory_policy} property
    # @option attributes [OCI::CloudMigrations::Models::OlvmMigrationOptions] :migration_policy The value to assign to the {#migration_policy} property
    ...
    # @option attributes [OCI::CloudMigrations::Models::OlvmVmPlacementPolicy] :placement_policy The value to assign to the {#placement_policy} property
    # @option attributes [BOOLEAN] :is_run_once The value to assign to the {#is_run_once} property
    # @option attributes [OCI::CloudMigrations::Models::OlvmSerialNumber] :serial_number The value to assign to the {#serial_number} property
    # @option attributes [OCI::CloudMigrations::Models::OlvmIcon] :small_icon The value to assign to the {#small_icon} property
    ...
    # @option attributes [OCI::CloudMigrations::Models::OlvmVmStatus] :status The value to assign to the {#status} property
    ...
    # @option attributes [OCI::CloudMigrations::Models::OlvmVmType] :type The value to assign to the {#type} property
    # @option attributes [OCI::CloudMigrations::Models::OlvmUsb] :usb The value to assign to the {#usb} property
