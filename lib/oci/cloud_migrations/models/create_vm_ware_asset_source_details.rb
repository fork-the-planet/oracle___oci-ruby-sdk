...
module OCI
  ...
  class CloudMigrations::Models::CreateVmWareAssetSourceDetails < CloudMigrations::Models::CreateAssetSourceDetails
    ...
    def hash
      [type, display_name, compartment_id, environment_id, inventory_id, assets_compartment_id, discovery_schedule_id, freeform_tags, defined_tags, system_tags, environment_type, vcenter_endpoint, discovery_credentials, replication_credentials, are_historical_metrics_collected, are_realtime_metrics_collected].hash
    end
