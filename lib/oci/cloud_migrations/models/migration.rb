...
module OCI
  ...
  class CloudMigrations::Models::Migration
    ...
    MIGRATION_TYPE_ENUM = [
      MIGRATION_TYPE_OCI = 'OCI'.freeze,
      MIGRATION_TYPE_OLVM = 'OLVM'.freeze,
    ...
    # @return [OCI::CloudMigrations::Models::MigrationConfig]
    attr_accessor :migration_config
    ...
    def self.swagger_types
      {
        ...
        'migration_config': :'OCI::CloudMigrations::Models::MigrationConfig',
    ...
    # @option attributes [OCI::CloudMigrations::Models::MigrationConfig] :migration_config The value to assign to the {#migration_config} property
    ...
    def initialize(attributes = {})
      ...
      self.migration_type = "OCI" if migration_type.nil? && !attributes.key?(:'migrationType') # rubocop:disable Style/StringLiterals
      ...
      self.migration_type = "OCI" if migration_type.nil? && !attributes.key?(:'migrationType') && !attributes.key?(:'migration_type') # rubocop:disable Style/StringLiterals

      self.migration_config = attributes[:'migrationConfig'] if attributes[:'migrationConfig']

      raise 'You cannot provide both :migrationConfig and :migration_config' if attributes.key?(:'migrationConfig') && attributes.key?(:'migration_config')

      self.migration_config = attributes[:'migration_config'] if attributes[:'migration_config']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        migration_config == other.migration_config &&
    ...
    def hash
      [id, display_name, compartment_id, lifecycle_state, lifecycle_details, time_created, time_updated, replication_schedule_id, is_completed, migration_type, migration_config, freeform_tags, defined_tags, system_tags, security_attributes].hash
    end
