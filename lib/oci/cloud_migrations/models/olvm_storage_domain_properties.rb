...
module OCI
  ...
  class CloudMigrations::Models::OlvmStorageDomainProperties
    ...
    # @return [OCI::CloudMigrations::Models::Storage]
    ...
    def self.swagger_types
      {
        ...
        'storage': :'OCI::CloudMigrations::Models::Storage',
    ...
    # @option attributes [OCI::CloudMigrations::Models::Storage] :storage The value to assign to the {#storage} property
