...
module OCI
  ...
  class CloudMigrations::Models::ComputeProperties
    ...
    # @return [Array<OCI::CloudMigrations::Models::GpuDevice>]
    ...
    # @return [Array<OCI::CloudMigrations::Models::Nic>]
    attr_accessor :nics
    ...
    # @return [Array<OCI::CloudMigrations::Models::Disk>]
    attr_accessor :disks
    ...
    # @return [Array<OCI::CloudMigrations::Models::Nvdimm>]
    attr_accessor :nvdimms

    # @return [OCI::CloudMigrations::Models::NvdimmController]
    attr_accessor :nvdimm_controller

    # @return [OCI::CloudMigrations::Models::ScsiController]
    ...
    def self.swagger_types
      {
        ...
        'gpu_devices': :'Array<OCI::CloudMigrations::Models::GpuDevice>',
        ...
        'nics_count': :'Integer',
        'nics': :'Array<OCI::CloudMigrations::Models::Nic>',
        'storage_provisioned_in_mbs': :'Integer',
        'disks_count': :'Integer',
        'disks': :'Array<OCI::CloudMigrations::Models::Disk>',
        'firmware': :'String',
        'latency_sensitivity': :'String',
        'nvdimms': :'Array<OCI::CloudMigrations::Models::Nvdimm>',
        'nvdimm_controller': :'OCI::CloudMigrations::Models::NvdimmController',
        'scsi_controller': :'OCI::CloudMigrations::Models::ScsiController',
    ...
    # @option attributes [Array<OCI::CloudMigrations::Models::GpuDevice>] :gpu_devices The value to assign to the {#gpu_devices} property
    ...
    # @option attributes [Array<OCI::CloudMigrations::Models::Nic>] :nics The value to assign to the {#nics} property
    ...
    # @option attributes [Array<OCI::CloudMigrations::Models::Disk>] :disks The value to assign to the {#disks} property
    ...
    # @option attributes [Array<OCI::CloudMigrations::Models::Nvdimm>] :nvdimms The value to assign to the {#nvdimms} property
    # @option attributes [OCI::CloudMigrations::Models::NvdimmController] :nvdimm_controller The value to assign to the {#nvdimm_controller} property
    # @option attributes [OCI::CloudMigrations::Models::ScsiController] :scsi_controller The value to assign to the {#scsi_controller} property
