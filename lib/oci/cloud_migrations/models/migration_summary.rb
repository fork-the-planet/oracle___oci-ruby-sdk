...
module OCI
  ...
  class CloudMigrations::Models::MigrationSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, is_completed, replication_schedule_id, migration_type, migration_config, freeform_tags, defined_tags, system_tags, security_attributes].hash
    end
