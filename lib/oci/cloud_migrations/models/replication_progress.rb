...
module OCI
  ...
  class CloudMigrations::Models::ReplicationProgress
    ...
    # @return [String]
    attr_accessor :last_replication_sub_status
    ...
    # @option attributes [String] :last_replication_sub_status The value to assign to the {#last_replication_sub_status} property
