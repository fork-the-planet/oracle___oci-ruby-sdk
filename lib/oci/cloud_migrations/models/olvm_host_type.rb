...
module OCI
  ...
  class CloudMigrations::Models::OlvmHostType
    HOST_TYPE_ENUM = [
      HOST_TYPE_OVIRT_NODE = 'OVIRT_NODE'.freeze,
      HOST_TYPE_RHEL = 'RHEL'.freeze,
      HOST_TYPE_RHEV_H = 'RHEV_H'.freeze
    ].freeze
    ...
    def host_type=(host_type)
      raise "Invalid value for 'host_type': this must be one of the values in HOST_TYPE_ENUM." if host_type && !HOST_TYPE_ENUM.include?(host_type)
