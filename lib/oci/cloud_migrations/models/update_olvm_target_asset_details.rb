...
module OCI
  ...
  class CloudMigrations::Models::UpdateOlvmTargetAssetDetails < CloudMigrations::Models::UpdateTargetAssetDetails
    ...
    def hash
      [type, is_excluded_from_execution, ms_license].hash
    end
