...
module OCI
  ...
  class CloudMigrations::Models::Asset
    ASSET_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudMigrations::Models::AwsEc2Asset' if type == 'AWS_EC2'
      return 'OCI::CloudMigrations::Models::VmwareVmAsset' if type == 'VMWARE_VM'
      return 'OCI::CloudMigrations::Models::AwsEbsAsset' if type == 'AWS_EBS'
      return 'OCI::CloudMigrations::Models::VmAsset' if type == 'VM'

      # TODO: Log a warning when the subtype is not found.
      'OCI::CloudMigrations::Models::Asset'
    end
    ...
    def hash
      [display_name, inventory_id, id, compartment_id, source_key, external_asset_key, asset_type, time_created, time_updated, asset_source_ids, lifecycle_state, freeform_tags, defined_tags, system_tags, environment_type].hash
    end
