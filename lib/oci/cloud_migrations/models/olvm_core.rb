...
module OCI
  ...
  class CloudMigrations::Models::OlvmCore
    ...
    # @option attributes [Integer] :socket The value to assign to the {#socket} property
    def initialize(attributes = {})
      ...
      self.socket = attributes[:'socket'] if attributes[:'socket']
    end
