...
module OCI
  ...
  class CloudMigrations::Models::OlvmTargetAsset < CloudMigrations::Models::TargetAsset
    ...
    def hash
      [id, display_name, lifecycle_state, lifecycle_details, migration_plan_id, compartment_id, created_resource_id, type, is_excluded_from_execution, compatibility_messages, estimated_cost, time_created, time_updated, time_assessed, migration_asset, ms_license].hash
    end
