...
module OCI
  ...
  class CloudMigrations::Models::CreateMigrationAssetDetails
    ...
    def hash
      [display_name, inventory_asset_id, migration_id, replication_schedule_id, availability_domain, replication_compartment_id, snap_shot_bucket_name, replication_location_detail, depends_on].hash
    end
