...
module OCI
  ...
  class CloudMigrations::Models::OlvmIcon
    ...
    # @option attributes [String] :media_type The value to assign to the {#media_type} property
    ...
    def initialize(attributes = {})
      ...
      self.media_type = attributes[:'mediaType'] if attributes[:'mediaType']

      raise 'You cannot provide both :mediaType and :media_type' if attributes.key?(:'mediaType') && attributes.key?(:'media_type')

      self.media_type = attributes[:'media_type'] if attributes[:'media_type']
    ...
    def hash
      [comment, data, description, id, media_type, name].hash
    end
