...
module OCI
  ...
  class CloudMigrations::Models::OlvmTargetAssetSummary < CloudMigrations::Models::TargetAssetSummary
    ...
    def hash
      [id, display_name, lifecycle_state, migration_plan_id, compartment_id, created_resource_id, type, is_excluded_from_execution, compatibility_messages, estimated_cost, time_created, lifecycle_details, time_updated, time_assessed, migration_asset, ms_license].hash
    end
