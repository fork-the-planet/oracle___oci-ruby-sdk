...
module OCI
  ...
  class CloudMigrations::Models::OlvmMigrationOptions
    AUTO_CONVERGE_ENUM = [
    ...
    # @return [OCI::CloudMigrations::Models::MigrationBandwidth]
    ...
    # @option attributes [OCI::CloudMigrations::Models::MigrationBandwidth] :bandwidth The value to assign to the {#bandwidth} property
