...
module OCI
  ...
  class CloudMigrations::Models::UpdateAwsAssetSourceDetails < CloudMigrations::Models::UpdateAssetSourceDetails
    ...
    def hash
      [type, display_name, assets_compartment_id, discovery_schedule_id, freeform_tags, defined_tags, system_tags, environment_type, discovery_credentials, replication_credentials, are_historical_metrics_collected, are_realtime_metrics_collected, is_cost_information_collected].hash
    end
