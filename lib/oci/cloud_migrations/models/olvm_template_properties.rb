...
module OCI
  ...
  class CloudMigrations::Models::OlvmTemplateProperties
    ...
    # @return [OCI::CloudMigrations::Models::OlvmTemplateVersion]
    ...
    # @return [OCI::CloudMigrations::Models::OlvmVirtualMachine]
    attr_accessor :vm
    ...
    # @option attributes [OCI::CloudMigrations::Models::OlvmTemplateVersion] :version The value to assign to the {#version} property
    ...
    # @option attributes [OCI::CloudMigrations::Models::OlvmVirtualMachine] :vm The value to assign to the {#vm} property
