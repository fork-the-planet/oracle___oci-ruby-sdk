...
module OCI
  ...
  class CloudMigrations::Models::OlvmBootProtocol
    PROTOCOL_ENUM = [
      PROTOCOL_AUTOCONF = 'AUTOCONF'.freeze,
      PROTOCOL_DHCP = 'DHCP'.freeze,
      PROTOCOL_NONE = 'NONE'.freeze,
      PROTOCOL_POLY_DHCP_AUTOCONF = 'POLY_DHCP_AUTOCONF'.freeze,
      PROTOCOL_STATIC = 'STATIC'.freeze
    ].freeze
