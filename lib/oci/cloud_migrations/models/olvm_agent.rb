...
module OCI
  ...
  class CloudMigrations::Models::OlvmAgent
    # Fence agent address
    # @return [String]
    ...
    # @return [BOOLEAN]
    attr_accessor :is_encrypt_options
    ...
    # @option attributes [BOOLEAN] :is_concurrent The value to assign to the {#is_concurrent} property
    # @option attributes [String] :description The value to assign to the {#description} property
    # @option attributes [BOOLEAN] :is_encrypt_options The value to assign to the {#is_encrypt_options} property
