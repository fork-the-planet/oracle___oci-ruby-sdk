...
module OCI
  ...
  class CloudMigrations::Models::VmwareVmProperties
    # Cluster name.
    # @return [String]
    ...
    # @return [Array<OCI::CloudMigrations::Models::CustomerTag>]
    ...
    def self.swagger_types
      {
        ...
        'customer_tags': :'Array<OCI::CloudMigrations::Models::CustomerTag>',
    ...
    # @option attributes [Array<OCI::CloudMigrations::Models::CustomerTag>] :customer_tags The value to assign to the {#customer_tags} property
