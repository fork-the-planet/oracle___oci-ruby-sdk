...
module OCI
  ...
  class CloudMigrations::Models::CreateOlvmTargetAssetDetails < CloudMigrations::Models::CreateTargetAssetDetails
    ...
    def hash
      [migration_plan_id, type, is_excluded_from_execution, ms_license].hash
    end
