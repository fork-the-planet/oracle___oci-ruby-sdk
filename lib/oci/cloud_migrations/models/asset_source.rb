...
module OCI
  ...
  class CloudMigrations::Models::AssetSource
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudMigrations::Models::OlvmAssetSource' if type == 'OLVM'
      return 'OCI::CloudMigrations::Models::AwsAssetSource' if type == 'AWS'
    ...
    def hash
      [type, id, compartment_id, display_name, environment_id, inventory_id, assets_compartment_id, discovery_schedule_id, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags, environment_type].hash
    end
